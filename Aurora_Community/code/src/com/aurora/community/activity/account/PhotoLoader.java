...
public abstract class PhotoLoader<T> extends AsyncTask<String, Integer, Bitmap> {
    ...
    private static String getFinalCropPhotoFileName() {
        return "."+AccountPreferencesUtil.getInstance(CommunityApp.getInstance()).getUserID() + ".jpg";
    }
    ...
    public static Bitmap loadLocalCacheIcon() {
        ...
        AccountPreferencesUtil pref = AccountPreferencesUtil.getInstance(CommunityApp.getInstance());
        if (iconFile.exists()) {
