...
import com.aurora.community.utils.AccountPreferencesUtil;
...
public abstract class BaseAccountActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setBackItemRes(R.drawable.aurora_actionbar_back_arrow_selector);
	    setActionBarBg(R.drawable.aurora_action_bar_top_bg);
	    setTitleColor(getResources().getColor(R.color.action_bar_account_text_color));
