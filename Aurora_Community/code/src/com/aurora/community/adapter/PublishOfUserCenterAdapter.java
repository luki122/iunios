...
public class PublishOfUserCenterAdapter extends BaseAdapter {

	private List<PublishDataInfo> datas;
	...
	public PublishOfUserCenterAdapter(List<PublishDataInfo> datas,
			Context mContext) {
		super();
		this.datas = datas;
	...
	private void setData(int position,Holder holder){
		PublishDataInfo data = datas.get(position);
		setShowText(data, holder);
		setShowImage(data, holder);
	}
	
	private void setShowText(PublishDataInfo data,Holder holder){
	...
	private void setShowImage(PublishDataInfo data,Holder holder){
