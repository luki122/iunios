...
public class ImagePickerPhotoAdapter extends BaseAdapter{
	...
	public ImagePickerPhotoAdapter(Context c ,ArrayList<PhotoInfo> l,GridView g,int left){
		this.context = c;
		this.list  = l;
	...
	public void refreshView(int index){
		...
		if(info.isChoose()){
			final AnimationDrawable frame = (AnimationDrawable)context.getResources().getDrawable(R.drawable.quick_check_animation); 
			...
			holder.item_check.setImageDrawable(context.getResources().getDrawable(R.drawable.quick_check_01));
		}
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_image_pick_photo, null);
			holder.item_photo = (ImageView)convertView.findViewById(R.id.item_iv_photo);
			holder.item_check = (ImageView)convertView.findViewById(R.id.item_iv_selected);
	...
	if(list.get(position).isChoose()){
		...
		ImageLoaderHelper.disPlay(info.getPath_file(), 
				new RotateImageViewAware(holder.item_photo,info.getPath_absolute()), DefaultUtil.getDefaultImageDrawable(context));
		...
		holder.item_check.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(info.isChoose()){
					...
					((ImageView)arg0).setImageDrawable(context.getResources().getDrawable(R.drawable.quick_check_01));
