...
import com.aurora.community.activity.account.VerifyCodeLoader;
import com.aurora.community.activity.account.VerifyCodeLoader.LoadVerifyCodeErrorInfo;
import com.aurora.community.activity.account.VerifyCodeLoader.OnVerifyCodeLoadDoneListener;
...
public class VerifyCodeView extends FrameLayout implements OnVerifyCodeLoadDoneListener {
    ...
    private static final float sRoundRadius = DensityUtil.dip2px(CommunityApp.getInstance(), 5);
