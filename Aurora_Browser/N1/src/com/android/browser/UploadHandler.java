...
public class UploadHandler {
    ...
    void openFileChooser(ValueCallback<Uri[]> callback, FileChooserParams fileChooserParams) {
        ...
        if (mimeType.equals(imageMimeType)) {
            if (mediaSource.equals(mediaSourceValueCamera) || captureEnabled) {
            ...
            if (mediaSource.equals(mediaSourceValueCamcorder) || captureEnabled) {
            ...
            if (mediaSource.equals(mediaSourceValueMicrophone) || captureEnabled) {
