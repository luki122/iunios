...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    /**
     * 
     * Vulcan created this method in 2015年1月20日 下午5:57:35 .
     */
    public static void executeSetup() {
    	BackgroundHandler.execute(getInstance().mSetup);
    }
    ...
    private BrowserSettings(Context context) {
        ...
        changeDefaultHomepage();
        BackgroundHandler.execute(mSetup);
    }

    private void changeDefaultHomepage() {
        String oldHomepageUrl = "http://m.iuni.com/";
        String newHomepageUrl = "file:///android_asset/index.html";

        String homepageMode = mPrefs.getString(PREF_HOMEPAGE_PICKER, "default");
        String homepageUrl = mPrefs.getString(PREF_HOMEPAGE, oldHomepageUrl);
        if ("default".equals(homepageMode) && oldHomepageUrl.equals(homepageUrl)) {
            setHomePage(newHomepageUrl);
        }
    }
    ...
    private void syncSetting(WebSettings settings) {
        ...
        settings.setLoadsImagesAutomatically(!noPicture());
    ...
    public void clearHistory() {
        ...
        Log.d("vbrowser","clearHistory: resolver = " + resolver);
    }
    ...
    public String getSearchEngineName() {
        ...
        return mPrefs.getString(PREF_SEARCH_ENGINE, "baidu");
    }
    ...
    /**
     * 
     * Vulcan created this method in 2015年1月21日 上午11:46:34 .
     * @return
     */
    public boolean noPicture() {
    	Boolean b =  mPrefs.getBoolean(PREF_NO_PICTURE_MODE, false);
    	Log.d("noPicture","noPicture = " + b);
    	return b;
    }
    ...
    public void setHomePage(String value) {
        ...
        Log.d("vset","setHomePage: value = " + value);
    }
    ...
    /**
     * 
     * Vulcan created this method in 2015年1月24日 下午6:49:27 .
     * @return
     */
    public boolean saveFormdata() {
        Boolean b = mPrefs.getBoolean(PREF_SAVE_FORMDATA, true);
        Log.d("vset","saveFormdata: " + b);
        return b;
    }
    ...
    /**
     * 
     * Vulcan created this method in 2015年1月26日 下午5:45:22 .
     * @return
     */
    public boolean rememberPasswords() {
        Boolean b =  mPrefs.getBoolean(PREF_REMEMBER_PASSWORDS, true);
        Log.d("vset","rememberPasswords: " + b);
        return b;
    }
