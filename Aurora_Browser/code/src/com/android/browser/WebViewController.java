...
public interface WebViewController {
    ...
    void doUpdateVisitedHistory(Tab tab, boolean isReload, String url);
    ...
    void changeStatueOfWebToolsButton();
    void setShouldShowErrorView(boolean show);
    boolean getErrorViewState();
    Bitmap getErrorBitmap(Tab tab, int mCaptureWidth, int mCaptureHeight, int mainViewWidth);
}
