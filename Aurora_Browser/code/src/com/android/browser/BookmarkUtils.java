...
public class BookmarkUtils {
	...
	public static void displayRemoveBookmarkHistoryDialog(String title, final Uri uri, final Context context, final Message msg) {
		new AuroraAlertDialog.Builder(context)
        .setIconAttribute(android.R.attr.alertDialogIcon)
        .setTitle(context.getResources().getString(R.string.autofill_profile_editor_delete_profile))
        .setMessage(context.getResources().getString(R.string.if_delete_the) + title + "？")
        .setPositiveButton(R.string.ok,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int whichButton) {
