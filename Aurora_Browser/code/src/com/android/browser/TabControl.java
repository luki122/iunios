...
import com.android.phase1.view.AuroraTab;
...
public class TabControl {
    ...
    public void setNumberChangeListener(NumberChangeListener listener) {
        mListener = listener;
    }
    ...
    void addPreloadedTab(Tab tab) {
        ...
        mTabs.add(tab);
        mListener.onNumberChange(mTabs.size());
    ...
    Tab createNewTab(Bundle state, boolean privateBrowsing) {
        ...
        Tab t = new AuroraTab(mController, w, state);
        mTabs.add(t);
        mListener.onNumberChange(mTabs.size());
    ...
    void restoreState(Bundle inState, long currentId,
        ...
        for (long id : ids) {
            ...
            if (state == null || state.isEmpty()) {
                ...
                // to the tab list
                Tab t = new AuroraTab(mController, state);
                tabMap.put(id, t);
                mTabs.add(t);
                mListener.onNumberChange(mTabs.size());
