...
public class BrowserActivity extends AuroraActivity implements OnGlobalLayoutListener{
    ...
    private Controller createController() {
        ...
        if (xlarge) {
            ...
            ui = new AuroraPhoneUi(this, controller);
        }
        controller.setUi(ui);
        return controller;
    }
    ...
    private boolean mOnLayoutCreatedCalled = false;
    private Intent mBrowserIntent = null;
