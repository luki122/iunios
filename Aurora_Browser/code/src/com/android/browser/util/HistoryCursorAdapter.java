...
public abstract class HistoryCursorAdapter<T> extends BaseAdapter {
    ...
    public HistoryCursorAdapter(Context context, Cursor c) {
        ...
        mCursorAdapter = new CursorAdapter(context, c, 0) {
            ...
            public void notifyDataSetInvalidated() {
                ...
                mSize = getCount();
                mGeneration++;
                HistoryCursorAdapter.this.notifyDataSetInvalidated();
            }
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (view == null
                        || container.owner != HistoryCursorAdapter.this
                ...
                bindView(view, container.bind_object, msg.what);
            }
        };
    }
