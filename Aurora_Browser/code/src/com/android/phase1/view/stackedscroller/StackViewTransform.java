...
public class StackViewTransform {
    ...
    public StackViewTransform() {
        // Do nothing
    }

    public StackViewTransform(StackViewTransform o) {
    ...
    public void applyToTaskView(View v, int duration, boolean allowLayers, AnimatorListener animatorListener) {
        ...
        if (duration > 0) {
            ...
            anim.setListener(animatorListener);
