...
class StackViewTouchHandler implements SwipeHelper.Callback {
    ...
    private static final float sDefaultStackOverscrollPct = 0.0875f;

    StackViewLayout mSv;
    StackViewScroller mScroller;
    ...
    StackView mActiveTaskView = null;
    ...
    public StackViewTouchHandler(Context context, StackViewLayout sv, StackViewScroller scroller) {
    ...
    StackView findViewAtPoint(int x, int y) {
        int childCount = mSv.getChildCount();
        for (int i = childCount - 1; i >= 0; i--) {
            StackView tv = (StackView) mSv.getChildAt(i);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIsScrolling) {
                    ...
                    if (Float.compare(overScrollAmount, 0f) != 0) {
                        ...
                        float maxOverScroll = sDefaultStackOverscrollPct;
