...
class FakeShadowDrawable extends Drawable {
    ...
    private static final int sDefaultFakeShadowStartColor = 0x44000000;
    private static final int sDefaultFakeShadowEndColor = 0x03000000;
    ...
    public FakeShadowDrawable(Context context) {
        mShadowStartColor = sDefaultFakeShadowStartColor;
        mShadowEndColor = sDefaultFakeShadowEndColor;
        mInsetShadow = StackViewUtil.dip2px(context, 1);
        int fakeShadowSize = StackViewUtil.dip2px(context, 8);
        setShadowSize(fakeShadowSize, fakeShadowSize);
        
        mCornerShadowPaint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
        mCornerShadowPaint.setStyle(Paint.Style.FILL);
        mCornerShadowPaint.setDither(true);
        mCornerRadius = StackViewUtil.dip2px(context, 2);
