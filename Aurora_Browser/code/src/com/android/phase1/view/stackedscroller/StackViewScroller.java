...
public class StackViewScroller {
    ...
    private static final int sDefaultStackScrollDuration = 225;
    ...
    public StackViewScroller(Context context, StackViewLayoutAlgorithm layoutAlgorithm) {
    ...
    public void setStackScroll(float s) {
    	//Log.d("vscroll","setStackScroll: s = " + s);
        mStackScrollP = s;
        if (mCb != null) {
    ...
    void animateScroll(float curScroll, float newScroll, final Runnable postRunnable) {
        ...
        mScrollAnimator.setDuration(sDefaultStackScrollDuration);
