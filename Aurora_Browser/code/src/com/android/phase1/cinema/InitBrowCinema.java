...
public class InitBrowCinema extends Cinema {

	public InitBrowCinema(Context context, View contentView,
	...
	public void create(Context context) {
		...
		oa = titleBarAndToolBarAnimator(0, -titlebarHeight, CINEMA_TIME);
		oa2 = toolBarAndToolBarAnimator(0, toolbarHeight, CINEMA_TIME);
		oa3 = webViewContentAnimator(titlebarHeight,0, CINEMA_TIME);
		animatorList.add(oa);
		animatorList.add(oa2);
		animatorList.add(oa3);
		//as.play(oa).with(oa2).with(oa3);
