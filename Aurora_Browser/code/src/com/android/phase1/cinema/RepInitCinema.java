...
/*		int toolbarHeight = context.getResources().getDimensionPixelSize(
		...
		// oa =
		// titleBarAndToolBarAnimator(-mFixedTitlebarContainer.getHeight(),0,CINEMA_TIME);
		// oa2 = toolBarAndToolBarAnimator(mToolBarContainer.getHeight(),0
		// ,CINEMA_TIME);
		oa3 = webViewContentAnimator(0, titlebarHeight, CINEMA_TIME);
		// animatorList.add(oa);
