...
//	private static final String TAG = CameraManager.class.getSimpleName();
	...
	// the dimentions of frame has been fixed by xml
	...
	private CameraManager(Context context) {
		...
		// get the dimentions for the frame of camera
		FRAME_WIDTH = (int)context.getResources().getDimension(R.dimen.vs_barcode_scanning_frame_width);
		FRAME_HEIGHT = (int)context.getResources().getDimension(R.dimen.vs_barcode_scanning_frame_height);
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		if (camera == null) {
			...
			// add to change the display of camera to be "portrait" mode
...
//		Log.d("ZXingDemo", "CameraManager-----------requestPreviewFrame");
		if (camera != null && previewing) {
...
//			int topOffset = (screenResolution.y - height) / 2;
			int topOffset = (int)context.getResources().getDimension(R.dimen.vs_barcode_scanning_top_offset);
	...
	public Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			Point screenResolution = configManager.getScreenResolution();
			Log.d("ZXingDemo", "CameraManager------getFramingRectInPreview  cameraResolution = "+cameraResolution+" and screenResolution = "+screenResolution);
			...
			rect.bottom = rect.bottom * cameraResolution.x /screenResolution.y + 
					(int)context.getResources().getDimension(R.dimen.vs_barcode_compensation);//U3-362;//U2-123;
			/******add for potrait end*****/

			
			Log.d("ZXingDemo", "CameraManager------getFramingRectInPreview  rect.left = "+rect.left+" and rect.right = "+rect.right);
			Log.d("ZXingDemo", "CameraManager------getFramingRectInPreview  rect.top = "+rect.top+" and rect.bottom = "+rect.bottom);
	...
	public void openFlashLight(boolean b) {
		if(camera!=null){
