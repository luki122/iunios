...
import com.aurora.internal.view.*;
...
//    intent.setType(ContactsContract.Contacts.CONTENT_ITEM_TYPE);
	//adding contact directly and not need to choose a contact
  ...
  final void launchIntent(Intent intent) {
    try {
      ...
      builder.setTitle(R.string.vs_barcode_app_name);
      builder.setMessage(R.string.vs_barcode_add_contacts_fail);
      builder.setPositiveButton(R.string.vs_dialog_yes, null);
      builder.show();
    }
  }
...
public void addContacts() {
	Log.d("ZXingDemo", "ResultHandler----------addContacts");
