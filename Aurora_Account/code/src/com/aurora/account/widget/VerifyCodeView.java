...
import com.aurora.account.activity.VerifyCodeLoader;
import com.aurora.account.activity.VerifyCodeLoader.LoadVerifyCodeErrorInfo;
import com.aurora.account.activity.VerifyCodeLoader.OnVerifyCodeLoadDoneListener;
...
public class VerifyCodeView extends FrameLayout implements OnVerifyCodeLoadDoneListener {
    ...
    /**验证码刷新的URL*/
    private final String mVCCodeUrl = Globals.HTTP_REQUEST_URL +
    ...
    private static final float sRoundRadius = DensityUtil.dip2px(AccountApp.getInstance(), 5);
    ...
    public VerifyCodeView(Context context, AttributeSet attrs, int defStyle) {
        ...
        LayoutInflater.from(context).inflate(R.layout.verify_code_view, this);
