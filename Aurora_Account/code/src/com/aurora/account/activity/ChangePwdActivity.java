...
public class ChangePwdActivity extends BaseActivity implements OnClickListener {
	...
	private void initViews() {
		...
		mOldPwdEt.setPadding(mOldPwdEt.getPaddingLeft(), mOldPwdEt.getPaddingTop(),DensityUtil.dip2px(this, 16), mOldPwdEt.getPaddingBottom());
		mNewPwdEt.setPadding(mNewPwdEt.getPaddingLeft(), mNewPwdEt.getPaddingTop(),DensityUtil.dip2px(this, 16), mNewPwdEt.getPaddingBottom());
