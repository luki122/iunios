...
//	private Button btn_next;
	...
	private void initViews() {
	    ...
	    mAccountEt.setPadding(mAccountEt.getPaddingLeft(), mAccountEt.getPaddingTop(),DensityUtil.dip2px(this, 16), mAccountEt.getPaddingBottom());
	    mPwdEt = (ClearableEditText) findViewById(R.id.password_cet);
	    mPwdEt.setPadding(mPwdEt.getPaddingLeft(), mPwdEt.getPaddingTop(),DensityUtil.dip2px(this, 16), mPwdEt.getPaddingBottom());
