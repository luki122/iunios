...
public class AccountPreferencesUtil {
    ...
    private static final String AUTO_BACKUP_TIME = "autoBackupTime";  // 每天自动启动同步的时间
//    private static final String PHOTO_AUTO_SYNC_TIME = "photoAutoSyncTime";	// 云相册每天自动启动同步的时间
...
//    public void setPhotoAutoSyncTime(String autoSyncTime) {
//        putStringValue(PHOTO_AUTO_SYNC_TIME, getSafeString(autoSyncTime));
//    }
//    
//    public String getPhotoAutoSyncTime() {
//        String autoSyncTime = getString(PHOTO_AUTO_SYNC_TIME, "00:00");
//        return autoSyncTime;
//    }
    
    /**
    * @Title: setAutoBackupTime
    * @Description: TODO 设置每天自动备份开始时间
    * @param @param autoSyncTime
    * @return void
    * @throws
     */
    public void setAutoBackupTime(String autoSyncTime) {
        putStringValue(AUTO_BACKUP_TIME, getSafeString(autoSyncTime));
    }
    
    /**
    * @Title: getAutoBackupTime
    * @Description: TODO 获取每天自动备份开始时间
    * @param @return
    * @return String
    * @throws
     */
    public String getAutoBackupTime() {
        String autoSyncTime = getString(AUTO_BACKUP_TIME, "00:00");
        return autoSyncTime;
    }
...
//        removeString(USER_ID);
        ...
        AccountProvider.notifyQueryDataChanged(); // User nick变了，通知content provider监听器
    }
