...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    public boolean tryShow() {
        ...
        mPopup.setAnimationStyle(com.aurora.R.style.AuroraMenuRightTopAnimation);  
        mPopup.setHorizontalOffset(-16);
//        mPopup.setVerticalOffset(27);
        mPopup.setVerticalOffset(21);
        mPopup.show();
