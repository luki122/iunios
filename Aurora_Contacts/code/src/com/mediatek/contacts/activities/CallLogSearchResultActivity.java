 ...
 */
public class CallLogSearchResultActivity extends AuroraListActivity implements
    ...
    protected void onCreate(Bundle state) {
        ...
        if (Intent.ACTION_VIEW.equals(action)) {
            ...
            Intent newIntent = new Intent(this, AuroraCallDetailActivity.class);
    ...
    void setSimIndicatorVisibility(boolean visible) {
        if (visible)
            GnStatusBarManager.showSIMIndicator(mStatusBarMgr, getComponentName(),
                    ContactsFeatureConstants.VOICE_CALL_SIM_SETTING);
        else
