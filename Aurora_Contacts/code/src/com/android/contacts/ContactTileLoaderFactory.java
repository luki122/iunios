...
public final class ContactTileLoaderFactory {
     ...
     * query when {@link GnContactsContract#STREQUENT_PHONE_ONLY} flag
    ...
    public static CursorLoader createStrequentPhoneOnlyLoader(Context context) {
        Uri uri = Contacts.CONTENT_STREQUENT_URI.buildUpon()
                .appendQueryParameter(GnContactsContract.STREQUENT_PHONE_ONLY, "true").build();
    ...
    public static CursorLoader gnCreateStarredLoader(Context context) {
		return new CursorLoader(context, Contacts.CONTENT_URI, COLUMNS,
