...
public class ContactDetailFragment extends Fragment implements
    ...
    private AuroraButton mQuickFixButton;
 ...
 // aurora yudingmin 2015-01-12 added for bug #10724 end
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        // Gionee lihuafang 20120326 add for CR00555703 begin
        menu.removeItem(R.id.menu_association_sim);
        // Gionee lihuafang 20120326 add for CR00555703 end
        if (associationMenuItem != null && !GNContactsUtils.isOnlyQcContactsSupport()) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
        	//Gionee:huangzy 20130218 modify for CR00771607 start
        	mListView.setPadding(0, 0, 0, 0);
        	
        	/*mListView.setPadding(8, 4, 8, 0);
        	
        	View bottomSpace = new View(mContext);
        	bottomSpace.setMinimumHeight(8);
        	mListView.addFooterView(bottomSpace);*/
        	//Gionee:huangzy 20130218 modify for CR00771607 end
        }
...
//        ContactDetailDisplayUtils.setAlphaOnViewBackground(mAlphaLayer, mInitialAlphaValue);
        ...
        mQuickFixButton = (AuroraButton) mView.findViewById(R.id.contact_quick_fix);
    ...
    protected void bindData() {
        ...
        if (mStaticPhotoView != null) {
            ...
            if (mShowStaticPhoto) {
            	...
            	// gionee xuhz 20121124 modify for GIUI2.0 start
            	if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
                    ContactDetailDisplayUtils.setPhotoForDetail(mContext, mContactData, mStaticPhotoView, false);
            	} else {
                    ContactDetailDisplayUtils.setPhoto(mContext, mContactData, mStaticPhotoView);
            	}
            	// gionee xuhz 20121124 modify for GIUI2.0 end
            } else {
    ...
    private final void buildEntries() {
            ...
            for (NamedContentValues subValue : entity.getSubValues()) {
                ...
                */
                ...
                if (StructuredName.CONTENT_ITEM_TYPE.equals(mimeType)) {
                    ...
                    final Intent smsIntent = mHasSms ? IntentFactory.newCreateSmsIntent(entry.data) : null;
        ...
        if (!groups.isEmpty()) {
            ...
            if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
            	...
            	entry.typeString = mContext.getString(R.string.groupsLabel);
            } else {
...
//            if (ContactsApplication.sIsGnContactDetail) {
//                if ((entries.get(i).mimetype != null && Phone.CONTENT_ITEM_TYPE
//                        .equals(entries.get(i).mimetype)) && i < count - 1) {
//                    mAllEntries.add(new GnKindTitleViewEntry());
//                }
//            }
...
//            companyView = (TextView) view.findViewById(R.id.company);
    ...
    private static class DetailViewCache {
        ...
        */
        ...
        // GIONEE licheng Apr 20, 2012 add for CR00576369 start
        public ImageView gnPhoneNumIcon = null;
        // GIONEE licheng Apr 20, 2012 add for CR00576369 end
         ...
         */            
            ...
            */
            ...
            if (true == ContactsUtils.mIsGnContactsSupport) {
                gnPhoneNumIcon = (ImageView) view.findViewById(R.id.gn_phone_num_icon);
            }
            // GIONEE licheng Apr 20, 2012 add for CR00576369 end
    ...
    private final class ViewAdapter extends BaseAdapter {
        ...
        private void filterEntriesShow(ArrayList<ViewEntry> allEntries) {
        	...
        	ArrayList<ViewEntry> entriesShow = new ArrayList<ContactDetailFragment.ViewEntry>();
...
//        	int desiredLayoutResourceId;
//        	if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
//                desiredLayoutResourceId = mContactHasSocialUpdates ?
//                        R.layout.detail_header_contact_with_updates :
//                        R.layout.aurora_detail_header_contact_without_updates;
//        	} else {
//                desiredLayoutResourceId = mContactHasSocialUpdates ?
//                        R.layout.detail_header_contact_with_updates :
...
//            	// gionee xuhz 20121124 modify for GIUI2.0 start
//            	if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
//                    ContactDetailDisplayUtils.setPhotoForDetail(mContext, mContactData, viewCache.photoView);
//            	} else {
...
//        }
        ...
        private View getDetailEntryView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                // GIONEE licheng Apr 20, 2012 add modfiy CR00576369 start
                /*
                ...
                */
                ...
                // Gionee <jialf> <2013-04-16> modified for CR00798010 end
                // GIONEE licheng Apr 20, 2012 add modify CR00576369 end
            ...
            if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
                v.setBackgroundResource(mGgkjBgIndex[position]);
            }
            
            //Gionee:huangzy 20120717 add for CR00650857 start
            if (ContactsApplication.sIsGnContactsSupport) {
                // gionee xuhz 20120730 remove for CR00658687 start
                //if (Phone.CONTENT_ITEM_TYPE.equals(entry.mimetype)) {
                // gionee xuhz 20120730 remove for CR00658687 end
                    v.findViewById(R.id.primary_action_view).setOnLongClickListener(new OnLongClickListener() {
                    ...
                    v.findViewById(R.id.primary_action_view).setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
            ...
            //Gionee:huangzy 20120717 add for CR00650857 end
...
//            registerForContextMenu(actionsButtonContainer);
            ...
            // GIONEE licheng Apr 20, 2012 add for CR00576369 start            
            if (true == ContactsUtils.mIsGnContactsSupport) {
                if (entry.mimetype != null && entry.mimetype.equals(Phone.CONTENT_ITEM_TYPE)) {
                    views.gnPhoneNumIcon.setVisibility(View.VISIBLE);
                } else {
                    views.gnPhoneNumIcon.setVisibility(View.GONE);
                }
            }
            // GIONEE licheng Apr 20, 2012 add for CR00576369 end
            
            if (ContactsApplication.sIsGnContactsSupport &&
            		CommonDataKinds.Phone.CONTENT_ITEM_TYPE.equals(entry.mimetype)) {
            	if (!ContactsApplication.sIsGnGGKJ_V2_0Support) {
            		if (views.gnPhoneNumIcon != null) {
                        if (ContactsApplication.sIsGnDarkStyle) {
                            views.gnPhoneNumIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.gn_phone_num_icon_dark));
                        } else {
                            views.gnPhoneNumIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.gn_phone_num_icon));
                        }
                    }	
            	}
    ...
    */
    ...
    private View getHeaderEntryView(View convertView, ViewGroup parent, int high) {
        ...
        if (viewCache.photoView != null) {
        	// gionee xuhz 20121124 modify for GIUI2.0 start
        	if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
                ContactDetailDisplayUtils.setPhotoForDetail(mContext, mContactData, viewCache.photoView, false);
        	} else {
                ContactDetailDisplayUtils.setPhoto(mContext, mContactData, viewCache.photoView);
        	}
        	// gionee xuhz 20121124 modify for GIUI2.0 end
