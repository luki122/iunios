 ...
 */
public class AuroraContactDetailLayoutController {
    ...
    private AuroraContactDetailFragment mDetailFragment;
    ...
    private AuroraContactDetailFragment.Listener mContactDetailFragmentListener;
    ...
    public AuroraContactDetailLayoutController(Activity activity, Bundle savedState,
            FragmentManager fragmentManager, View viewContainer, AuroraContactDetailFragment.Listener
            contactDetailFragmentListener) {

        if (fragmentManager == null) {
            throw new IllegalStateException("Cannot initialize a AuroraContactDetailLayoutController "
    ...
    private void initialize(Bundle savedState) {
        ...
        mDetailFragment = (AuroraContactDetailFragment) mFragmentManager.findFragmentByTag(
        ...
        if (mDetailFragment == null) {
            mDetailFragment = new AuroraContactDetailFragment();
     ...
     */
    public AuroraContactDetailFragment getDetailFragment() {
        return mDetailFragment;
    }
    /*
