...
public class GnTextView extends AuroraTextView {
    ...
    public static final int GN_FONT_SIZE_SYSTEM = 0;
    public static final int GN_FONT_SIZE_LARGE = 1;
    public static final int GN_FONT_SIZE_EXTRA_LARGE = 2;
    
    static int mLargeTextType = GN_FONT_SIZE_SYSTEM;

    private static final String GN_FONT_SIZE = "gn_font_size";
    
    public static final String TAG = "GnTextView";
