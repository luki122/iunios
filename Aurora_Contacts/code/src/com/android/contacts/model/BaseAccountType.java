...
import gionee.provider.GnContactsContract.CommonDataKinds.BaseTypes;
...
public abstract class BaseAccountType extends AccountType {
    ...
    // aurora <ukiliu> <2013-9-25> modify for auroro ui begin
    	if (ContactsApplication.auroraContactsSupport) {
    		switch (type) {
    		case Phone.TYPE_MOBILE: return new EditType(type, R.string.telType_Moblie);
			case Phone.TYPE_HOME: return new EditType(type, R.string.telType_Home);
			case Phone.TYPE_WORK: return new EditType(type, R.string.telType_Work);
			case Phone.TYPE_FAX_WORK: return new EditType(type, R.string.telType_Fax);
			case Phone.TYPE_OTHER: return new EditType(type, R.string.othertype);
			default:
				break;
			}
    	}
    // aurora <ukiliu> <2013-9-25> modify for auroro ui end
    ...
    // aurora <ukiliu> <2013-9-25> modify for auroro ui begin
    	if (ContactsApplication.auroraContactsSupport) {
    		switch (type) {
    		case (Email.TYPE_WORK):return new EditType(type, R.string.emailType_Work);
    		case (Email.TYPE_HOME):return new EditType(type, R.string.emailType_Private);
    		case (Email.TYPE_OTHER):return new EditType(type, R.string.othertype);
    		default:
    			break;
    		}
    	}
    ...
    protected static EditType buildPostalType(int type) {
    	if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
    		switch (type) {
    		case StructuredPostal.TYPE_HOME: return new EditType(type, R.string.addressType_Home);
    		case StructuredPostal.TYPE_WORK: return new EditType(type, R.string.addressType_Company);
			case StructuredPostal.TYPE_OTHER: return new EditType(type, R.string.othertype);
			case StructuredPostal.TYPE_CUSTOM: return new EditType(type, R.string.telType_custom);
			default:
				break;
			}
    	}
    ...
    protected static EditType buildImType(int type) {
        // aurora <wangth> <2014-1-9> add for aurora begin
        if (ContactsApplication.auroraContactsSupport) {
            switch (type) {
            case Im.PROTOCOL_AIM: return new EditType(type, R.string.imType_Aim);
            case Im.PROTOCOL_YAHOO: return new EditType(type, R.string.imType_Yahoo);
            case Im.PROTOCOL_SKYPE: return new EditType(type, R.string.imType_Skype);
            case Im.PROTOCOL_QQ: return new EditType(type, R.string.imType_Qq);
            case Im.PROTOCOL_GOOGLE_TALK: return new EditType(type, R.string.imType_GooleTalk);
            case Im.PROTOCOL_ICQ: return new EditType(type, R.string.imType_Icq);
            case Im.PROTOCOL_JABBER: return new EditType(type, R.string.imType_Jabber);
            case Im.PROTOCOL_MSN: return new EditType(type, R.string.imType_Msn);
            case Im.PROTOCOL_CUSTOM: return new EditType(type, R.string.telType_custom);
            }
        }
        // aurora <wangth> <2014-1-9> add for aurora end
    ...
    protected static EditType buildEventType(int type, boolean yearOptional) {
        return new EventEditType(type, getTypeResource(type)).setYearOptional(yearOptional);
    }
    ...
    protected DataKind addDataKindDisplayName(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(DataKind.PSEUDO_MIME_TYPE_DISPLAY_NAME,
                R.string.nameLabelsGroup, -1, true, getTextFieldsEditorViewRes()));
        kind.actionHeader = new SimpleInflater(R.string.nameLabelsGroup);
        kind.actionBody = new SimpleInflater(Nickname.NAME);
        kind.typeOverallMax = 1;
    ...
    protected DataKind addDataKindNickname(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Nickname.CONTENT_ITEM_TYPE,
                    R.string.nicknameLabelsGroup, 115, true, getTextFieldsEditorViewRes()));
        kind.typeOverallMax = 1;
    ...
    protected DataKind addDataKindPhone(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Phone.CONTENT_ITEM_TYPE, R.string.phoneLabelsGroup,
                10, true, getTextFieldsEditorViewRes()));
        kind.hintRes = R.string.aurora_phone_hint_text;
...
//        kind.typeList.add(buildPhoneType(Phone.TYPE_CUSTOM).setSecondary(true).setCustomColumn(Phone.LABEL));
    ...
    protected DataKind addDataKindEmail(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Email.CONTENT_ITEM_TYPE, R.string.emailLabelsGroup,
                15, true, getTextFieldsEditorViewRes()));
...
//                buildEmailType(Email.TYPE_CUSTOM).setSecondary(true).setCustomColumn(Email.LABEL));
        ...
        kind.hintRes = R.string.aurora_email_hint_text;
...
//                R.string.postalLabelsGroup, 25, true, getTextFieldsEditorViewRes()));
...
//    }
    ...
    protected DataKind addDataKindStructuredPostal(Context context) throws DefinitionException {
        ...
        kind.hintRes = R.string.aurora_address_hint_text;
        return kind;
    }
    /*
    ...
    protected DataKind addDataKindIm(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Im.CONTENT_ITEM_TYPE, R.string.imLabelsGroup, 5, true,
                    getTextFieldsEditorViewRes()));
    ...
    protected DataKind addDataKindOrganization(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Organization.CONTENT_ITEM_TYPE,
                    R.string.organizationLabelsGroup, 20, true,
                    getTextFieldsEditorViewRes()));
        kind.actionHeader = new SimpleInflater(R.string.organizationLabelsGroup);
        kind.actionBody = new SimpleInflater(Organization.COMPANY);
        kind.typeOverallMax = 1;

        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Organization.COMPANY, R.string.aurora_company_hint_text,
                FLAGS_GENERIC_NAME));
//        kind.fieldList.add(new EditField(Organization.TITLE, R.string.aurora_position_hint_text,
//                FLAGS_GENERIC_NAME));
    ...
    protected DataKind addDataKindNote(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Note.CONTENT_ITEM_TYPE,
                    R.string.label_notes, 110, true, getTextFieldsEditorViewRes()));
        kind.typeOverallMax = 1;
        kind.actionHeader = new SimpleInflater(R.string.label_notes);
        kind.actionBody = new SimpleInflater(Note.NOTE);
        kind.fieldList = Lists.newArrayList();
        kind.fieldList.add(new EditField(Note.NOTE, R.string.aurora_note_hint_text, FLAGS_NOTE));
    ...
    protected DataKind addDataKindWebsite(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(Website.CONTENT_ITEM_TYPE,
                R.string.websiteLabelsGroup, 120, true, getTextFieldsEditorViewRes()));
    ...
    protected DataKind addDataKindSipAddress(Context context) throws DefinitionException {
        DataKind kind = addKind(new DataKind(SipAddress.CONTENT_ITEM_TYPE,
                    R.string.label_sip_address, 130, true, getTextFieldsEditorViewRes()));
    ...
    private static class NameKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
            ...
            final DataKind kd = newDataKind(context, parser, attrs, true,
                    ...
                    R.string.nameLabelsGroup, Weight.NONE, getTextFieldsEditorViewRes(),
                    new SimpleInflater(R.string.nameLabelsGroup),
                    new SimpleInflater(Nickname.NAME));
            kd.typeOverallMax = 1;
            kinds.add(kd);
    ...
    private static class StructuredPostalKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
            ...
            final DataKind kind = newDataKind(context, parser, attrs, false,
                    ...
                    getTextFieldsEditorViewRes(), new PostalActionInflater(),
    ...
    private static class OrganizationKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
            ...
            final DataKind kind = newDataKind(context, parser, attrs, false,
                    ...
                    Weight.ORGANIZATION, getTextFieldsEditorViewRes() ,
    ...
    private static class SipAddressKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
            ...
            final DataKind kind = newDataKind(context, parser, attrs, false,
                    ...
                    Weight.SIP_ADDRESS, getTextFieldsEditorViewRes(),
...
//            kind.fieldList.add(new EditField(Event.DATA, R.string.aurora_editor_event_day, FLAGS_EVENT));
    ...
    protected static int getTextFieldsEditorViewRes() {
    	return ContactsApplication.auroraContactsSupport ? R.layout.aurora_text_fields_editor_view
    			: R.layout.text_fields_editor_view;
    }
    
    private static int getTypeResource(Integer type) {
    	if (type != null) {
    		if(type  == Event.TYPE_ANNIVERSARY) {
    			return R.string.aurora_editor_event_day;
    		}
    	}
