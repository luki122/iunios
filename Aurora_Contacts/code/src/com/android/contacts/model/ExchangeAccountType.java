...
public class ExchangeAccountType extends BaseAccountType {
    ...
    public ExchangeAccountType(Context context, String resPackageName) {
      ...
      //Gionee <huangzy> <2013-06-14> remove for CR00825803 begin
//    @Override
...
//        return kind;
//    }
      //Gionee <huangzy> <2013-06-14> remove for CR00825803 end
    ...
    protected DataKind addDataKindPhone(Context context) throws DefinitionException {
        ...
        //Gionee:huangzy 20120714 add for CR00625604 start
        if (ContactsApplication.sIsGnContactsSupport) {
            ...
            kind.typeList.add(buildPhoneType(Phone.TYPE_WORK).setSpecificMax(2));kind.typeList.add(buildPhoneType(Phone.TYPE_FAX_WORK).setSecondary(true)
                    .setSpecificMax(1));
        ...
        //Gionee:huangzy 20120714 add for CR00625604 end
