...
public class DialpadView extends LinearLayout {
	...
	private final int[] mButtonIds = new int[] {R.id.aurora_zero, R.id.aurora_one, R.id.aurora_two, R.id.aurora_three,
			R.id.aurora_four, R.id.aurora_five, R.id.aurora_six, R.id.aurora_seven, R.id.aurora_eight, R.id.aurora_nine, R.id.aurora_star,
			R.id.aurora_pound};
...
//
//		
//		ViewPropertyAnimator animator0 = dialButton.animate();
//		int dialButtonTranslationX=AuroraDialActivityV3.screenW/2-mContext.getResources().getDimensionPixelOffset(R.dimen.fab_padding_right)
//				-mContext.getResources().getDimensionPixelOffset(R.dimen.dialbutton_width)/2;
//		Log.d(TAG,"dialButtonTranslationX:"+dialButtonTranslationX);
//		dialButton.setTranslationX(0);
...
//				AuroraDialActivityV3.fab1.setVisibility(View.GONE);
			}
...
/*		if(dialButton==null){
		dialButton = findViewById(R.id.aurora_dialButton);
		}
		ViewPropertyAnimator animator0 = dialButton.animate();
		int dialButtonTranslationX=AuroraDialActivityV3.screenW/2-mContext.getResources().getDimensionPixelOffset(R.dimen.fab_padding_right)
				-mContext.getResources().getDimensionPixelOffset(R.dimen.dialbutton_width)/2;
		Log.d(TAG,"dialButtonTranslationX:"+dialButtonTranslationX);
		dialButton.setTranslationX(dialButtonTranslationX);
		animator0.translationX(0);
		animator0.setInterpolator(AnimUtils.EASE_OUT)
		.setStartDelay(0)
		.setDuration(500)
		.setListener(showListener)
		...
		for (int i = 0; i < mButtonIds.length; i++) {
			...
			final LinearLayout dialpadKey = (LinearLayout) findViewById(mButtonIds[i]);
	...
	private int getKeyButtonAnimationDelay(int buttonId) {
		if (mIsLandscape) {
			if (mIsRtl) {
				switch (buttonId) {
				case R.id.aurora_three: return KEY_FRAME_DURATION * 1;
				case R.id.aurora_six: return KEY_FRAME_DURATION * 2;
				case R.id.aurora_nine: return KEY_FRAME_DURATION * 3;
				case R.id.aurora_pound: return KEY_FRAME_DURATION * 4;
				case R.id.aurora_two: return KEY_FRAME_DURATION * 5;
				case R.id.aurora_five: return KEY_FRAME_DURATION * 6;
				case R.id.aurora_eight: return KEY_FRAME_DURATION * 7;
				case R.id.aurora_zero: return KEY_FRAME_DURATION * 8;
				case R.id.aurora_one: return KEY_FRAME_DURATION * 9;
				case R.id.aurora_four: return KEY_FRAME_DURATION * 10;
				...
				switch (buttonId) {
				case R.id.aurora_one: return KEY_FRAME_DURATION * 1;
				case R.id.aurora_four: return KEY_FRAME_DURATION * 2;
				case R.id.aurora_seven: return KEY_FRAME_DURATION * 3;
				case R.id.aurora_star: return KEY_FRAME_DURATION * 4;
				case R.id.aurora_two: return KEY_FRAME_DURATION * 5;
				case R.id.aurora_five: return KEY_FRAME_DURATION * 6;
				case R.id.aurora_eight: return KEY_FRAME_DURATION * 7;
				case R.id.aurora_zero: return KEY_FRAME_DURATION * 8;
				case R.id.aurora_three: return KEY_FRAME_DURATION * 9;
				case R.id.aurora_six: return KEY_FRAME_DURATION * 10;
				case R.id.aurora_nine:
				case R.id.aurora_pound:
					return KEY_FRAME_DURATION * 11;
				}
			}
		} else {
			switch (buttonId) {
			case R.id.aurora_one: return KEY_FRAME_DURATION * 1;
			case R.id.aurora_two: return KEY_FRAME_DURATION * 2;
			case R.id.aurora_three: return KEY_FRAME_DURATION * 3;
			case R.id.aurora_four: return KEY_FRAME_DURATION * 4;
			case R.id.aurora_five: return KEY_FRAME_DURATION * 5;
			case R.id.aurora_six: return KEY_FRAME_DURATION * 6;
			case R.id.aurora_seven: return KEY_FRAME_DURATION * 7;
			case R.id.aurora_eight: return KEY_FRAME_DURATION * 8;
			case R.id.aurora_nine: return KEY_FRAME_DURATION * 9;
			case R.id.aurora_star: return KEY_FRAME_DURATION * 10;
