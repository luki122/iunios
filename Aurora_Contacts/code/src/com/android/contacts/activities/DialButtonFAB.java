...
public class DialButtonFAB extends RelativeLayout {
    ...
    public DialButtonFAB(Context context) {
        super(context);
        this.ctx = context;
        init(null);
    }

    public DialButtonFAB(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.ctx = context;
        init(attrs);
    }

    public DialButtonFAB(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.ctx = context;
        init(attrs);
    }

    public DialButtonFAB(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        ld.setLayerInset(1, 0, 0, 5, 5);
    ...
    private void init(AttributeSet attrSet) {
        ...
        try {
            setBgColor(arr.getColor(R.styleable.FAB_bg_color, getResources().getColor(R.color.fab_bg_dialbutton)));
