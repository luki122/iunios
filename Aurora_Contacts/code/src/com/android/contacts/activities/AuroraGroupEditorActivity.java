...
public class AuroraGroupEditorActivity extends ContactsActivity 
    ...
    protected static final int GROUP_SAVE_EDIT = 1;
    ...
    public void onCreate(Bundle savedState) {
        ...
        actionBar.setTitle(R.string.aurora_editor_group_info);
        addAuroraActionBarItem(AuroraActionBarItem.Type.Done, GROUP_SAVE_EDIT);
