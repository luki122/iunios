...
public class AuroraDialtactsActivityV2 extends AuroraActivity implements FragmentCallbacks,updateDiapadButtonListener{

	private static final String TAG = "liyang-AuroraDialtactsActivityV2";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(intent!=null){
			Log.d(TAG,"onCreate:"+intent+" "+intent.getAction()+" intent.getdata:"+intent.getData()
					+" savedInstanceState:"+savedInstanceState+" this:"+this+" taskid:"+this.getTaskId()+" flags:"+intent.getFlags());	
		}		

		super.onCreate(savedInstanceState);
		
		setAuroraContentView(R.layout.aurora_dialtacts_activity_layout, AuroraActionBar.Type.Normal);
		...
		actionBar.setmOnActionBarBackItemListener(new AuroraActionBar.OnAuroraActionBarBackItemClickListener() {
			...
			public void onAuroraActionBarBackItemClicked(int arg0) {
				Log.d(TAG, "onAuroraActionBarBackItemClicked");
				// TODO Auto-generated method stub
				AuroraDialtactsActivityV2.this.finish();
			}
		});	
	...
	protected void onResume() {
		...
		Log.d("liyang","AuroraDialactsActivityV2 onResume()");
...
//		SystemUtils.switchStatusBarColorMode(SystemUtils.STATUS_BAR_MODE_WHITE, this);
	...
	private GestureDetector mGestureDetector = new GestureDetector(new GestureDetector.OnGestureListener() {
		...
		public boolean onScroll(MotionEvent e1, MotionEvent e2,
			...
			//        	Log.d("liyang","onScroll2");

			if(mGnDialpadFragment.getDigits2().getVisibility()==View.GONE) return false;
					...
					if (null != e1 && null != e2) {
						...
						if (Math.abs(distanceX) < FLING_MAX_HORIZONTAL_DISTANCE && rect.contains(x1, y1)) {//aurora change zhouxiaobing 20130918
							if (Math.abs(distanceY) > FLING_MIN_VERTICAL_DISTANCE && isDialpadShowing
								...
								if(mGnDialpadFragment.getDigitsTextLen() > 0){
									mGnDialpadFragment.showDialpad(false, true);
									if (button2 != null){
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		Log.v("liyang", "AuroraDialactsActivity dispatchKeyEvent  "); 
...
//			if(AuroraDialerSearchAdapter.dismissPopupWindow()) return true;
	...
	protected void onStart() {
		Log.d("liyang","AuroraDialactsActivityV2 onStart()");
	...
	protected void onPause() {
		super.onPause();
		Log.d("liyang","AuroraDialactsActivityV2 onPause()");
	...
	protected void onStop() {
		// TODO Auto-generated method stub
		super.onStop();
		Log.d("liyang","AuroraDialactsActivityV2 onStop()");
	...
	protected void onNewIntent(Intent newIntent) {
		Log.d("liyang","AuroraDialactsActivityV2 onNewIntent()");
