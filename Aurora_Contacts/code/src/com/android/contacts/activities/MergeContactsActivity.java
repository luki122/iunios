...
public class MergeContactsActivity extends AuroraListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// gionee xuhz 20120612 modify for CR00585969 start
		if (ContactsApplication.sIsGnContactsSupport) {
			String title = getString(R.string.gn_menu_merge_contacts);
			ab.setTitle(title);
			// gionee xuhz 20120711 modify for CR00640617 start
//			if (mSameAllRecord != null) {
//				String subTitle = String.format(getString(R.string.gn_mergeble), mSameAllRecord.size());
//				ab.setSubtitle(subTitle);
//			}
			// gionee xuhz 20120711 modify for CR00640617 end
		} else {
			String title = String.format(getString(R.string.gn_mergeble), mSameAllRecord.size());
			ab.setTitle(title);
		}
		// gionee xuhz 20120612 modify for CR00585969 end
