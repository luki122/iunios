...
public class PeopleActivity extends ContactsActivity
    ...
    private final ContactsIntentResolver mIntentResolver;
	...
	private final ContactTileListFragment.Listener mFavoritesFragmentListener =
            new StrequentContactListFragmentListener();

    private ContactListFilterController mContactListFilterController;

    private ContactsUnavailableFragment mContactsUnavailableFragment;
    private final ProviderStatusLoader mProviderStatusLoader;
    ...
    private void createViewsAndFragments(Bundle savedState) {
        ...
        boolean showAsText = ContactsApplication.sIsGnContactsSupport ? true : isUsingTwoPanes;
        mActionBarAdapter = new ActionBarAdapter(this, this, getActionBar(), showAsText);
    ...
    private void showContactsUnavailableFragmentIfNecessary() {
        ...
        Log.d(TAG, "[PeopleActivity -> showContactsUnavailableFragmentIfNecessary()]: mProviderStatus = "+mProviderStatus+"; providerStatus = " + providerStatus);
        if (providerStatus == mProviderStatus) {
        	Log.d(TAG, "[PeopleActivity -> showContactsUnavailableFragmentIfNecessary()]: providerStatus == mProviderStatus");
            return;
        }
        ...
        if (mProviderStatus == ProviderStatus.STATUS_NORMAL) {
        	Log.d(TAG, "[PeopleActivity -> showContactsUnavailableFragmentIfNecessary()]: mainView = " +mainView + "; mAllFragment = " + mAllFragment);
    ...
    private class ContactsUnavailableFragmentListener
        ...
        public void onAddAccountAction() {
            ...
            intent.putExtra(Settings.EXTRA_AUTHORITIES,
                    new String[] { GnContactsContract.AUTHORITY });
            startActivity(intent);
        }
...
//        }
        ...
        int menuRes = (ContactsApplication.sIsGnContactsSupport ? R.menu.gn_actions_v3 : R.menu.actions);
    ...
    private void invalidateOptionsMenuIfNeeded() {
    	Log.d(TAG, "[PeopleActivity -> invalidateOptionsMenuIfNeeded()]: isOptionsMenuChanged() = " + isOptionsMenuChanged());
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_settings: {
                ...
                settingsAreMultiPane = false;//Gionee:huangzy 20130327 add for CR00786922
                if (!settingsAreMultiPane) {
                    intent.putExtra(AuroraPreferenceActivity.EXTRA_SHOW_FRAGMENT,
                            DisplayOptionsPreferenceFragment.class.getName());
                    intent.putExtra(AuroraPreferenceActivity.EXTRA_SHOW_FRAGMENT_TITLE,
            ...
            case R.id.gn_menu_go_dialpad: {
                startActivity(IntentFactory.newGoDialpadIntent());
                break;
            }
        ...
        switch (mActionBarAdapter.getCurrentTab()) {
        case FAVORITES:
        	mFavoritesFragment.onOptionsItemSelected(item);
        	break;
        }
    ...
    private void createNewGroupWithAccountDisambiguation() {
        ...
        if (accounts.size() <= 1 || mAddGroupImageView == null) {
            ...
            final Intent intent = new Intent(this, GroupInsertActivity.class);
        ...
        popup.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final Intent intent = new Intent(PeopleActivity.this, GroupInsertActivity.class);
                intent.setAction(Intent.ACTION_INSERT);
...
//            }
    ...
    public void onBackPressed() {
        if (mActionBarAdapter.isSearchMode()) {
        	//Gionee:huangzy 20120725 add for CR00624255 start
        	Log.i("James", "PeopleAcivity onBackPressed isSearchMode");
        	//Gionee:huangzy 20120725 add for CR00624255 end
            mActionBarAdapter.setSearchMode(false);
        } else if (isTaskRoot()) {
        	//Gionee:huangzy 20120725 add for CR00624255 start
        	Log.i("James", "PeopleAcivity onBackPressed isTaskRoot");
        	//Gionee:huangzy 20120725 add for CR00624255 end
...
//        }
    ...
    private boolean mGnIsHideMenu = false;
    ...
    protected boolean imExportAction() {
    	/**
         * Change Feature by Mediatek Begin. Original Android's Code:
         * ImportExportDialogFragment.show(getFragmentManager());
         */
        if (MultiChoiceService.isProcessing(MultiChoiceService.TYPE_DELETE)) {
            // Gionee:wangth 20120716 modify for CR00647568 begin
            /*
            Toast.makeText(PeopleActivity.this, R.string.contact_delete_all_tips,
                    Toast.LENGTH_SHORT).show();
            */
            Toast.makeText(PeopleActivity.this, R.string.gn_contact_delete_all_tips,
                    Toast.LENGTH_SHORT).show();
            // Gionee:wangth 20120716 modify for CR00647568 end
            return false;
        }
    ...
    public void onClick(View view) {
    	int id = view.getId();
    	switch (id) {
		case R.id.empty_view_add_contact:
			addContactAction();
			break;
		case R.id.empty_view_imexport:
			imExportAction();
			break;
...
//    public void gnSetHideMenu(boolean isHide) {
//    	mGnIsHideMenu = isHide;
//    }
