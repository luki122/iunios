...
public class ExportProcessor extends ProcessorBase {
    ...
    private void doFinishNotification(final String title, final String description) {
        ...
        final Intent intent = new Intent(mService, AuroraDialActivity.class);
        // Gionee:wangth 20120619 add for CR00625224 beginSuccessfully finished importing
//        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra("switch_to_contacts_page", true);
//        intent.putExtra("is_importing", true);
        // Gionee:wangth 20120619 add for CR00625224 end
        final Notification notification =
