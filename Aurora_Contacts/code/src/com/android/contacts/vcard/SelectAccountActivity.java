...
public class SelectAccountActivity extends ContactsActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        //Gionee:huangzy 20130304 add for CR00775183 start
        ...
        //Gionee:huangzy 20130304 add for CR00775183 end
    ...
    public static Dialog getSelectAccountDialog(Context context, int resId,
        ...
        //Gionee:huangzy 20130304 modify for CR00775183 start
        /*final Context dialogContext = new ContextThemeWrapper(context, android.R.style.Theme_Light);*/
        final Context dialogContext = ContactsApplication.sIsGnGGKJ_V2_0Support ? context :
        	new ContextThemeWrapper(context, android.R.style.Theme_Light);
        //Gionee:huangzy 20130304 modify for CR00775183 end
        ...
        return new AuroraAlertDialog.Builder(context).setTitle(R.string.dialog_new_contact_account)
                .setTitleDividerVisible(true).setSingleChoiceItems(accountAdapter, 0, onClickListener).setOnCancelListener(
