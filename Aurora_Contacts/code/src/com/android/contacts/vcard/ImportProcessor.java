...
//Gionee:wangth 20120524 merge for CR00600886 start
import com.android.vcard.VCardConfig;
import com.android.contacts.ContactsUtils;
import com.android.contacts.util.gn.chardet.FileCharsetDetector;
//Gionee:wangth 20120524 merge for CR00600886 end
...
public class ImportProcessor extends ProcessorBase implements VCardEntryHandler {
    ...
    public static boolean mIsFinishImport = false;
  ...
  //aurora changes zhouxiaobing 20131220 for some vcf fails     
//        final VCardEntryCommitter committer = new VCardEntryCommitter(mResolver);
//        constructor.addEntryHandler(committer);
      final AuroraVCardEntryCommitter committer = new AuroraVCardEntryCommitter(mResolver);
        constructor.addEntryHandler(committer);
 //aurora changes zhouxiaobing 20131220 for some vcf fails          
        ...
        try {
            ...
            try {
                ...
                String charset = new FileCharsetDetector().guestFileEncoding(path);
                Log.d(LOG_TAG, "localDataUri-->" + uri + "  |  charset-->" + charset);

//                if ("UTF-8".equalsIgnoreCase(charset)) {
//                    VCardConfig.setDefaultImportCharset("UTF-8");
//                } else {
//                    VCardConfig.setDefaultImportCharset("GBK");
//                }
            } catch (Exception e) {
                Log.e(LOG_TAG, "Exception " + e.getMessage());
//                VCardConfig.resetDefaultImportCharset();
            }
            // Gionee:wangth 20120524 merge for CR00600886 end
                ...
                if (mListener != null) {
                    if (uris != null && uris.size() > 0) {
                        ...
                        if (ContactsUtils.mIsGnContactsSupport) {
                            Log.d(LOG_TAG, "finish----mJobId-->" + mJobId);
                            mIsFinishImport = true;
                        }
                        // Gionee:wangth 20120709 add for CR00640372 end
                    } else {
