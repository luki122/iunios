 ...
 */
public class CancelActivity extends AuroraActivity implements ServiceConnection {
    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        case R.id.dialog_cancel_confirmation: {
            ...
            final AuroraAlertDialog.Builder builder = new AuroraAlertDialog.Builder(this, AuroraAlertDialog.THEME_AMIGO_FULLSCREEN)
                    .setTitle(title)
                    .setMessage(message)
                    //Gionee:wangth 20120421 modify for CR00576666 begin
                    
                    .setPositiveButton(android.R.string.ok, new RequestCancelListener())
                    .setOnCancelListener(mCancelListener)
                    .setNegativeButton(android.R.string.cancel, mCancelListener);
                    
                    /*.setPositiveButton(R.string.gn_yes, new RequestCancelListener())
                    .setOnCancelListener(mCancelListener)
                    .setNegativeButton(R.string.gn_no, mCancelListener);*/
                    //Gionee:wangth 20120421 modify for CR00576666 end
