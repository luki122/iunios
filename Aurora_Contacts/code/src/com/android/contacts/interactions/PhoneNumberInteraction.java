...
public class PhoneNumberInteraction implements OnLoadCompleteListener<Cursor> {
    ...
    private static class PhoneItemAdapter extends ArrayAdapter<PhoneItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // gionee xuhz 20120525 xuhz add for CR00608271 start
            if (ContactsApplication.sIsGnTransparentTheme) {
                typeView.setTextColor(view.getResources().getColor(R.color.gn_phone_disambig_item_text1));
                
                final TextView numberView = (TextView) view.findViewById(android.R.id.text2);
                numberView.setTextColor(view.getResources().getColor(R.color.gn_phone_disambig_item_text2));
            }
            // gionee xuhz 20120525 xuhz add for CR00608271 end
            return view;
        }
    }
    ...
    public static class PhoneDisambiguationDialogFragment extends DialogFragment
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            // Gionee:wangth 20120616 remove for CR00614337 begin
            //final View setPrimaryView = inflater.inflate(R.layout.set_primary_checkbox, null);
            // Gionee:wangth 20120616 remove for CR00614337 end
            return new AuroraAlertDialog.Builder(activity)
        ...
        public void onClick(DialogInterface dialog, int which) {
            final AuroraAlertDialog alertDialog = (AuroraAlertDialog)dialog;
            if (mPhoneList.size() > which && which >= 0) {
                ...
                // Gionee:wangth 20120621 modify for CR00627035 begin
                //if (checkBox.isChecked()) {
                if (checkBox != null && checkBox.isChecked()) {
                //Gionee:wangth 20120621 modify for CR00627035 end
        ...
        switch (interactionType) {
            ...
            default:
            	if (ContactsApplication.sIsGnContactsSupport) {
            		intent = IntentFactory.newDialNumberIntent(phoneNumber);
            	} else {
	                intent = new Intent(
