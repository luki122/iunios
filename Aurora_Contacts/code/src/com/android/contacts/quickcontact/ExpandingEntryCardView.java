...
public class ExpandingEntryCardView extends CardView {
    ...
    public static final class Entry {
        ...
        public String getAlternateContentDescription() {
...
//        }
    ...
    private CharSequence getExpandButtonText() {
        if (!TextUtils.isEmpty(mExpandButtonText)) {
            ...
            return getResources().getText(R.string.expanding_entry_card_view_see_all);
     ...
     */
    protected void inflateInitialEntries(LayoutInflater layoutInflater) {
...
//            mExpandCollapseArrow.setColorFilter(mThemeColorFilter);
    ...
    protected View createEntryView(LayoutInflater layoutInflater, final Entry entry,
            int iconVisibility) {
        final EntryView view = createEntryViewLayout(layoutInflater);
        ...
        if (!TextUtils.isEmpty(entry.getHeader())) {
            header.setText(HyphonManager.getInstance().formatNumber(entry.getHeader()));
        } else {
        ...
        if (!TextUtils.isEmpty(entry.getSubHeader())) {
            subHeader.setText(HyphonManager.getInstance().formatNumber(entry.getSubHeader()));
        } else {
...
//        transitionSet.addTransition(scrollTransition);
    ...
    public void setTitle(String title) {
        ...
        mTitleContainer.setVisibility(TextUtils.isEmpty(title) ? View.GONE : View.VISIBLE);
...
//        }
    ...
    public void setExpandButtonOnClickListener(OnClickListener l){
    	if(mExpandCollapseButton != null) {
    		mExpandCollapseButton.setOnClickListener(l);
    	}
    }
