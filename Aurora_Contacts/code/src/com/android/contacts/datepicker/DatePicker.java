...
import aurora.widget.AuroraNumberPicker; // import android.widget.NumberPicker;
import aurora.widget.AuroraNumberPicker.OnValueChangeListener; // import android.widget.NumberPicker.OnValueChangeListener;
...
public class DatePicker extends FrameLayout {
    ...
    private final AuroraNumberPicker mDayPicker;
    private final AuroraNumberPicker mMonthPicker;
    private final AuroraNumberPicker mYearPicker;
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDayPicker = (AuroraNumberPicker) findViewById(R.id.day);
        mDayPicker.setFormatter(AuroraNumberPicker.TWO_DIGIT_FORMATTER);
        ...
        mMonthPicker = (AuroraNumberPicker) findViewById(R.id.month);
        mMonthPicker.setFormatter(AuroraNumberPicker.TWO_DIGIT_FORMATTER);
        ...
        mYearPicker = (AuroraNumberPicker) findViewById(R.id.year);
        ...
        int mStartYear = DEFAULT_START_YEAR;
        int mEndYear = DEFAULT_END_YEAR;
