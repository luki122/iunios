...
public final class CallLogQuery {
   ...
   // The SECTION is not used for MTK new calllog feature
    ...
    public static final int CALLS_JOIN_DATA_VIEW_NAME = 26;
    public static final int CALLS_JOIN_DATA_VIEW_CALLPHOTO = 27;
    ...
    public static final int GN_CALLS_JOIN_DATA_VIEW_CALLS_COUNT = PROJECTION_CALLS_JOIN_DATAVIEW.length;
    public static final int GN_CALLS_JOIN_DATA_VIEW_CALLS_COUNT_IDS = GN_CALLS_JOIN_DATA_VIEW_CALLS_COUNT+1;
    ...
    static {
        ...
        GN_PROJECTION_CALLS_JOIN_DATAVIEW[length] = GN_CALLS_COUNT_BY_NUMBER; 
