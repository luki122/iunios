...
public class BackScrollManager {
    ...
    private final AuroraListView mListView;
     ...
     * view.
     */
    public static void bind(ScrollableHeader header, AuroraListView listView) {
        BackScrollManager backScrollManager = new BackScrollManager(header, listView);
        backScrollManager.bind();
    }

    private BackScrollManager(ScrollableHeader header, AuroraListView listView) {
        mHeader = header;
        mListView = listView;
    }
