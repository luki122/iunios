...
public final class GroupMemberLoader extends CursorLoader {
    ...
    public static class GroupEditorQuery {
        ...
        // gionee xuhz 20121208 add for GIUI2.0 start
        public static final int CONTACT_PHOTO_ID = 7;
        // gionee xuhz 20121208 add for GIUI2.0 end
    }
    ...
    public static class GroupDetailQuery {
        ...
        //Gionee:huangzy 20121212 modify for CR00742116 start
        public static final int CONTACT_PHOTO_ID            = 8;
        //Gionee:huangzy 20121212 modify for CR00742116 end
    }
    ...
    private GroupMemberLoader(Context context, long groupId, String[] projection) {
        ...
        if (prefs.getSortOrder() == GnContactsContract.Preferences.SORT_ORDER_PRIMARY) {
