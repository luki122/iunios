...
public final class ContactListFilter implements Comparable<ContactListFilter>, Parcelable {
    ...
    public static ContactListFilter restoreDefaultPreferences(SharedPreferences prefs) {
        ...
        if (filter == null) {
            // aurora <wangth> <2014-1-4> modify for aurora begin
//            filter = ContactListFilter.createFilterWithType(FILTER_TYPE_ALL_ACCOUNTS);
            filter = new ContactListFilter(ContactListFilter.FILTER_TYPE_ACCOUNT,
                    ...
                    null, null);
            // aurora <wangth> <2014-1-4> modify for aurora end
        }
    ...
    public static final Parcelable.Creator<ContactListFilter> CREATOR =
        ...
        public ContactListFilter createFromParcel(Parcel source) {
            ...
            String exInfo = source.readString();
            
            ContactListFilter filter = new ContactListFilter(filterType, accountType, accountName, dataSet, null);
            filter.setExInfo(exInfo);
	...
	public static int getIconFilterType(int filterType) {
		switch (filterType) {
	        case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS: {
	        	return ResConstant.getIconRes(ResConstant.IconTpye.Account);
	        }
	        case ContactListFilter.FILTER_TYPE_STARRED: {
	        	return R.drawable.ic_menu_star_holo_light;
	        }
	        case ContactListFilter.FILTER_TYPE_CUSTOM: {
	        	return ResConstant.getIconRes(ResConstant.IconTpye.Setting);
	        }
