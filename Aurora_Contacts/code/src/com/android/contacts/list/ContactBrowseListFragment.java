...
//    }
    ...
    protected void refreshSelectedContactUri() {
        if (mContactLookupTask != null) {
        	Log.d(TAG, "[ContactBrowseListFragment -> refreshSelectedContactUri()], mContactLookupTask != null");
            mContactLookupTask.cancel();
        }
        Log.d(TAG, "[ContactBrowseListFragment -> refreshSelectedContactUri()], isSelectionVisible = "+isSelectionVisible());
        if (!isSelectionVisible()) {
            return;
        }

        mRefreshingContactUri = true;
        Log.d(TAG, "[ContactBrowseListFragment -> refreshSelectedContactUri()], mSelectedContactUri = " + mSelectedContactUri);
        if (mSelectedContactUri == null) {
            onContactUriQueryFinished(null);
            return;
        }
        Log.d(TAG, "[ContactBrowseListFragment -> rrefreshSelectedContactUri()], mSelectedContactDirectoryId = " + mSelectedContactDirectoryId);
    ...
    public void setQueryString(String queryString, boolean delaySelection) {
        ...
        super.setMultiPhoneSearch(true);
    ...
    private void parseSelectedContactUri() {
        if (mSelectedContactUri != null) {
            String directoryParam =
                    mSelectedContactUri.getQueryParameter(GnContactsContract.DIRECTORY_PARAM_KEY);
