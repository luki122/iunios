...
public class CustomContactListFilterActivity extends ContactsActivity
        implements View.OnClickListener, aurora.widget.AuroraExpandableListView.OnChildClickListener,
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (ContactsApplication.sIsGnTransparentTheme) {
            ...
            setTheme(R.style.GN_ContactListFilterTheme_dark);
        } else if (ContactsApplication.sIsGnLightTheme) {
            setTheme(R.style.GN_ContactListFilterTheme_light);
        } 
        // gionee xuhz add for support gn theme start
    	
        super.onCreate(icicle);
        
        // gionee xuhz 20121129 modify for GIUI2.0 start
        if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
            setContentView(R.layout.gn_contact_list_filter_custom);
        } else {
            setContentView(R.layout.contact_list_filter_custom);
        }
        // gionee xuhz 20121129 modify for GIUI2.0 end

        mList = (AuroraExpandableListView) findViewById(com.android.internal.R.id.list);
        mList.setOnChildClickListener(this);
        mList.setHeaderDividersEnabled(true);
        // gionee xuhz 20120729 add for CR00658824 start
        if (ContactsApplication.sIsGnContactsSupport) {
            // gionee xuhz 20121129 modify for GIUI2.0 start
            if (!ContactsApplication.sIsGnGGKJ_V2_0Support) {
                mList.setGroupIndicator(this.getResources().getDrawable(R.drawable.gn_expander_ic_folder));
            }
            // gionee xuhz 20121129 modify for GIUI2.0 end
        }
        // gionee xuhz 20120729 add for CR00658824 end
    ...
    public static class CustomFilterConfigurationLoader extends AsyncTaskLoader<AccountSet> {
        ...
        public AccountSet loadInBackground() {
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                 ...
                 * GnContactsContract.Groups.newEntityIterator(resolver.query(
                 * groupsUri.build(), null, null, null, null)); CR ID:
                 * ALPS00116855 Descriptions:
                 */

                // Gionee:wangth 20121215 modify for CR00741560 begin
                /*
                EntityIterator iterator = GnContactsContract.Groups.newEntityIterator(resolver.query(
                ...
                */
                ...
                if (cursor == null) {
                    // db is error
                    Looper.prepare();
                    Toast.makeText(context, R.string.gn_usim_group_error_toast,
                            Toast.LENGTH_SHORT).show();
                    break;
                }
                
                EntityIterator iterator = GnContactsContract.Groups.newEntityIterator(cursor);
                // Gionee:wangth 20121215 modify for CR00741560 end
                /*
                 * Bug Fix by Mediatek End.
                 */
    ...
    private static Uri addCallerIsSyncAdapterParameter(Uri uri) {
        return uri.buildUpon()
            .appendQueryParameter(GnContactsContract.CALLER_IS_SYNCADAPTER, "true")
            .build();
    }
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            if (null == displayName) {
                //Gionee:wangth 20120414 modify for CR00572641 begin
                //text1.setText(account.mName);
                if (ContactsUtils.mIsGnContactsSupport && AccountType.ACCOUNT_TYPE_LOCAL_PHONE.equals(account.mType)) {
                    final String mPhoneString = mContext.getString(R.string.gn_phone_text);
                    text1.setText(mPhoneString);
                } else {
                    text1.setText(account.mName);
                }
                //Gionee:wangth 20120414 modify for CR00572641 end
     ...
     */
    @Override
    public boolean onChildClick(AuroraExpandableListView parent, View view, int groupPosition,
    ...
    public void onCreateContextMenu(ContextMenu menu, View view,
        ...
        final int groupPosition = AuroraExpandableListView.getPackedPositionGroup(info.packedPosition);
        final int childPosition = AuroraExpandableListView.getPackedPositionChild(info.packedPosition);
    ...
    public static class UpdateTask extends
        ...
        private AuroraProgressDialog mProgress;
        ...
        protected void onPreExecute(Activity target) {
            ...
            mProgress = AuroraProgressDialog.show(
