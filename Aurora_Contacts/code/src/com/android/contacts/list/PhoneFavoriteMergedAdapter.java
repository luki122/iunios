...
public class PhoneFavoriteMergedAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public PhoneFavoriteMergedAdapter(Context context,
        ...
        // gionee xuhz 20120518 modify start
        if (ContactsApplication.sIsGnContactsSupport) {
            mItemPaddingLeft = resources.getDimensionPixelSize(R.dimen.gn_contact_list_item_left_margin);
            mItemPaddingRight = resources.getDimensionPixelSize(R.dimen.gn_contact_list_item_right_margin);
            mFrequentHeaderPaddingTop = resources.getDimensionPixelSize(
                    R.dimen.gn_frequent_header_padding_top);
        } else {
        ...
        // gionee xuhz 20120518 modify end
