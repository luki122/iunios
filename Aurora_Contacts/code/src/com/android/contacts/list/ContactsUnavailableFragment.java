...
public class ContactsUnavailableFragment extends Fragment implements OnClickListener {
    ...
    private AuroraButton mCreateContactButton;
    private AuroraButton mAddAccountButton;
    private AuroraButton mImportContactsButton;
    private AuroraButton mUninstallAppsButton;
    private AuroraButton mRetryUpgradeButton;
    ...
    public View onCreateView(
        ...
        mCreateContactButton = (AuroraButton) mView.findViewById(R.id.create_contact_button);
        mCreateContactButton.setOnClickListener(this);
        mAddAccountButton = (AuroraButton) mView.findViewById(R.id.add_account_button);
        mAddAccountButton.setOnClickListener(this);
        mImportContactsButton = (AuroraButton) mView.findViewById(R.id.import_contacts_button);
        mImportContactsButton.setOnClickListener(this);
        mUninstallAppsButton = (AuroraButton) mView.findViewById(R.id.import_failure_uninstall_button);
        mUninstallAppsButton.setOnClickListener(this);
        mRetryUpgradeButton = (AuroraButton) mView.findViewById(R.id.import_failure_retry_button);
