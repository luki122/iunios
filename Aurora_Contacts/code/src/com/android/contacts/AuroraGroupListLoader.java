 ...
 * groups.
 */
public final class AuroraGroupListLoader extends CursorLoader {
    ...
    public AuroraGroupListLoader(Context context) {
        ...
        */
        super(context, GROUP_LIST_URI, COLUMNS, Groups.ACCOUNT_TYPE + " NOT NULL AND "
                + Groups.ACCOUNT_NAME + " NOT NULL AND " + Groups.AUTO_ADD + "=0 AND " +
                Groups.FAVORITES + "=0 AND " + Groups.DELETED + "=0 AND " + Groups.GROUP_VISIBLE + "=1"
                + " AND ((account_type='com.google' AND notes is not null AND group_is_read_only=1) OR (account_type!='com.google'))", 
                null, Groups.ACCOUNT_NAME);
