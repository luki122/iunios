...
// Gionee lihuafang 20120424 add for CR00573564 begin
import com.android.contacts.ContactsUtils;
import com.mediatek.contacts.ContactsFeatureConstants.FeatureOption;
// Gionee lihuafang 20120424 add for CR00573564 end
...
import gionee.provider.GnContactsContract.Contacts.Data;
...
public class SuggestedMemberListAdapter extends ArrayAdapter<SuggestedMember> {
    ...
    private static final int RAW_CONTACT_SIM_ID = 3;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (byteArray == null) {
            ...
            // Gionee lihuafang 20120424 add for CR00573564 begin
            else if (ContactsUtils.mIsGnContactsSupport && ContactsUtils.mIsGnShowSlotSupport) {
            ...
            // Gionee lihuafang 20120424 add for CR00573564 end
                ...
                if (SimCardUtils.SimType.SIM_TYPE_SIM == simType) {
                    ...
                    icon.setImageResource(R.drawable.ic_contact_picture_usim_contact);
                } else {
                    icon.setImageResource(R.drawable.ic_contact_picture_holo_light);
                } 
            }
    ...
    public class SuggestedMemberFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            Cursor cursor = mContentResolver.query(
                    ...
                    accountClause + " AND (" +
                    RawContacts.DISPLAY_NAME_PRIMARY + " LIKE ? OR " +
                    RawContacts.DISPLAY_NAME_ALTERNATIVE + " LIKE ? ) AND " +
