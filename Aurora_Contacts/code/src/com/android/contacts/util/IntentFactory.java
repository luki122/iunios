...
import com.android.contacts.AuroraCallDetailActivityV2;
...
public class IntentFactory {
    ...
    public static Intent newDialNumberIntent(String numberType, String number, int type, boolean ifAutoIpDial) {
    	...
    	// gionee xuhz 20120910 modify for CR00688935 endContactsUtils.phoneIsCdma()
...
//        intent.putExtra("is_importing", true);
    ...
    public static Intent newShowCallDetailIntent(Context context, String number) {
    	Intent intent = new Intent(context, AuroraCallDetailActivityV2.class);
 ...
 //aurora changes zhouxiaobing 20130925   
    ...
    public static Intent newShowFullCallDetailIntentV2(Context context, long rawcontactid) {
    	Intent intent = new Intent(context, FullCallDetailActivity.class);
    	intent.putExtra("rawcontactid", rawcontactid);
    	intent.putExtra("contact_detail", true);
    	intent.setClass(context, FullCallDetailActivity.class);
