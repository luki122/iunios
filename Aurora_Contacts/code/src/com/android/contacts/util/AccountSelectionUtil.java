...
public class AccountSelectionUtil {
    ...
    public static Dialog getSelectAccountDialog(Context context, int resId,
        ...
        return new AuroraAlertDialog.Builder(context)
    ...
    public static void doImportFromSdCard(Context context, AccountWithDataSet account) {
        ...
        if (context instanceof Activity) {
            ...
            activity.startActivityForResult(importIntent, AuroraContactImportExportActivity.REQUEST_CODE);
        } else {
            context.startActivity(importIntent);
        }
        /*
...
//aurora add zhouxiaobing 20131211 start    
    public static void doImportFromSdCard2(Context context, AccountWithDataSet account) {
        Intent importIntent = new Intent(context,
                com.android.contacts.vcard.ImportVCardActivity.class);
        if (account != null) {
            importIntent.putExtra("account_name", account.name);
        ...
        importIntent.putExtra("isSdcard2", true);
        if (mVCardShare) {
            importIntent.setAction(Intent.ACTION_VIEW);
            importIntent.setData(mPath);
        }
