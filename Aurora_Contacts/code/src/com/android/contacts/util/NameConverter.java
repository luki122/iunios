...
public class NameConverter {
    ...
    public static String structuredNameToDisplayName(Context context,
        ...
        Builder builder = GnContactsContract.AUTHORITY_URI.buildUpon().appendPath("complete_name");
    ...
    public static Map<String, String> displayNameToStructuredName(Context context,
        ...
        // Gionee:wangth 20120711 add for CR00632607 begin
        if (cursor != null) {
        // Gionee:wangth 20120711 add for CR00632607 end
        try {
            if (cursor.moveToFirst()) {
