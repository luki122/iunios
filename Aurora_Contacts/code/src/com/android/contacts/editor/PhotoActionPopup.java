...
public class PhotoActionPopup {
    ...
    private static ArrayList<ChoiceListItem> getChoiceList(Context context, int mode) {
        ...
        if (mode == MODE_NO_PHOTO || mode == MODE_PHOTO_ALLOW_PRIMARY
            ...
            if (ContactsApplication.sIsGnGGKJ_V2_0Support) {
            	resId = mode == MODE_NO_PHOTO ? R.string.gn_pick_photo : R.string.gn_pick_new_photo;
            } else {
            	resId = mode == MODE_NO_PHOTO ? R.string.pick_photo :R.string.pick_new_photo;	
            }
    ...
    public static ListPopupWindow createPopupMenu(Context context, View anchorView,
    	...
    	final ArrayList<ChoiceListItem> choices = getChoiceList(context, mode);
    ...
    public static AuroraAlertDialog createDialogMenu(Context context, final Listener listener, int mode) {
    	final ArrayList<ChoiceListItem> choices = getChoiceList(context, mode);
/*        final ListAdapter adapter = new ArrayAdapter<ChoiceListItem>(context,
                R.layout.select_dialog_item, choices);*/
        ...
        final AuroraAlertDialog dialog = 
        	new AuroraAlertDialog.Builder(context/*, AlertDialog.THEME_AMIGO_FULLSCREEN*/)
        	.setTitle(R.string.gn_pick_avata_title)
