...
import gionee.provider.GnContactsContract.Contacts.AggregationSuggestions.Builder;
...
//        }
    ...
    private void loadAggregationSuggestions(Uri uri) {
        ...
        // Gionee:wangth 20121122 modify for CR00735129 begin
        /*
        ...
        */
        ...
        try {
            ...
            // Gionee:wangth 20120705 modify for CR00637063 begin
            /*
            cursor.close();
            */
            if (cursor != null) {
            ...
            // Gionee:wangth 20120705 modify for CR00637063 end
        }
        // Gionee:wangth 20121122 modify for CR00735129 end
    }
