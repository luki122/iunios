...
public final class ContactsPreferences extends ContentObserver {
	...
	private static final String TAG = "liyang-ContactsPreferences";
    ...
    public int getDefaultSortOrder() {
        if (mContext.getResources().getBoolean(R.bool.config_default_sort_order_primary)) {
            return GnContactsContract.Preferences.SORT_ORDER_PRIMARY;
        } else {
            return GnContactsContract.Preferences.SORT_ORDER_ALTERNATIVE;
        }
    }
        ...
        if (mSortOrder == -1) {
            try {
                mSortOrder = Settings.System.getInt(mContext.getContentResolver(),
                        GnContactsContract.Preferences.SORT_ORDER);
    ...
    public void setSortOrder(int sortOrder) {
        ...
        Settings.System.putInt(mContext.getContentResolver(),
                GnContactsContract.Preferences.SORT_ORDER, sortOrder);
    }
    ...
    public int getDefaultDisplayOrder() {
        if (mContext.getResources().getBoolean(R.bool.config_default_display_order_primary)) {
            return GnContactsContract.Preferences.DISPLAY_ORDER_PRIMARY;
        } else {
            return GnContactsContract.Preferences.DISPLAY_ORDER_ALTERNATIVE;
        }
    }
        ...
        if (mDisplayOrder == -1) {
            try {
                mDisplayOrder = Settings.System.getInt(mContext.getContentResolver(),
                        GnContactsContract.Preferences.DISPLAY_ORDER);
            } catch (SettingNotFoundException e) {
    ...
    public void setDisplayOrder(int displayOrder) {
        ...
        Settings.System.putInt(mContext.getContentResolver(),
                GnContactsContract.Preferences.DISPLAY_ORDER, displayOrder);
    }
    ...
    public void registerChangeListener(ChangeListener listener) {
        ...
        Log.d(TAG,"Settings.System.getUriFor(GnContactsContract.Preferences.SORT_ORDER):"+Settings.System.getUriFor(
                        GnContactsContract.Preferences.SORT_ORDER));
        
        Log.d(TAG, "Settings.System.getUriFor(GnContactsContract.Preferences.DISPLAY_ORDER):"+Settings.System.getUriFor(
                        GnContactsContract.Preferences.DISPLAY_ORDER));
                        
        contentResolver.registerContentObserver(
                Settings.System.getUriFor(
                        GnContactsContract.Preferences.SORT_ORDER), false, this);
        contentResolver.registerContentObserver(
                Settings.System.getUriFor(
                        GnContactsContract.Preferences.DISPLAY_ORDER), false, this);
    }
