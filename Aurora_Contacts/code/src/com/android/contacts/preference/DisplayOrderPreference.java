 ...
 */
public final class DisplayOrderPreference extends AuroraListPreference {
    ...
    private void prepare() {
        ...
        setEntryValues(new String[]{
                String.valueOf(GnContactsContract.Preferences.DISPLAY_ORDER_PRIMARY),
                String.valueOf(GnContactsContract.Preferences.DISPLAY_ORDER_ALTERNATIVE),
        });
    ...
    public CharSequence getSummary() {
        switch (mPreferences.getDisplayOrder()) {
            case GnContactsContract.Preferences.DISPLAY_ORDER_PRIMARY:
                return mContext.getString(R.string.display_options_view_given_name_first);
            case GnContactsContract.Preferences.DISPLAY_ORDER_ALTERNATIVE:
