 ...
 */
public final class SortOrderPreference extends AuroraListPreference {
    ...
    private void prepare() {
        ...
        setEntryValues(new String[]{
                String.valueOf(GnContactsContract.Preferences.SORT_ORDER_PRIMARY),
                String.valueOf(GnContactsContract.Preferences.SORT_ORDER_ALTERNATIVE),
        });
    ...
    public CharSequence getSummary() {
        switch (mPreferences.getSortOrder()) {
            case GnContactsContract.Preferences.SORT_ORDER_PRIMARY:
                return mContext.getString(R.string.display_options_sort_by_given_name);
            case GnContactsContract.Preferences.SORT_ORDER_ALTERNATIVE:
