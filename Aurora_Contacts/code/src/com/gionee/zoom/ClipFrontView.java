...
import com.gionee.zoom.activity.ZoomClipViewActivity;
...
//        p.addCircle(windowWidth/2, ccy, radius, Path.Direction.CW);
        canvas.drawRect(0, 0, windowWidth, ccy - radius, mShadePaint);
      canvas.drawRect(0, ccy + radius, windowWidth, windowHeight, mShadePaint);    	
      canvas.drawRect(0, ccy - radius, windowWidth/2 - radius, ccy + radius, mShadePaint);    	
      canvas.drawRect(windowWidth/2 - radius + radiusWidth , ccy - radius + radiusWidth, windowWidth/2 + radius - radiusWidth, ccy + radius - radiusWidth, mLightPaint);    		
//      Path p =  new Path();
//      p.moveTo(windowWidth/2, ccy - radius);
//      p.lineTo(0, ccy - radius);
//      p.lineTo(0, ccy + radius);
