...
import com.gionee.zoom.utils.SpringDynamics;
...
public class DynamicZoomControl implements Observer {
    ...
    private static final float GN_Y_REST_VELOCITY_TOLERANCE = 0.5f;
    // Gionee fangbin 20120725 modified for CR00652031 start
    private static final float GN_Y_REST_POSITION_TOLERANCE = 0.5f;
    // Gionee fangbin 20120725 modified for CR00652031 end
    ...
    private final Runnable mUpdateRunnable = new Runnable() {
        public void run() {
            ...
            final boolean flagY = mPanDynamicsY.isAtRest(GN_Y_REST_VELOCITY_TOLERANCE, GN_Y_REST_POSITION_TOLERANCE);
            mPanDynamicsX.gnUpdate(startTime, false);
            mPanDynamicsY.gnUpdate(startTime, flagY);
