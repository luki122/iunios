...
public class CustomMenu extends PopupWindow {
	...
	public void initViewInWin() {
		...
		mFrameLayout = (FrameLayout) inflater.inflate(R.layout.custom_menu,
				null);
	...
	public void initDatas() {
		titles = mContext.getResources().getStringArray(R.array.custom_menu_items);
		for (int i = 0; i < titles.length; i++) {
			HashMap<String, Object> map = new HashMap<String, Object>();
			map.put("title", titles[i]);
			itemList.add(map);
		}
		adapter = new SimpleAdapter(mContext, itemList, R.layout.menu_item,
