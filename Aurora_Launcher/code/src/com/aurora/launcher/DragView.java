...
public class DragView extends View {
	...
	private boolean mIsDragPendingWidget = false;
	...
	public DragView(Launcher launcher, Bitmap bitmap, int registrationX,
			...
			final float initialScale, ViewGroup viewgroup) {
		super(launcher);
		mDragLayer = viewgroup;
		initialize(bitmap, registrationX, registrationY, left, top, width,
				height, initialScale);
	}
	...
	public void setIsDragPendingWidget(boolean isDragPendingWidget) {
		mIsDragPendingWidget = isDragPendingWidget;
	}

	public boolean getIsDragPendingWidget() {
		return mIsDragPendingWidget;
	}

	/** Initialize miscellaneous */
	private void initialize(Bitmap bitmap, int registrationX,
			int registrationY, int left, int top, int width, int height,
			final float initialScale) {
		...
		mAnim.addUpdateListener(new AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				//M: shigq fix bug #13862 for Android5.0 start
				/*if (sDragAlpha != 1f) {
					setAlpha(sDragAlpha * value + (1f - value));
				}*/
				//M: shigq fix bug #13862 fro Android5.0 end
