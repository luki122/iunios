...
public class WallpaperChooser extends Activity {
	...
	//Aurora xiejun modify for BUG#962 begin
    Fragment mFragmentView = null;
	//Aurora xiejun modify for BUG#962 end
    @Override
    ...
    protected void onStart() {
    	...
    	if (mFragmentView == null) {
	    	 mFragmentView=getFragmentManager().findFragmentById(R.id.wallpaper_chooser_fragment);
