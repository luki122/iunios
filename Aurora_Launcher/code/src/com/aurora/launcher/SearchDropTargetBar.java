...
public class SearchDropTargetBar extends FrameLayout implements
	...
	// AURORA-START::xiejun::delete seartch bar
	...
	// AURORA-END::xiejun::delete seartch bar
	...
	// Aurora <jialf> <2013-11-06> modify for not reverse animation begin
	private boolean mNeedReverse;
	// Aurora <jialf> <2013-11-06> modify for not reverse animation end
	...
	public void finishAnimations() {
		...
		// AURORA-START::xiejun::delete seartch bar
		/*
		 * prepareStartAnimation(mQSBSearchBar); mQSBSearchBarAnim.reverse();
		 */
		// AURORA-END::xiejun::delete seartch bar
	}
	...
	public void onDragEnd() {
		// Aurora <jialf> <2013-11-06> modify for not reverse animation begin
		if (!mDeferOnDragEnd && mNeedReverse) {
