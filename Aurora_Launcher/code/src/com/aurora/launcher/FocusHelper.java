...
public class FocusHelper {
    ...
    static boolean handleFolderKeyEvent(View v, int keyCode, KeyEvent e) {
        ShortcutAndWidgetContainer parent = (ShortcutAndWidgetContainer) v.getParent();
        final CellLayout layout = (CellLayout) parent.getParent();
        // Aurora <haojj> <2013-10-24> add for field begin
        final FolderWorkspace fWorkspace = (FolderWorkspace) layout.getParent();
        final Folder folder = (Folder) fWorkspace.getParent();
        // final Folder folder = (Folder) layout.getParent();
        // Aurora <haojj> <2013-10-24> end
