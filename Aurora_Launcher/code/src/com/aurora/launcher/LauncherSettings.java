...
class LauncherSettings {
	...
	static boolean isEnableWidgets;
	public static final String  WIDGET_WHOLE_SWITCH = "WIDGET_WHOLE_SWITCH";
    ...
    static interface BaseLauncherColumns extends BaseColumns {
        ...
        // Aurora <haojj> <2013-12-21> add for title的简拼和全拼及九键搜索备用 begin
        static final String SIMPLE_PINYIN = "simplePinyin";
        static final String FULL_PINYIN = "fullPinyin";
        static final String SIMPLE_PINYIN_T9 = "simple_t9";
        static final String FULL_PINYIN_T9 = "quan_t9";
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        */
        ...
        // Aurora <jialf> <2013-09-23> add for loading data begin
        static final String FLAGS = "flags";
        // Aurora <jialf> <2013-09-3> add for loading data end
        
        static final String FIRST_INSTALL_TIME = "firstInstallTime";//iconcat, vulcan added it in 2014-7-11
        
        static final String ENABLE_WIDGETS = "enableWidgets";
    }
}
