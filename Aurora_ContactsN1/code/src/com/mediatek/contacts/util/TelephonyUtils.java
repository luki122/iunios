...
public class TelephonyUtils {
    ...
    public static int get3GCapabilitySIM() {
        ...
        if (FeatureOption.MTK_GEMINI_3G_SWITCH) {
            ...
            try {
                retval = ((telephony == null) ? -1 : AuroraITelephony.get3GCapabilitySIM(telephony));
            } catch (Exception e) {
                retval = 0;
            }
        }
    ...
    public static boolean isSimReady(int id) {
        final int slot = ContactsUtils.getSlotBySubId(id);
    ...
    public static boolean isSimReadyInner(int slot) {
        ...
        if(slot == DEFAULT_SIM)
            ...
            retval = AuroraTelephonyManager.getSimStateGemini(slot) == TelephonyManager.SIM_STATE_READY;
        }
        return retval;
    }
...
//        }
    ...
    public static boolean isRadioOnInner(int slot) {
        ...
        try {
            ...
            if(slot >= 0)
                retval = AuroraITelephony.isRadioOnGemini(telephony, slot);
        } catch(Exception e) {
            retval = false;
        }
        return retval;
