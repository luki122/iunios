...
public class DefaultVoicemailNotifier implements VoicemailNotifier {
    ...
    private static final String TAG = "DefaultVoicemailNotifier";
    ...
    public void updateNotification(Uri newCallUri) {
        ...
        // Gionee:wangth 20130104 add for CR00756576 begin
        if (null == newCalls) {
            clearNotification();
            return;
        }
        // Gionee:wangth 20130104 add for CR00756576 end
        ...
        if (newCalls.length == 1) {
            ...
            contentIntent = new Intent(mContext, AuroraCallDetailActivity.class);
            contentIntent.setData(newCalls[0].callsUri);
            contentIntent.putExtra(AuroraCallDetailActivity.EXTRA_VOICEMAIL_URI,
    ...
    private static final class DefaultNewCallsQuery implements NewCallsQuery {
        ...
        public NewCall[] query() {
            ...
            // Gionee:wangth 20121228 add for CR00753399 begin
            // db may be reboot when device booting, so can not confirm the connection pool is all connecting.  
//            catch (IllegalStateException ie) {
            catch (Exception ie) {
                ie.printStackTrace();
                return null;
            }
            // Gionee:wangth 20121228 add for CR00753399 end
            finally {
