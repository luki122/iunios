...
public final class CallLogQuery {
   ...
   // The SECTION is not used for MTK new calllog feature
    ...
    public static final int CALLS_JOIN_DATA_VIEW_DISPLAY_NAME = 12;
     
    public static final int CALLS_JOIN_DATA_VIEW_CALL_NUMBER_TYPE = 13;
     
    public static final int CALLS_JOIN_DATA_VIEW_CALL_NUMBER_TYPE_ID = 14;
    public static final int CALLS_JOIN_DATA_VIEW_PHOTO_ID = 15;
     
    public static final int CALLS_JOIN_DATA_VIEW_INDICATE_PHONE_SIM = 16;
     
    public static final int CALLS_JOIN_DATA_VIEW_CONTACT_ID = 17;
     
    public static final int CALLS_JOIN_DATA_VIEW_LOOKUP_KEY = 18;
    public static final int CALLS_JOIN_DATA_VIEW_PHOTO_URI = 19;
     
    public static final int CALLS_JOIN_DATA_VIEW_AREA = 20; 
    public static final int CALLS_JOIN_DATA_VIEW_REJECT = 21; 
     
    public static final int CALLS_JOIN_DATA_VIEW_MARK = 22; 
    public static final int CALLS_JOIN_DATA_VIEW_USER_MARK = 23; 
    public static final int CALLS_JOIN_DATA_VIEW_PRIVATE_ID = 24;

    //The previous lines are provided and maintained by Mediatek Inc.
    
    //Gionee:huangzy 20120906 modify for CR00688166 start
    private static final String GN_CALLS_COUNT_BY_NUMBER = "calls_count";
    private static final String GN_CALLS_COUNT_BY_NUMBER_IDS = "calls_count_ids";
    public static final int GN_CALLS_JOIN_DATA_VIEW_CALLS_COUNT = 25;
    public static final int GN_CALLS_JOIN_DATA_VIEW_CALLS_COUNT_IDS = 26;
    
    private static final String[] GN_PROJECTION_CALLS_JOIN_DATAVIEW;
    static {
