    ...
    public static ContactInfo fromCursor(Cursor c) {
        ...
        if (null != newContactInfo) {
            try {
                ...
                newContactInfo.numberArea = c.getString(CallLogQuery.CALLS_JOIN_DATA_VIEW_AREA);
                newContactInfo.userMark = c.getString(CallLogQuery.CALLS_JOIN_DATA_VIEW_MARK); // add for reject by wangth
                newContactInfo.markCount = c.getInt(CallLogQuery.CALLS_JOIN_DATA_VIEW_USER_MARK);
