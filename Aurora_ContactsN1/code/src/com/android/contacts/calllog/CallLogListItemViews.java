...
public final class CallLogListItemViews {
    ...
    private final TextView callLogDate;
    public final QuickContactBadge quickContactPhoto;
     
    private final TextView calllogName;
     
    private final TextView calllogNumber;
     
     
    private final com.android.contacts.calllog.CallTypeIconsView calllogType;
     
    private final TextView calllogCount;
     
    private final TextView calllogSimName;
     
    private final TextView calllogTime;
    private final ImageView calllogNewCall;
    
     
    private final PhoneCallDetailsViews phoneCallDetailsViews;
