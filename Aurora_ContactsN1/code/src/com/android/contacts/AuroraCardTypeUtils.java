...
public class AuroraCardTypeUtils{
    ...
    private static String mSimType1 = "unknown", mSimType2 = "unknown";
	...
	public static String getIccCardType(ITelephony iTel) {
	    if(mSimType1.equals("unknown")) {
	    	mSimType1 = AuroraITelephony.getIccCardType(iTel);
        }
	...
	public static String getIccCardTypeGemini(ITelephony iTel, int slotId) {
        ...
        if(result.equals("unknown")) {
        	result = AuroraITelephony.getIccCardTypeGemini(iTel, slotId);
        }
	...
	private static void getType(){
    	if(GNContactsUtils.isMultiSimEnabled()) {
        	mSimType1 = AuroraITelephony.getIccCardTypeGemini(iTel, 0);
            mSimType2 = AuroraITelephony.getIccCardTypeGemini(iTel, 1);		
    	} else {
    		mSimType1 = AuroraITelephony.getIccCardType(iTel);
    	}
	} 
