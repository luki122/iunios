...
public class LegacyPostalAddressListAdapter extends ContactEntryListAdapter {
    ...
    private static final String[] POSTALS_PROJECTION = new String[] {
    ...
    private static final int POSTAL_ID_COLUMN_INDEX = 0;
     
    private static final int POSTAL_TYPE_COLUMN_INDEX = 1;
     
    private static final int POSTAL_LABEL_COLUMN_INDEX = 2;
     
    private static final int POSTAL_NUMBER_COLUMN_INDEX = 3;
     
    private static final int POSTAL_DISPLAY_NAME_COLUMN_INDEX = 4;
    private static final int POSTAL_PHONETIC_NAME_COLUMN_INDEX = 5;
