...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    private void updateIndexer(Cursor cursor) {
        ...
        if (bundle != null && bundle.containsKey(Contacts.EXTRA_ADDRESS_BOOK_INDEX_TITLES)) {
            String sections[] =
...
//      }
    ...
    private boolean mIsQueryForDialer = false;
    ...
    public int getContactID(int position) {
        ...
        if (getIsQueryForDialer()) {
            return cursor.getInt(cursor.getColumnIndexOrThrow(DialerSearch.CONTACT_ID));
        }
    ...
    public int getRawcontactId(int position) {
        ...
        // aurora <wangth> <2013-10-19> modify for aurora ui begin 
        if (getIsQueryForDialer()) {
            int contactId = cursor.getInt(cursor.getColumnIndexOrThrow(DialerSearch.CONTACT_ID));
    ...
    public int getIndicatePhoneSim(int position) {
        ...
        if (getIsQueryForDialer()) {
            return cursor.getInt(cursor.getColumnIndexOrThrow(DialerSearch.INDICATE_PHONE_SIM));        	
        }
