...
public abstract class ContactListAdapter extends ContactEntryListAdapter {
    ...
    protected static class ContactQuery {
        ...
        //The following lines are provided and maintained by Mediatek inc.
        private static final int CONTACT_SNIPPET          = 10;
    }
    ...
    public Uri getContactUri(int partitionIndex, Cursor cursor) {
        ...
        String lookupKey = cursor.getString(ContactQuery.CONTACT_LOOKUP_KEY);
        if (getIsQueryForDialer()) {
            contactId = cursor.getLong(AuroraDialerSearchResultColumns.CONTACT_ID_INDEX);
            lookupKey = cursor.getString(AuroraDialerSearchResultColumns.CONTACT_NAME_LOOKUP_INDEX);
        }
...
//                }
    ...
    protected void bindName(final ContactListItemView view, Cursor cursor) {
            ...
            if (getIsQueryForDialer()) {
                ...
                view.showDisplayName(cursor, ContactQuery.CONTACT_DISPLAY_NAME, 0);
            }
