        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    protected static class AccountDisplay {
        ...
        private GroupDelta mUngrouped;
        private ArrayList<GroupDelta> mSyncedGroups = Lists.newArrayList();
        private ArrayList<GroupDelta> mUnsyncedGroups = Lists.newArrayList();

        /**
         * Build an {@link AccountDisplay} covering all {@link Groups} under the
         * given {@link AccountWithDataSet}.
         */
        private AccountDisplay(ContentResolver resolver, String accountName, String accountType,
                String dataSet) {
            mName = accountName;
            mType = accountType;
            mDataSet = dataSet;
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
            ...
            if (null == displayName) {
                //Gionee:wangth 20120414 modify for CR00572641 begin
                //text1.setText(account.mName);
                if ( AccountType.ACCOUNT_TYPE_LOCAL_PHONE.equals(account.mType)) {
