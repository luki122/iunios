    ...
    private static class TextWatcherLoadAsyncTask extends
        ...
        protected PhoneNumberFormattingTextWatcher doInBackground(Void... params) {
           // return new PhoneNumberFormattingTextWatcher(mCountryCode);
            // aurora <wangth> <2013-10-29> add for aurora ui begin 
            mTextView.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
            // aurora <wangth> <2013-10-29> add for aurora ui end
        	return new AuroraPhoneNumberFormattingTextWatcher(mCountryCode,mTextView);//aurora change zhouxiaobing 20130918
        }
