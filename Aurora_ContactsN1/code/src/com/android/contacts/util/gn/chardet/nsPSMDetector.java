...
public abstract class nsPSMDetector {
   ...
   private static final int SIMPLIFIED_CHINESE  =  3 ;
    
   private static final int TRADITIONAL_CHINESE =  4 ;
    
   private static final int KOREAN              =  5 ;

    
   private static final int NO_OF_LANGUAGES     =  6 ;
    
   private static final int MAX_VERIFIERS       = 16 ;
