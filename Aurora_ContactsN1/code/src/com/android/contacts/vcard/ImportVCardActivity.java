...
public class ImportVCardActivity extends ContactsActivity {
    ...
    /* package */ private VCardImportExportListener mListener;
...
//                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private void doScanExternalStorageAndImportVCard() {
        ...
        String path = null;
            ...
            path = AuroraStorageManager.getDefaultPath();
            if(isSdCard2)
            	path=AuroraStorageManager.getInstance(this).getExternalStoragePath();//aurora add zhouxiaobing 20131211
