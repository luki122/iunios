...
public class PhoneCallDetailsHelper {
    ...
    */
    ...
    public PhoneCallDetailsHelper(Resources resources, CallTypeHelper callTypeHelper,
            PhoneNumberHelper phoneNumberHelper, CallLogSubInfoHelper CallLogSubInfoHelper,
            Context context) {
        mResources = resources;
        mCallTypeHelper = callTypeHelper;
        mPhoneNumberHelper = phoneNumberHelper;
        mCallLogSubInfoHelper = CallLogSubInfoHelper;
        mContext = context;
    }
    ...
    public void setPhoneCallDetails(CallLogListItemView views, PhoneCallDetails details,
        ...
        * Descriptions:
        */
        views.setCallType(details.callType);
        /**
        * Change Feature by Mediatek End.
        */
        ...
        */
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            if (null != mCallLogSubInfoHelper) {
                setSubinfo(views.getSimNameTextView(),
                        mCallLogSubInfoHelper.getSimDisplayNameById(details.simId),
                        mCallLogSubInfoHelper.getSimColorDrawableById(details.simId));
            }
        }else {
    ...
    */
    ...
    /** Sets the call subInfo. */
    private void setSubinfo(TextView view, final String simName, final Drawable simColor) {
    	log("setSubinfo() simName == " + simName );
        if ("".equals(simName) || null == simColor) {
        	log("setSubinfo() simName is null or   simColor is null, simname will not show");
