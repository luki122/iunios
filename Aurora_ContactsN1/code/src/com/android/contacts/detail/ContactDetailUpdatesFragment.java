...
//            ContactDetailDisplayUtils.setAlphaOnViewBackground(mAlphaLayer, alpha);
    ...
    public int getFirstListItemOffset() {
        return ContactDetailDisplayUtils.getFirstListItemOffset((AuroraListView)getListView());
    }
    ...
    public void requestToMoveToOffset(int offset) {
    	try {
    		ContactDetailDisplayUtils.requestToMoveToOffset((AuroraListView)getListView(), offset);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    }
