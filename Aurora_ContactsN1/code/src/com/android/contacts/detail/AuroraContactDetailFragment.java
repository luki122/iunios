...
public class AuroraContactDetailFragment extends Fragment implements
    ...
    private static final String TAG = "AuroraContactDetailFragment";
...
//                mAllEntries.add(new SeparatorViewEntry());
    ...
    static class ViewEntry {
        ...
        private ViewEntry(int viewType) {
     ...
     * list of data.
     */
    private static class DetailViewEntry extends ViewEntry implements Collapsible<DetailViewEntry> {
        ...
        private Intent getCallIntent(String number, int slot) {
        	Intent intent = ContactsUtils.getCallNumberIntent(number, slot);
...
//                    secondaryActionClickListener);
    ...
    private final class ViewAdapter extends BaseAdapter {
        ...
        private void bindDetailView(int position, View view, DetailViewEntry entry) {
            ...
            views.data.setGravity(Gravity.START|Gravity.CENTER_VERTICAL);
     ...
     */
    private void showNewAddWidget(DetailViewCache views, DetailViewEntry entry, int visibility) {
    ...
    */
     ...
     */
    private NamedContentValues getFirstNamedContentValues(ContactLoader.Result contactData, final String mimeType) {        
        if (contactData == null) {
    ...
    */
    ...
    private static boolean isUnSync(DataKind kind, ContentValues values ){
        /*
         * Bug Fix by Mediatek Begin. Original Android's code: xxx CR ID:
         * ALPS00246021 Descriptions:
         */
