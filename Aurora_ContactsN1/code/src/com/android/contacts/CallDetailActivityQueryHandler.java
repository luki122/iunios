...
/**
 * Class used by {@link AuroraCallDetailActivity} to fire async content resolver queries.
 */
...
//    private final AuroraCallDetailActivity mCallDetailActivity;

    public CallDetailActivityQueryHandler(AuroraCallDetailActivity mCallDetailActivity) {
        super(ContactsApplication.getInstance().getContentResolver());
//        mCallDetailActivity = callDetailActivity;
     ...
     * query a call to {@link AuroraCallDetailActivity#updateVoicemailStatusMessage(Cursor)} is made.
     * <p>
