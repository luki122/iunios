...
public class NfcHandler implements NfcAdapter.CreateNdefMessageCallback {
    ...
    private final AuroraContactDetailFragment mContactFragment;

    public static void register(Activity activity, AuroraContactDetailFragment contactFragment) {
    ...
    public NfcHandler(AuroraContactDetailFragment contactFragment) {
