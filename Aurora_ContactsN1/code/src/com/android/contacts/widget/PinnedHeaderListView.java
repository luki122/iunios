...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    private PinnedHeaderListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        // gionee xuhz 20120807 modify for CR00664338 start
        mHeaderPaddingLeft = getPaddingLeft();
        mHeaderWidth = r - l - mHeaderPaddingLeft - getPaddingRight();
        super.onLayout(changed, l, t, r, b);
        // gionee xuhz 20120807 modify for CR00664338 end
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        ContactsUtils.mListHeaderTop = top;
    ...
    private void drawHeader(Canvas canvas, PinnedHeader header, long currentTime) {
        ...
        ContactsUtils.mListHeaderY = header.y;
        ...
        if (mOnScrollListener != null) {
            mOnScrollListener.onScroll(this, mFirstVisibleItem, mVisibleItemCount, mTotalItemCount);
        }
    }
}
