...
public class ContactSaveService extends IntentService {
    ...
    private static final String EXTRA_CONTACT_STATE = "state";
    
    private static final String EXTRA_SAVE_IS_PROFILE = "saveIsProfile";
    public static final String EXTRA_SAVE_SUCCEEDED = "saveSucceeded";

    //aurora <wangth> <2013-9-16> add for auroro ui begin
    private static final String ACTION_AURORA_CREATE_GROUP = "auroraCreateGroup";
    private static final String ACTION_AURORA_UPDATE_GROUP = "auroraUpdateGroup";
    private static final String ACTION_AURORA_CREATE_GROUP2 = "auroraCreateGroup2";//aurora add zhouxiaobing 20131216
    ...
    private static final String EXTRA_GROUP_LABEL = "groupLabel";
    private static final String EXTRA_RAW_CONTACTS_TO_ADD = "rawContactsToAdd";
    private static final String EXTRA_RAW_CONTACTS_TO_REMOVE = "rawContactsToRemove";
    private static final String EXTRA_RAW_CONTACTS_TO_UPDATE = "rawContactsToUpdate";

    private static final String ACTION_SET_STARRED = "setStarred";
    private static final String ACTION_DELETE_CONTACT = "delete";
    private static final String EXTRA_CONTACT_URI = "contactUri";
    private static final String EXTRA_STARRED_FLAG = "starred";

    private static final String ACTION_SET_SUPER_PRIMARY = "setSuperPrimary";
    private static final String ACTION_CLEAR_PRIMARY = "clearPrimary";
    private static final String EXTRA_DATA_ID = "dataId";

    private static final String ACTION_JOIN_CONTACTS = "joinContacts";
    private static final String EXTRA_CONTACT_ID1 = "contactId1";
    private static final String EXTRA_CONTACT_ID2 = "contactId2";
    private static final String EXTRA_CONTACT_WRITABLE = "contactWritable";

    private static final String ACTION_SET_SEND_TO_VOICEMAIL = "sendToVoicemail";
    private static final String EXTRA_SEND_TO_VOICEMAIL_FLAG = "sendToVoicemailFlag";

    /*
     * New Feature by Mediatek Begin.            
     * using by block video call     
     */
    private static final String ACTION_SET_BLOCK_VIDEO_CALL = "blockVideoCall";
    private static final String EXTRA_BLOCK_VIDEO_CALL_FLAG = "blockVideoCallFlag";
    /*
     * New Feature  by Mediatek End.
    */
    
    private static final String ACTION_SET_RINGTONE = "setRingtone";
    private static final String EXTRA_CUSTOM_RINGTONE = "customRingtone";
