...
public class MmsSmsProvider extends ContentProvider {
   ...
   // Aurora xuyong 2014-09-19 added for aurora reject feature end
    ...
    private static final int CHANGE_CONV_FOLD_STATUS             = 45;
    ...
    private static final String[] MMS_SMS_COLUMNS =
            { BaseColumns._ID, Mms.DATE, Mms.DATE_SENT, Mms.READ, Mms.THREAD_ID, Mms.LOCKED, Mms.SIM_ID,"star", "fold"};
     //gionee gaoj 2012-3-27 added for CR00555790 end
    ...
    static {
     ...
     //gionee gaoj 2012-3-27 added for CR00555790 end
        // Aurora xuyong 2015-12-29 added for aurora 2.0 new feature start
        URI_MATCHER.addURI(AUTHORITY,"fold", CHANGE_CONV_FOLD_STATUS);
        // Aurora xuyong 2015-12-29 added for aurora 2.0 new feature end
 ...
 //       Xlog.d(LOG_TAG, "query uri = " + uri);
    ...
    private String searchContacts(String pattern) {
     //   Xlog.d(LOG_TAG,"searchContacts pattern = "+pattern);
        String in = " IN ";
        // Aurora xuyong 2016-03-08 modified for bug #20674 start
        Builder builder = PICK_PHONE_EMAIL_FILTER_URI.buildUpon();
        // Aurora xuyong 2016-03-08 modified for bug #20674 end
        ...
        try {
            builder.appendPath(new String(pattern.getBytes("utf-8"), "iso-8859-1"));
...
*/
 ...
 //       Xlog.d(LOG_TAG, "update URI is " + uri);
        switch(URI_MATCHER.match(uri)) {
            // Aurora xuyong 2015-12-29 added for aurora 2.0 new feature start
            case CHANGE_CONV_FOLD_STATUS:
                db.update("sms", values, selection, selectionArgs);
                db.update("pdu", values, selection, selectionArgs);
                return 1;
             // Aurora xuyong 2015-12-29 added for aurora 2.0 new feature end
        //Aurora yudingmin 2014-11-05 added for aurora special feature start
