...
public class TelephonyProvider extends ContentProvider
{
        ...
        public static ContentValues setDefaultValue(ContentValues values) {
            ...
            if (mVersion < (15 << 16 | 6)) {
                ...
                if (!values.containsKey(Telephony.Carriers.SUB_ID)) {
                    values.put(Telephony.Carriers.SUB_ID, -1);
                }
                ...
                //put at last one content to prevent empty ContentValue caused SQLite error
                values.put(Telephony.Carriers.NAME, "");
            }
            return values;
        }
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case URL_PREFERAPN_NO_UPDATE: {
                qb.appendWhere("_id = " + getPreferredApnId(PREF_FILE + subId));
                break;
            }

            // M: MTK tethering support
            case URL_PREFERTETHERINGAPN: {
                qb.appendWhere("_id = " + getPreferredApnId(PREF_TETHERING_FILE + subId));
                break;
            }
    ...
    public Uri insert(Uri url, ContentValues initialValues)
    {
        ...
        switch (match)
        {
            ...
            case URL_PREFERAPN_NO_UPDATE:
            {
                if (initialValues != null) {
                    if(initialValues.containsKey(COLUMN_APN_ID)) {
                        setPreferredApnId(PREF_FILE + subId, initialValues.getAsLong(COLUMN_APN_ID));
                    }
                }
                break;
            }
            ...
            case URL_PREFERTETHERINGAPN: {
                if (initialValues != null) {
                    if (initialValues.containsKey(COLUMN_APN_ID)) {
                        setPreferredApnId(PREF_TETHERING_FILE + subId, initialValues
    ...
    public int delete(Uri url, String where, String[] whereArgs)
    {
        ...
        switch (match)
        {
            ...
            case URL_PREFERAPN_NO_UPDATE:
            {
                setPreferredApnId(PREF_FILE + subId, (long) -1);
            ...
            // M: MTK modfified
            case URL_PREFERTETHERINGAPN: {
                setPreferredApnId(PREF_TETHERING_FILE + subId, (long) -1);
                count = 1;
                break;
            }
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs)
    {
        ...
        switch (match)
        {
            ...
            case URL_PREFERAPN_NO_UPDATE:
            {
                if (values != null) {
                    if (values.containsKey(COLUMN_APN_ID)) {
                        setPreferredApnId(PREF_FILE + subId, values.getAsLong(COLUMN_APN_ID));
            ...
            case URL_PREFERTETHERINGAPN:
            {
                if (values != null) {
                    if (values.containsKey(COLUMN_APN_ID)) {
                        setPreferredApnId(PREF_TETHERING_FILE + subId, values
                                .getAsLong(COLUMN_APN_ID));
                        count = 1;
                    }
                }
