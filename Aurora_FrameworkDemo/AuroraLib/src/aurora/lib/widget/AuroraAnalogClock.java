...
public class AuroraAnalogClock extends ImageView {
    ...
    */
    ...
    public AuroraAnalogClock(Context context, AttributeSet attrs,
        ...
        mDial = r.getDrawable(com.aurora.lib.R.drawable.aurora_appwidget_clock_dial);
        mHourHand = r.getDrawable(com.aurora.lib.R.drawable.aurora_appwidget_clock_hour);
        mMinuteHand = r.getDrawable(com.aurora.lib.R.drawable.aurora_appwidget_clock_minute);
        mSecondHand = r.getDrawable(com.aurora.lib.R.drawable.aurora_appwidget_clock_second);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!mNoSeconds) {
            ...
            if (changed) {
                ...
                secondHand.setBounds(x - (w / 2), y - (h / 2) - 107, x + (w / 2), y + (h / 2) - 107);
            }
        ...
        if (changed) {
            ...
            minuteHand.setBounds(x - (w / 2), y - (h / 2) - 95, x + (w / 2), y + (h / 2) - 95);
        }
        ...
        if (changed) {
            ...
            hourHand.setBounds(x - (w / 2), y - (h / 2) - 70, x + (w / 2), y + (h / 2) - 70);
        }
