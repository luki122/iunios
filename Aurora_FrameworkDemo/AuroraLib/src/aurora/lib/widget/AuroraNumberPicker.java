...
public class AuroraNumberPicker extends LinearLayout {
    ...
    public AuroraNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLablePaddingRight = getResources().getDimensionPixelSize(com.aurora.lib.R.dimen.aurora_number_picker_label_padding_right);
        // process style attributes
        initScrollCache();
        TypedArray attributesArray = context.obtainStyledAttributes(attrs,
                R.styleable.AuroraNumberPicker, defStyle, 0);
        mSolidColor = attributesArray.getColor(R.styleable.AuroraNumberPicker_aurorasolidColor, 0);
...
//            y += mOtherTextSize+mSelectorTextGapHeight;
        ...
        if(mLable != null){
        	...
        	if(mSetTextColor){
                ...
                mSelectorWheelPaint.setColor(getContext().getResources().getColor(com.aurora.lib.R.color.aurora_numberpicker_select_text_color));
            }
