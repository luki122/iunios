...
import com.android.auroramusic.model.CustomDurationScroller;
...
public class BannerViewPager extends ViewPager {
	...
	private boolean isBorderAnimation = true; // 是否需要动画
	private boolean stopScrollWhenTouch = true; // 触摸时是否停止自动滚动
	private boolean isStopByTouch = false; // 是否触摸时停止的滚动
