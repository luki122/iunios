...
public class AuroraSearchLyricView extends View implements OnTouchListener {

	private static final String TAG = "AuroraSearchLyricView";
	...
	public AuroraSearchLyricView(Context context) {
		this(context, null);
	}

	public AuroraSearchLyricView(Context context, AttributeSet attrs) {
