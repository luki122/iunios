...
public class ControlPanelEffect {
    ...
    public static void initEffectsPreferences(final Context context, final String packageName,
        ...
        try {
            ...
            LogUtil.v(TAG, "isGlobalEnabled = " + isGlobalEnabled);
                ...
                if (value == true) {
                    ...
                    if (controlMode == ControlMode.CONTROL_EFFECTS) {
                        ...
                        if (virtualizerEffect != null) {
                            ...
                            final int vIStrength = prefs.getInt(Key.virt_strength.toString(),
                                    defaultstrength);
                            //Log.i(TAG, "zll ---- setParameterBoolean 1");
                        ...
                        if (bassBoostEffect != null) {
                            ...
                            final int bBStrength = prefs.getInt(Key.bb_strength.toString(),
                                    BASS_BOOST_STRENGTH_DEFAULT);
                            //Log.i(TAG, "zll ---- setParameterBoolean 2");
                            setParameterInt(context, packageName,
                        ...
                        if (equalizerEffect != null) {
                            ...
                            //Log.i(TAG, "zll ---- setParameterBoolean 3");
    ...
    public static void setParameterInt(final Context context, final String packageName,
        ...
        try {
            ...
            //Log.i(TAG, "zll ----- setParameterInt 1 controlMode:"+controlMode+",audioSession:"+audioSession);
            // Set effect parameters
            if (controlMode == ControlMode.CONTROL_EFFECTS) {
            	//Log.i(TAG, "zll ----- setParameterInt 2 key:"+key);
                switch (key) {
                ...
                case eq_current_preset: {
                    final Equalizer equalizerEffect = getEqualizerEffect(audioSession);
                    //Log.i(TAG, "zll ----- setParameterInt 2.1 equalizerEffect:"+equalizerEffect);
                    if (equalizerEffect != null) {
                        ...
                        //Log.i(TAG, "zll ----- setParameterInt 2.2 preset:"+preset+",numPresets:"+numPresets);
                        if (preset < numPresets) {
                            ...
                            for (short band = 0; band < numBands; band++) {
                                short bandLevel = 0;
                                //Log.i(TAG, "zll ----- setParameterInt 2.3 band:"+band+",eQPresetCIExtremeBandLevelDefault[band]:"+eQPresetCIExtremeBandLevelDefault[band]);
                                if (preset == numPresets) {
                                    // CI EXTREME
                                ...
                                //Log.i(TAG, "zll ----- setParameterInt 2.4 band:"+band+",bandLevel:"+bandLevel);
            	...
            	//Log.i(TAG, "zll ----- setParameterInt 3 key:"+key);
                switch (key) {
                // Virtualizer
                case virt_strength:
                    // Do nothing
            ...
            //Log.i(TAG, "zll ----- setParameterInt 4 strKey:"+strKey+",value:"+value);
            // Set preferences
    ...
    public static void setParameterInt(final Context context, final String packageName,
    	...
    	LogUtil.d(TAG, "----packageName:"+packageName+" audioSession:"+audioSession+" key:"+key+" arg:"+arg);
    ...
    public static void setEnabledAll(final Context context, final String packageName,
        ...
        //Log.i(TAG, "zll ---- setParameterBoolean setEnabledAll 4");
