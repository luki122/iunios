...
public class AuroraAlbumListAdapter extends BaseAdapter {
	...
	public View getView(int index, View converView, ViewGroup parent) {
		...
		RelativeLayout rl_control_padding = (RelativeLayout) converView.findViewById(com.aurora.R.id.control_padding);//DisplayUtil.dip2px(mActivity, 12)
		rl_control_padding.setPadding(0, 0, 0, 0);//(int) mActivity.getResources().getDimension(com.aurora.R.dimen.checkbox_margin_right_in_listview_with_index)
