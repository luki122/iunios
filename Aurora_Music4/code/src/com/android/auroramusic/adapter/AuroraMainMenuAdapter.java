	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			if (layoutId != -1) {
				...
				arg1 = LayoutInflater.from(mContext).inflate(R.layout.aurora_first_main_item, null);
			}
	...
	private class ShowSongSizeTask extends AsyncTask<Void, Integer, Integer> {
		...
		private void setSizeText(int size) {
			...
			case 7:
				...
				break;
			case 1:
				textview.setText(mContext.getString(R.string.aurora_playlist_total_songs, size));
				break;
			case 2:
				textview.setText(mContext.getString(R.string.aurora_playlist_total_singer, size));
				break;
			case 3:
				textview.setText(mContext.getString(R.string.aurora_playlist_total_fold, size));
				break;
			case 6:
