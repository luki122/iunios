...
public class AuroraSearchArtistAdapter extends BaseAdapter {
	...
	public AuroraSearchArtistAdapter(Context context, List<OnlineArtist> list) {
		mList = list;
		mContext = context;
		mImageSize = (int) mContext.getResources().getDimension(
				R.dimen.aurora_netartist_size);
	...
	private void initImageCacheParams() {
		mOptions = new DisplayImageOptions.Builder()
				...
				.showImageOnLoading(R.drawable.aurora_lyric_select_uncheked)
