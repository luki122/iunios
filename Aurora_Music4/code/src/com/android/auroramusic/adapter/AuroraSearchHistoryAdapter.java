...
public class AuroraSearchHistoryAdapter extends BaseAdapter {
	...
	public AuroraSearchHistoryAdapter(Context context,boolean is) {
		mContext=context;
		isHistory =is;
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		HoldView holdView;
		if (arg1 == null) {
			arg1 = LayoutInflater.from(mContext).inflate(com.aurora.R.layout.aurora_slid_listview,
					null);
			RelativeLayout front = (RelativeLayout) arg1
					.findViewById(com.aurora.R.id.aurora_listview_front);
			LayoutInflater.from(mContext).inflate(R.layout.aurora_search_history_item, front);
			...
			holdView.name=(TextView) arg1.findViewById(R.id.aurora_id_history);
			holdView.sustion=(TextView) arg1.findViewById(R.id.aurora_id_sustion);
