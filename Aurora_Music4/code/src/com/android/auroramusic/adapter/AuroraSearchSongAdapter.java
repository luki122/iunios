...
public class AuroraSearchSongAdapter extends BaseAdapter {
	...
	private static final String TAG="AuroraSearchSongAdapter";
	...
	public AuroraSearchSongAdapter(Context context, List<OnlineSong> list) {
		mSongList = list;
		mContext = context;
