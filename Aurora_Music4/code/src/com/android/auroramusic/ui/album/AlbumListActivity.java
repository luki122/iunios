...
public class AlbumListActivity extends AbstractBaseActivity implements AlbumListFragment.Callbacks, MusicUtils.Defs, ServiceConnection {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAuroraContentView(R.layout.activity_album_list, AuroraActionBar.Type.Normal);
	...
	private class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			if (play_all == msg.what) {
				ArrayList<AuroraListItem> arrayList = MusicUtils.getSongsForArtist(mActivity, Long.parseLong(mArtistId), mPathsXml);
