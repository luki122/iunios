...
public class AuroraMediaPlayHome extends AbstractBaseActivity implements OnClickListener, MusicUtils.Defs {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			setAuroraMenuCallBack(auroraActionBarItemCallBack);
			...
			setMenuEnable(true);
			setAuroraMenuItems(R.menu.menu_main);
	...
	private void showDeleteDialog() {
		if (mAuroraAlertDialog == null) {
			AuroraAlertDialog.Builder build = new AuroraAlertDialog.Builder(this).setTitle(R.string.aurora_exit).setMessage(R.string.aurora_exit_tips)
	...
	private void showNetworkDialog() {
		...
		AuroraAlertDialog dialog = new AuroraAlertDialog.Builder(this).setTitleDividerVisible(true).setTitle(R.string.use_network_title)
				.setPositiveButton(R.string.menu_continue, new DialogInterface.OnClickListener() {
