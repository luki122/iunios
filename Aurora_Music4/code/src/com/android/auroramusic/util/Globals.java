...
public class Globals {
	...
	// add by chenhl start 20140808
	public static final int FILE_SIZE_FILTER = 1024 * 500; // 搜索歌曲过滤文件大小
	...
	/**
	 * {@link AuroraMusicUtil#getMountedStorage(android.content.Context)}}
	 * QUERY_SONG_FILTER 与QUERY_SONG_FILTER_1 赋值
	 */
	public static String QUERY_SONG_FILTER = ""; // 搜索歌曲过滤条件//MediaStore.Audio.Media.DATA + " NOT LIKE '" + FILE_PATH + "/CallRecording%' "
	public static String QUERY_SONG_FILTER_1 = null; // 搜索歌曲过滤条件
	public static String PLAYER_QUERY_SONG_FILTER = null; // 搜索歌曲过滤条件
	public static final String AURORA_DIAL_RECODE_DIR = "/CallRecording%\"";// 通话录音
	public static final String AURORA_PLAYLIST_TIP = "aurora"; // 歌单头用于区别是自定义歌单
	public static final String AURORA_NOTE_DIR = "/note/sound%\""; // 备忘录录音
	public static final String AURORA_NOTE_DIR2 = "/IUNINote/sound%\"";// 备忘录录音
	public static final String AURORA_ANDROID_DATA = "/Android/%data%\"";
	public static final String AURORA_CALLRECORDING = "/CallRecording%\"";
	public static final boolean SHOW_SEARCH_LRC = false;
	public static final long AURORA_LOW_MEMORY = 3*1024*1024;//3M

	// add by chenhl end 20140606
	...
	public static final long LOW_MEMORY = AURORA_LOW_MEMORY*10;

	public static final String SYSTEM_SEPARATOR = System.getProperty("file.separator");
	public static boolean mTestMode = false;// test
	public static String storagePath = Environment.getExternalStorageDirectory().getPath();
	public static String BASE_PATH = storagePath + SYSTEM_SEPARATOR + "Music" + SYSTEM_SEPARATOR + "auroramusic";
	...
	public static String baseLycPath = SYSTEM_SEPARATOR + "Music" + SYSTEM_SEPARATOR + "auroramusic"+SYSTEM_SEPARATOR + "lyric";
	...
	public static String baseSongImagePath = SYSTEM_SEPARATOR + "Music" + SYSTEM_SEPARATOR + "auroramusic"+SYSTEM_SEPARATOR + "songImage";
	public static String mSongImagePath = BASE_PATH + SYSTEM_SEPARATOR + "songImage";

	public static void initPath(String path) {
		storagePath = path;
		BASE_PATH = storagePath + SYSTEM_SEPARATOR + "Music" + SYSTEM_SEPARATOR + "auroramusic";
	...
	public static final String PLAYER_NAVI_KEY_HIDE = "navigation_key_hide"; // Settings.System
				
	public static boolean STORAGE_PATH_SETTING = false;//是否显示存储设置 

	public static boolean SWITCH_FOR_ONLINE_MUSIC = true; // 打开在线音乐开关
	public static boolean SWITCH_FOR_SOUND_CONTROL = false;// 打开音效按钮 默认关闭
															// 在AuroraMusicUtil里面根据机型打开
	public static boolean NO_MEUN_KEY=false;//没有菜单键
	public static int SWITCH_FOR_ONLINE_MUSIC_Quality = 1;// 1 L 2 M 3 H //低中高
