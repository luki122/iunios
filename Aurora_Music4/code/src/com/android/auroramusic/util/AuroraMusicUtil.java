...
public class AuroraMusicUtil {
	...
	public static void setMusicProp() {
		try {
			...
			if (prop.equalsIgnoreCase("IUNI i1") || prop.contains("GiONEE i1") || prop.equalsIgnoreCase("IUNI N1") || prop.equalsIgnoreCase("IUNI U0003")) {// u3m,8905
				Globals.SWITCH_FOR_SOUND_CONTROL = true;
			} else {
				Globals.SWITCH_FOR_SOUND_CONTROL = false;
			}
			
			if(prop.equalsIgnoreCase("IUNI N1") || prop.equalsIgnoreCase("IUNI U5")||prop.equalsIgnoreCase("IUNI U0003")){
