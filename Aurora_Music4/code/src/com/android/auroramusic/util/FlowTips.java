...
public class FlowTips {
	...
	public static boolean showPlayFlowTips(final Context context, final OndialogClickListener l) {
		...
		AuroraAlertDialog dialog = new AuroraAlertDialog.Builder(context)
				...
				}).setTitleDividerVisible(true).setTitle(R.string.aurora_flow_tips)
	...
	public static void showWifiSwitch(final Context context) {
		View layout = LayoutInflater.from(context).inflate(R.layout.aurora_net_setting, null);
		AuroraSwitch switch1 = (AuroraSwitch) layout.findViewById(R.id.aurora_close_wifi_switch);
		...
		AuroraAlertDialog dialog = new AuroraAlertDialog.Builder(context).setTitleDividerVisible(true).setView(layout)
				.create();// .setTitle(R.string.aurora_net_setting)
		dialog.setCanceledOnTouchOutside(true);
		dialog.show();
	}
