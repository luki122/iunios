...
/*
 * lory add 2014.5.9 start
 * 存储当前music的信息结构体，本地音乐，则根据m_SongId和m_AlbumId获取music的专辑图片 ，网络music则根据URL获取图片;
 */
public class AuroraListItem implements AuroraIListItem {

	// private long mId;//lory del duplicate 2014.5.20 start
	...
	private String mPath;// 本地文件路径(绝对路径---不使用)
	...
	private int mWidth = 0;// 2014.10.31 lory add for cache size
	private int mHight = 0;// 2014.10.31 lory add for cache size
	...
	public AuroraListItem() {
	}// add by ukiliu 2014-06-25

	public AuroraListItem(long songId, String title, String uri, String albumName, long albumid, String artistName, int isNet, String albumUri, String lrcUri, String lrcAuthor, int order,boolean isAvailable){
	...
	// 必须使用的数据结构字段
	public AuroraListItem(long songId, String title, String uri, String albumName, long albumid, String artistName, int isNet, String albumUri, String lrcUri, String lrcAuthor, int order) {
		this(songId, title, uri, albumName, albumid, artistName, isNet, albumUri, lrcUri, lrcAuthor, order, true);
	}

	// 2014.10.31 lory add for cache size start
	...
	// 2014.10.31 lory add for cache size end
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AuroraListItem other = (AuroraListItem) obj;
		if (mAlbumName == null) {
	...
	public String toString() {
		return "AuroraListItem [mBitmap=" + mBitmap + ", mTitle=" + mTitle + ", mAlbumName=" + mAlbumName + ", mUri=" + mUri + ", mPath=" + mPath + ", mArtistName=" + mArtistName + ", m_AlbumImgUri="
	...
	public AuroraListItem(Parcel pl) {
	...
	public static final Parcelable.Creator<AuroraListItem> CREATOR = new Parcelable.Creator<AuroraListItem>() {

		@Override
		public AuroraListItem createFromParcel(Parcel source) {
			return new AuroraListItem(source);
		}

		@Override
		public AuroraListItem[] newArray(int size) {
			return new AuroraListItem[size];
		}
	};
}
