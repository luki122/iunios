...
public class TotalCount implements Runnable {
	 ...
	 *            值
	 */
	public TotalCount(Context context, String module_id, String action_id,
			int value) {
	...
	public void CountData() {
		ThreadPoolExecutor threadPool = ThreadPoolExecutorUtils.getThreadPoolExecutor().getExecutor();//CountManage.getThreadPoolExecutor();
