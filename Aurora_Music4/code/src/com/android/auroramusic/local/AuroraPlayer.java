...
public class AuroraPlayer {
	...
	private final static String TAG = "AuroraPlayer-MediaPlayer";
    /**
    ...
    static {
        ...
        System.loadLibrary("auroraplayer");
    ...
    public AuroraPlayer() {
         ...
         */
        native_setup(new WeakReference<AuroraPlayer>(this));
    }
   ...
   /* public void setSurface(Surface surface) {
     ...
     */
    public static AuroraPlayer create(Context context, Uri uri) {
        try {
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> headers)
        ...
        //Log.d(TAG, "zll setDataSource scheme:"+scheme+",uri:"+uri.toString());
        if(scheme == null || scheme.equals("file")) {
            setDataSource(uri.getPath());
            return;
        }

        //Log.d(TAG, "zll Couldn't open file on client side, trying server side");
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode|PowerManager.ON_AFTER_RELEASE, AuroraPlayer.class.getName());
...
//    private static final int KEY_PARAMETER_TIMED_TEXT_ADD_OUT_OF_BAND_SOURCE = 1001;
    ...
    private static class EventHandler extends WeakHandler<AuroraPlayer>
    {
        public EventHandler(AuroraPlayer mp, Looper looper) {
            super(mp, looper);
        }

        @Override
        public void handleMessage(Message msg) {
        	AuroraPlayer player = getOwner();
        	if(player == null)
        		return;
            ...
            case MEDIA_ERROR:
                ...
                Log.e(TAG, "zll Error (" + msg.arg1 + "," + msg.arg2 + ")");
    ...
    {
    	AuroraPlayer mp = (AuroraPlayer)((WeakReference)mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
    ...
    public interface OnPreparedListener
    {
         ...
         */
        void onPrepared(AuroraPlayer mp);
    }
    ...
    public interface OnCompletionListener
    {
         ...
         */
        void onCompletion(AuroraPlayer mp);
    }
    ...
    public interface OnBufferingUpdateListener
    {
         ...
         */
        void onBufferingUpdate(AuroraPlayer mp, int percent);
    }
    ...
    {
        void onLiveEndTimeUpdate(AuroraPlayer mp, int endTime);
    }
    ...
    public interface OnSeekCompleteListener
    {
         ...
         */
        public void onSeekComplete(AuroraPlayer mp);
    }
    ...
    public interface OnErrorListener
    {
         ...
         */
        boolean onError(AuroraPlayer mp, int what, int extra);
    }
    ...
    public interface OnInfoListener
    {
         ...
         */
        boolean onInfo(AuroraPlayer mp, int what, int extra);
    }
