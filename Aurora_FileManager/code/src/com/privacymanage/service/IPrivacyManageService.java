 ...
 * Original file: /home/jiangxh/Workspace/Aurora_PrivacyManage/code/src/com/privacymanage/service/IPrivacyManageService.aidl
 */
package com.privacymanage.service;
public interface IPrivacyManageService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.privacymanage.service.IPrivacyManageService
{
private static final java.lang.String DESCRIPTOR = "com.privacymanage.service.IPrivacyManageService";
...
/**
 * Cast an IBinder object into an com.privacymanage.service.IPrivacyManageService interface,
 * generating a proxy if needed.
 */
public static com.privacymanage.service.IPrivacyManageService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.privacymanage.service.IPrivacyManageService))) {
return ((com.privacymanage.service.IPrivacyManageService)iin);
}
return new com.privacymanage.service.IPrivacyManageService.Stub.Proxy(obj);
}
...
java.lang.String _arg1;
_arg1 = data.readString();
com.privacymanage.data.AidlAccountData _result = this.getCurrentAccount(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.privacymanage.service.IPrivacyManageService
{
...
/**
     ...
     * @param className 子模块对应界面的类名
     */
@Override public com.privacymanage.data.AidlAccountData getCurrentAccount(java.lang.String pkgName, java.lang.String className) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.privacymanage.data.AidlAccountData _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(pkgName);
_data.writeString(className);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.privacymanage.data.AidlAccountData.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
/**
     ...
     * @param className 子模块对应界面的类名
     */
public com.privacymanage.data.AidlAccountData getCurrentAccount(java.lang.String pkgName, java.lang.String className) throws android.os.RemoteException;
/**
     * 获取所有隐私账户的id
     */
