...
public class AuroraFragment extends Fragment implements IBackPressedListener,
		onFileCategoryInfoChangedLisenter, OperationInterfaceLisenter,
		IActionOnClickListener {
	/**
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (getCurrentFragment() instanceof FileCategoryFragment
				|| getCurrentFragment() instanceof PictureFragment
				|| getCurrentFragment() instanceof PictureCategoryFragment
		...
		leftView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (isOperationFile()
						...
						&& getFileExplorerActivity().getIsGetMoreVideo()
		...
		rightView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (getCurrentFragment() instanceof PictureCategoryFragment) {
					((PictureCategoryFragment) getCurrentFragment())
							.setItemPicAnim(false);
				} else if (getCurrentFragment() instanceof PictureFragment) {
					((PictureFragment) getCurrentFragment())
							.setItemPicAnim(false);
				}
	...
	public void onResume() {
		if (auroraListView != null) {
			if ((activity.getCurrentFragment() instanceof FileViewFragment)
					|| (activity.getCurrentFragment() instanceof FileCategoryFragment)) {
...
//		LogUtil.elog(TAG, "onBack() 0");
	...
	public boolean auroraSetRubbishBack() {
		if (getAuroraListView() != null
				&& getAuroraListView().auroraIsRubbishOut()) {
