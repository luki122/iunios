...
public class MediaFile {
	...
	public static final int FILE_TYPE_3GPP_AUDIO = 14;
	...
	static void addFileType(String extension, int fileType, String mimeType) {
		sFileTypeMap.put(extension, new MediaFileType(fileType,
				mimeType));
	...
	static {
		...
		addFileType("3GPP", FILE_TYPE_3GPP_AUDIO, "audio/3gpp");
	 ...
	 * 
	 * @param mimeType
	 * @return 0 MimeType no  MediaFileType
	 */
	public static int getFileTypeByMimeType(String mimeType) {
		...
		try {
			return sMimeTypeMap.get(mimeType.toLowerCase());
		} catch (Exception e) {
			LogUtil.e(TAG, "mimeType:"+mimeType);
			return 0;
		}
	}
