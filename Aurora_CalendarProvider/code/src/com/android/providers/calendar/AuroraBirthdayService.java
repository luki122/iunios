 ...
 */
public class AuroraBirthdayService extends IntentService {

    public AuroraBirthdayService() {
        super("AuroraBirthdayService");
    }
    ...
    public void onHandleIntent(Intent intent) {
    	...
    	Cursor cursor = cr.query(
                ...
                Calendars.ACCOUNT_NAME + "='" + AuroraBirthdayReceicer.BIRTHDAY_REMINDER_ACCOUNT_NAME + "'",
                null,
                null);
        if (cursor == null) stopSelf();
        ...
        if (cursor.moveToFirst()) {
            ...
            values.put(Calendars.ACCOUNT_NAME, AuroraBirthdayReceicer.BIRTHDAY_REMINDER_ACCOUNT_NAME);
            values.put(Calendars.ACCOUNT_TYPE, CalendarContract.ACCOUNT_TYPE_LOCAL);
            values.put(Calendars.CALENDAR_DISPLAY_NAME, AuroraBirthdayReceicer.BIRTHDAY_REMINDER_ACCOUNT_NAME);
            values.put(Calendars.CALENDAR_COLOR, -9215145);
            values.put(Calendars.CALENDAR_ACCESS_LEVEL, 700);
            values.put(Calendars.SYNC_EVENTS, 1);
            values.put(Calendars.OWNER_ACCOUNT, AuroraBirthdayReceicer.BIRTHDAY_REMINDER_ACCOUNT_NAME);
        ...
        Cursor birthdayCursor = cr.query(
        		...
        		Data.MIMETYPE + "='" + CommonDataKinds.Event.CONTENT_ITEM_TYPE + "'",
                null,
                null);
        if (birthdayCursor != null) {
            ...
            eventRecurrence.wkst = EventRecurrence.calendarDay2Day(Time.MONDAY + 1);
