...
public class CalendarProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    private void verifyTransactionAllowed(int type, Uri uri, ContentValues values,
        ...
        if (type == TRANSACTION_INSERT && values != null && values.containsKey(CalendarContract.Calendars.ACCOUNT_TYPE) &&
                values.getAsString(CalendarContract.Calendars.ACCOUNT_TYPE).equals(CalendarContract.ACCOUNT_TYPE_LOCAL)) {
            return;
        }
