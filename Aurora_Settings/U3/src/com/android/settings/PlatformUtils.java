...
public class PlatformUtils {
	...
	public static boolean isAddCredentialStorage() {
		...
		if(strName.length > 1 && (strName[1].equals("MI2") ||strName[1].equals("H60L01"))) {
			isAdd = false;
		}else {
			isAdd = false;
		}
	...
	// End Add by gary.gou---SecuritySettings.java ----Credential storage
        ...
        public static void setButtonLightEnabled(IHardwareService light){
           try {
                  light.setButtonLightEnabled(true);
	       } catch (RemoteException e) {
		Log.v("PlatformUtils","remote call for turn on button light failed.");
	    }
        }
