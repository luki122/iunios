...
public final class BluetoothPairingDialog extends AuroraActivity implements
    ...
    private AuroraButton mOkButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GnSettingsUtils.getThemeType(getApplicationContext()).equals(GnSettingsUtils.TYPE_LIGHT_THEME)) {
            setTheme(R.style.GnSettingsLightThemeDialog);
        } else {
            setTheme(R.style.GnSettingsDarkThemeDialog);
        }
        // Gionee fangbin 20120619 added for CR00622030 end
...
//    }
    private void createUserEntryDialog(CachedBluetoothDeviceManager deviceManager) {
        ...
        builder.setTitle(getString(R.string.bluetooth_pairing_request));
