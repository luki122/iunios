 ...
 */
final class BluetoothDiscoverableEnabler implements AuroraPreference.OnPreferenceClickListener {
    ...
    private final AuroraPreference mDiscoveryPreference;
    ...
    BluetoothDiscoverableEnabler(Context context, LocalBluetoothAdapter adapter,
            AuroraPreference discoveryPreference) {
        mContext = context;
