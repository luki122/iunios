...
public final class DeviceProfilesSettings extends SettingsPreferenceFragment
    ...
    private AuroraEditTextPreference mDeviceNamePref;

    private final HashMap<LocalBluetoothProfile, AuroraCheckBoxPreference> mAutoConnectPrefs
            = new HashMap<LocalBluetoothProfile, AuroraCheckBoxPreference>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceNamePref = (AuroraEditTextPreference) findPreference(KEY_RENAME_DEVICE);
     ...
     */
    private AuroraCheckBoxPreference createProfilePreference(LocalBluetoothProfile profile) {
        AuroraCheckBoxPreference pref = new AuroraCheckBoxPreference(getActivity());
    ...
    public boolean onPreferenceChange(AuroraPreference preference, Object newValue) {
        if (preference == mDeviceNamePref) {
            ...
            onProfileClicked(prof, (AuroraCheckBoxPreference) preference);
    ...
    private void onProfileClicked(LocalBluetoothProfile profile, AuroraCheckBoxPreference profilePref) {
    ...
    private void refreshProfiles() {
        for (LocalBluetoothProfile profile : mCachedDevice.getConnectableProfiles()) {
            AuroraCheckBoxPreference profilePref = (AuroraCheckBoxPreference)findPreference(profile.toString());
            if (profilePref == null) {
    ...
    private void refreshProfilePreference(AuroraCheckBoxPreference profilePref,
