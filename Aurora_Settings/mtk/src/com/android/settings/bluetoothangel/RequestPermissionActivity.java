 ...
 */
public class RequestPermissionActivity extends AuroraActivity implements
    ...
    // by this AuroraActivity and RequestPermissionHelperActivity
    ...
    private void proceedAndFinish() {
        ...
        if (mEnableOnly) {
            ...
            returnCode = mTimeout;
            // AuroraActivity.RESULT_FIRST_USER should be 1
