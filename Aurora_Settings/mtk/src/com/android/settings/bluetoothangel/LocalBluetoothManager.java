...
public final class LocalBluetoothManager {
    ...
    private AuroraPreferenceFragment mForegroundActivity;
    ...
    public AuroraPreferenceFragment getForegroundActivity() {
    ...
    synchronized void setForegroundActivity(AuroraPreferenceFragment context) {
        if (context != null) {
