...
public final class BluetoothNameDialogFragment extends DialogFragment implements TextWatcher {
    ...
    // Gionee <xiaolin><2013-4-9> modify for CR00783869 start
    // private static final int BLUETOOTH_NAME_MAX_LENGTH_BYTES = 59;
    private static final int BLUETOOTH_NAME_MAX_LENGTH_BYTES = 30;
    // Gionee <xiaolin><2013-4-9> modify for CR00783869 end
    ...
    AuroraEditText mDeviceNameView;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //Gionee:zhang_xin 2012-12-17 delete for CR00746738 start
        mAlertDialog = new AuroraAlertDialog.Builder(getActivity())
        //        .setIcon(android.R.drawable.ic_dialog_info)
                ...
                .create();
        //Gionee:zhang_xin 2012-12-17 delete for CR00746738 end
    ...
    private View createDialogView(String deviceName) {
        ...
        mDeviceNameView = (AuroraEditText) view.findViewById(R.id.edittext);
        ...
        mDeviceNameView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    //gionee fengxb 2012-12-18 add for CR00747470 start 
                    if(v.getText().toString().length() == 0){
                        return false;
                    }
                    //gionee fengxb 2012-12-18 add for CR00747470 end 
