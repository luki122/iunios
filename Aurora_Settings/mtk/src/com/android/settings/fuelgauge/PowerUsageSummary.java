 ...
 */
public class PowerUsageSummary extends AuroraPreferenceFragment implements Runnable {
    ...
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen preferenceScreen, AuroraPreference preference) {
        if (preference instanceof AuroraCheckBoxPreference) {
            ...
            if (KEY_CPU_DTM.equals(preference.getKey())) {
                ...
                AuroraCheckBoxPreference prf = (AuroraCheckBoxPreference) preference;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case H_CHECK_POWER_SAVING_MESSAGE:
                    ((AuroraCheckBoxPreference)findPreference(KEY_CPU_DTM)).setChecked(true);
                    break;
                case H_UNCHECK_POWER_SAVING_MESSAGE:
                    ((AuroraCheckBoxPreference)findPreference(KEY_CPU_DTM)).setChecked(false);
                    break;
                /// @}
