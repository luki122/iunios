...
import aurora.preference.AuroraSeekBarDialogPreference;
...
public class BrightnessPreference extends AuroraSeekBarDialogPreference implements
    ...
    protected void onBindDialogView(View view) {
        ...
        Log.e("BrightnessPreference","mSeekBar="+(mSeekBar==null));
    ...
    private void setBrightness(int brightness, boolean write) {
        if (mAutomaticMode) {
            ...
            //Gionee <wangguojing> <2013-08-20> modify for CR00834982 begin
            brightness = (brightness * range)/SEEK_BAR_RANGE + mScreenBrightnessMinimum+1;
            //Gionee <wangguojing> <2013-08-20> modify for CR00834982 end
            try {
                IPowerManager power = IPowerManager.Stub.asInterface(
                        ServiceManager.getService("power"));
                if (power != null) {
