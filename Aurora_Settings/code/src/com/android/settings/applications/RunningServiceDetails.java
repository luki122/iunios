...
public class RunningServiceDetails extends Fragment
    ...
    //Gionee:zhang_xin 2013-01-17 add for CR00746738 start
    View mRunningServicesDivider1 , mRunningServicesDivider2;
    //Gionee:zhang_xin 2013-01-17 add for CR00746738 end
    ...
    void addServicesHeader() {
        if (mNumServices == 0) {
            ...
            //Gionee:zhang_xin 2013-01-17 add for CR00746738 start
            mRunningServicesDivider1 = mInflater.inflate(R.layout.gn_separator_label_divider,
                mAllDetails, false);
            mAllDetails.addView(mRunningServicesDivider1);
            //Gionee:zhang_xin 2013-01-17 add for CR00746738 end
        }
        mNumServices++;
    }
    ...
    void addProcessesHeader() {
        if (mNumProcesses == 0) {
            ...
            //Gionee:zhang_xin 2013-01-17 add for CR00746738 start
            mRunningServicesDivider2 = mInflater.inflate(R.layout.gn_separator_label_divider,
                mAllDetails, false);
            mAllDetails.addView(mRunningServicesDivider2);
            //Gionee:zhang_xin 2013-01-17 add for CR00746738 end
        }
        mNumProcesses++;
    }
    ...
    void addServiceDetailsView(RunningState.ServiceItem si, RunningState.MergedItem mi,
        ...
        if (isService && mi.mUserId != UserHandle.myUserId()) {
            ...
            detail.mReportButton.setText(R.string.aurora_report);
    ...
    void addDetailViews() {
        ...
        //Gionee:zhang_xin 2013-01-17 add for CR00746738 start
        if (mRunningServicesDivider1 != null) {
            mAllDetails.removeView(mRunningServicesDivider1);
            mRunningServicesDivider1 = null;
        }
        
        if (mRunningServicesDivider2 != null) {
            mAllDetails.removeView(mRunningServicesDivider2);
            mRunningServicesDivider2 = null;
        }
        //Gionee:zhang_xin 2013-01-17 add for CR00746738 end
