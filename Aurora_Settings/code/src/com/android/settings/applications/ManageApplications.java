...
//Gionee qiuxd 20121117 add for CR00733240 start
import android.os.SystemProperties;
//Gionee qiuxd 20121117 add for CR00733240 end
...
public class ManageApplications extends Fragment implements
    ...
    // sort order
    //Gionee lihq 2012-09-14 modify for CR00689094 start 
    //private int mSortOrder = SORT_ORDER_ALPHA;
    private int mSortOrder = SORT_ORDER_SIZE;
    //Gionee lihq 2012-09-14 modify for CR00689094 end
    //Gionee <wanggj> <2013-07-12> add for CR00834951 begin
    private static final boolean sHasInternalStorage = SystemProperties.get("ro.gn.sdcard.type").equals("internal");
    //Gionee <wanggj> <2013-07-12> add for CR00834951 end

    
    private ApplicationsState mApplicationsState;
    //Gionee <wangguojing> <2013-07-25> add for CR00837650 begin
    private static ManageApplications mManageApplications ;
    public static ManageApplications getManageApplicationsInstance() {
		return mManageApplications ;
		
    }
    public ManageApplications() {
        mManageApplications = this;
    ...
    public static class TabInfo implements OnItemClickListener {
        ...
        public View build(LayoutInflater inflater, ViewGroup contentParent, View contentChild) {
            ...
            if (mListContainer != null) {
            	...
            	View emptyView = mListContainer.findViewById(android.R.id.empty);
    ...
    //Gionee qiuxd 2012-11-17 add for CR00733240 start
    private static final boolean GN_APP_PERMISSION_CONTROL_SUPPORT = SystemProperties.get("ro.gn.app.perm.ctrl").equals("yes");
    private boolean mIsNeedToFinish = false;
    //Gionee qiuxd 2012-11-17 add for CR00733240 end
    ...
    AuroraAlertDialog mResetDialog;
        ...
        public void rebuild(boolean eraseold) {
            ...
            switch (mFilterMode) {
                ...
                case FILTER_APPS_SDCARD:
                    ...
                    //Gionee <wanggj> <2013-07-12> modify for CR00834951 begin
                    if (sHasInternalStorage) {					
                    } else {
                    ...
                    //Gionee <wanggj> <2013-07-12> modify for CR00834951 end
                    break;
                default:
                    filterObj = null;
                    break;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            synchronized (entry) {
                ...
                if (entry.label != null) {
                    ...
                    // Gionee fangbin 20120716 delete for CR00633832 start
                    /*
                    ...
                    */
                    // Gionee fangbin 20120716 delete for CR00633832 end
                }
    ...
    //Gionee <chenml> <2013-07-25> modify for CR00839374 begin 
        if (!Environment.isExternalStorageEmulated() && GnUtils.isExSdcardInserted(getActivity())) {
    ...
    //Gionee <chenml> <2013-07-25> modify for CR00839374 end 
        ...
        mTabs.add(tab);
        //Gionee qiuxd 20121117 add for CR00733240 start
        if(GN_APP_PERMISSION_CONTROL_SUPPORT) 
        {   
            if(intent.getBooleanExtra("gnPermCtrl", false))
            {
                startApplicationDetailsActivity(intent.getStringExtra("pkgName"));
            }
        }
        //Gionee qiuxd 20121117 add for CR00733240 end
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //Gionee:zhang_xin 2013-01-17 modify for CR00746738 start
        // tabs.setTabIndicatorColorResource(android.R.color.holo_blue_light);
        tabs.setTabIndicatorColorResource(R.color.gn_text_color);
        //Gionee:zhang_xin 2013-01-17 modify for CR00746738 end
    ...
    //Gionee qiuxd 2012-11-17 add for CR00733240 start
    // utility method used to start sub activity
    private void startApplicationDetailsActivity(String pkgName) {
        // start new fragment to display extended information
    	mIsNeedToFinish = true;
        Bundle args = new Bundle();
        args.putString(InstalledAppDetails.ARG_PACKAGE_NAME, pkgName);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        //Gionee <wangguojing> <2013-08-14> modify for CR00855913 begin
        menu.add(0, SORT_ORDER_ALPHA, 1, R.string.sort_order_alpha)
                .setIcon(R.drawable.gn_ic_menu_sort_alphabetically)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, SORT_ORDER_SIZE, 2, R.string.sort_order_size)
                .setIcon(R.drawable.gn_ic_menu_sort_by_size)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, SHOW_RUNNING_SERVICES, 3, R.string.show_running_services)
		   .setIcon(R.drawable.gn_ic_menu_running_services)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, SHOW_BACKGROUND_PROCESSES, 3, R.string.show_background_processes)
		   .setIcon(R.drawable.gn_ic_menu_background_processes)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, RESET_APP_PREFERENCES, 4, R.string.reset_app_preferences)
                .setIcon(R.drawable.gn_ic_menu_reset_app_preferences)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        //Gionee <wangguojing> <2013-08-14> modify for CR00855913 end
        updateOptionsMenu();
    }
    ...
    void updateOptionsMenu() {
        ...
        if (mCurTab != null && mCurTab.mListType == LIST_TYPE_RUNNING) {
            ...
            if (mOptionsMenu.findItem(SORT_ORDER_ALPHA) != null) {
                mOptionsMenu.findItem(SORT_ORDER_ALPHA).setVisible(false);
            }
            if (mOptionsMenu.findItem(SORT_ORDER_SIZE) != null) {
                mOptionsMenu.findItem(SORT_ORDER_SIZE).setVisible(false);
            }
            if (mOptionsMenu.findItem(SHOW_RUNNING_SERVICES) != null) {
                mOptionsMenu.findItem(SHOW_RUNNING_SERVICES).setVisible(showingBackground);
            }
            if (mOptionsMenu.findItem(SHOW_BACKGROUND_PROCESSES) != null) {
                mOptionsMenu.findItem(SHOW_BACKGROUND_PROCESSES).setVisible(!showingBackground);
            }
            if (mOptionsMenu.findItem(RESET_APP_PREFERENCES) != null) {
...
//                            nm.setNotificationsEnabledForPackage(app.packageName, true);
                            android.app.GnINotificationManager.setNotificationsEnabledForPackage(app.packageName, app.uid, true, nm);
