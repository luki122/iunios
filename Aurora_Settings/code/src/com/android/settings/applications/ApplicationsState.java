...
public class ApplicationsState {
            ...
            if (this.icon == null) {
                if (this.apkFile.exists()) {
                    ...
                    this.icon = context.getResources().getDrawable(
                    		com.android.settings.R.drawable.sym_app_on_sd_unavailable_icon);
                }
    ...
    public class Session {
        ...
        void handleRebuildList() {
			...
			// gionee wangyaohui 20121121 modify for CR00734139 begin
			...
			// gionee wangyaohui 20121121 modify for CR00734139 end 
