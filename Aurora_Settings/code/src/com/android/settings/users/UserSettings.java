...
public class UserSettings extends SettingsPreferenceFragment
    ...
    private AuroraPreferenceGroup mUserListCategory;
    private AuroraPreference mMePreference;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mUserListCategory = (AuroraPreferenceGroup) findPreference(KEY_USER_LIST);
        mMePreference = (AuroraPreference) findPreference(KEY_USER_ME);
        mMePreference.setOnPreferenceClickListener(this);
        if (!mIsOwner) {
            mMePreference.setSummary(null);
        }
        AuroraPreference ownerInfo = findPreference("user_owner_info");
    ...
    public Dialog onCreateDialog(int dialogId) {
        switch (dialogId) {
            case DIALOG_CONFIRM_REMOVE: {
                Dialog dlg = new AuroraAlertDialog.Builder(getActivity())
    ...
    private void updateUserList() {
        ...
        if (mAddingUser) {
            AuroraPreference pref = new UserPreference(getActivity(), null, UserPreference.USERID_UNKNOWN,
                    false, null);
    ...
    private void setPhotoId(AuroraPreference pref, UserInfo user) {
