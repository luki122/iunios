...
public class SyncSettings extends AccountPreferenceBase
    ...
    private AuroraCheckBoxPreference mAutoSyncPreference;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAutoSyncPreference =
                (AuroraCheckBoxPreference) getPreferenceScreen().findPreference(KEY_SYNC_SWITCH);
    ...
    private void removeAccountPreferences() {
        AuroraPreferenceScreen parent = getPreferenceScreen();
