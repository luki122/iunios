...
public class ProxySelector extends Fragment implements DialogCreatable {
    ...
    AuroraEditText    mHostnameField;
    AuroraEditText    mPortField;
    AuroraEditText    mExclusionListField;
    Button      mOKButton;
    Button      mClearButton;
    ...
    private void initView(View view) {
        mHostnameField = (AuroraEditText)view.findViewById(R.id.hostname);
        mHostnameField.setOnFocusChangeListener(mOnFocusChangeHandler);

        mPortField = (AuroraEditText)view.findViewById(R.id.port);
        mPortField.setOnClickListener(mOKHandler);
        mPortField.setOnFocusChangeListener(mOnFocusChangeHandler);

        mExclusionListField = (AuroraEditText)view.findViewById(R.id.exclusionlist);
