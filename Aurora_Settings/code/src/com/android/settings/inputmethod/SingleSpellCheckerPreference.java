...
public class SingleSpellCheckerPreference extends AuroraPreference {
    ...
    private void onSubtypeButtonClicked(View arg0) {
        ...
        final AuroraAlertDialog.Builder builder = new AuroraAlertDialog.Builder(mFragment.getActivity());
        ...
        builder.setSingleChoiceItems(items, checkedItem, new AuroraAlertDialog.OnClickListener() {
            @Override
