...
public class KeyboardLayoutPickerFragment extends SettingsPreferenceFragment
    ...
    private HashMap<AuroraCheckBoxPreference, KeyboardLayout> mPreferenceMap =
            new HashMap<AuroraCheckBoxPreference, KeyboardLayout>();
    ...
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen preferenceScreen,
        ...
        if (preference instanceof AuroraCheckBoxPreference) {
            AuroraCheckBoxPreference checkboxPref = (AuroraCheckBoxPreference)preference;
    ...
    private AuroraPreferenceScreen createPreferenceHierarchy() {
        AuroraPreferenceScreen root = getPreferenceManager().createPreferenceScreen(getActivity());
        Context context = getActivity();

        for (KeyboardLayout layout : mKeyboardLayouts) {
            AuroraCheckBoxPreference pref = new AuroraCheckBoxPreference(context);
    ...
    private void updateCheckedState() {
        ...
        for (Map.Entry<AuroraCheckBoxPreference, KeyboardLayout> entry : mPreferenceMap.entrySet()) {
