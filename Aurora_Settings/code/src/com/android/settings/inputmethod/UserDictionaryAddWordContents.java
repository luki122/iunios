...
public class UserDictionaryAddWordContents {
    ...
    private final AuroraEditText mWordEditText;
    private final AuroraEditText mShortcutEditText;
    private String mLocale;
    private final String mOldWord;
    private final String mOldShortcut;

    /* package */ UserDictionaryAddWordContents(final View view, final Bundle args) {
        mWordEditText = (AuroraEditText)view.findViewById(R.id.user_dictionary_add_word_text);
        mShortcutEditText = (AuroraEditText)view.findViewById(R.id.user_dictionary_add_shortcut);
