...
//                null, null, null);
        Cursor cursor = null;
        try {
        	 cursor = activity.managedQuery(UserDictionary.Words.CONTENT_URI,
                     new String[] { UserDictionary.Words.LOCALE },
                     null, null, null);
		} catch (Exception e) {
     ...
     */
    protected void createUserDictSettings(AuroraPreferenceGroup userDictGroup) {
    ...
    /**
     * Create a single User Dictionary AuroraPreference object, with its parameters set.
     * @param locale The locale for which this user dictionary is for.
     * @return The corresponding preference.
     */
    protected AuroraPreference createUserDictionaryPreference(String locale, AuroraActivity activity) {
        final AuroraPreference newPref = new AuroraPreference(getActivity());
