...
public final class LocalBluetoothAdapter {
    ...
    int getScanType(int filterType) {
        if (FILTER_TYPE_PRX == filterType) {
            return TYPE_DUAL_MODE;
            } else {
                return TYPE_BR_EDR_ONLY;
            }
       }
       
    int getScanType(BluetoothDeviceFilter.Filter filter) {
            BluetoothDeviceFilter.Filter prxfilter = BluetoothDeviceFilter.getFilter(FILTER_TYPE_PRX);
    ...
    void startScanning(boolean force) {
        startScanning(force, TYPE_BR_EDR_ONLY);
    }
