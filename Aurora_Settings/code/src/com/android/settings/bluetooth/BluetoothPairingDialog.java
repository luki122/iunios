 ...
 */
public final class BluetoothPairingDialog extends AuroraActivity implements
    ...
    private AuroraEditText mPairingView;
    ...
    private AuroraAlertDialog mUserEntryDialog;
    private AuroraAlertDialog mConfirmationDialog;
    private AuroraAlertDialog mDisplayPasskeyOrPinDialog;
    private AuroraAlertDialog mConsentDialog;
...
//        // Gionee fangbin 20120727 removed for CR00658330 start
//        // p.mIconId = android.R.drawable.ic_dialog_info;
//        // Gionee fangbin 20120727 removed for CR00658330 end
...
//    }
    private void createUserEntryDialog(CachedBluetoothDeviceManager deviceManager) {
        ...
        builder.setTitle(getString(R.string.bluetooth_pairing_request)).setCancelable(false);
        builder.setView(createPinEntryView(deviceManager.getName(mDevice)));
        ...
        mUserEntryDialog = builder.create();

mUserEntryDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            @Override
            public void onShow(DialogInterface arg0) {
                showSoftInput(mPairingView);
            }
        });

        mUserEntryDialog.show();
        
        mOkButton = mUserEntryDialog.getButton(DialogInterface.BUTTON_POSITIVE);
        mOkButton.setEnabled(false);
    }
...
//        CheckBox alphanumericPin = (CheckBox) view.findViewById(R.id.alphanumeric_pin);
        mPairingView = (AuroraEditText) view.findViewById(R.id.text);
...
//    }
    private void createConfirmationDialog(CachedBluetoothDeviceManager deviceManager) {
        AuroraAlertDialog.Builder builder = new AuroraAlertDialog.Builder(this);
        builder.setTitle(getString(R.string.bluetooth_pairing_request)).setCancelable(false);
        builder.setView(createView(deviceManager));
        builder.setPositiveButton(getString(R.string.bluetooth_pairing_accept), this);
        builder.setNegativeButton(getString(R.string.bluetooth_pairing_decline), this);
    ...
    private void createDisplayPasskeyOrPinDialog(CachedBluetoothDeviceManager deviceManager) {
        ...
        builder.setView(createView(deviceManager));
        builder.setNegativeButton(getString(android.R.string.cancel), this);
        mDisplayPasskeyOrPinDialog = builder.create();
        mDisplayPasskeyOrPinDialog.show();
