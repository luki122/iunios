 ...
 */
public class RequestPermissionHelperActivity extends AuroraActivity implements
...
//        }
    ...
    private void createDialog() {
        ...
        if (mEnableOnly) {
            builder.setMessage(getString(R.string.bluetooth_ask_enablement));
        } else {
            if (mTimeout == BluetoothDiscoverableEnabler.DISCOVERABLE_TIMEOUT_NEVER) {
                builder.setMessage(getString(R.string.bluetooth_ask_enablement_and_lasting_discovery));
            } else {
