 ...
 */
public final class BluetoothDevicePreference extends AuroraPreference implements
    ...
    private AuroraAlertDialog mUnpairDialog;
	// Aurora liugj 2013-10-22 added for aurora's new feature end
    ...
    public BluetoothDevicePreference(Context context,
        ...
        if (cachedDevice.getBondState() == BluetoothDevice.BOND_BONDED && DevicePickerFragment.mIsBondNeedDetailIcon) {
    ...
    */
    ...
    public void onDeviceAttributesChanged() {
        ...
        if (iconResId != 0) {
			// Aurora liugj 2013-10-22 deleted for aurora's new feature start
            //setIcon(iconResId);
			// Aurora liugj 2013-10-22 deleted for aurora's new feature end
        }
    ...
    private void unpair() {
        ...
        String message = context.getString(R.string.bluetooth_unpair_dialog_text, name);
        String title = context.getString(R.string.bluetooth_title_unpair);

        DialogInterface.OnClickListener unpairListener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                mCachedDevice.unpair();
            }
        };
        Utils.showUnpairDialog(context,
                mUnpairDialog, unpairListener, title,
 ...
 //int connectionStatus  =profile.getConnectionStatus(cachedDevice.getDevice());
