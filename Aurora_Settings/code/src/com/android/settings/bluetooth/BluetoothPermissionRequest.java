...
public final class BluetoothPermissionRequest extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BluetoothDevice.ACTION_CONNECTION_ACCESS_REQUEST)) {
            ...
            if (powerManager.isScreenOn() &&
                ...
                //wolfu add Acquire wakelock so that LCD comes up since screen is off
    ...
    private void sendIntentToReceiver(final String intentName, final boolean allowed,
        ...
        Log.d(TAG, "sendIntentToReceiver "+intentName+ " " + allowed + " " + extraName + " " + extraValue + " "+mDevice +" "+mRequestType);

        mContext.sendBroadcastAsUser(intent, UserHandle.CURRENT, android.Manifest.permission.BLUETOOTH_ADMIN);
    }
}
