 ...
 */
public class DebugIntentSender extends AuroraActivity {
    private AuroraEditText mIntentField;
    private AuroraEditText mDataField;
    private AuroraEditText mAccountField;
    private AuroraEditText mResourceField;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mIntentField = (AuroraEditText) findViewById(R.id.intent);
        mIntentField.setText(Intent.ACTION_SYNC);
        Selection.selectAll((Spannable) mIntentField.getText());

        mDataField = (AuroraEditText) findViewById(R.id.data);
        mDataField.setBackgroundResource(android.R.drawable.editbox_background);

        mAccountField = (AuroraEditText) findViewById(R.id.account);
        mResourceField = (AuroraEditText) findViewById(R.id.resource);
