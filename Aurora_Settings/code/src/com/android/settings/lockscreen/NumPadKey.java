...
public class NumPadKey extends AuroraAnimationImageView {
...
//    ShowDigitView mDigitView;
    ...
    private View.OnClickListener mListener = new View.OnClickListener() {
        ...
        public void onClick(View thisView) {
            ...
            /*if (mDigitView == null) {
                if (mDigitViewResId > 0) {
                    final ShowDigitView digitView = ( ShowDigitView ) NumPadKey.this.getRootView().findViewById(mDigitViewResId);
                    if (digitView != null && digitView instanceof ShowDigitView) {
                        mDigitView = digitView;
                    }
                }
            }
            
            if (mDigitView != null && mTextView.isEnabled()) {
                mDigitView.onTextChange(mTextView.length());
            }*/
        }
    };
...
//        setShowDigitViewResId(a.getResourceId(R.styleable.NumPadKey_digitView, 0));
...
//    public void setShowDigitViewResId(int resId) {
//        mDigitView = null;
//        mDigitViewResId = resId;
//    }
