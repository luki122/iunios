...
public class VoiceInputOutputSettings implements OnPreferenceChangeListener {
    ...
    private AuroraPreferenceGroup mParent;
    private AuroraPreferenceCategory mVoiceCategory;
    private AuroraListPreference mRecognizerPref;
    private AuroraPreference mRecognizerSettingsPref;
    private AuroraPreference mTtsSettingsPref;
    private AuroraPreferenceScreen mSettingsPref;
    ...
    public void onCreate() {
        ...
        mVoiceCategory = (AuroraPreferenceCategory) mParent.findPreference(KEY_VOICE_CATEGORY);
        mRecognizerPref = (AuroraListPreference) mVoiceCategory.findPreference(KEY_RECOGNIZER);
        ...
        mSettingsPref = (AuroraPreferenceScreen)
