...
public class NativePrivacySettings extends SettingsPreferenceFragment implements
DialogInterface.OnClickListener{
    ...
    private void showEraseBackupDialog() {
        ...
        /*
        mConfirmDialog = new AuroraAlertDialog.Builder(getActivity()).setMessage(msg)
                ...
                .show();
        */
        mConfirmDialog = new AuroraAlertDialog.Builder(getActivity(), AuroraAlertDialog.THEME_AMIGO_FULLSCREEN).setMessage(msg)
                .setTitle(R.string.gn_settings_warning)
                .setPositiveButton(android.R.string.ok, this)
                .setNegativeButton(android.R.string.cancel, this)
                .show();
