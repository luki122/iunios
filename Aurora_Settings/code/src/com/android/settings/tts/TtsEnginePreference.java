...
public class TtsEnginePreference extends AuroraPreference {
     ...
     */
    private final AuroraPreferenceActivity mPreferenceActivity;
    ...
    public TtsEnginePreference(Context context, EngineInfo info, RadioButtonGroupState state,
            AuroraPreferenceActivity prefActivity) {
        super(context);
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        mSettingsIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // AuroraPreferenceActivity.startPreferenceFragment because the
