...
public class TextToSpeechSettings extends SettingsPreferenceFragment implements
    ...
    /** AuroraPreference key for the "play TTS example" preference. */
    private static final String KEY_PLAY_EXAMPLE = "tts_play_example";

    /** AuroraPreference key for the TTS rate selection dialog. */
    private static final String KEY_DEFAULT_RATE = "tts_default_rate";

    /**
     * AuroraPreference key for the engine selection preference.
     */
    ...
    private AuroraPreferenceCategory mEnginePreferenceCategory;
    private AuroraListPreference mDefaultRatePref;
    private AuroraPreference mPlayExample;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnginePreferenceCategory = (AuroraPreferenceCategory) findPreference(
                KEY_ENGINE_PREFERENCE_SECTION);
        mDefaultRatePref = (AuroraListPreference) findPreference(KEY_DEFAULT_RATE);
    ...
    private void initSettings() {
        ...
        AuroraPreferenceActivity preferenceActivity = null;
        if (getActivity() instanceof AuroraPreferenceActivity) {
            preferenceActivity = (AuroraPreferenceActivity) getActivity();
        } else {
            throw new IllegalStateException("TextToSpeechSettings used outside a " +
                    "AuroraPreferenceActivity");
        }
    ...
    private void onVoiceDataIntegrityCheckDone(Intent data) {
        ...
        for (int i = 0; i < engineCount; ++i) {
            final AuroraPreference p = mEnginePreferenceCategory.getPreference(i);
