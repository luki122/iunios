 ...
 */
public class QuickLaunchSettings extends AuroraPreferenceActivity implements
    ...
    /** AuroraPreference category to hold the shortcut preferences. */
    private AuroraPreferenceGroup mShortcutGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShortcutGroup = (AuroraPreferenceGroup) findPreference(KEY_SHORTCUT_CATEGORY);
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (mClearDialogShortcut > 0 && which == AuroraAlertDialog.BUTTON_POSITIVE) {
            // Clear the shortcut
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        AuroraPreference pref = (AuroraPreference) getPreferenceScreen().getRootAdapter().getItem(position);
