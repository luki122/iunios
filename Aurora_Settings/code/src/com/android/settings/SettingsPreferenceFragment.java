 ...
 */
public class SettingsPreferenceFragment extends AuroraPreferenceFragment implements DialogCreatable {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        //Gionee <wangguojing> <2013-07-29> modify for CR00837650 begin
        /*if (mHelpUrl != null) {
	 ...
	 //Gionee <wangguojing> <2013-07-29> modify for CR00837650 end
    }

    /*
     * The name is intentionally made different from AuroraActivity#finish(), so that
    ...
    /**
     * Returns the ContentResolver from the owning AuroraActivity.
     */
    ...
    /**
     * Returns the specified system service from the owning AuroraActivity.
     */
    ...
    /**
     * Returns the PackageManager from the owning AuroraActivity.
     */
    ...
    public boolean startFragment(
        ...
        if (getActivity() instanceof AuroraPreferenceActivity) {
            AuroraPreferenceActivity preferenceActivity = (AuroraPreferenceActivity)getActivity();
    ...
    public boolean startFragment(Fragment caller, String fragmentClass,
        ...
        if (getActivity() instanceof AuroraPreferenceActivity) {
            ...
            Log.w(TAG,
                    "Parent isn't AuroraPreferenceActivity, thus there's no way to launch the "
