...
public class AirplaneModeEnabler implements AuroraPreference.OnPreferenceChangeListener {

    private final Context mContext;

    private PhoneStateIntentReceiver mPhoneStateReceiver;
    
    private final AuroraCheckBoxPreference mCheckBoxPref;
    ...
    public AirplaneModeEnabler(Context context, AuroraCheckBoxPreference airplaneModeCheckBoxPreference) {
