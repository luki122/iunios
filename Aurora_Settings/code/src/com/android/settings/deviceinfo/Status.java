 ...
 *
 */
public class Status extends AuroraPreferenceActivity {
    ...
    private AuroraPreference mSignalStrength;
	...
	*/
       ...
       // Gionee <chenml> <2013-08-23> modify for CR00857897 end 
        AuroraPreference removablePref;
     ...
     * @param key the key for the AuroraPreference item
     */
    ...
    /**
     * @param preference The key for the AuroraPreference item
    ...
    private void setWimaxStatus() {
        ...
        if (ni == null) {
            ...
            AuroraPreference ps = (AuroraPreference) findPreference(KEY_WIMAX_MAC_ADDRESS);
    ...
    private void setIpAddressStatus() {
        AuroraPreference ipAddressPref = findPreference(KEY_IP_ADDRESS);
