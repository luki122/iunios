...
public class StorageVolumePreferenceCategory extends AuroraPreferenceCategory {
    ...
    private StorageVolumePreferenceCategory(Context context, StorageVolume volume) {
        ...
        setTitle(volume != null ? /*volume.getDescription(context)  qy*/ context.getText(R.string.aurora_internal_storage)
...
//            mFormatPreference.setSummary(R.string.sd_format_summary);
            mFormatPreference.setTitle(R.string.internal_storage_format);            
            mFormatPreference.setSummary(R.string.internal_storage_format_summary);
    ...
    private void updatePreferencesFromState() {
        ...
        if (mVolume == null || mMountTogglePreference == null) return;
    ...
    public void updateApproximate(long totalSize, long availSize) {
    	...
    	Log.i("qy", "totalSize ===="+totalSize);
    	Log.i("qy", "availSize ===="+availSize);
...
//        mUsageBarPreference.setProgressAndMax((int)(availSize/10000000f),(int)(totalSize/10000000f));
        mUsageBarPreference.setProgressAndMax((int)((usedSize*1000)/totalSize),1000);
        mUsageBarPreference.setSummary(getContext().getResources().getString(R.string.avail_size)+formatSize(availSize));
        mUsageBarPreference.setTitle(getContext().getResources().getString(R.string.total_size)+formatSize(totalSize));  // end
    ...
    private static long totalValues(HashMap<String, Long> map, String... keys) {
        long total = 0;
        for (String key : keys) {
            if (map.get(key) == null) return total;
            total += map.get(key);
        }
        return total;
    }
    ...
    public void updateDetails(MeasurementDetails details) {
        ...
        // qy add
//        mUsageBarPreference.setProgressAndMax((int)(details.availSize/10000000f),(int)(details.totalSize/10000000f));
        mUsageBarPreference.setProgressAndMax((int)((details.totalSize-details.availSize)*1000/details.totalSize),1000);
        mUsageBarPreference.setSummary(getContext().getResources().getString(R.string.avail_size)+formatSize(details.availSize));
        mUsageBarPreference.setTitle(getContext().getResources().getString(R.string.total_size)+formatSize(details.totalSize));
        // end
...
//            mUsageBarPreference.addEntry(order, size / (float) mTotalSize, pref.color);            
    ...
    public Intent intentForClick(AuroraPreference pref) {
        ...
        if (pref == mFormatPreference) {
        	// qy add
        	new AlertDialog.Builder(getContext()).setTitle(R.string.format_title).setCancelable(false)
        	.setMessage(R.string.format_message)
        	.setPositiveButton(R.string.format_cancel,
            ...
            .setNegativeButton(R.string.format_continue, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                	...
                	.setMessage(R.string.format_confirm_message
                            ...
                            }).setNegativeButton(R.string.format_ok, new DialogInterface.OnClickListener() {
