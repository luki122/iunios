 ...
 */
public class WifiApDialog extends AuroraAlertDialog implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPassword = (AuroraEditText) mView.findViewById(R.id.password);
    ...
    private void validate() {
        if ((mSsid != null && mSsid.length() == 0) || (TextUtils.isEmpty(mSsid.getText().toString().trim())) ||
