...
/**
 * WifiSetings AuroraActivity specific for SetupWizard with X-Large screen size.
 */
public class WifiSettingsForSetupWizardXL extends AuroraActivity implements OnClickListener {
    ...
    /*
     * States of current screen, which should be saved and restored when AuroraActivity is relaunched
    ...
    /**
     * Called when the list of AccessPoints are modified and this AuroraActivity needs to refresh
     * the list.
     * @param preferenceScreen
     */
    /* package */ void onAccessPointsUpdated(
            AuroraPreferenceScreen preferenceScreen, Collection<AccessPoint> accessPoints) {
