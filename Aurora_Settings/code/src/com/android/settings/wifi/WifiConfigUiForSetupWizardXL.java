...
public class WifiConfigUiForSetupWizardXL implements WifiConfigUiBase, OnFocusChangeListener {
    ...
    /**
     * @param activity AuroraActivity which creates this object.
    ...
    public void requestFocusAndShowKeyboard(int editViewId) {
        ...
        } else if (!(viewToBeFocused instanceof AuroraEditText)) {
            Log.w(TAG, "password field is not AuroraEditText");
        } else {
