...
import com.android.settings.lockscreen.AuroraLockPatternView;
import com.android.settings.lockscreen.AuroraLockPatternView.DisplayMode;
...
//        protected LockPatternView mLockPatternView;
        protected AuroraLockPatternView mLockPatternView;
        protected TextView mFooterText;
        private TextView mFooterLeftButton;
        private TextView mFooterRightButton;
//        protected List<LockPatternView.Cell> mChosenPattern = null;
        protected List<AuroraLockPatternView.Cell> mChosenPattern = null;
        ...
        private final List<AuroraLockPatternView.Cell> mAnimatePattern =
                Collections.unmodifiableList(Lists.newArrayList(
                        AuroraLockPatternView.Cell.of(0, 0),
                        AuroraLockPatternView.Cell.of(0, 1),
                        AuroraLockPatternView.Cell.of(1, 1),
                        AuroraLockPatternView.Cell.of(2, 1)
                ));
        ...
        protected AuroraLockPatternView.OnPatternListener mChooseNewLockPatternListener =
                new AuroraLockPatternView.OnPatternListener() {
                ...
                public void onPatternDetected(List<AuroraLockPatternView.Cell> pattern) {
                    if (mUiStage == Stage.NeedToConfirm || mUiStage == Stage.ConfirmWrong) {
                        ...
                        if (pattern.size() < LockPatternUtils.MIN_LOCK_PATTERN_SIZE) {
                            ...
                            mChosenPattern = new ArrayList<AuroraLockPatternView.Cell>(pattern);
                            updateStage(Stage.FirstChoiceValid);
                        }
                    } else {
                        throw new IllegalStateException("Unexpected stage " + mUiStage + " when "
...
//            mLockPatternView = (LockPatternView) view.findViewById(R.id.lockPattern);
            mLockPatternView = (AuroraLockPatternView) view.findViewById(R.id.lockPattern);
            //Aurora <zhang_xin> <2013-12-16> modify for pattern end
