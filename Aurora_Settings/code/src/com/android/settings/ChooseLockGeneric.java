...
import com.android.settings.lockscreen.ChooseLockDigit;
...
public class ChooseLockGeneric extends AuroraPreferenceActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        //Aurora <zhang_xin> <2013-12-10> modify for choose password begin
        private static final String KEY_UNLOCK_SET_DIGIT = "unlock_set_digit";
        //Aurora <zhang_xin> <2013-12-10> modify for choose password end
        ...
        public boolean onPreferenceTreeClick(AuroraPreferenceScreen preferenceScreen,
            ...
            //Aurora <zhang_xin> <2013-12-10> modify for choose password begin
            else if (KEY_UNLOCK_SET_DIGIT.equals(key)) {
                updateUnlockMethodAndFinish(
                        DevicePolicyManager.PASSWORD_QUALITY_NUMERIC, false);
            }
            //Aurora <zhang_xin> <2013-12-10> modify for choose password end
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == CONFIRM_EXISTING_REQUEST && resultCode == AuroraActivity.RESULT_OK) {
            ...
            for (int i = entries.getPreferenceCount() - 1; i >= 0; --i) {
                ...
                if (pref instanceof AuroraPreferenceScreen) {
                    ...
                    if (KEY_UNLOCK_SET_OFF.equals(key)) {
                        ...
                        //Aurora <zhang_xin> <2013-12-10> modify for choose password begin
//                      visible = singleUser; // don't show when there's more than 1 user
                      visible = false; // don't show when there's more than 1 user
                      //Aurora <zhang_xin> <2013-12-10> modify for choose password end
                      
                      //Begin add by gary.gou for cta test
                      /*
                      boolean  CTAEnable = SystemProperties.getBoolean("ro.config.ctaenable",false);
                      if(CTAEnable){
                    	  visible = true; 
                      }
                      */
                      ...
                      visible = true; 
                      //End add by gary.gou for cta test
                        ...
                        //Aurora <zhang_xin> <2013-12-9> modify for choose password begin
//                      visible = weakBiometricAvailable; // If not available, then don't show it.
                      visible = false;
                      //Aurora <zhang_xin> <2013-12-9> modify for choose password end
                    } else if (KEY_UNLOCK_SET_PATTERN.equals(key)) {
...
//                  KEY_UNLOCK_SET_PATTERN.equals(key) || KEY_UNLOCK_SET_PIN.equals(key);
          return KEY_UNLOCK_BACKUP_INFO.equals(key)  ||
                  KEY_UNLOCK_SET_PATTERN.equals(key) || KEY_UNLOCK_SET_PIN.equals(key)
                  || KEY_UNLOCK_SET_DIGIT.equals(key);
          //Aurora <zhang_xin> <2013-12-10> modify for choose password end
        }
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled) {
            ...
            if (quality == DevicePolicyManager.PASSWORD_QUALITY_NUMERIC) {
                ...
                Intent intent = new Intent().setClass(getActivity(), ChooseLockDigit.class);
            ...
            //Aurora <zhang_xin> <2013-12-10> modify for choose password end
                ...
                getActivity().setResult(AuroraActivity.RESULT_OK);
                finish();
            } else {
                finish();
            }
	...
	*/
        getAuroraActionBar().setTitle(R.string.lockpassword_choose_lock_generic_header);
