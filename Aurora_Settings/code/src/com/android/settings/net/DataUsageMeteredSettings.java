...
public class DataUsageMeteredSettings extends SettingsPreferenceFragment {
    ...
    private AuroraPreferenceCategory mMobileCategory;
    private AuroraPreferenceCategory mWifiCategory;
    private AuroraPreference mWifiDisabled;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mMobileCategory = (AuroraPreferenceCategory) findPreference("mobile");
        mWifiCategory = (AuroraPreferenceCategory) findPreference("wifi");
    ...
    private AuroraPreference buildMobilePref(Context context) {
    ...
    private AuroraPreference buildWifiPref(Context context, WifiConfiguration config) {
    ...
    private class MeteredPreference extends AuroraCheckBoxPreference {
