...
public class Utils {
    ...
    public static boolean updatePreferenceToSpecificActivityOrRemove(Context context,
            AuroraPreferenceGroup parentPreferenceGroup, String preferenceKey, int flags) {

        AuroraPreference preference = parentPreferenceGroup.findPreference(preferenceKey);
        if (preference == null) {
            return false;
        }
    ...
    public static boolean updatePreferenceToSpecificActivityFromMetaDataOrRemove(Context context,
            AuroraPreferenceGroup parentPreferenceGroup, String preferenceKey) {
    ...
    private static String formatIpAddresses(LinkProperties prop) {
        ...
        Log.d("gd","IP Addresses="+addresses);
        return addresses;
    }
    ...
    public static void prepareCustomPreferencesList(
        ...
        if (movePadding && parent instanceof PreferenceFrameLayout) {
            ...
            final int paddingSide = res.getDimensionPixelSize(
                    R.dimen.preference_fragment_padding_side);
