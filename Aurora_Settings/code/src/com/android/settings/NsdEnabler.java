 ...
 */
public class NsdEnabler implements AuroraPreference.OnPreferenceChangeListener {
    ...
    public NsdEnabler(Context context, AuroraCheckBoxPreference checkBoxPreference) {
        mContext = context;
