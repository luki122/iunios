...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
        ...
        public final void setImageViewResources(Context context, RemoteViews views) {
            ...
            switch (getTriState(context)) {
                case STATE_DISABLED:
                    ...
                    // Gionee huming 2012-09-02 add for CR00683446 begin
                    notifyWidgetChange(context,buttonId,getButtonImageId(false),indicatorId,IND_DRAWABLE_OFF[pos]);
                    // Gionee huming 2012-09-02 add for CR00683446 end
                    break;
                case STATE_ENABLED:
                    views.setContentDescription(containerId,
                    ...
                    // Gionee huming 2012-09-02 add for CR00683446 begin
                    notifyWidgetChange(context,buttonId,getButtonImageId(true),indicatorId,IND_DRAWABLE_ON[pos]);
                    // Gionee huming 2012-09-02 add for CR00683446 end
                    break;
                case STATE_INTERMEDIATE:
                    ...
                    if (isTurningOn()) {
                        ...
                        // Gionee huming 2012-09-02 add for CR00683446 begin
                        notifyWidgetChange(context,buttonId,getButtonImageId(true),indicatorId,IND_DRAWABLE_MID[pos]);
                        // Gionee huming 2012-09-02 add for CR00683446 end
                    } else {
                        views.setContentDescription(containerId,
    ...
    private static void updateButtons(RemoteViews views, Context context) {
        ...
        // Gionee huming 2012-09-02 add for CR00683446 begin
        int brightnessBtId = R.id.img_brightness;
        int brightnessBtResId = 0;
        int brightnessIndId = R.id.ind_brightness;
        int brightnessIndResId = 0;
        // Gionee huming 2012-09-02 add for CR00683446 end
        ...
        if (getBrightnessMode(context)) {
            ...
            views.setImageViewResource(R.id.ind_brightness,
                    R.drawable.appwidget_settings_ind_on_r_holo);
            // Gionee huming 2012-09-02 add for CR00683446 begin
            brightnessBtResId = R.drawable.ic_appwidget_settings_brightness_auto_holo;
            brightnessIndResId = R.drawable.appwidget_settings_ind_on_r_holo;
            // Gionee huming 2012-09-02 add for CR00683446 end
        } else {
            ...
            if (brightness > full) {
                ...
                views.setImageViewResource(R.id.img_brightness,
                  ...
                  // Gionee huming 2012-09-02 add for CR00683446 begin
                brightnessBtResId = R.drawable.ic_appwidget_settings_brightness_full_holo;
                // Gionee huming 2012-09-02 add for CR00683446 end      
        ...
        // Gionee huming 2012-09-02 add for CR00683446 begin
                brightnessBtResId = R.drawable.ic_appwidget_settings_brightness_half_holo;
                // Gionee huming 2012-09-02 add for CR00683446 end        
            } else {
                views.setContentDescription(R.id.btn_brightness,
                        context.getString(R.string.gadget_brightness_template,
                ...
                // Gionee huming 2012-09-02 add for CR00683446 begin
                brightnessBtResId = R.drawable.ic_appwidget_settings_brightness_off_holo;
                // Gionee huming 2012-09-02 add for CR00683446 end
            }
            // Set the ON state
            if (brightness > half) {
                ...
                views.setImageViewResource(R.id.ind_brightness,
                        R.drawable.appwidget_settings_ind_off_r_holo);
                // Gionee huming 2012-09-02 add for CR00683446 begin
                brightnessIndResId = R.drawable.appwidget_settings_ind_off_r_holo;
                // Gionee huming 2012-09-02 add for CR00683446 end
            }
        }
        // Gionee huming 2012-09-02 add for CR00683446 begin
        notifyWidgetChange(context, brightnessBtId, brightnessBtResId,
                brightnessIndId, brightnessIndResId);
        // Gionee huming 2012-09-02 add for CR00683446 end
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("com.gionee.launcher.settingswidgetcreate".equals(action)) {
            Log.d("HUMING", "updateButtons");
            RemoteViews views = new RemoteViews(context.getPackageName(),
                    R.layout.widget);
            updateButtons(views, context);
        }
...
//        } else if (SyncStorageEngine.SYNC_CONNECTION_SETTING_CHANGED_INTENT.getAction()
        } else if (SYNC_CONNECTION_SETTING_CHANGED_INTENT.getAction()
                .equals(action)) {
    ...
    // Gionee huming 2012-09-02 add for CR00683446 begin
    static void notifyWidgetChange(Context context, int buttonId,
            int buttonResId, int indId, int indResId) {
        if(SystemProperties.get("ro.gn.effect.open","no").equals("yes")){
            Resources resources = context.getResources();
            String buttonIdName = resources.getResourceEntryName(buttonId);
            String buttonResName = resources.getResourceEntryName(buttonResId);
            String indIdName = resources.getResourceEntryName(indId);
            String indResName = resources.getResourceEntryName(indResId);
            
            String str = buttonIdName + "#" + buttonResName + "#" + indIdName + "#" + indResName;
            // mLauncherSettings = str;
            // Log.d("HUMING", "--="+mLauncherSettings);
            Intent intent = new Intent("com.android.settings.settingswidgetchange");
            intent.putExtra("changer", str);
