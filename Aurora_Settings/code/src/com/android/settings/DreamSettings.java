...
public class DreamSettings extends SettingsPreferenceFragment {
    ...
    //Gionee <wangguojing> <2013-07-25> add for CR00837650 begin
    private  static DreamSettings mDreamSettings ;
    public static DreamSettings getDreamSettingsInstance() {
		return mDreamSettings ;
		
    }
    public DreamSettings() {
        mDreamSettings = this;
        Settings.mKey = "DreamSettings" ;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        mSwitch = new AuroraSwitch(activity);
        ...
        activity.getAuroraActionBar().setCustomView(mSwitch, new AuroraActionBar.LayoutParams(
	...
	*/
    ...
    private Dialog createWhenToDreamDialog() {
        ...
        return new AuroraAlertDialog.Builder(mContext)
