...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private AuroraCheckBoxPreference mDtmfTone;
    private AuroraCheckBoxPreference mSoundEffects;
    private AuroraCheckBoxPreference mHapticFeedback;
    private AuroraPreference mMusicFx;
    private AuroraCheckBoxPreference mLockSounds;
    private AuroraPreference mRingtonePreference;
    private AuroraPreference mNotificationPreference;

    private Runnable mRingtoneLookupRunnable;

    private AudioManager mAudioManager;

    private AuroraPreference mDockAudioSettings;
    private AuroraCheckBoxPreference mDockSounds;
    private Intent mDockIntent;
    private AuroraCheckBoxPreference mDockAudioMediaEnabled;
    ...
    private AuroraPreferenceGroup mSoundSettings;
...
//            findPreference(KEY_RING_VOLUME).setDependency(null);
        ...
        mVibrateWhenRinging = (AuroraCheckBoxPreference) findPreference(KEY_VIBRATE);
        mVibrateWhenRinging.setPersistent(false);
        mVibrateWhenRinging.setChecked(Settings.System.getInt(resolver,
                Settings.System.VIBRATE_WHEN_RINGING, 0) != 0);

        mDtmfTone = (AuroraCheckBoxPreference) findPreference(KEY_DTMF_TONE);
        mDtmfTone.setPersistent(false);
        mDtmfTone.setChecked(Settings.System.getInt(resolver,
                Settings.System.DTMF_TONE_WHEN_DIALING, 1) != 0);
        mSoundEffects = (AuroraCheckBoxPreference) findPreference(KEY_SOUND_EFFECTS);
        mSoundEffects.setPersistent(false);
        mSoundEffects.setChecked(Settings.System.getInt(resolver,
                Settings.System.SOUND_EFFECTS_ENABLED, 1) != 0);
        mHapticFeedback = (AuroraCheckBoxPreference) findPreference(KEY_HAPTIC_FEEDBACK);
        mHapticFeedback.setPersistent(false);
        mHapticFeedback.setChecked(Settings.System.getInt(resolver,
                Settings.System.HAPTIC_FEEDBACK_ENABLED, 1) != 0);
        mLockSounds = (AuroraCheckBoxPreference) findPreference(KEY_LOCK_SOUNDS);
        ...
        if (TelephonyManager.PHONE_TYPE_CDMA == activePhoneType) {
            AuroraListPreference emergencyTonePreference =
                (AuroraListPreference) findPreference(KEY_EMERGENCY_TONE);
        ...
        mSoundSettings = (AuroraPreferenceGroup) findPreference(KEY_SOUND_SETTINGS);
        ...
        if (!Utils.isVoiceCapable(getActivity())) {
            for (String prefKey : NEED_VOICE_CAPABILITY) {
                AuroraPreference pref = findPreference(prefKey);
                if (pref != null) {
        ...
        if (preference == mVibrateWhenRinging) {
            ...
            if (dockState == Intent.EXTRA_DOCK_STATE_UNDOCKED) {
                ...
                if (isBluetooth) {
                    ...
                    AuroraPreferenceScreen ps = (AuroraPreferenceScreen)mDockAudioSettings;
    ...
    private void initDockSettings() {
        ...
        if (needsDockSettings()) {
            mDockSounds = (AuroraCheckBoxPreference) findPreference(KEY_DOCK_SOUNDS);
                ...
                if (isBluetooth) {
                    ...
                    if (dockState == Intent.EXTRA_DOCK_STATE_LE_DESK) {
                        ...
                        mDockAudioMediaEnabled =
                                (AuroraCheckBoxPreference) findPreference(KEY_DOCK_AUDIO_MEDIA_ENABLED);
    ...
    private Dialog createUndockedMessage() {
        final AuroraAlertDialog.Builder ab = new AuroraAlertDialog.Builder(getActivity());
