 ...
 */
public class SettingsLicenseActivity extends AuroraActivity {
    ...
    private AuroraProgressDialog mSpinnerDlg;
	...
	*/
	//AURORA-END::delete temporarily for compile::waynelin::2013-9-14
       // getAuroraActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        AuroraProgressDialog pd = AuroraProgressDialog.show(this, title, msg, true, false);
        pd.setProgressStyle(AuroraProgressDialog.STYLE_SPINNER);
        mSpinnerDlg = pd;
    ...
    private void showPageOfText(String text) {
        // Create an AuroraAlertDialog to display the WebView in.
