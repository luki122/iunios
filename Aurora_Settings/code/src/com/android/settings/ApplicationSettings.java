...
public class ApplicationSettings extends SettingsPreferenceFragment {
    ...
    private AuroraCheckBoxPreference mToggleAdvancedSettings;
    private AuroraListPreference mInstallLocation;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mToggleAdvancedSettings = (AuroraCheckBoxPreference)findPreference(
        ...
        mInstallLocation = (AuroraListPreference) findPreference(KEY_APP_INSTALL_LOCATION);
