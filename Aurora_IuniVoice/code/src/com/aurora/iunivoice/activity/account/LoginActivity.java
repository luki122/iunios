...
import com.aurora.iunivoice.widget.OnSizeChangeLinearLayout.OnSizeChangedListener;
			...
			public void run() {
				...
				if (value != null) {
					...
					case UserLoginObject.CODE_SUCCESS:
						...
						sp.edit().putBoolean("isLoginFromApp", true).commit();
						com.aurora.iunivoice.utils.Log.v("lmjssjj", "isLoginFromApp:"+true);
