...
public class TwitterItemPreviewActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				...
				// TODO Auto-generated method stub
				String title = String.valueOf(arg0 + 1) + "/"
						+ String.valueOf(result.size());
				setTitleText(title);
				setCurrentItem(arg0);
	...
	public void setupAuroraActionBar() {
		...
		addActionBarItem(R.drawable.aurora_delete_selector,
				ACTION_BAR_ITEM_DELETE);
	}
	...
	private void delete() {
		...
		if (result.size() == 1) {
			...
			result.remove(getCurrentItem());
			adapter.notifyDataSetChanged();
			String title = String.valueOf(getCurrentItem() + 1) + "/"
					+ String.valueOf(result.size());
			setTitleText(title);
		}
