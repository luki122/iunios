...
public class ImagePreviewActivity extends BaseActivity {
	...
	public static final int RESULT_BACK = 2000;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitleText(String.valueOf(current + 1) + "/"
	...
	public void setupAuroraActionBar() {
		...
		addActionBarItem(getString(R.string.image_picker_actionbar_tv_done),
				ACTION_ITEM_DONE);
	}
	...
	public void setupViews() {
		...
		mViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				// TODO Auto-generated method stub
				setTitleText(String.valueOf(arg0 + 1) + "/"
						+ String.valueOf(list.size()));
			}
	...
	static class SamplePagerAdapter extends PagerAdapter {
		...
		public View instantiateItem(ViewGroup container, int position) {
			...
			ImageLoaderHelper.disPlay(
					...
					new RotateImageViewAware(photoView, photoInfo
							.getPath_absolute()), DefaultUtil
							.getDefaultImageDrawable(context));

			container.addView(child, LayoutParams.MATCH_PARENT,
				...
				public void onClick(View arg0) {
					...
					if (photoInfo.isChoose()) {
						...
						if (isSelectedMax() == maxItem) {
							Toast.makeText(context, "最多选择9张图片！",
