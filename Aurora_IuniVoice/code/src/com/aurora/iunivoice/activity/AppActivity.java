...
import com.aurora.iunivoice.interfaces.IAppActionBar;
import com.aurora.iunivoice.view.ActionBarLayout;
import com.aurora.iunivoice.view.ActionBarLayout.OnActionBarItemClickListener;
import com.aurora.iunivoice.view.MenuPopupWindow;
import com.aurora.iunivoice.view.MenuPopupWindow.OnBottomMenuClickListener;
import com.umeng.analytics.MobclickAgent;

@SuppressLint("NewApi")
@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
public class AppActivity extends FragmentActivity implements IAppActionBar, OnBottomMenuClickListener {
...
//		menuPop.showAsDropDown(actionBarLayout);
		if(hideView == null)
		{
			...
			hideView.setBackgroundColor(R.color.common_activity_hide_bg);
...
//			actionBarLayout.setActionBarBg(res);
	...
	public void setContentBg(int res) {
		// TODO Auto-generated method stub
		if (fr_content != null) {
			fr_content.setBackgroundResource(res);
		}
	}
