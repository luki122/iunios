...
public class ActionBarLayout extends RelativeLayout implements IAppActionBar {
	...
	private void addHomeView(){
		homeView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.actionbar_home_layout, null);
	...
	public void enableBackItem(boolean enable){
		...
		if (enable) {
			homeView.setPadding(getResources().getDimensionPixelOffset(R.dimen.action_bar_paddingleft_back), 0, getPaddingRight(), 0);
		} else {
			homeView.setPadding(getResources().getDimensionPixelOffset(R.dimen.action_bar_paddingleft), 0, getPaddingRight(), 0);
		}
	}
	@Override
...
//		item.setPadding(actionBarItemMargin, actionBarItemPaddingTopBottom, actionBarItemMargin, actionBarItemPaddingTopBottom);
		item.setPadding(actionBarItemMargin, actionBarItemPaddingTopBottom, 0, actionBarItemPaddingTopBottom);
