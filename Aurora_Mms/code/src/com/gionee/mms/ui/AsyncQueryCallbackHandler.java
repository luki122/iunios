 ...
 * queries easier.
 */
public abstract class AsyncQueryCallbackHandler extends Handler {
    ...
    public AsyncQueryCallbackHandler(ContentResolver cr) {
        super();
    ...
    public void handleMessage(Message msg) {
        ...
        switch (event) {
            case EVENT_ARG_QUERY:
                onQueryComplete(token, args.cookie, args.result);
                break;
