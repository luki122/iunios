...
public class MmsPlayerActivityItemData {
    ...
    public MmsPlayerActivityItemData(Context context, Uri imageUri, Uri videoUri, String audioName, String text) {
        mImageUri = imageUri;
        mVideoUri = videoUri;
    ...
    private Bitmap getThumbnailFromImageUri(Uri imageUri, Context context, int width, int height) {
        ...
        if (raw == null) {
            if (sThumbDefaultImage == null) {
                sThumbDefaultImage = null;//BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_multi_save_thumb_image);
            }
    ...
    private Bitmap getThumbnailFromVideoUri(Uri VideoUri, Context context, int width, int height) {
        ...
        if (raw == null) {
            if (sThumbDefaultVideo == null) {
                sThumbDefaultVideo = null;//BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_multi_save_thumb_video);
            }
