    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        Cursor phoneCursor =
            mContentResolver.query(uri,
                    ...
                    null,
                    null);
        //gionee gaoj 2012-7-25 modified for CR00657464 start
        if (phone.length() > 0) {
        ...
        //gionee gaoj 2012-7-25 modified for CR00657464 end
    }
    ...
    private void updateAvatarView(Context context, String addr, QuickContactDivot avatar, long contactId) {
        ...
        if (contactId > 0) {
            ...
            if (data != null) {
                ...
                avatarDrawable = context.getResources().getDrawable(-1/*R.drawable.ic_contact_picture*/); // default avatar
            }
        } else {
            avatarDrawable = context.getResources().getDrawable(-1/*R.drawable.ic_contact_picture*/); // default avatar
        }
