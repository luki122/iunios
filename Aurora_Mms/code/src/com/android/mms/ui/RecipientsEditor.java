...
// a1
    ...
    public RecipientsEditor(Context context, AttributeSet attrs) {
         ...
         * an address completion from the AuroraAutoCompleteTextView menu, it
...
// a0
        Log.v(TAG, "RecipientsEditor:contactToToken, contact.getNameAndNumber=" + c.getNameAndNumber());
// a1
