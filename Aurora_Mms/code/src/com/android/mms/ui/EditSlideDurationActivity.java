 ...
 */
public class EditSlideDurationActivity  extends AuroraActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // Input text field.
        mDur = (AuroraEditText) findViewById(R.id.text);
        mDur.setText(String.valueOf(dur));
        mDur.setOnKeyListener(mOnKeyListener);

        // Done button.
        mDone = (AuroraButton) findViewById(R.id.done);
