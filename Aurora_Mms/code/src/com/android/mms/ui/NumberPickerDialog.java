 ...
 */
public class NumberPickerDialog extends AuroraAlertDialog implements OnClickListener {
    ...
    private final AuroraNumberPicker mNumberPicker;
    ...
    public NumberPickerDialog(Context context,
            ...
            int rangeMax,
            int title) {
        this(context, AuroraAlertDialog.THEME_HOLO_LIGHT, callBack, number, rangeMin, rangeMax, title);
    }   
    ...
    public NumberPickerDialog(Context context,
        ...
        setButton(DialogInterface.BUTTON_POSITIVE, getContext().getText(R.string.set), this);
        setButton(DialogInterface.BUTTON_NEGATIVE, getContext().getText(R.string.no),
        ...
        setView(view);
        mNumberPicker = (AuroraNumberPicker)view.findViewById(R.id.number_picker);
