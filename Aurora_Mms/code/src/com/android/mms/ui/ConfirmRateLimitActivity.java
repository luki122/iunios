...
public class ConfirmRateLimitActivity extends AuroraActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AuroraButton button = (AuroraButton) findViewById(R.id.btn_yes);
        ...
        button = (AuroraButton) findViewById(R.id.btn_no);
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                doAnswer(false);
            }
