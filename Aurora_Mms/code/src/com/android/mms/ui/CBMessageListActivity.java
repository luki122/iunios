 ...
 */
public class CBMessageListActivity extends AuroraActivity
    ...
    private AuroraListView mMsgListView;
   ...
   //add for multi-delete
    ...
    private void initResourceRefs() {
       ...
       // Initialize members for UI elements.
        mMsgListView =  (AuroraListView) findViewById(R.id.history);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Log.i(LogTag.CB, "saved thread id:" + mConversation.getThreadId());
    }
    ...
    public void onDraftChanged(final long threadId, final boolean hasDraft) {
        ...
        mQueryHandler.post(new Runnable() {
            public void run() {
                Log.d(LogTag.CB, "onDraftChanged: threadId=" + threadId + ", hasDraft=" + hasDraft);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.d(LogTag.CB, "onConfigurationChanged: " + newConfig);
    }
    ...
    private final class MessageListQueryHandler extends BaseProgressQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            switch (token) {
                ...
                default:
                    Log.e(LogTag.CB, "onQueryComplete called with unknown token " + token);
            }
        }
    ...
    private void log(String format, Object... args) {
        ...
        Log.d(LogTag.CB, "[" + Thread.currentThread().getId() + "] " + s);
    }
