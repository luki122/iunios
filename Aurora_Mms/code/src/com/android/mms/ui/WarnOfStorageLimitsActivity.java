 ...
 */
public class WarnOfStorageLimitsActivity extends AuroraActivity implements DialogInterface,
    ...
    private static final int POSITIVE_BUTTON = AuroraAlertDialog.BUTTON_POSITIVE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Gionee <zhouyj> <2013-07-11> add for CR00825445 begin
        mAlert.setTitle(getString(R.string.storage_limits_activity));
        //Gionee <zhouyj> <2013-07-11> add for CR00825445 end
