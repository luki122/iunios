...
// a1
    ...
    private SlideViewInterface createGnMediaView(int stub_view_id, int real_view_id,
        ...
        LinearLayout view = (LinearLayout) getStubView(stub_view_id, real_view_id);
        view.setVisibility(View.VISIBLE);
        ImageButton removeAttachBt = (ImageButton)view.findViewById(R.id.aurora_remove_bt);
        ...
        removeAttachBt.setOnClickListener(new MessageOnClick(MSG_REMOVE_ATTACHMENT));
    ...
    private SlideViewInterface createGnSlideshowView(boolean inPortrait, int msgSize) {
        ...
        ImageButton auroraRemoveBt = (ImageButton)view.findViewById(R.id.aurora_remove_bt);
        view.setVisibility(View.VISIBLE);
        // show Mms Size
        ...
        auroraRemoveBt.setOnClickListener(new MessageOnClick(MSG_REMOVE_ATTACHMENT));
