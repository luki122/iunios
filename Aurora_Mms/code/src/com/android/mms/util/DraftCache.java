...
public class DraftCache {
    ...
    private void rebuildCache() {
        ...
        Cursor cursor = SqliteWrapper.query(
            ...
            DRAFT_PROJECTION, "is_privacy >= 0", null, null);
    ...
    public synchronized void setDraftState(long threadId, boolean hasDraft) {
        ...
        // Aurora  xuyong 2015-02-05 modified for bug #11583 start
        boolean changed = false;
        // Aurora  xuyong 2015-02-05 modified for bug #11583 end
        if (hasDraft) {
            // Aurora  xuyong 2015-02-05 modified for bug #11583 start
            if (!mDraftSet.contains(threadId)) {
