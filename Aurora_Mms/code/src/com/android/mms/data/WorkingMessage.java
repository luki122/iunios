...
// a1
    ...
    private void syncTextToSlideshow() {
        // Aurora xuyong 2016-03-14 modified for bug #21287 start
        if (mSlideshow == null/* || mSlideshow.size() != 1*/)
        // Aurora xuyong 2016-03-14 modified for bug #21287 end
            return;
...
// m1
    ...
    private void syncTextFromSlideshow() {
        ...
        // Aurora xuyong 2016-03-14 deleted for bug #21287 start
        /*if (mSlideshow.size() != 1) {
            return;
        }*/
        // Aurora xuyong 2016-03-14 deleted for bug #21287 end
        SlideModel slide = mSlideshow.get(0);
...
// m1
    ...
    private void updateDraftSmsMessage(final Conversation conv, String contents) {
        ...
        if (MmsApp.mGnMessageSupport && conv.getRecipients() != null) {
            ...
            // Aurora xuyong 2015-12-04 added for aurora2.0 new feature start
            values.put("notification_index", Utils.isNotificationMsg(mActivity, addreString, contents) ? 1 : 0);
            // Aurora xuyong 2015-12-04 added for aurora2.0 new feature end
        }
