...
public class CBMessage {
    ...
    private static final Uri MESSAGE_URI = GnTelephony.CbSms.CONTENT_URI;// Uri.parse("content://cb/messages");
    // Query all URI
    private static final Uri sAllMessageUri = GnTelephony.CbSms.CONTENT_URI;
    ...
    private static final String[] ALL_MESSAGE_PROJECTION = { "_id",
            GnTelephony.CbSms.SIM_ID, GnTelephony.CbSms.CHANNEL_ID,
            GnTelephony.CbSms.BODY, GnTelephony.CbSms.READ,
            GnTelephony.CbSms.DATE, GnTelephony.CbSms.THREAD_ID };
    private static final String[] ALL_CHANNEL_PROJECTION = { "_id",
            GnTelephony.CbSms.CbChannel.NAME,
            GnTelephony.CbSms.CbChannel.NUMBER };
...
//    }
    ...
    public static void startQueryForAll(AsyncQueryHandler handler, int token) {
        ...
        handler.startQuery(token, null, sAllMessageUri, ALL_MESSAGE_PROJECTION,
                null, null, GnTelephony.CbSms.DEFAULT_SORT_ORDER);
    }
