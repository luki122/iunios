                    ...
                    if (part == null) {
                        ...
                        if (part == null) {
                            ...
                            if (part == null) {
                                ...
                                if (lastDocCharAt > 0) {
                                    Log.i(TAG, "findPart(): src2 = " + src.substring(0, lastDocCharAt));
                ...
                if (contentType.equals("application/oct-stream") || contentType.equals("application/octet-stream")) {                    
                    if (src!=null) {
                        ...
                        if (suffix.equals(".bmp")) {                        
                            ...
                            Log.e(TAG, "can not parse content-type from src. src: "+src);                        
                        }
                    } else {
                        throw new UnsupportContentTypeException("Unsupported Content-Type: " + contentType +"; src==null");
                    }
                }
                Log.d(TAG, "Done! contentType="+contentType);
            ...
            if (tag.equals(SmilHelper.ELEMENT_TAG_TEXT)) {
                ...
                if (contentType.equals("application/oct-stream") || contentType.equals("application/octet-stream")) {                    
                    if (src!=null) {
                        ...
                        if (suffix.equals("")) {
                            Log.e(TAG, "can not parse content-type from src, cause of no file type.");  
