...
public class AuroraRoundDrawable extends BitmapDrawable {
// Aurora xuyong 2014-04-29 modified for aurora's new feature end
    public static final String TAG = "AuroraRoundDrawable";
    ...
    // Aurora xuyong 2014-04-29 added for aurora's new feature start
    public AuroraRoundDrawable(Resources resources, Bitmap bitmap) {
        this(bitmap, AuroraRoundImageView.DEFAULT_RADIUS, 0, ColorStateList.valueOf(DEFAULT_BORDER_COLOR), false);
    }
    // Aurora xuyong 2014-04-29 added for aurora's new feature end
    public AuroraRoundDrawable(Bitmap bitmap, float cornerRadius, int border, ColorStateList borderColor) {
        this(bitmap, cornerRadius, border, borderColor, false);
    }

    public AuroraRoundDrawable(Bitmap bitmap, float cornerRadius, int border, ColorStateList borderColor, boolean oval) {
    ...
    public static Drawable fromDrawable(Drawable drawable, float radius, int border, ColorStateList borderColor, boolean isOval) {
        if (drawable != null) {
            if (drawable instanceof TransitionDrawable) {
                ...
                for (int i = 0; i < num; i++) {
                    ...
                    if (d instanceof ColorDrawable) {
                        ...
                        drawableList[i] = new AuroraRoundDrawable(drawableToBitmap(td.getDrawable(i)), radius, border, borderColor, isOval);
                    }
                }
            ...
            if (bm != null) {
                return new AuroraRoundDrawable(bm, radius, border, borderColor, isOval);
            } else {
