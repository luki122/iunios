...
public class AuroraGroupReciResendAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Aurora xuyong 2013-12-17 modified for aurora's new feature start
        // Aurora xuyong 2016-02-22 modified for aurora 2.0 new feature start
        holder.mCheckBox.setChecked(ComposeMessageActivity.selectResendMap.get(mIdList.get(position)));
        // Aurora xuyong 2016-02-22 modified for aurora 2.0 new feature end
        // Aurora xuyong 2013-12-17 modified for aurora's new feature end
