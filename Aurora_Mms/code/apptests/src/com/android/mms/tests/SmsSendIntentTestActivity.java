...
public class SmsSendIntentTestActivity extends AuroraActivity {
    /** Tag string for our debug logs */
    private static final String TAG = "SmsSendIntentTestActivity";
    private AuroraEditText mRecipient;
    private AuroraEditText mMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecipient = (AuroraEditText)findViewById(R.id.sms_recipient);
        mMessage = (AuroraEditText)findViewById(R.id.sms_content);

        mRecipient.setText("650-278-2055"); // use this to prime a number

        AuroraButton sendButton = (AuroraButton) findViewById(R.id.sms_send_message);
        ...
        AuroraButton sendMultiButton = (AuroraButton) findViewById(R.id.sms_send_multi_message);
        ...
        AuroraButton sendLongButton = (AuroraButton) findViewById(R.id.sms_send_long_message);
        ...
        AuroraButton primeButton = (AuroraButton) findViewById(R.id.sms_prime_message);
