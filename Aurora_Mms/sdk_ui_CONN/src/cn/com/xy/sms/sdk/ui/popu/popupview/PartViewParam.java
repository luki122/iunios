...
public class PartViewParam implements Serializable {
    ...
    public int mPaddingLeftType = 0; // The layout and the container left padding
    public int mPaddingTopType = 0; // The layout and the container top padding
    public int mPaddingRightType = 0; // The layout and the container right padding
    public int mPaddingBottomType = 0; // The layout and the container bottom padding
    public int mUiPartMarginTopType = 0;// UI layout with the former one control the margin top of type
