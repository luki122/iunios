...
public abstract class UIPart {
    ...
    public int mAddRootView = 0;// add RootView  0:not need 1: need  only bodyViewGroup one child and set content bg and padtop 
    public HashMap<String, Object> mExtendParam = null;// PART of extension parameters
