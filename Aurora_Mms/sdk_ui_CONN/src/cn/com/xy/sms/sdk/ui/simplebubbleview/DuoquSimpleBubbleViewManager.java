...
public class DuoquSimpleBubbleViewManager {
    ...
    public static void getSimpleBubbleData(String msgIds,String phoneNum,String smsCenterNum,String smsContent,long smsReceiveTime,byte returnCacheType,HashMap<String,Object> extend,SdkCallBack callBack,boolean scrollFing) throws Exception{
    ...
    public static View getSimpleBubbleView(Activity ctx,JSONArray jsonArray,ViewGroup buttonGroup,HashMap<String,Object> extend) throws Exception{
          if(jsonArray == null || buttonGroup==null)return null;
