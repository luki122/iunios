...
public class ListDialog extends Dialog {
    ...
    public ListDialog(OnSurelistener osl, JSONArray dataSourceJsonArray, Context context, int dialogStyle,
                ...
                for (String key : drawAdapter.mCheckedStates.keySet()) {
                    if (drawAdapter.mCheckedStates.get(key).equals(true)) {
                        try {
                            mNoDataReturn = false;
                            if (mOls != null) {
                                mOls.onClick(mDataSourceJsonArray.getJSONObject(Integer.parseInt(key)));
                            }
                            ListDialog.this.dismiss();
    ...
    class DrawAdapter extends BaseAdapter {
        ...
        public View getView(final int arg0, View convertView, ViewGroup arg2) {
            ...
            if (convertView == null) {
                convertView = getLayoutInflater().inflate(R.layout.duoqu_list_items_content, null);
            ...
            viewHolder.mItemTextView.setText(((JSONObject) getItem(arg0)).optString("name"));

            viewHolder.mItemRadioButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mCheckedStates.put(String.valueOf(arg0), ((RadioButton) v).isChecked());
            ...
            boolean res = false;
            if (mCheckedStates.get(String.valueOf(arg0)) == null || mCheckedStates.get(String.valueOf(arg0)) == false) {
                res = false;
