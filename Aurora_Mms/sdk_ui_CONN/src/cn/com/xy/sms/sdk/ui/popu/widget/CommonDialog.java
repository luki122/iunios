...
public class CommonDialog extends Dialog {
	...
	public CommonDialog(Context context) {
		...
		try {
			ViewManger.setViewBg(Constant.getContext(), title_layout, "#FAFAFA", R.drawable.duoqu_top_rectangle,-1);
			ViewManger.setViewBg(Constant.getContext(), bottom_layout, "#FAFAFA", R.drawable.duoqu_bottom_rectangle,-1);
			ViewManger.setViewBg(Constant.getContext(), duoqu_bottom_split_line, "#d1d1d1", R.drawable.duoqu_line,1);
		...
		int  padding=(Math.round(Constant.getContext().getResources().getDimension(R.dimen.popup_content_padding))*2);
	...
	public CommonDialog(Context context,String title,String content,String leftText,
			String rightText,onExecListener execListener, onCancelListener cancelListener,
