...
public class ImageCache {
    ...
    private static final int DEFAULT_COMPRESS_QUALITY = 50;//70;
    ...
    public void addBitmapToCache(String data, BitmapDrawable value) {
        ...
        if (mMemoryCache != null) {
            ...
            //Log.i(TAG, "zll --- addBitmapToCache");
        }
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        //Log.i(TAG, "zll ---- ddd addBitmapToCache size:"+(value.getBitmap().getRowBytes()*value.getBitmap().getHeight())/1024);
                    } catch (IOException e) {}
                }
            }
        }
    ...
    public Bitmap getBitmapFromDiskCache(String data) {
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
            	//bitmap = ImageResizer.decodeFromSearchDB(data);
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        if (inputStream != null) {
                            ...
                            //bitmap = ImageResizer.decodeSampledBitmapFromDescriptor(fd, ImageResizer.cache_ImageWidth, ImageResizer.cache_ImageHeight, this);
                            //Log.e(TAG, "zll getBitmapFromDiskCache - size:"+(bitmap.getRowBytes()*bitmap.getHeight())/1024+",getWidth:"+bitmap.getWidth()+",getHeight:"+bitmap.getHeight());
                        }
                    }
                } catch (final IOException e) {
                    Log.e(TAG, "zll getBitmapFromDiskCache - " + e);
                } finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
    ...
    public void clearMemoryCache() {
    	if (mMemoryCache != null) {
            ...
            if (BuildConfig.DEBUG) {
                //Log.d(TAG, "zll --- Memory cache cleared");
            }
        }
		return;
	}
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath =
                Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ||
                        ...
                        //Log.i("lll", "zll --- cachePath + File.separator + uniqueName:"+(cachePath + File.separator + uniqueName));
