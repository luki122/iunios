...
public class PaperListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.paperSelected = (AuroraCheckBox) convertView.findViewById(R.id.paper_selected);
		...
		if (whichSelected == position) {
			holder.paperSelected.setChecked(true);;
		} else {
			holder.paperSelected.setChecked(false);;
		}
	...
	private static class ViewHolder {
		...
		private AuroraCheckBox paperSelected;
	}
