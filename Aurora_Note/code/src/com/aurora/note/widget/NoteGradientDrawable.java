...
public class NoteGradientDrawable extends Drawable {
    /**
     ...
     */
    public NoteGradientDrawable(Orientation orientation, int[] colors) {
    ...
    public void inflate(Resources r, XmlPullParser parser,
        ...
        setVisible(a.getBoolean(com.android.internal.R.styleable.GradientDrawable_visible, true),
                false);
    ...
    final static class GradientState extends ConstantState {
        ...
        public Drawable newDrawable() {
            return new NoteGradientDrawable(this);
        }
    ...
    private NoteGradientDrawable(GradientState state) {
