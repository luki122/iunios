...
LOCAL_SRC_FILES := $(call all-java-files-under,$(src_dirs)) \
           src/com/secure/service/IAidlService.aidl \
           src/com/netmanage/service/INetFlowService.aidl \
           src/com/netmanage/service/INetFlowServiceCallback.aidl \
...
LOCAL_PACKAGE_NAME := Aurora_NetManage 
...
libyouju:libs/fastjson-1.1.8.jar \
libyouju:libs/lbepkgpermsdk.jar \
libyouju:libs/protobuf-java-2.4.1-lite.jar \
libyouju:libs/LBESecV3_SDK.jar \
libyouju:libs/tms.jar \
