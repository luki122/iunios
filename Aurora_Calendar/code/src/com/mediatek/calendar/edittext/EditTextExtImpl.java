...
public class EditTextExtImpl implements IEditTextExt {
    ...
    @Override
    public void setLengthInputFilter(AuroraEditText inputText, Context context,
            int maxLength) {
    ...
    private InputFilter[] createInputFilter(AuroraEditText inputText, final Context context,
            final int maxLength) {
