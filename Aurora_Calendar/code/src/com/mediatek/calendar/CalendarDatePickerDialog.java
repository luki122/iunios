...
/**
 * Almost the same as the {@link AuroraDatePickerDialog} except a little change made to avoid
 * notifying call back in onStop() method when it exits normally.
 */
public class CalendarDatePickerDialog extends AuroraAlertDialog implements OnClickListener,
    ...
    private final AuroraDatePicker mDatePicker;
    ...
    public CalendarDatePickerDialog(Context context, int theme, OnDateSetListener callBack, int year,
        ...
        setView(view);
        mDatePicker = (AuroraDatePicker) view.findViewById(R.id.datePicker);
    ...
    /**
     * Gets the {@link AuroraDatePicker} contained in this dialog.
     * 
