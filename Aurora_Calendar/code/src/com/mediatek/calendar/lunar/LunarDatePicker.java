...
public class LunarDatePicker extends FrameLayout {
    ...
    private final AuroraEditText mDaySpinnerInput;

    private final AuroraEditText mMonthSpinnerInput;

    private final AuroraEditText mYearSpinnerInput;
    ...
    //the index of AuroraEditText in the AuroraNumberPicker 
...
//         attributesArray.recycle();
        ...
        OnValueChangeListener onChangeListener = new OnValueChangeListener() {
            public void onValueChange(AuroraNumberPicker picker, int oldVal,
                    int newVal) {
                updateInputState();
        ...
        // day
        mDaySpinner = (AuroraNumberPicker) findViewById(R.id.day);
        // /M: comment this line @{
        ...
        if (mDaySpinner.getChildCount() == PICKER_CHILD_COUNT) {
            // set the Middle AuroraEditText of Numberpicker read only.
            ...
            mDaySpinnerInput = new AuroraEditText(context);
            Log.e(TAG, "mDaySpinner.getChildCount() != 3,It isn't init ok.");
        }

        // month
        mMonthSpinner = (AuroraNumberPicker) findViewById(R.id.month);
        ...
        if (mMonthSpinner.getChildCount() == PICKER_CHILD_COUNT) {
            ...
            // Normally,this will always not happen.
            mMonthSpinnerInput = new AuroraEditText(context);
            Log.e(TAG, "mMonthSpinner.getChildCount() != 3,It isn't init ok.");
        }
        // year
        mYearSpinner = (AuroraNumberPicker) findViewById(R.id.year);
        ...
        if (mYearSpinner.getChildCount() == PICKER_CHILD_COUNT) {
            ...
            // Normally,this will always not happen.
            mYearSpinnerInput = new AuroraEditText(context);
    ...
    /**
     * Sets the minimal date supported by this {@link AuroraNumberPicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     * 
     * @param minDate
    ...
    private void updateSpinners() {
        ...
        /**
         * M: Do some workaround to avoid AuroraNumberPicker.setDisplayedValues to modify the minimum value or maximum value to default  @{
         */
     ...
     */
    private void setImeOptions(AuroraNumberPicker spinner, int spinnerCount,
            int spinnerIndex) {
        ...
        //get the middle AuroraEditText of  AuroraNumberPicker
    ...
    /*private void setContentDescriptions() {
        ...
        //set the Top Button of AuroraNumberPicker
        ...
        //set the Bottom Button of AuroraNumberPicker
    ...
    /**
     * get the Edit input text of AuroraNumberPicker.
     * @param numberPicker The AuroraNumberPicker to be get
     * @return the AuroraEditText get
     */
    public AuroraEditText getNumberPickerInputText(AuroraNumberPicker numberPicker) {
        return (AuroraEditText)numberPicker.getChildAt(PICKER_CHILD_INPUT_TEXT_INDEX);
    }
