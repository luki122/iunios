...
/**
 * Almost the same as the {@link AuroraTimePickerDialog} except a little change made
 * to avoid notifying call back in onStop() method when it exits normally.
 */
public class CalendarTimePickerDialog extends AuroraAlertDialog
        implements OnClickListener, OnTimeChangedListener {
    private static final String HOUR = "hour";
    private static final String MINUTE = "minute";
    private static final String IS_24_HOUR = "is24hour";

    private final AuroraTimePicker mTimePicker;
    ...
    public CalendarTimePickerDialog(Context context,
        ...
        setView(view);
        mTimePicker = (AuroraTimePicker) view.findViewById(R.id.timePicker);
