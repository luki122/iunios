...
public class GNEventInfoFragment extends Fragment implements OnCheckedChangeListener,
	...
	private Handler textUpdteHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			Log.i("jiating","GNEventInfoFragment....textUpdteHandler....handleMessage...msg.what"+msg.what);
			switch(msg.what) {
					 ...
					 TextView textView = (TextView) view.findViewById(id);
				      ...
				      //Gionee <jiating><2013-07-01> modify for CR00819533 begin
				        ...
				        if(id==R.id.when_start_datetime ||id==R.id.when_end_datetime ){
				        	...
				        	Log.i("jiating","GNEventInfoFragment....text="+textString);
							if(textString.contains(mActivity.getString(R.string.gn_agenda_time_noon))){
								...
								Log.i("jiating","GNEventInfoFragment..contains..text="+textString);
							}
				        }
    ...
    public GNEventInfoFragment(Context context, Uri uri, long startMillis, long endMillis,
...
//        setStyle(DialogFragment.STYLE_NO_TITLE, 0);
    ...
    public GNEventInfoFragment() {
    }



    public GNEventInfoFragment(Context context, long eventId, long startMillis, long endMillis,
            int attendeeResponse, boolean isDialog, int windowStyle) {
...
//       //Gionee jiating 2013-04-09 modify for actionBar begin 
//        AuroraActionBar bar = mActivity.getAuroraActionBar();
//        if (bar != null) {
...
//        //Gionee jiating 2013-04-09 modify for actionBar end
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            mView = inflater.inflate(R.layout.gn_event_info, container, false);
        ...
        mWhenStartDateTime = (TextView) mView.findViewById(R.id.when_start_datetime);
        mWhenEndDateTime=(TextView) mView.findViewById(R.id.when_end_datetime);
    ...
    private final Runnable onDeleteRunnable = new Runnable() {
        @Override
        public void run() {
            if (GNEventInfoFragment.this.mIsPaused) {
                mDismissOnResume = true;
                return;
            }
            if (GNEventInfoFragment.this.isVisible()) {
//                GNEventInfoFragment.this.dismiss();
            }
        }
    };
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        Log.i("jiating","GNFragmentaurora ...onCreateOptionsMenu");
//        // Show edit/delete buttons only in non-dialog configuration
        if (!mIsDialog && !mIsTabletConfig || mWindowStyle == GNEventInfoFragment.FULL_WINDOW_STYLE) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.i("jiating","GNFragmentaurora ...onOptionsItemSelected");
//        // If we're a dialog we don't want to handle menu buttons
        ...
        if (itemId == android.R.id.home) {
			...
			Statistics.onEvent(getActivity(), Statistics.EVENT_INFO_EDIT);
            ///@}
			...
			Statistics.onEvent(getActivity(), Statistics.EVENT_INFO_DELETE);
            mDeleteHelper =
                    new DeleteEventHelper(mActivity, mActivity, true /* exitWhenDone */);
            mDeleteHelper.setDeleteNotificationListener(GNEventInfoFragment.this);
         ...
         */
        	...
        	Log.i("jiating","R.id.info_action_share");
			Statistics.onEvent(getActivity(), Statistics.EVENT_INFO_SHARE);
        	sendShareEvent(mActivity, mEventId);
        	return true;
        }
        
        else if (!mIsDialog && !mIsTabletConfig || mWindowStyle == GNEventInfoFragment.FULL_WINDOW_STYLE){
    ...
    public void onPrepareOptionsMenu(Menu menu) {
    	// TODO Auto-generated method stub
    	Log.i("jiating","GNFragment......onPrepareOptionsMenu");
...
*/
    ...
    private void updateEvent(View view) {
        ...
        if (description != null && description.length() != 0) {
        	mDescRow.setVisibility(View.VISIBLE);
        	mDesc.setText(description);
        }else{
        	mDescRow.setVisibility(View.GONE);
        }
...
//    }
    ...
    private void updateCalendar(View view) {
        ...
        if (mCalendarsCursor != null && mEventCursor != null) {
            ...
            if ((!mIsDialog && !mIsTabletConfig ||
                    mWindowStyle == GNEventInfoFragment.FULL_WINDOW_STYLE) && mMenu != null) {
    ...
    public void initReminders(View view, Cursor cursor) {
        ...
        if (mHasAlarm) {
            ...
            updateReminderContainerVisibility();
            EventViewUtils.updateReminderDiver(mView, mReminderViews.size(), mMaxReminders);
      ...
      //Gionee <jiating><2013-07-01> modify for CR00819533 begin
        ...
        if(id==R.id.when_start_datetime ||id==R.id.when_end_datetime ){
			...
			if(textString.contains(mActivity.getString(R.string.gn_agenda_time_noon))){
				...
				textString=textString.replace(mActivity.getString(R.string.gn_agenda_time_noon), mActivity.getString(R.string.gn_agenda_time_noon_replace));
				Log.i("jiating","GNEventInfoFragment..contains中午..text="+textString);
			}
        }
      //Gionee <jiating><2013-07-01> modify for CR00819533 end
        textView.setText(textString);*/
   ...
   ///M: add removeDuplicate() function. @{
    ...
    private void updateAddReminderBtnVisibility() {
        ...
        if (mReminderViews.size() >= mMaxReminders) {
            ...
            //Gionee jiating 2013-04-07 modify for update reminder View begin
        ...
        //Gionee jiating 2013-04-07 modify for update reminder View end
    }
  //Gionee jiating 2013-04-03 modify for reminder_add change from Button to  ReleativeLayout begin
    private View mAddReminderBtn = null;
    
    
    private void updateReminderContainerVisibility() {
    	Log.i("jiating","updateReminderContainerVisibility.....reminders.size()="+mReminderViews.size()+"maxReminders...="+mMaxReminders);
    	 LinearLayout mRemindersContainer = (LinearLayout) mScrollView.findViewById(R.id.reminder_items_container);
    	 if (mReminderViews.size() >= mMaxReminders) {
 			Log.i("jiating","updateReminderContainerVisibility.......if11");
 			...
 			Log.i("jiating","updateReminderContainerVisibility.......else if11");
 			mRemindersContainer.setVisibility(View.GONE);
 		}else{
 			Log.i("jiating","updateReminderContainerVisibility.......else11");
 			mRemindersContainer.setVisibility(View.VISIBLE);
