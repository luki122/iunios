...
///M:#ClearAllEvents#
public class GNSelectClearableCalendarsFragment extends Fragment
    ...
    private AuroraButton mBtnDelete;
    ...
    public GNSelectClearableCalendarsFragment() {
    }

    public GNSelectClearableCalendarsFragment(int itemLayout) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mList = (AuroraListView)mView.findViewById(R.id.list);
        ...
        mBtnDelete = (AuroraButton) mView.findViewById(R.id.btn_ok);
        if (mBtnDelete != null) {
            mBtnDelete.setOnClickListener(mClickListener);
            mBtnDelete.setEnabled(false);
        }
        AuroraButton cancel = (AuroraButton) mView.findViewById(R.id.btn_cancel);
        if (cancel != null) {
    ...
    private OnClickListener mClickListener = new OnClickListener() {
        public void onClick(View view) {
            ...
            case R.id.btn_ok:
                ...
                AuroraAlertDialog dialog = new AuroraAlertDialog.Builder(mContext)
                .setTitle(R.string.delete_label)
                .setMessage(R.string.clear_all_selected_events_title)
                .setNegativeButton(android.R.string.cancel, null).setCancelIcon(false).
                create();
