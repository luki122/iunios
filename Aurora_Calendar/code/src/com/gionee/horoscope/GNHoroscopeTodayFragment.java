...
public class GNHoroscopeTodayFragment  extends Fragment{
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    isFirst=true;
		Log.v("GNHoroscopeTodayFragment...onCreate---");
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Log.v("GNHoroscopeTodayFragment...onCreateView---");
		astroLuckIndexRat = (RatingBar) view.findViewById(R.id.constellation_comprehensive_luck_ratingbar);
		healthIndexRat = (RatingBar) view.findViewById(R.id.gn_day_constellation_health_index_ratingbar);
	    workIndexRat = (RatingBar) view.findViewById(R.id.gn_day_constellation_work_index_ratingbar);
		loveIndexRat = (RatingBar) view.findViewById(R.id.gn_day_constellation_love_index_ratingbar);
	    wealthIndexRat = (RatingBar) view.findViewById(R.id.gn_day_constellation_wealth_index_ratingbar);
		luckyColorText = (TextView) view.findViewById(R.id.gn_day_constellation_lucky_color_view);
		luckyNumberText = (TextView) view.findViewById(R.id.gn_day_constellation_lucky_numbers_view);
		speedDatingText = (TextView) view.findViewById(R.id.gn_day_constellation_speed_dating_constellation_view);
...
//		hocosposeContent.setMovementMethod(ScrollingMovementMethod.getInstance()) ;
		// Gionee <jiating><2013-06-20> modify for CR00827812 bend
	...
	public void onResume() {
		...
		super.onResume();
		setViewState();
		Log.v("GNHoroscopeTodayFragment...onResume---");
	}
...
public void onPause() {
	// TODO Auto-generated method stub
	super.onPause();
	Log.v("GNHoroscopeTodayFragment...onPause---");
}

	private void setViewState(){
		Log.v("GNHoroscopeTodayFragment...setViewState---.."+"isFirst="+isFirst+"isFailed="+isFailed+"GNHoroscopeActivity.isChangeHoroscope()="+GNHoroscopeActivity.isChangeHoroscope());
...
//			tengxunLog.setVisibility(View.VISIBLE);
	...
	public void setViewData(Message msg) {
		...
		try {
			Log.i("GNHoroscopeTodayFragment...setViewData....dayAstroInfo="+dayAstroInfo.description);
			if(msg.arg1==GNAstroUtils.GET_ASTRO_STATUS_OK){
				Log.v("setViewData-----dayAstroInfo.indexHealthStar="+dayAstroInfo.indexHealthStar+"GET_ASTRO_STATUS_OK");
				astroLuckIndexRat.setRating(dayAstroInfo.indexComprehensionStar);
				...
				isFailed=true;
				Log.i("GNHoroscopeTodayFragment...setViewDatadayAstroInfo..getDataFailed");
