...
public class LegalHolidayUtils implements ILegalHoliday {
	...
	private void putInnerHolidayData() {
		...
		int dayType2016[] = {3, 3, 3, 1, 3, 3, 3, 3, 3, 3, 3, 1, 3, 3, 3, 3, 3, 3, 3, 3, 3, 1,
				3, 3, 3, 1, 3, 3, 3, 3, 3, 3, 3, 1, 1};

		for (int i = 0; i < yearDays2016.length; i++) {
			if (!mHolidayMap.containsKey(firstJulianDay2016 + yearDays2016[i])) {
				mHolidayMap.put(firstJulianDay2016 + yearDays2016[i], dayType2016[i]);
			}
		}
	}
