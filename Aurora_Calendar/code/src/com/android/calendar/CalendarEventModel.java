...
public class CalendarEventModel implements Serializable {
    ...
    public static class Attendee implements Serializable {
      ...
      //Gionee <jiating> <2013-04-11>  modify for  CR00000000 other apckage used add public begin
       ...
       //Gionee <jiating> <2013-04-11>  modify for CR00000000 other apckage used add public end
        public String mName;
    ...
    public CalendarEventModel(Context context) {
        ...
        String defaultReminder = prefs.getString(
                GeneralPreferences.KEY_DEFAULT_REMINDER, GeneralPreferences.DEFAULT_TIME_VALUE);
        int defaultReminderMins = Integer.parseInt(defaultReminder);
		Log.i("GNEditEvent","GNEditEvent-addReminder-14---" + defaultReminderMins);
		//Gionee <pengwei><20130815> modify for CR00852287 begin
        if (defaultReminderMins != GeneralPreferences.NO_REMINDER) {
    		...
    		//Gionee <pengwei><20130815> modify for CR00852287 end
    }
