...
public class AlertActivity extends Activity implements OnClickListener {
    ...
    private AuroraButton mDismissAllButton;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.aurora_alert_activity/*alert_activity*/);
        setTitle(R.string.alert_title);

        mQueryHandler = new QueryHandler(this);
        mAdapter = new AlertAdapter(this, R.layout.aurora_alert_item/*alert_item*/);

        mListView = (AuroraListView) findViewById(R.id.alert_container);
        mListView.setItemsCanFocus(true);
        mListView.setAdapter(mAdapter);
        mListView.setOnItemClickListener(mViewListener);

        mDismissAllButton = (AuroraButton) findViewById(R.id.dismiss_all);
