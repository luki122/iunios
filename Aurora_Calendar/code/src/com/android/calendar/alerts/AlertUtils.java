...
public class AlertUtils {
    ...
    public static final String SHOW_BIRTHDAY_INFO_KEY = "showbirthdayinfo";
    ...
    public static Intent buildBirthdayInfoViewIntent(Context context, long millis) {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setClass(context, AuroraBirthdayInfoActivity.class);
    ...
    public static void removeEventNotification(Context context, long eventId, long startMillis,
        ...
        deleteIntent.putExtra(AlertUtils.NOTIFICATION_ID_KEY, (notiId != null) ? notiId.intValue()
                : -1);
