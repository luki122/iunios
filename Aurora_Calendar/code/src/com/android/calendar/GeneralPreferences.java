...
public class GeneralPreferences extends AuroraPreferenceFragment implements
        OnSharedPreferenceChangeListener, OnPreferenceChangeListener {
    // The name of the shared preferences file. This name must be maintained for historical
    // reasons, as it's what AuroraPreferenceManager assigned the first time the file was created.
    ...
    public static final String DEFAULT_TIME_VALUE = "10";
