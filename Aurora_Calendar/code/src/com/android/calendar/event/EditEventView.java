...
import com.gionee.calendar.GNEventInfoFragment;
...
public class EditEventView implements View.OnClickListener, DialogInterface.OnCancelListener,
    ...
    AuroraButton mStartDateButton;
    AuroraButton mEndDateButton;
    AuroraButton mStartTimeButton;
    AuroraButton mEndTimeButton;
    AuroraButton mTimezoneButton;
    View mTimezoneRow;
    ...
    private AuroraAlertDialog mTimezoneDialog;
    ...
    private class DateClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ///@}
            AuroraDatePickerDialog dpd = new AuroraDatePickerDialog(
    ...
    public boolean fillModelFromReadOnlyUi() {
        ...
        int status = GNEventInfoFragment.getResponseFromButtonId(
    ...
    private boolean fillModelFromUI() {
        ...
        int status = GNEventInfoFragment.getResponseFromButtonId(mResponseRadioGroup
    ...
    public EditEventView(AuroraActivity activity, View view, EditDoneRunnable done) {
        ///M: #extension# @{
        ...
        mStartDateButton = (AuroraButton) view.findViewById(R.id.start_date);
        mEndDateButton = (AuroraButton) view.findViewById(R.id.end_date);
        mWhenView = (TextView) mView.findViewById(R.id.when);
        mTimezoneTextView = (TextView) mView.findViewById(R.id.timezone_textView);
        mStartTimeButton = (AuroraButton) view.findViewById(R.id.start_time);
        mEndTimeButton = (AuroraButton) view.findViewById(R.id.end_time);
        mTimezoneButton = (AuroraButton) view.findViewById(R.id.timezone_button);
...
//        extension.setLengthInputFilter((EditText) mDescriptionTextView, mActivity, DESCRIPTION_MAX_LENGTH);
    ...
    public void setModel(CalendarEventModel model) {
        ...
        if (canRespond) {
            int buttonToCheck = GNEventInfoFragment
...
///M: MTK code below
    ...
    /**
     * M:Set the view only can be selected once event   
     * set the spinner enable
     * @param enable true the enable,or false.
     */
