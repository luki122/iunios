...
public class EventViewUtils {
    ...
    public static ArrayList<ReminderEntry> reminderItemsToReminders(
        ...
        for (int index = 0; index < len; index++) {
            ...
            AuroraSpinner minuteSpinner = (AuroraSpinner) layout.findViewById(R.id.reminder_minutes_value);
            AuroraSpinner methodSpinner = (AuroraSpinner) layout.findViewById(R.id.reminder_method_value);
     ...
     */
    private static void setReminderSpinnerLabels(Activity activity, AuroraSpinner spinner,
            ArrayList<String> labels) {
        Resources res = activity.getResources();
        spinner.setPrompt(res.getString(R.string.reminders_label));
        
        //Gionee <jiating><2013-06-09> modfify for CR00000000 superTheme begin
//        int resource = android.R.layout.simple_spinner_item;
        int resource = R.layout.gn_edit_event_repeat_item;
        
      //Gionee <jiating><2013-06-09> modfify for CR00000000 superTheme end
    ...
    public static boolean addReminder(final Activity activity, View view, View.OnClickListener listener,
        ...
        LinearLayout reminderItem = (LinearLayout) inflater.inflate(R.layout.edit_reminder_item,
                null);
        //Gionee <jiating>  <2013-04-11> modify for CR00000000 update reminder view  begin
        
        View reminderItemDiver=reminderItem.findViewById(R.id.gn_deit_reminder_item_diver);
        Log.i("jiating","addReminder.....items.size()="+items.size()+"maxReminders...="+maxReminders);
        if(items.size()==0 || items.size() >= maxReminders-1 ){
        	Log.i("jiating","addReminder.......if");
        	reminderItemDiver.setVisibility(View.GONE);
        }else{
         	Log.i("jiating","addReminder.......else");
        	reminderItemDiver.setVisibility(View.VISIBLE);
        }
        //Gionee <jiating>  <2013-04-11> modify for CR00000000 update reminder view  end
        if (parent != null) {
         ...
         */
        AuroraSpinner spinner = (AuroraSpinner) reminderItem.findViewById(R.id.reminder_minutes_value);
        spinner.setOnTouchListener(new OnTouchListener() {
			@Override
			public boolean onTouch(View v, MotionEvent event) {
				// TODO Auto-generated method stub
				if(event.getAction() == MotionEvent.ACTION_DOWN){
					Statistics.onEvent(activity,Statistics.EDIT_EVENT_REMINDE);
				}
				return false;
			}
		});
        //Gionee <jiating>  <2013-05-16> modify for CR00000000 update reminder view  begin
        spinner.setPadding(0,0,0,0);
      //Gionee <jiating>  <2013-05-16> modify for CR00000000 update reminder view  end
         ...
         * will not be shown.
         */
        spinner = (AuroraSpinner) reminderItem.findViewById(R.id.reminder_method_value);
      //Gionee <jiating>  <2013-05-16> modify for CR00000000 update reminder view  begin
        spinner.setPadding(0,0,0,0);
        //Gionee <jiating>  <2013-05-16> modify for CR00000000 update reminder view  end
        ...
        //Gionee <jiating>  <2013-04-11> modify for CR00000000 reminder_method_value Gone begin
        spinner.setVisibility(View.GONE);
        //Gionee <jiating>  <2013-04-11> modify for CR00000000 reminder_method_value Gone end
		...
		Log.i("GNEditEvent","GNEditEvent-EventViewUtils-reminderItem == " + reminderItem);
    ...
    public static void updateAddReminderButton(View view, ArrayList<LinearLayout> reminders,
        ...
        Log.i("jiating","updateAddReminderButton.....reminders.size()="+reminders.size()+"maxReminders...="+maxReminders);
        if (reminderAddButton != null) {
         	Log.i("jiating","updateAddReminderButton.......if");
            if (reminders.size() >= maxReminders) {
            	Log.i("jiating","updateAddReminderButton.......if11");
                reminderAddButton.setEnabled(false);
                reminderAddButton.setVisibility(View.GONE);
                //Gionee <jiating>  <2013-04-11> modify for CR00000000 update reminder View begin
            } else if(reminders.size()==0){
            	Log.i("jiating","updateAddReminderButton.......else if");
    			...
    			Log.i("jiating","updateAddReminderButton.......else");
    			 reminderAddButton.setEnabled(true);
                 reminderAddButton.setVisibility(View.VISIBLE);
  ...
  //Gionee <jiating>  <2013-04-11> modify for CR00000000 update reminder View begin
     ...
     * reminders.
     */
    public static void updateAddReminderButton(Activity mActivity,View view, ArrayList<LinearLayout> reminders,
            int maxReminders) {
        View reminderAddButton = view.findViewById(R.id.reminder_add);
        Log.i("jiating","updateAddReminderButton.....reminders.size()="+reminders.size()+"maxReminders...="+maxReminders);
        if (reminderAddButton != null) {
    ...
    public static void updateReminderDiver(View view, int numberReminders,
            int maxReminders) {
        View reminderDiver = view.findViewById(R.id.gn_deit_reminder_item_diver);

        Log.i("jiating","updateReminderDiver.....numberReminders="+numberReminders+"maxReminders...="+maxReminders);
        if (reminderDiver != null) {
        	Log.i("jiating","updateReminderDiver.......if");
        	  if(numberReminders==1  ){
        		   	Log.i("jiating","updateReminderDiver.......if11111");
        		  reminderDiver.setVisibility(View.GONE);
              }else{
            	   	Log.i("jiating","updateReminderDiver.......else");
            	  reminderDiver.setVisibility(View.VISIBLE);
              }
