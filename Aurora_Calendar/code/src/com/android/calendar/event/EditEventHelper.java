...
//Gionee <jiating>  <2013-04-11> modify for for CR00000000 new view design begin
    public static final int MODIFY_UNINITIALIZED = 0;
    public static final int MODIFY_SELECTED = 1;
//Gionee <jiating>  <2013-04-11> modify for for CR00000000 new view design end
...
//	Gionee <jiating>  <2013-04-11> modify for new for CR00000000 view design end
    ...
    static final String CALENDARS_WHERE_WRITEABLE_VISIBLE = Calendars.CALENDAR_ACCESS_LEVEL + ">="
            ...
            + " AND " + Calendars.ACCOUNT_NAME + "!='" + Utils.BIRTHDAY_REMINDER_ACCOUNT_NAME + "'"
            + " AND " + Calendars.ACCOUNT_NAME + "!='" + Utils.NOTE_REMINDER_ACCOUNT_NAME + "'"
            + " AND " + Calendars.ACCOUNT_NAME + "!='" + Utils.EMAIL_REMINDER_ACCOUNT_NAME + "'";
     ...
     * constants
     */
///	 Gionee <jiating>  <2013-04-11> modify for CR00000000  new view design begin
     public static void updateRecurrenceRule(int selection, CalendarEventModel model,
            int weekStart) {
//   Gionee <jiating>  <2013-04-11> modify for CR00000000  new view design end			
        // Make sure we don't have any leftover data from the previous setting
        EventRecurrence eventRecurrence = new EventRecurrence();
Log.i("jiating","updateRecurrenceRule......selection="+selection);

        if (selection == DOES_NOT_REPEAT) {
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_ONCE);
            model.mRrule = null;
            return;
			...
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_DAY);
            eventRecurrence.freq = EventRecurrence.DAILY;
        } else if (selection == REPEATS_EVERY_WEEKDAY) {
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_WEEK_DAY);
			...
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_EVERY_WEEK);
            eventRecurrence.freq = EventRecurrence.WEEKLY;
            int[] days = new int[1];
            int dayCount = 1;
			...
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_EVERY_REPEATS_MONTHLY_ON_DAY);
			...
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_EVERY_MONTHLY_ON_DAY_COUNT);
            eventRecurrence.freq = EventRecurrence.MONTHLY;
			...
			Statistics.onEvent(mContext, Statistics.EDIT_EVENT_REPITE_EVERY_YEAR);
    ...
    public static boolean hasChanged(CalendarEventModel originalModel, CalendarEventModel mModel) {
    	Log.e("liumx","originalModel================================="+originalModel.mTitle);
    	Log.e("liumx","originalModel================================="+originalModel.mDescription);
    	Log.e("liumx","originalModel================================="+originalModel.mStart);
    	Log.e("liumx","originalModel================================="+originalModel.mRrule);
    	Log.e("liumx","originalModel================================="+originalModel.mHasAlarm);
    	Log.e("liumx","originalModel================================="+originalModel.mEnd);
    	Log.e("liumx","##########################=================================");
    	Log.e("liumx","mModel================================="+mModel.mTitle);
    	Log.e("liumx","mModel================================="+mModel.mDescription);
    	Log.e("liumx","mModel================================="+mModel.mStart);
    	Log.e("liumx","mModel================================="+mModel.mRrule);
    	Log.e("liumx","mModel================================="+mModel.mHasAlarm);
    	Log.e("liumx","mModel================================="+mModel.mEnd);
    	
    	if (!originalModel.mTitle.equals(mModel.mTitle)) {
    		return true;
    	}
    	
    	if (originalModel.mDescription == null) {
    		if (mModel.mDescription != null) {
    			Log.e("liumx","mModel=================================1");
    			return true;
    		}
    	} else if (!originalModel.mDescription.equals(mModel.mDescription)) {
    		Log.e("liumx","mModel=================================2");
    		return true;
    	}
    	
    	if (originalModel.mDuration == null) {
    		if (mModel.mDuration != null) {
    			Log.e("liumx","mModel=================================11");
    			return true;
    		}
    	} else if (!originalModel.mDuration.equals(mModel.mDuration)) {
    		Log.e("liumx","mModel=================================22");
    		return true;
    	}
    	
    	if (originalModel.mStart != mModel.mStart) {
    		Log.e("liumx","mModel=================================3");
    		return true;
    	}
    	
    	if (originalModel.mEnd != mModel.mEnd) {
    		Log.e("liumx","mModel=================================4");
    		return true;
    	}
    	
    	if (originalModel.mHasAlarm != mModel.mHasAlarm) {
    		Log.e("liumx","mModel=================================5");
    		return true;
    	}
    	
    	if (originalModel.mRrule == null) {
    		if (mModel.mRrule != null) {
    			Log.e("liumx","mModel=================================6");
    			return true;
    		}
    	} else if (!originalModel.mRrule.equals(mModel.mRrule)) {
    		Log.e("liumx","mModel=================================7");
    		return true;
    	}
