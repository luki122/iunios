...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
    ...
    //Gionee <jiating>  <2013-04-11> modify for CR00000000  actionbar begin
    private View mActionBarView;
    //Gionee <jiating>  <2013-04-11> modify for CR00000000  actionbar end
...
//        AuroraActivity auroraActivityTemp=(AuroraActivity)mActivity;
//        AuroraActionBar bar= auroraActivityTemp.getAuroraActionBar();
//        if (bar != null) {
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Gionee <jiating>  <2013-04-11> modify for CR00000000  reminder_add change from Button to  ReleativeLayout begin
        mAddReminderBtn = mView.findViewById(R.id.reminder_add);
      //Gionee <jiating>  <2013-04-11> modify for CR00000000  reminder_add change from Button to  ReleativeLayout end
...
//    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
    	Log.i("jiating","aurora ...EventInfo...onCreateOptionsMenu");
...
//         Show edit/delete buttons only in non-dialog configuration
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	Log.i("jiating","aurora ...EventInfo...onOptionsItemSelected");
//         If we're a dialog we don't want to handle menu buttons
    ...
    private void updateCustomAppButton() {
        buttonSetup: {
            final AuroraButton launchButton = (AuroraButton) mView.findViewById(R.id.launch_custom_app_button);
