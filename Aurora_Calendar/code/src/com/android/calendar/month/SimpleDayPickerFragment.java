 ...
 * </p>
 */
abstract public class SimpleDayPickerFragment extends ListFragment implements OnScrollListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // Gionee don't display month name in month view start
        // mMonthName = (TextView) getView().findViewById(R.id.month_name);
        // Gionee don't display month name in month view end
