...
public class SimpleWeekView extends View {
    ...
    protected static int WEEK_VIEW_DEFAULT_HEIGHT = 52;
    ...
    // Gionee add for judging whether this week contains date of focus month start
    // Quick lookup for checking whether this week contains date of focus month
    protected boolean mHasFocusMonthDay;
    // Gionee add for judging whether this week contains date of focus month end
    ...
    public SimpleWeekView(Context context) {
        ...
        if (mScale == 0) {
            ...
            WEEK_VIEW_DEFAULT_HEIGHT = res.getInteger(R.integer.month_week_view_height);
            if (mScale != 1) {
                WEEK_VIEW_DEFAULT_HEIGHT *= mScale;
    ...
    public void setWeekParams(HashMap<String, Integer> params, String tz) {
        ...
        // Gionee adjust mHeight as mWidth start
        /*
        ...
        */
        // Gionee adjust mHeight as mWidth end
        ...
        int focusMonth = params.containsKey(VIEW_PARAMS_FOCUS_MONTH) ? 
        		params.get(VIEW_PARAMS_FOCUS_MONTH) : DEFAULT_FOCUS_MONTH;
        // Gionee add for judging whether this week contains date of focus month start
...
//            }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mCellWidth = (int) ((float) w / this.mNumDays);
        // adjust mHeight as mWidth start
        // mHeight = mWidth / mNumCells;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    	...
    	mHeight = WEEK_VIEW_DEFAULT_HEIGHT/*(int) (MeasureSpec.getSize(widthMeasureSpec) / mNumCells * ratio)*/;
        // Gionee adjust mHeight as mWidth end
