...
public class SearchActivity extends AuroraActivity implements CalendarController.EventHandler,
   ...
   private static boolean mIsMultipane;
    ...
    private AuroraEventInfoFragment mEventInfoFragment;
	...
	//Gionee <jiating>  <2013-04-18>  modify for  GNAgendaFragment instead of AgendaFragment begin
        GNAgendaFragment searchResultsFragment = new GNAgendaFragment(timeMillis, true);
			//Gionee <jiating>  <2013-04-18>  modify for  GNAgendaFragment instead of AgendaFragment end
    ...
    private void showEventInfo(EventInfo event) {
        if (mShowEventDetailsWithAgenda) {
            ...
            mEventInfoFragment = new AuroraEventInfoFragment(this, event.id,
                    event.startTime.toMillis(false), event.endTime.toMillis(false),
                    event.getResponse(), false, AuroraEventInfoFragment.DIALOG_WINDOW_STYLE);
