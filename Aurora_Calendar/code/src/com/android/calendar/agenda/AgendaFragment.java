...
public class AgendaFragment extends Fragment implements CalendarController.EventHandler,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            int topDeviation = savedInstanceState.getInt(BUNDLE_KEY_RESTORE_TOP_DEVIATION, 0);
            AgendaWindowAdapter.setTopDeviation(topDeviation);
            /// @}
        }
...
//        mContentResolver.registerContentObserver(Events.CONTENT_URI, true, mObserver);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int listTopDeviation = mAdapter.saveTopDeviation(mTime);
        outState.putInt(BUNDLE_KEY_RESTORE_TOP_DEVIATION, listTopDeviation);
        /// @}
