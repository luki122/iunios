...
public class StickyHeaderListView extends FrameLayout implements OnScrollListener {
    ...
    protected AuroraListView mListView = null;
    protected AuroraListView.OnScrollListener mListener = null;
   ...
   public interface HeaderHeightListener {
     ...
     */
    public void setOnScrollListener(AuroraListView.OnScrollListener listener) {
        mListener = listener;
    }
    ...
    private void setChildViews() {
        ...
        for (int i = 0; i < iChildNum; i++) {
            ...
            if (v instanceof AuroraListView) {
                setListView((AuroraListView) v);
            }
        }

        // No child ListView - add one
        if (mListView == null) {
            setListView(new AuroraListView(mContext));
        }
