...
import com.aurora.calendar.util.StringUtils;
...
//	}
	...
	public static boolean showSysAuthDialog(final Activity activity, final ContentResolver cr, final Context context) {
		...
		if (showKey) {
			...
			builder.setPositiveButton(activity.getString(R.string.sys_auth_dlg_continue), 
				...
				public void onClick(DialogInterface dialog, int id) {
					...
					checkBirthdayReminder(cr, context);
				}
			});
	...
	private static void checkBirthdayReminder(ContentResolver cr, Context context) {
