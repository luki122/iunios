    ...
    public void delete(long begin, long end, CalendarEventModel model, int which) {
        ...
        if (TextUtils.isEmpty(rRule)) {
            AuroraAlertDialog dialog = new AuroraAlertDialog.Builder(mContext)
                    .setTitle(R.string.aurora_delete_event_dialog)
            ...
            if (originalEvent == null) {
                ...
                dialog.setButton(DialogInterface.BUTTON_POSITIVE,
                        mContext.getText(R.string.aurora_delete),
            ...
            CharSequence[] labels = new CharSequence[labelArray.size()];
            ...
            AuroraAlertDialog dialog = new AuroraAlertDialog.Builder(mContext)
                    ...
                    .setTitle(R.string.aurora_delete_recurring_event)
                    .setTitleDividerVisible(true)
//                    .setIconAttribute(android.R.attr.alertDialogIcon)
                    // .setSingleChoiceItems(adapter, which, mDeleteListListener)
                    .setSingleChoiceItems(labels, which, mDeleteListListener)
                    .setPositiveButton(R.string.aurora_delete, mDeleteRepeatingDialogListener)
                    .setNegativeButton(android.R.string.cancel, null).create();
            if (mParent != null && mParent.isFinishing()) {
                LogUtil.w(TAG, "delete failed, parent is finishing.");
                return;
