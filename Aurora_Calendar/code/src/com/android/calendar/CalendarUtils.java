...
public class CalendarUtils {
			...
			protected void onQueryComplete(int token, Object cookie,
				...
				synchronized (mTZCallbacks) {
					...
					if (keyColumn < 0 || valueColumn < 0) {
						LogUtil.w(TAG,
								"Some problem happened in Cursor, the index is set to -1, return directly.");
						mTZQueryInProgress = false;
						mFirstTZRequest = true;
						return;
					}
			...
			try {
				synchronized (mTZCallbacks) {
					if (mFirstTZRequest) {
						...
						// preferences, set mTZQueryInProgress to false, and
						// call all
	 ...
	 *            The value to write
	 */
	public static void setSharedPreference(SharedPreferences prefs, String key,
			String value) {
		// SharedPreferences prefs = getSharedPreferences(context);
