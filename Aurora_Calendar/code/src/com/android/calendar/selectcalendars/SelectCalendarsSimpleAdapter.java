...
public class SelectCalendarsSimpleAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mRowCount==1){
        	view.setBackgroundResource(R.drawable.gn_all_in_one_sliding_content_single_on_off);
        }else if(mRowCount>1 && position ==0){
        	view.setBackgroundResource(R.drawable.gn_all_in_one_sliding_content_top_on_off);
        }else if(mRowCount>1 &&  position ==mRowCount-1){
        	view.setBackgroundResource(R.drawable.gn_all_in_one_sliding_content_bottom_on_off);
        }else{
        	view.setBackgroundResource(R.drawable.gn_all_in_one_sliding_content_middle_on_off);
        }
