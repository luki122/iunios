...
//		mIsClickMoreButton = false;
		...
		mEventReminderView = view.findViewById(R.id.reminder);
		...
		if (isOpen) {
			mReminderMe.setImageResource(R.drawable.aurora_event_reminder_open);
		} else {
			mReminderMe.setImageResource(R.drawable.aurora_event_reminder_close);
		}
...
//		initMultiAutoCompleteTextView((RecipientEditTextView) mAttendeesList);
		...
		mEventReminderView.setOnClickListener(new OnClickListener() {
