...
public abstract class EmailContent {
    ...
    public static final class Message extends EmailContent implements SyncColumns, MessageColumns {
        ...
        public int mFlagAttachment = 0;//paul modify
        public int mFlags = 0;
        ...
        public void restore(Cursor cursor) {
            ...
            mFlagAttachment = cursor.getInt(CONTENT_FLAG_ATTACHMENT_COLUMN);//paul modify
            ...
            if (mText == null && mHtml == null && mTextReply == null && mHtmlReply == null &&
                ...
                if (doSave) {
                    ...
                    if (update(context, toContentValues()) == 1) {
                        //Log.i("SQF_LOG", "EmailContent::update...22222..");
                        return getUri();
                    }
                    return null;
                }
