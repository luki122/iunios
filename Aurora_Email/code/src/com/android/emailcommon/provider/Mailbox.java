...
public class Mailbox extends EmailContent implements MailboxColumns, Parcelable {
    ...
    static {
        ...
        SYNCABLE_TYPES.put(TYPE_DRAFTS, true);//modify by shihao for sync drafts
     ...
     */
    //Aurora <shihao> <2014-11-07> for  new DrawLayout folder List begin
//    public static final int[] REQUIRED_FOLDER_TYPES =
//            { TYPE_INBOX, TYPE_DRAFTS, TYPE_OUTBOX, TYPE_SENT, TYPE_TRASH };
    public static final int[] REQUIRED_FOLDER_TYPES =
    	{ TYPE_INBOX,TYPE_SENT,TYPE_DRAFTS, TYPE_TRASH };
   //Aurora <shihao> <2014-11-07> for  new DrawLayout folder List end.
    ...
    public static Mailbox newSystemMailbox(Context context, long accountId, int mailboxType) {
        ...
        switch (mailboxType) {
            ...
            case TYPE_SENT:
            case TYPE_TRASH:
            case TYPE_DRAFTS://add by shihao
