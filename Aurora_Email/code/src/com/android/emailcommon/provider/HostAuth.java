...
public final class HostAuth extends EmailContent implements HostAuthColumns, Parcelable {
    ...
    public void setConnection(String protocol, String address,
    	...
    	//Log.d("cjslog", "protocol " + protocol + " address " + address + 
    	//		" port "+ port + " flags " + flags + " clientCertAlias " + clientCertAlias);
        ...
        if (mPort == PORT_UNKNOWN) {
            ...
            if (LEGACY_SCHEME_SMTP.equals(mProtocol)) {
            	//Aurora <shihao> <2014-10-31> for default smtp port begin
//                mPort = useSSL ? 465 : 587;
            	mPort = useSSL ? 465 : 25;
            	//Aurora <shihao> <2014-10-31> for default smtp port end
            }
        }
    ...
    public void setConnection(String scheme, String host, int port) {
        ...
        //cjs add for qq mail
        if(host.endsWith("qq.com") || host.endsWith("gmail.com")){
        	flags = 9;    //be careful because maybe cause login fail;
        }
        //cjs add for qq mail
