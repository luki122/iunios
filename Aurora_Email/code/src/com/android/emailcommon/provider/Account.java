...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
	...
	public static final int INVALID_SYNC_INTERVAL = -1;//paul add
    ...
    public static int mSyncInterval;//paul modify
    ...
    public static String mSignature;//paul modify
    ...
    public Account() {
        ...
        mSyncInterval = INVALID_SYNC_INTERVAL;//paul modify -1
        mSyncLookback = -1;
        mFlags = 0;
