...
case TRANSACTION_cancelAttachment:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
this.cancelAttachment(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void cancelAttachment(long attachmentId) throws android.os.RemoteException
{
	android.os.Parcel _data = android.os.Parcel.obtain();
	android.os.Parcel _reply = android.os.Parcel.obtain();
	try {
	_data.writeInterfaceToken(DESCRIPTOR);
	_data.writeLong(attachmentId);
	mRemote.transact(Stub.TRANSACTION_cancelAttachment, _data, _reply, 0);
	}
	finally {
	_reply.recycle();	
	_data.recycle();
...
static final int TRANSACTION_cancelAttachment = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
...
public void cancelAttachment(long attachmentId) throws android.os.RemoteException;
}
