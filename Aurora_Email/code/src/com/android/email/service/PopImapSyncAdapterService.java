...
public class PopImapSyncAdapterService extends Service {
    ...
    private static class SyncAdapterImpl extends AbstractThreadedSyncAdapter {
        ...
        public void onPerformSync(android.accounts.Account account, Bundle extras,
        	...
        	//MyLog.i("SQF_LOG", "PopImapSyncAdapterService::SyncAdapterImpl::onPerformSync");
    ...
    private static void sync(final Context context, final long mailboxId,
        ...
        try {
            ...
            //MyLog.i("SQF_LOG", "--- --- PopImapSyncAdapterService::sync set Mailbox.UI_SYNC_STATUS  to  EmailContent.SYNC_STATUS_NONE");
    ...
    private static void performSync(Context context, android.accounts.Account account,
    	...
    	//MyLog.i("SQF_LOG", "PopImapSyncAdapterService::performSync!!!!");
        Cursor c = null;
        try {
