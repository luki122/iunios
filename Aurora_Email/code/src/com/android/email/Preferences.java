...
public class Preferences {
    ...
    private static final int AUTO_ADVANCE_DEFAULT = AUTO_ADVANCE_MESSAGE_LIST;//AUTO_ADVANCE_OLDER paul modify
    private static final boolean CONFIRM_DELETE_DEFAULT = true;//false paul modify
