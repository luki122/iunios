...
public class AccountCheckSettingsFragment extends Fragment {
    ...
    //Aurora <shihao> <2015-01-08> modify for Account Manual_Setup_Login begin
    private static boolean needShowDialog = false;
    private static String mProtocol = new String();
    ...
    public static AccountCheckSettingsFragment newInstance(int mode, Fragment parentFragment) {
    	return newInstance(mode, parentFragment, false);
    }
    public static AccountCheckSettingsFragment newInstance(int mode, Fragment parentFragment, boolean showDialog) {
  ...
  //Aurora <shihao> <2015-01-08> modify for Account Manual_Setup_Login end
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mAccountCheckTask == null) {
            ...
            mProtocol = checkAccount.mHostAuthRecv.mProtocol;
            ...
            switch (newState) {
                ...
                case STATE_AUTODISCOVER_AUTH_DIALOG:
                  ...
                  //Aurora <shihao> <2015-01-08> modify for Account Manual_Setup_Login end
                    ...
                    //Aurora <shihao> <2014-10-24> for show errormessage when login failed Begin
                    getCallbackTarget().onSendErrorMessage(getErrorString(getActivity(), ex),ex); 
                    finish();
                    //Aurora <shihao> <2014-10-24> for show errormessage when login failed end
                    break;
    ...
    private class AccountCheckTask extends AsyncTask<Void, Integer, MessagingException> {
        ...
        protected MessagingException doInBackground(Void... params) {
            try {
            	...
            	LogUtils.i("shihao","AccountCheckSetupFragment::doInBackground ----> CHECK_INCOMING =="+((mMode & SetupData.CHECK_INCOMING) != 0) );
            	...
            	LogUtils.i("shihao","AccountCheckSetupFragment::doInBackground ----> CHECK_OUTGOING =="+((info.usesSmtp && (mMode & SetupData.CHECK_OUTGOING) != 0)));
    ...
    private static String getErrorString(Context context, MessagingException ex) {
        ...
        switch (ex.getExceptionType()) {
            ...
            case MessagingException.CERTIFICATE_VALIDATION_ERROR://///////////////
            	//Aurora <shihao> <2014-10-28> for Login failed
/*                id = TextUtils.isEmpty(message)
            ...
            case MessagingException.AUTHENTICATION_FAILED:
            	//Aurora <shihao> for new notiforcation of error
            	if(!TextUtils.isEmpty(mProtocol)){
	            	message = mProtocol.toUpperCase().trim();
	            	id = R.string.aurora_account_setup_failed_dlg_auth_message;
            	}else
...
//            final AlertDialog.Builder builder = new AlertDialog.Builder(context)
            ...
            //Aurora <shihao> <20150120> for tip error begin
            builder.setTitle(R.string.aurora_list_delete_item_tip_title);
