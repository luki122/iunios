...
public class AccountSettingsUtils {
     ...
     * 
     */
    public static ContentValues getStaticContentValues(int syncInterval,String signature) {
        ContentValues cv = new ContentValues();
    ...
    public static ContentValues getSenderNameValues(String senderName) {
        ContentValues cv = new ContentValues();
		cv.put(AccountColumns.SENDER_NAME, senderName);
        return cv;
    }
