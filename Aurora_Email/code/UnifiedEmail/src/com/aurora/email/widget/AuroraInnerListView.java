...
public class AuroraInnerListView extends AuroraListView  {
	private ScrollView parentScrollView;

	public AuroraInnerListView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public AuroraInnerListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public AuroraInnerListView(Context context, AttributeSet attrs, int defStyle) {
