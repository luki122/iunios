...
public class ConversationPagerAdapter extends FragmentStatePagerAdapter2
     ...
     */
    private boolean mDetachedMode = true;//private boolean mDetachedMode = false; paul modify
    /**
    ...
    public Fragment getItem(int position) {
        ...
        return f;		
		*/
        mCurrentFragment = getConversationViewFragment(c);
        return mCurrentFragment;
    }
	//paul add start
	private AbstractConversationViewFragment mCurrentFragment = null;
	public void pageAction(int itemId){
		if(null != mCurrentFragment){
			mCurrentFragment.pageAction(itemId);
		}
	}
	//paul add end
