...
public class ConfirmDialogFragment extends DialogFragment {
     ...
     */
    private final AuroraAlertDialog.OnClickListener POSITIVE_ACTION = new AuroraAlertDialog.OnClickListener() {
        @Override
        public void onClick(DialogInterface arg0, int arg1) {
            ...
            // development.
            final AuroraAlertDialog.OnClickListener listener =
    ...
    public ConfirmDialogFragment(int res) { confirmResId = res; }
    public static ConfirmDialogFragment newInstance(CharSequence message, int res) {
        final ConfirmDialogFragment f = new ConfirmDialogFragment(res);
    ...
    public Dialog onCreateDialog(Bundle savedState) {
		...
		//paul add start
		if(0 == confirmResId) {
			builder.setPositiveButton(R.string.ok, POSITIVE_ACTION);
		}else{
			builder.setPositiveButton(confirmResId, POSITIVE_ACTION);
		}
		//paul add end
