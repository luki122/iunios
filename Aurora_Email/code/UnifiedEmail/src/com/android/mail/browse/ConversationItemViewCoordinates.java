...
public class ConversationItemViewCoordinates {
    ...
    public static final class Config {
        ...
        public Config setFilterText(String filter) {
            mFilter = filter;
            return this;
        }
    ...
    final int sendersTextLeftPadding;
    final int paperClipLeftPadding;
    final int starLeftPadding;
    ...
    int snippetWidth = 0;
    int snippetHeight = 0;
    int snippetLineCount = 0;
    float snippetFontSize = 0;
    //Aurora <SQF> <2014-11-18>  for NEW_UI end
    ...
    private ConversationItemViewCoordinates(final Context context, final Config config,
        ...
        //View contactImagesView = view.findViewById(R.id.contact_image); //SQF Annotated on 2014.

        switch (config.getGadgetMode()) {
            case GADGET_CONTACT_PHOTO:
                //contactImagesView.setVisibility(View.VISIBLE);//SQF Annotated on 2014.
                break;
            case GADGET_CHECKBOX:
                //Aurora <SQF> <2014-11-14>  for NEW_UI begin
                //SQF ANNOTATED ON 2014-11-14
            	//contactImagesView.setVisibility(View.GONE);
                //contactImagesView = null;
                //Aurora <SQF> <2014-11-14>  for NEW_UI end
...
//        Utils.dumpViewTree((ViewGroup) view);
        ...
        */
        ...
        sendersTextLeftPadding = res.getDimensionPixelSize(R.dimen.aurora_senders_text_left_padding);//SQF ADDED
        paperClipLeftPadding = res.getDimensionPixelSize(R.dimen.aurora_paper_clip_left_padding);//SQF ADDED
        starLeftPadding = res.getDimensionPixelSize(R.dimen.aurora_star_left_padding);//SQF ADDED
        ...
        if(snippet != null) {
        	...
        	snippetLineCount = getLineCount(snippet);
