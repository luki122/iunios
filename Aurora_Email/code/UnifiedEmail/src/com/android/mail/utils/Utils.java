...
public class Utils {
	 ...
	 * @return -1 ：同一天.    0：昨天 .   1 ：前天. 2:前天以后
	 * @throws ParseException 转换异常
	 * @author JXH
	 */
	public static int isYeaterday(long oldTime,Date newTime) throws ParseException{
		if(newTime==null){
			newTime=new Date();
		}
	   ...
	   /* else if((today.getTime()-oldTime)>86400000 && (today.getTime()-oldTime)<=86400000*2){ //是前天
	    	return 1;
	    }*/else {
			return 1;
		}
