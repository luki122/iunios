...
public class NotificationUtils {
    ...
    public static void setNewEmailIndicator(Context context, final int unreadCount,
    	...
    	//Log.d("cjslog", "setNewEmailIndicator");
    ...
    private static void validateNotifications(Context context, final Folder folder,
            ...
            NotificationKey key) {
    	//Log.d("cjslog", "validateNotifications");
        ...
        try {
            ...
            if (unreadCount > 0) {
                ...
                if (cursor.moveToNext()) {
                    ...
                    //cjs add begin
                    notificationIntent.putExtra("launchConversationMode", launchConversationMode);
                    //cjs add end
    ...
    private static Bitmap getDefaultNotificationIcon(
        ...
        if (folder.notificationIconResId != 0) {
        	 Log.d("JXH", "getDefaultNotificationIcon notificationIconResId");
            resId = folder.notificationIconResId;
        } else if (multipleNew) {
        	 Log.d("JXH", "getDefaultNotificationIcon ic_notification_multiple_mail_holo_dark");
            resId = R.drawable.ic_notification_multiple_mail_holo_dark;
        } else {
        	   Log.d("JXH", "getDefaultNotificationIcon ic_contact_picture");
    ...
    private static void configureLatestEventInfoFromConversation(final Context context,
        ...
        if (unseenCount > 1) {
            ...
            //Log.d("cjslog", " The title of the notification is the new messages string " + newMessagesString);
            ...
            if (com.android.mail.utils.Utils.isRunningJellybeanOrLater()) {
                ...
                // The body of the notification is the account name, or the label name.
            	//Log.d("cjslog", "2 " + notificationAccount + " ///" + notificationLabelName + isInbox);
            ...
            try {
                ...
                if (Utils.isRunningJellybeanOrLater()) {
                    ...
                    //Log.d("cjslog", "1 " + getSingleMessageLittleText(context, conversation.subject));
                    notification.setContentText(
                	...
                	//Log.d("cjslog", "For an old-style notification " + conversation.subject);
    ...
    private static CharSequence getSingleMessageLittleText(Context context, String subject) {
        ...
        //Log.d("cjslog", "subject " + subject);
        if(TextUtils.isEmpty(subject)){
        	subject = context.getResources().getString(R.string.nosubject);
        }
