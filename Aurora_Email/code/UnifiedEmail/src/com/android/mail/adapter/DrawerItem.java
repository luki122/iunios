...
public class DrawerItem {
    ...
    //Aurora <shihao> <2014-11-04> for launch accounts when the number of allaccounts more than 4 begin
    public static final int VIEW_LAUNCH_ACCOUTS = 4;
    public static boolean isLaunchAccounts = false;
    public boolean isLastFolder = false;
//    private static final int LAST_FIELD = VIEW_WAITING_FOR_SYNC + 1;
    public static final int VIEW_SETTING = 5;   //cjs add for setting item

    private static final int LAST_FIELD = VIEW_SETTING + 1;
    //Aurora <shihao> <2014-11-04> for launch accounts when the number of allaccounts more than 4 end
    ...
    /** Aurora <shihao> <2014-11-04> for launch Accounts list begin
     * Create a launch accounts item 
     *
     * @param activity the underlying activity
     * @param resource the string resource: R.string.all_folders_heading
     * @return a drawer item for the header.
     */
    public static DrawerItem ofLaunch(ControllableActivity activity, boolean isLaunch,BidiFormatter bidiFormatter) {
    	isLaunchAccounts = isLaunch;
        return new DrawerItem(VIEW_LAUNCH_ACCOUTS, activity, null, INERT_HEADER, null, -1, false,
                bidiFormatter);
    }
    //Aurora <shihao> <2014-11-04> for launch Accounts list end
    ...
    /**
     * Aurora for add a setting item 
     */
    public static DrawerItem ofSetting(ControllableActivity activity,
            BidiFormatter bidiFormatter){
    	return new DrawerItem(VIEW_SETTING, activity, null, INERT_HEADER, null, -1, false, 
    			bidiFormatter);
    }
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        switch (mType) {
            ...
            case VIEW_WAITING_FOR_SYNC:
                ...
                break;
            //Aurora <shihao> <2014-11-04> for launch accounts when the number of allaccounts more than 4 begin
            case VIEW_LAUNCH_ACCOUTS:
            	result = getLaunchView(convertView,parent);
            	break;
            	//Aurora <shihao> <2014-11-04> for launch accounts when the number of allaccounts more than 4 end
            case VIEW_SETTING :
            	result = getSettingView(convertView,parent);
            	break;
            default:
    ...
    private View getSettingView(View convertView, ViewGroup parent) {
    	//Log.d("cjslog", "getSettingView");
		// TODO Auto-generated method stub
    	final View settingView ;
    	if(convertView != null){
    		settingView = (View) convertView;
    	}else {
    		//Log.d("cjslog", "1");
    		settingView = (View) mInflater.inflate(R.layout.aurora_setting_item, parent,false);
			//Log.d("cjslog", "2");
		}
		/*TextView textView = (TextView)settingView.findViewById(R.id.aurora_drawer_setting);
...
/*    	settingView.setOnClickListener(new View.OnClickListener() {
    ...
    private View getAccountView(View convertView, ViewGroup parent) {
        ...
        accountItemView.bind(mActivity,mAccount, mIsSelected, mResource);
...
//        headerView.setText(mResource);
     ...
     * @return a text header at the given position.
     */
    private View getLaunchView(View convertView, ViewGroup parent) {
        final View launchView;
        if (convertView != null) {
        	launchView = (View) convertView;
        } else {
        	launchView = (View) mInflater.inflate(
                    R.layout.launch_list_accounts, null, false);
        }
        View v = launchView.findViewById(R.id.launch_accounts);
        v.setSelected(isLaunchAccounts);
        return launchView;
    }
    //Aurora <shihao> <2014-11-04> for New DrawLayout end
    ...
    private View getFolderView(View convertView, ViewGroup parent) {
        ...
        folderItemView.bind(mFolder, mActivity, mBidiFormatter, isLastFolder);
