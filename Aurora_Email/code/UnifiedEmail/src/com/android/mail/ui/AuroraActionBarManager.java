	...
	public void setMode(Mode mode) {
		...
		case INITIAL_MODE:
			...
			if(mNeedSetCustomView) {
				Log.i("SQF_LOG", "setMode...INITIAL_MODE 2222222");
	...
	private OnAuroraActionBarItemClickListener mAuroActionBarItemClickListener = new OnAuroraActionBarItemClickListener() {
		public void onAuroraActionBarItemClicked(int itemId) {
			...
			case AURORA_SEARCH_ACTION:
				final AuroraSearchView mSearchView = mActivity.getSearchView();
				...
				mActivity.getAuroraActionBar().setOnActionbarSearchViewQuitListener(new OnActionbarSearchViewQuitListener() {
...
/*			case R.id.aurora_backup_to_calendar:
	...
	public boolean onBackPressed() {
		...
		if (viewmode == ViewMode.SEARCH_RESULTS_CONVERSATION
			...
			quitSearch(mActivity.getViewMode());
