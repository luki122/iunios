...
public final class SystemFolderSelectorAdapter extends FolderSelectorAdapter {
    ...
    protected boolean meetsRequirements(Folder folder) {
    	...
    	if(Folder.isType(folder.type, UIProvider.FolderType.DRAFT)) {
			return false;
    	}
        return folder.supportsCapability(FolderCapabilities.CAN_ACCEPT_MOVED_MESSAGES) && folder.isProviderFolder();
