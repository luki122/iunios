...
public class ConversationSelectionSet implements Parcelable {
    ...
    //Aurora <SQF> <2014-11-04>  for NEW_UI begin
    ...
    public void removeAll(ArrayList<Conversation> conversations) {
        synchronized (mLock) {
            final boolean initiallyNotEmpty = !mInternalMap.isEmpty();
    ...
    public void putAll(ArrayList<Conversation> conversations) {
    ...
    //Aurora <SQF> <2014-11-04>  for NEW_UI end
