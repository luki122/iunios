...
import com.android.email.EmailDataCount;
import com.android.emailcommon.provider.EmailContent;
import com.android.mail.compose.ComposeActivity;
import com.android.mail.providers.Folder;
import com.android.mail.utils.StorageLowState;
import com.android.mail.utils.Utils;
import com.aurora.email.AuroraNotificationUtils;
...
public class MailActivity extends AbstractMailActivity implements ControllableActivity {
    ...
    private AuroraActionBarManager mAuroraActionBarManager;
    ...
    public void onBackPressed() {
        ...
        if (getAuroraActionBarManager().actionBarIsAnimating()) {
            return;
        }
        if (null != getAuroraActionBarManager() && getAuroraActionBarManager().onBackPressed()) {//paul modify
            return;
        }
    ...
    public void setListViewNeedsAnimation(boolean needs) {
        ...
        fragment.setListViewNeedsAnimation(needs);
    }

    public ConversationListFragment getConversationListFragment() {
        ConversationListFragment fragment = ((AbstractActivityController) mController).getConversationListFragment();
        return fragment;
    }
    ...
    public SwipeableListView getSwipeableListView() {
        ...
        return fragment.getSwipeableListView();
    }
    //Aurora <SQF> <2014-10-27>  for NEW_UI end

    //Aurora <SQF> <2014-12-15>  for NEW_UI begin
    public AuroraActionBarManager getAuroraActionBarManager() {
        return mAuroraActionBarManager;
    }
    ...
    public void onCreate(Bundle savedState) {
        ...
        //Aurora <SQF> <2014-12-15>  for NEW_UI begin
        mAuroraActionBarManager = new AuroraActionBarManager(this);
        //Aurora <SQF> <2014-12-15>  for NEW_UI end
        ...
        //Aurora <shihao> <2015-02-09> for data count begin
        try {
            EmailDataCount.updataData(this, EmailDataCount.AURORA_EMAIL_OPEN_ID, 1);

            int accountCount = EmailContent.count(this, com.android.emailcommon.provider.Account.CONTENT_URI);
            String uri = EmailDataCount.getAccountCountUri(this);
            int sbCount = EmailDataCount.queryAccountsCount(this, EmailDataCount.AURORA_EMAIL_ACCOUNT_ID, uri);
            if (accountCount != sbCount) {
                EmailDataCount.deleteData(this, uri);
                String uri2 = EmailDataCount.updataData(this, EmailDataCount.AURORA_EMAIL_ACCOUNT_ID, accountCount);
                EmailDataCount.editSharePreference(this, uri2);
            }
        } catch (IllegalArgumentException e) {
            Log.i("shihao", "MailActivity IllegalArgumentException");
        }
        //Aurora <shihao> <2015-02-09> for data count end
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        //Log.i("SQF_LOG", "MailActivity::onKeyDown");
        //Aurora <SQF> <2014-10-27>  for NEW_UI begin
        //AuroraActionBar consumed KEYCODE_BACK, so we need to call onBackPressed here.
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (getAuroraActionBarManager().getCurrentMode() == AuroraActionBarManager.Mode.DASH_BOARD_MODE
                    || getAuroraActionBarManager().getCurrentMode() == AuroraActionBarManager.Mode.DETAIL_MODE
                    || mViewMode.getMode() == ViewMode.SEARCH_RESULTS_CONVERSATION
                    || mViewMode.getMode() == ViewMode.SEARCH_RESULTS_LIST) {//paul add
                //Log.i("SQF_LOG", "MailActivity::onKeyDown: call onBackPressed");
                onBackPressed();
                return true;
            }
    ...
    protected void onStart() {
        super.onStart();
        mController.onStart();
        AuroraNotificationUtils.getInstance(this).setEntryState(true);//add by chenhl 
    }
    ...
    public void onStop() {
        super.onStop();
        mController.onStop();
        AuroraNotificationUtils.getInstance(this).setEntryState(false);//add by chenhl
        AuroraNotificationUtils.getInstance(this).showSendingNotification(this);//add by chenhl
    }
    ...
    protected void onDestroy() {
        ...
        //Aurora <SQF> <2014-10-27>  for NEW_UI begin
        //AuroraActionBarManager.releaseInstance();
        //Aurora <SQF> <2014-10-27>  for NEW_UI end
