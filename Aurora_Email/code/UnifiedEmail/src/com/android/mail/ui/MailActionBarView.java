...
import aurora.widget.AuroraSearchView.OnSuggestionListener;
...
public class MailActionBarView extends LinearLayout implements ViewMode.ModeChangeListener,
    ...
    //private AuroraSearchView mSearchWidget; paul del
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mSearch != null) {
            mSearchWidget = (AuroraSearchView) mSearch.getActionView();
