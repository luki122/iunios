    ...
    private void folderSort(final List<FolderRow> folderList) {
        ...
        for (final FolderRow folderRow : folderList) {
            ...
            // Special case the top level folders
			 //Aurora <shihao> 2014-11-19> for filter Parent_folder when move email to folders begin
/*            if (folderRow.mFolder.parent == null || folderRow.mFolder.parent.equals(Uri.EMPTY)) {
            ...
            root.addChild(node);
			 //Aurora <shihao> 2014-11-19> for filter Parent_folder when move email to folders end
        }
    ...
    // A copy from EmailProvider.getFolderDisplayName(...)
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        */
        //SQF MODIFIED TO:
        final String folderDisplay = getFolderDisplayName(folder.type, "");//SQF ADDED ON 2014.11.28
      	//Log.i("SQF_LOG", "!!!!!!!!!!!!!!! folderDisplay:" + folderDisplay + " row.mPathName:" + row.mPathName + " folder.name:" + folder.name);
        //Aurora <SQF> <2014-11-28>  for NEW_UI end
