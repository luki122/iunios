...
public class Folder implements Parcelable, Comparable<Folder> {
    ...
    public static void setIcon(Folder folder, ImageView iconView) {
        ...
        if (icon > 0) {
        	...
        	//Aurora <shihao> <2014-11-07> for new DrawLayout folder list Item icon begin
//            iconView.setVisibility(View.GONE);
            iconView.setImageResource(R.drawable.aurora_self_mailbox_icon2);
            iconView.setVisibility(View.VISIBLE);
            //Aurora <shihao> <2014-11-07> for new DrawLayout folder list Item icon begin
        }
    }
    ...
    //Aurora <shihao> <2014-11-11> for set Star_folder to second begin
    public boolean isStared(){
    	return isType(UIProvider.FolderType.STARRED);
    }
    //Aurora <shihao> <2014-11-11> for set Star_folder to second end
    /**
