...
public class Conversation implements Parcelable {
    ...
    public static boolean isFolderListform = true; //add by shihao 20150317
    /**
     * @see BaseColumns#_ID
     */
    public long id;
     ...
     */
    public int hasAttachments;//paul modify boolean
    /**
     ...
     */
    public FolderList rawFolders; //modify by shihao
    /**
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(hasAttachments);//paul modify
    ...
    private Conversation(Parcel in, ClassLoader loader) {
        ...
        hasAttachments = in.readInt();//paul modify
		...
		//Modify by shihao for backup to calendar 20150317
        if(isFolderListform)
	...
	public String toStrString() {
		return "Conversation [id=" + id + ", uri=" + uri + ", subject="
				+ subject + ", dateMs=" + dateMs + ", snippet=" + snippet
				+ ", hasAttachments=" + hasAttachments
				+ ", attachmentPreviewUri0=" + attachmentPreviewUri0
				+ ", attachmentPreviewUri1=" + attachmentPreviewUri1
				+ ", attachmentPreviewStates=" + attachmentPreviewStates
				+ ", attachmentPreviewsCount=" + attachmentPreviewsCount
				+ ", messageListUri=" + messageListUri + ", senders=" + senders
				+ ", numMessages=" + numMessages + ", numDrafts=" + numDrafts
				+ ", sendingState=" + sendingState + ", priority=" + priority
				+ ", read=" + read + ", seen=" + seen + ", starred=" + starred
				+ ", rawFolders=" + rawFolders + ", convFlags=" + convFlags
				+ ", personalLevel=" + personalLevel + ", spam=" + spam
				+ ", muted=" + muted + ", phishing=" + phishing + ", color="
				+ color + ", accountUri=" + accountUri + ", conversationInfo="
				+ conversationInfo + ", conversationBaseUri="
				+ conversationBaseUri + ", isRemote=" + isRemote + "]";
	}
    ...
    public Conversation(Cursor cursor) {
        if (cursor != null) {
            ...
            hasAttachments = cursor.getInt(UIProvider.CONVERSATION_HAS_ATTACHMENTS_COLUMN);//paul modify
			...
			/*
            MyLog.i("SQF_LOG", "readConversationInfo ---- conversationInfo.firstSnippet:" + conversationInfo.firstSnippet + 
            		" conversationInfo.firstUnreadSnippet:" + conversationInfo.firstUnreadSnippet +
            		" conversationInfo.lastSnippet:" + conversationInfo.lastSnippet);
            */
            ...
            if (conversationInfo == null) {
                ...
                MyLog.i("SQF_LOG", "111 Conversation::Conversation ---- snippet:" + snippet);
            ...
            //Aurora <SQF> <2014-12-23>  for NEW_UI begin    
            if(conversationInfo != null && ! TextUtils.isEmpty(conversationInfo.firstSnippet)) {
            	snippet = conversationInfo.firstSnippet;
            }
			//Aurora <SQF> <2014-12-23>  for NEW_UI end
    ...
    public static Conversation create(long id, Uri uri, String subject, long dateMs, String snippet,
            int hasAttachment/*paul modify boolean*/, Uri messageListUri, String senders,
    ...
    public String getSnippet() {
    	/*
    	if(conversationInfo != null && !TextUtils.isEmpty(conversationInfo.firstSnippet)) {
    		MyLog.i("SQF_LOG", "getSnippet::::::::::::::::::::::::::::1111" + conversationInfo.firstSnippet);
    	} else {
    		MyLog.i("SQF_LOG", "getSnippet::::::::::::::::::::::::::::2222" + snippet);
    	}
    	*/
    ...
    //Aurora <shihao> <2015-03-17> for back up Calendar begin
    public static Conversation fromBlob(byte[] blob) {
        if (blob == null) {
            return null;
        }
        ...
        p.setDataPosition(0);
        isFolderListform = false;
        final Conversation result = CREATOR.createFromParcel(p);
        p.recycle();
        return result;
    }
    ...
    //Aurora <shihao> <2015-03-17> for back up Calendar end
}
