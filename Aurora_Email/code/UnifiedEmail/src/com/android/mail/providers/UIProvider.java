...
public class UIProvider {
    ...
    public static final class CursorStatus {
        ...
        //Aurora <SQF> <2014-11-29>  for NEW_UI begin
        public static boolean isLoaded(int cursorStatus) {
        	return 0 != (cursorStatus & LOADED);
        }
        
        public static boolean errorOccurred(int cursorStatus) {
        	return 0 != (cursorStatus & ERROR);
        }
        
        public static boolean isCompleted(int cursorStatus) {
        	return 0 != (cursorStatus & COMPLETE);
        }
        //Aurora <SQF> <2014-11-29>  for NEW_UI end
    ...
    public static final String[] ATTACHMENT_PROJECTION = {
        ...
        AttachmentColumns.CONTENTID //add by chenhl
    };
    ...
    public static final class AttachmentColumns {
        ...
        public static final String CONTENTID = "mContentId";//add by chenhl
