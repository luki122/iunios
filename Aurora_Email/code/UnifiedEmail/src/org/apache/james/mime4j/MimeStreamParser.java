...
import java.io.ByteArrayOutputStream;//SQF TEST
...
public class MimeStreamParser {
	...
	//paul add start
    public void parse(InputStream is, String header) throws IOException {
        rootStream = new RootInputStream(is);
        parseMessage(rootStream, header);
    }
	//paul add end
     ...
     * @throws IOException on I/O errors.
     */
    private void parseEntity(InputStream is, String header) throws IOException {
        BodyDescriptor bd = parseHeader(is, header);
...
//                    }
    ...
    //SQF ADDED FOR TEST BEGIN
    
    public void writeIntoFile(InputStream inputStream) {
    	try {
	    	OutputStream  outputStream = new FileOutputStream("/mnt/sdcard/file-new.txt");
    ...
    private void parseMessage(InputStream is) throws IOException {
    	...
    	*/
    	MyLog.i("SQF_LOG", "MimeStreamParser::parseMessage ........................111111");
    	//MyLog.i2("SQF_LOG", "MimeStreamParser::parseMessage ........................" /*+ inputStream2String(is)*/);
        if (raw) {
        	//MyLog.i("SQF_LOG", "MimeStreamParser::parseMessage ........raw");
            handler.raw(new CloseShieldInputStream(is));
        } else {
        	//MyLog.i("SQF_LOG", "MimeStreamParser::parseMessage ........!raw");
            handler.startMessage();
            parseEntity(is, null);//paul modify
            handler.endMessage();
        }
    }
	//paul add start
    private void parseMessage(InputStream is, String header) throws IOException {
    	MyLog.i("SQF_LOG", "MimeStreamParser::parseMessage ........................222222");
        if (raw) {
            handler.raw(new CloseShieldInputStream(is));
        } else {
            handler.startMessage();
            parseEntity(is, header);
            handler.endMessage();
        }
    }
	//paul add end
     ...
     */
	 //paul modify
    private BodyDescriptor parseHeader(InputStream is, String header) throws IOException {
