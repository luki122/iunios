...
public class SMSDispatcherHook implements Hook {
    ...
    public void before_dispatch(MethodHookParam param) {
        ...
        if (param.args.length == 2) {
            ...
            mContext.sendOrderedBroadcast((Intent)param.args[0], (String)param.args[1], resultReceiver,
                    (SMSDispatcher)param.thisObject, -1, null, null);
        } else if (param.args.length == 3) {
            mContext.sendOrderedBroadcast((Intent)param.args[0], (String)param.args[1], (BroadcastReceiver)param.args[2],
                    (SMSDispatcher)param.thisObject, -1, null, null);
        }
    }
