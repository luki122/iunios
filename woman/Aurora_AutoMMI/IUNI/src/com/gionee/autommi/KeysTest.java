...
public class KeysTest extends BaseActivity {
	...
	private void preprocessKeys() {
	    ...
	    if(!SystemProperties.getBoolean("gn.autommi.keytest.camerea", false)){
            ...
            //Begin add by gary.gou for remove hall
            if(!SystemProperties.getBoolean("gn.autommi.keytest.hall", false)){
                Log.v("TAG","remove Test Item for hall");
	    	    removeTestItem("250");
                removeTestItem("251");
	    }
            //End add by gary.gou for remove hall
	}
