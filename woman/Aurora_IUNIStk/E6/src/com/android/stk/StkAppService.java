...
//                mStkService[slotId] + " For card : " + mUiccController.getUiccCard(slotId));
    ...
    private void handleCmd(CatCmdMessage cmdMsg) {
        ...
        case REFRESH:
            ...
            break;
        case LAUNCH_BROWSER:
            TextMessage mesg1 = mCurrentCmd.geTextMessage();
            if((mesg1 != null) && (mesg1.text == null || mesg1.text.length() == 0)) {
                mesg1.text = getResources().getString(R.string.default_browser_msg);
            }
