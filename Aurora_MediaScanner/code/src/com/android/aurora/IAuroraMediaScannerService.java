...
public static abstract class Stub extends android.os.Binder implements com.android.aurora.IAuroraMediaScannerService
{
private static final java.lang.String DESCRIPTOR = "com.android.aurora.IAuroraMediaScannerService";
...
/**
 * Cast an IBinder object into an com.android.aurora.IAuroraMediaScannerService interface,
 * generating a proxy if needed.
 */
public static com.android.aurora.IAuroraMediaScannerService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.android.aurora.IAuroraMediaScannerService))) {
return ((com.android.aurora.IAuroraMediaScannerService)iin);
}
return new com.android.aurora.IAuroraMediaScannerService.Stub.Proxy(obj);
}
...
com.android.aurora.IAuroraMediaScannerListener _arg2;
_arg2 = com.android.aurora.IAuroraMediaScannerListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.android.aurora.IAuroraMediaScannerService
{
...
/**
     ...
     */
@Override public void auroraRequestScanFile(java.lang.String path, java.lang.String mimeType, com.android.aurora.IAuroraMediaScannerListener listener) throws android.os.RemoteException
{
...
/**
     ...
     * If specified, the caller will be notified when scanning is complete via the listener.
     */
public void auroraRequestScanFile(java.lang.String path, java.lang.String mimeType, com.android.aurora.IAuroraMediaScannerListener listener) throws android.os.RemoteException;
/**
     * Older API, left in for backward compatibility.
     * Requests the media scanner to scan a file.
     * @param path the path to the file to be scanned.
