...
import com.aurora.featureoption.FeatureOption; //<shihao> <20150407> add for 5.0
...
public class PackageUtil {
    ...
    //Gionee qiuxd 201317 add for CR00765187 start
...
//            AmigoThemeManager themeManager =  new AmigoThemeManager(context);
//            String tmpStyle = themeManager.getAppThemeStyle(AmigoThemeManager.SETTINGS);
...
//        }
    ...
    //Gionee qiuxd 201317 add for CR00765187 end
    ...
    public static ApplicationInfo getApplicationInfo(File sourcePath) {
    	//<Aurora> <shihao> <20150407> add for 5.0 begin
...
//        return pkg.applicationInfo;
    	...
    	//<Aurora> <shihao> <20150407> add for 5.0 end
    }
...
//        return pkg;
     ...
     */
    public static View initSnippetForInstalledApp(AuroraActivity pContext,
     ...
     */
    public static View initSnippetForNewApp(AuroraActivity pContext, AppSnippet as,
            int snippetId) {
    ...
    public static boolean isPackageAlreadyInstalled(AuroraActivity context, String pkgName) {
