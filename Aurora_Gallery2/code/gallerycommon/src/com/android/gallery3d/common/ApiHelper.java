...
public class ApiHelper {
    ...
    //Aurora <SQF> <2014-08-01>  for NEW_UI begin
	...
	//Aurora <SQF> <2014-08-01>  for NEW_UI end
    ...
    public static interface VERSION_CODES {
        ...
        public static final int KITKAT = 19;//SQF ADDED ON 2014.7.31
    }
    ...
    public static final boolean HAS_VIEW_SYSTEM_UI_FLAG_LOW_PROFILE =
            hasField(View.class, "SYSTEM_UI_FLAG_LOW_PROFILE");
    ...
    public static final boolean HAS_SET_SYSTEM_UI_VISIBILITY = true; //SQF set to "true" ON 2014-07-15
