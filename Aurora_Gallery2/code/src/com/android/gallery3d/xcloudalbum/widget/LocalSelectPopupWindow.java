...
public class LocalSelectPopupWindow extends PopupWindow implements
		...
		if (mView != null) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent intent = new Intent(mContext, XCloudAutoUploadService.class);
	...
	public void baiduPhotoList(List<CommonFileInfo> list, boolean isDirPath,
		...
		// stopLoading();
		//paul add for BUG #15522
		ConcurrentHashMap<CommonFileInfo, List<CommonFileInfo>> hashMap = ((GalleryAppImpl)mContext.getApplicationContext()).getConcurrentHashMap();
		if(isDirPath){
			hashMap.clear();
			if(null == list) return;
			setInfos(list);
