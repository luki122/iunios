...
public class FakeTaskManager {
	...
	public void addUploadFakeBeans(FileTaskStatusBean bean) {
		...
		if(mFakeUploadBeans.containsKey(key) || bean.getStatusTaskCode()==FileTaskStatusBean.STATE_TASK_DONE) {	//wenyongzhe 2016.2.23
			return;
		}
	...
	public void addDownloadFakeBeans(FileTaskStatusBean bean) {
		String key = bean.getSource() + bean.getTarget();
		if(mFakeDownloadBeans.containsKey(key) || bean.getStatusTaskCode()==FileTaskStatusBean.STATE_TASK_DONE) {//wenyongzhe 2016.2.23
			return;
		}
