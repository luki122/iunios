...
public class LocalPopupWindowUtil {
	...
	*/
	...
	public void showSelectPopupWindow(String title, View rootView, OperationUtil util, ArrayList<MediaFileInfo> filePaths, final UploadToXCloudListener listener) {
		if (rootView == null) {
			return;
		}
//wenyongzhe 2016.1.30 modify start
		util.uploadToAlbumMedia(filePaths, null);
...
//			}
//		});
		//wenyongzhe 2016.1.30 modify end
	}
