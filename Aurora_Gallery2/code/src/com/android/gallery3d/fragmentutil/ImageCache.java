...
public class ImageCache {
    ...
    public BitmapDrawable getBitmapFromMemCache(String data) {
        ...
        if (MySelfBuildConfig.DEBUG && memValue != null) {
    ...
    protected Bitmap getBitmapFromReusableSet(BitmapFactory.Options options) {
        ...
        if (mReusableBitmaps != null && !mReusableBitmaps.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (null != item && item.isMutable()) {
                    ...
                    if (canUseForInBitmap(item, options)) {
                        ...
                        //iterator.remove();//Iuni <lory><2014-01-04> modify begin
                        deList.add(item);
                        break;
                    }
                } else {
            ...
            //mReusableBitmaps.retainAll(deList);
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
    	...
    	String cachePath = "";
    	try {
    		cachePath = Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())? getExternalCacheDir(context).getPath() :
