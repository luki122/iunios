...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        GalleryItem mItem = (GalleryItem)data;

        if (mImageCache != null) {
            value = mImageCache.getBitmapFromMemCache(String.valueOf(mItem.getUri()));
        }

        if (value != null) {
            // Bitmap found in memory cache
            imageView.setImageDrawable(value);
        } else if (cancelPotentialWork(mItem.getUri(), imageView)) {
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView);
            final AsyncDrawable asyncDrawable =
                    new AsyncDrawable(mResources, mLoadingBitmap, task);
            imageView.setImageDrawable(asyncDrawable);
            //Log.i(TAG, "zll ---- imageView.isHardwareAccelerated():"+imageView.isHardwareAccelerated());

            // NOTE: This uses a custom version of AsyncTask that has been pulled from the
            // framework and slightly modified. Refer to the docs at the top of the class
            // for more info on what was changed.
            task.executeOnExecutor(AsyncTask.DUAL_THREAD_EXECUTOR, mItem);
        }
    }
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, BitmapDrawable> {
        ...
        protected BitmapDrawable doInBackground(Object... params) {
            ...
            data = params[0];
            final String dataString = String.valueOf(((GalleryItem)data).getUri());
            Log.i(TAG, "zll --- dataString:"+dataString);
            Bitmap bitmap = null;
            BitmapDrawable drawable = null;
            
            final String keyString = dataString + Long.toString(((GalleryItem)data).getTime());
            ...
            if (mImageCache != null && !isCancelled() && getAttachedImageView() != null
            	...
            	bitmap = mImageCache.getBitmapFromDiskCache(keyString);
            }
            ...
            if (bitmap != null) {
                ...
                if (mImageCache != null) {
                	...
                	mImageCache.addBitmapToCache(keyString, drawable);
                }
            }
