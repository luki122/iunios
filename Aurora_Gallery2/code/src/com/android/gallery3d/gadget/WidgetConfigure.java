...
import com.android.gallery3d.fragmentapp.MyFragmentActivity;
...
public class WidgetConfigure extends Activity {
    ...
    private void setChoosenAlbum(Intent data) {
    	...
    	if (MySelfBuildConfig.USEFRAGMENTACTIVITY_FLAG) {
			...
			albumPath = data.getStringExtra(AlbumPicker.KEY_ALBUM_PATH);
		}
        WidgetDatabaseHelper helper = new WidgetDatabaseHelper(this);
        try {
    ...
    private void setWidgetType(Intent data) {
        ...
        if (widgetType == R.id.widget_type_album) {
        	//Iuni <lory><2014-01-13> modify begin
        	Intent intent;
        	if (MySelfBuildConfig.USEFRAGMENTACTIVITY_FLAG) {
        		intent = new Intent(this, MyFragmentActivity.class);
			} else {
				intent = new Intent(this, AlbumPicker.class);
			}
        	//Iuni <lory><2014-01-13> modify end
        	...
        	Intent request;
        	if (MySelfBuildConfig.USEFRAGMENTACTIVITY_FLAG) {
        		request = new Intent(this, MyFragmentActivity.class)
        		.setAction(Intent.ACTION_GET_CONTENT)
                .setType("image/*");
			} else {
				request = new Intent(this, DialogPicker.class)
                .setAction(Intent.ACTION_GET_CONTENT)
                .setType("image/*");
			}
        	//Iuni <lory><2014-01-13> modify end
