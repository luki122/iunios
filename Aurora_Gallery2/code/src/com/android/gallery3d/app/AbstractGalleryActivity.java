...
public class AbstractGalleryActivity extends AuroraActivity implements GalleryContext, IOperationComplete {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.i(TAG, "zll ---AbstractGalleryActivity onCreate");
...
//    }
    ...
    protected void onResume() {
        ...
        //Log.i("SQF_LOG", "AbstractGalleryActivity::onResume mIsActive:" + mIsActive);
        mGLRootView.lockRenderThread();
        try {
    ...
    protected void onPause() {
        ...
        //Log.i("SQF_LOG", "AbstractGalleryActivity::onPause mIsActive:" + mIsActive);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		//Log.i(TAG, "zll ----AbstractGalleryActivity onBackPressed 1");
    	if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
    		...
    		root.lockRenderThread();
	        try {
	        	//Log.i(TAG, "zll ----AbstractGalleryActivity onBackPressed 2");
		...
		//Log.i(TAG, "zll ----AbstractGalleryActivity onBackPressed 3");
	...
	public void renameComplete(boolean success) {
    	//Log.i("SQF_LOG", "AbstractGalleryActivity::renameComplete --> success:" + success);
	}

    @Override
	public void delComplete(boolean success) {
    	//Log.i("SQF_LOG", "AbstractGalleryActivity::delComplete --> success:" + success);
	}
	
    @Override
	public void moveOrCopyComplete(boolean success,boolean isMove,int errorCode) {
    	//Log.i("SQF_LOG", "AbstractGalleryActivity::moveOrCopyComplete --> success:" + success);
	}
	
    @Override
	public void createAlbumComplete(boolean success) {
    	//Log.i("SQF_LOG", "AbstractGalleryActivity::createAlbumComplete --> success:" + success);
	}
