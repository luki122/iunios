...
public class SinglePhotoDataAdapter extends TileImageViewAdapter
    ...
    public SinglePhotoDataAdapter(
        ...
        mHandler = new SynchronizedHandler(activity.getGLRoot()) {
            ...
            public void handleMessage(Message message) {
                ...
                if (mHasFullImage) {
					// Aurora <paul> <2014-01-11> added for gallery begin
					if(LOADING_FAIL == mLoadingState && null == message.obj){
						mPhotoView.notifyImageChange(0);
						return;
					}
					// Aurora <paul> <2014-01-11> added for gallery end
    ...
    private FutureListener<BitmapRegionDecoder> mLargeListener =
        ...
        public void onFutureDone(Future<BitmapRegionDecoder> future) {
            ...
            if (decoder == null){
				...
				mHandler.sendMessage(mHandler.obtainMessage(MSG_UPDATE_IMAGE,null));
				// Aurora <paul> <2014-01-11> added for gallery end
				return;
            }
    ...
    private void onDecodeThumbComplete(Future<Bitmap> future) {
        try {
            ...
            if (backup == null) {
                mLoadingState = LOADING_FAIL;
				mPhotoView.notifyImageChange(0);//paul add for BUG #15773 <2015-08-31>
                return;
            } else {
