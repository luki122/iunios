...
// Aurora <paul> <2014-03-13> for bug3195
...
// Aurora <paul> <2014-03-13> for bug3195 end
    ...
    @Override
    public void onPause() {
        clearScreenOnFlag();// Aurora <paul> <2014-03-13> for bug3195
        super.onPause();
        mIsActive = false;
        mModel.pause();
    ...
    public void onResume() {
        setScreenOnFlag();// Aurora <paul> <2014-03-13> for bug3195
        super.onResume();
        mIsActive = true;
        mModel.resume();
