...
class Paper {
    ...
    private static final int ROTATE_FACTOR = 6;//Iuni <lory><2014-02-20> modify 4->3
    ...
    public float[] getTransform(Rect rect, float scrollX) {
        ...
        float screenX = rect.centerY() - scrollX;
        ...
        //Log.i(TAG, "zll ---- eeee degrees:"+degrees+",t:"+t+",range:"+range+",left:"+left+",right:"+right+",scrollX:"+scrollX);
