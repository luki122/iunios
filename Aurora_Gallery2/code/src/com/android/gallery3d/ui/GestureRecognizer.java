...
public class GestureRecognizer {
	...
	//Aurora <paul> <2014-04-08> start
	private boolean mNeedCancelEvent = true;
    public boolean isSpecDown() {
        return mDownUpDetector.isSpecDown();
    }
	//Aurora <paul> <2014-04-08> end
    ...
    private class MyGestureListener
        ...
        public boolean onScroll(
			...
			if(isSpecDown()) return true;//Aurora <paul> <2014-04-08>
