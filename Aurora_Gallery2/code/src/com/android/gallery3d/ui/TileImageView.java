...
public class TileImageView extends GLView {
	...
	//Aurora <paul> <2015-09-29> add for BUG #16618 start	
	private Object mObjLock = new Object();
	//Aurora <paul> <2015-09-29> add for BUG #16618 end
    ...
    public void setScreenNail(ScreenNail s) {
		//Aurora <paul> <2015-09-29> modify for BUG #16618 start
		synchronized (mObjLock) {
			mScreenNail = s;
		}
		//mScreenNail = s;
		//Aurora <paul> <2015-09-29> modify for BUG #16618 end
    }
    
    //Aurora <SQF> <2014-04-10>  for NEW_UI begin
    public boolean hasValidSceenNailTexture() {
    ...
    public void notifyModelInvalidated() {
        invalidateTiles();
        if (mModel == null) {
			synchronized (mObjLock) {//Aurora <paul> <2015-09-29> add for BUG #16618 start
	            mScreenNail = null;
	            mImageWidth = 0;
	            mImageHeight = 0;
	            mLevelCount = 0;
    ...
    private void layoutTiles(int centerX, int centerY, float scale, int rotation) {
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < n; i++) {
				...
				if(null == tile) continue;//Aurora <paul> <2014-05-15> for MTTF
    ...
    private boolean isScreenNailAnimating() {
    	//Aurora <SQF> <2014-04-22>  for monkey test NullPointerException begin
    	if(null == mScreenNail) return false;
    	//Aurora <SQF> <2014-04-22>  for monkey test NullPointerException end
    ...
    private void uploadBackgroundTiles(GLCanvas canvas) {
        ...
        for (int i = 0; i < n; i++) {
            Tile tile = mActiveTiles.valueAt(i);
            if (null != tile && !tile.isContentValid()) queueForDecode(tile);//Aurora <paul> <2014-05-04> for MTTF if (!tile.isContentValid())
        }
    }
        ...
        public boolean onGLIdle(GLCanvas canvas, boolean renderRequested) {
            ...
            while (quota > 0) {
                ...
                if (!tile.isContentValid()) {
					// Aurora <paul> <2014-02-12> modified for gallery begin
					...
					// Aurora <paul> <2014-02-12> modified for gallery end
                    --quota;
                }
            }
