...
abstract class CanvasTexture extends UploadedTexture {
    ...
    protected Bitmap onGetBitmap() {
		Bitmap bitmap = null;
		try{
			bitmap = Bitmap.createBitmap(mWidth, mHeight, mConfig);

		}catch(OutOfMemoryError err){
			Log.e("CanvasTexture", "OutOfMemoryError onGetBitmap");
			return null;
		}
	...
	//Aurora <paul> <2014-10-11> for_gif start
    @Override
    protected void refreshBitmap(Bitmap bitmap) {
        onDraw(mCanvas, bitmap);
    }
	//Aurora <paul> <2014-10-11> for_gif end
