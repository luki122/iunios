 ...
 */
// Aurora liugj 2014-03-03 modified for wallpaper crop
public class CropView extends GLView {
    ...
    private static final float OUTLINE_WIDTH = 4f;
	 // Aurora liugj 2014-02-14 created for wallpaper crop end

    private static final int SIZE_UNKNOWN = -1;
    private static final int TOUCH_TOLERANCE = 30;

	 // Aurora liugj 2014-04-11 modified for 裁剪框最小值调整至合适大小 start
    private static final float MIN_SELECTION_LENGTH = 64f;
	 // Aurora liugj 2014-04-11 modified for 裁剪框最小值调整至合适大小 end
    ...
    private static final int MOVE_BLOCK = 16;
	 ...
	 // Aurora liugj 2014-02-14 created for wallpaper crop start
    private static final float MAX_SELECTION_RATIO = 1.0f;
    private static final float MIN_SELECTION_RATIO = 0.4f;
	 // Aurora liugj 2014-04-11 modified for 初始默认框充满 start
	 // Aurora liugj 2014-05-08 modified for reset initRecF start
    private static final float SELECTION_RATIO = 0.8f;
	 // Aurora liugj 2014-05-08 modified for reset initRecF end
	 // Aurora liugj 2014-04-11 modified for 初始默认框充满 end
	 // Aurora liugj 2014-02-14 created for wallpaper crop end
    ...
    //private int mWallpaperType = WALLPAPER_TYPE_PORT;
    // Aurora liugj 2014-02-14 created for wallpaper crop end
    ...
    private boolean mIsWallpaper = false;
	 ...
	 // Aurora liugj 2014-02-14 created for wallpaper crop start
    public CropView(AbstractGalleryActivity activity, boolean isWallpaper) {
        mActivity = activity;
