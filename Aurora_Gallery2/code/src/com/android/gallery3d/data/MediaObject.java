...
public abstract class MediaObject {
	...
	public static final int SUPPORT_TUYA = 1 << 17;
    ...
    public Uri getContentUri() {
        ...
        //Log.i(TAG, "zll Class " + className + "should implement getContentUri.");
        //Log.i(TAG, "zll The object was created from path: " + getPath());
        throw new UnsupportedOperationException();
    }
