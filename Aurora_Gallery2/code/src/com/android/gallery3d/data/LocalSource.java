    ...
    public MediaObject createMediaObject(Path path) {
        ...
        switch (mMatcher.match(path)) {
			...
			case LOCAL_MERGEIMAGE_ALBUM:
				return new AuroraLocalAlbum(path, app, mMatcher.getIntVar(0), true);
			case LOCAL_MERGEVIDEO_ALBUM:
				return new AuroraLocalAlbum(path, app, mMatcher.getIntVar(0), false);
            ...
            case LOCAL_IMAGE_ITEM:
            	MyLog.i2("SQF_LOG", "Local_Image_Item : path" + path);
