...
public abstract class MediaSet extends MediaObject {
    ...
    /* paul del for BUG #21339<2016-03-16>
    ...
    */
    ...
    //Aurora <SQF> <2014-07-22>  for NEW_UI begin
    /* paul del for BUG #21339<2016-03-16>
    public int getIndexOfItemEx(Path path, int hint) {
        // hint < 0 is handled below
        // first, try to find it around the hint
        Log.d("ggg_test","getIndexOfItemEx path:" + path + " hint:" + hint);
        int start = Math.max(0,
                hint - MEDIAITEM_BATCH_FETCH_COUNT / 2);
        
        ArrayList<MediaItem> list = null;
        //Log.i("SQF_LOG", "this instanceof LocalMergeAlbum ----> " + (this instanceof LocalMergeAlbum) + " this.class-->" + this.getClass().getName());
        list = getMediaItem(start, MEDIAITEM_BATCH_FETCH_COUNT, path);
