...
public class UriImage extends MediaItem {
	...
	private String mPath = null;//paul add for BUG #15339
    ...
    public UriImage(GalleryApp application, Path path, Uri uri, String contentType) {
		...
		//paul add for BUG #15339 end
    }

	//paul add for BUG #15339 start
	private void queryDownloadPath(){
		
		if(!"image/gif".equalsIgnoreCase(mContentType) || 
			!mUri.toString().startsWith("content://downloads/")){
			return;
		}
		Log.d(TAG,"queryDownloadPath");
		Cursor cursor = null;
		 try {
    ...
    private class RegionDecoderJob implements Job<BitmapRegionDecoder> {
        ...
        public BitmapRegionDecoder run(JobContext jc) {
            ...
            //Aurora <SQF> <2014-04-14>  for NEW_UI begin
            mState = STATE_INIT;
            //Aurora <SQF> <2014-04-14>  for NEW_UI end
            return decoder;
        }
    }
