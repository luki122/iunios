...
public class LocalAlbumSet extends MediaSet
	...
	// Aurora <zhanggp> <2013-12-23> added for gallery begin
    public static final Path PATH_MERGE_IMAGE = Path.fromString("/local/mergeimage");
    public static final Path PATH_MERGE_VIDEO = Path.fromString("/local/mergevideo");
    public static final Path PATH_MERGE_IMAGE_FAV = Path.fromString("/local/favmergeimage");
    public static final Path PATH_MERGE_VIDEO_FAV = Path.fromString("/local/favmergevideo");
	// Aurora <zhanggp> <2013-12-23> added for gallery end
