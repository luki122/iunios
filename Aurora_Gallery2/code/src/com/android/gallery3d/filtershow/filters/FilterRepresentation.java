...
public class FilterRepresentation {
    ...
    private int mPressedOverlayId = 0;
    ...
    public static final byte TYPE_AURORA_EFFECTS = 8;
	...
	public void beforeApply(){}//paul add
    ...
    //Aurora <SQF> <2014-6-4>  for NEW_UI begin
    public int getPressedOverlayId() {
        return mPressedOverlayId;
    }

    public void setPressedOverlayId(int overlayId) {
    	mPressedOverlayId = overlayId;
    }
    //Aurora <SQF> <2014-6-4>  for NEW_UI end
