...
public class FilterCropRepresentation extends FilterRepresentation {
	...
	//paul add
    public static void findNormalizedCrop(RectF crop, float bitmapWidth, float bitmapHeight) {
        crop.left /= bitmapWidth;
        crop.top /= bitmapHeight;
        crop.right /= bitmapWidth;
        crop.bottom /= bitmapHeight;
    ...
    public boolean isNil() {
		//paul modify   return mCrop.equals(sNilRect);
        return mCrop.equals(sNilRect) || mCrop.width() <= 0 || mCrop.height() <= 0;
