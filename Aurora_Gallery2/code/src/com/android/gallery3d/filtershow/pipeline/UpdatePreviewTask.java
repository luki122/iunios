...
public class UpdatePreviewTask extends ProcessingTask {
    ...
    public Result doInBackground(Request message) {
        ...
        if ( (buffer != null) && (renderingPreset != null) &&
            ...
            MasterImage.getImage().setPreviewUpdateFinish(true);
            //Aurora <SQF> <2014-07-26>  for NEW_UI end
        }
		MasterImage.getImage().setUpdating(false);//paul add
		MasterImage.getImage().setShowing(false);//paul add
        return null;
    }
