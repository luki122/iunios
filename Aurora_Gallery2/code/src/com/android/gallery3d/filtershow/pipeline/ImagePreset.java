...
public class ImagePreset {
    ...
    public void removeAuroraEffectFilter() {
		for (int i = 0; i < mFilters.size(); i++) {
			if (mFilters.elementAt(i).getFilterType() == FilterRepresentation.TYPE_AURORA_EFFECTS) {
				mFilters.remove(i);
				break;
			}
		}
    ...
    public void removeAuroraEffectFilter(FilterRepresentation filterRepresentation) {
    	if (filterRepresentation.getFilterType() == FilterRepresentation.TYPE_AURORA_EFFECTS) {
            for (int i = 0; i < mFilters.size(); i++) {
    ...
    public void removeFilter(FilterRepresentation filterRepresentation) {
    	//MyLog.i2("SQF_LOG", "ImagePreset::removeFilter filterRepresentation.serializationName:" + filterRepresentation.getSerializationName());
    ...
    public void addFilter(FilterRepresentation representation) {
        if (representation instanceof FilterUserPresetRepresentation) {
        	//Log.i("SQF_LOG", "ImagePreset::addFilter -->  representation instanceof FilterUserPresetRepresentation");
        	...
        	//Log.i("SQF_LOG", "ImagePreset::addFilter -->  representation.getFilterType() == FilterRepresentation.TYPE_GEOMETRY");
            for (int i = 0; i < mFilters.size(); i++) {
        	...
        	//Log.i("SQF_LOG", "ImagePreset::addFilter -->  representation.getFilterType() == FilterRepresentation.TYPE_BORDER");
        	...
        	//Log.i("SQF_LOG", "ImagePreset::addFilter -->  representation.getFilterType() == FilterRepresentation.TYPE_FX");
    ...
    //Aurora <SQF> <2014-09-16>  for NEW_UI begin
    public FilterRepresentation getAuroraEffectRepresentation() {
    	for (int i = 0; i < mFilters.size(); i++) {
            FilterRepresentation representation = mFilters.elementAt(i);
            if (representation.getFilterType() == FilterRepresentation.TYPE_AURORA_EFFECTS) {
                return representation;
            }
        }
    	return null;
    ...
    public FilterRepresentation getAuroraEffectRepresentation(FilterRepresentation filterRepresentation) {
    	if(filterRepresentation.getFilterType() != FilterRepresentation.TYPE_AURORA_EFFECTS) return null;
        for (int i = 0; i < mFilters.size(); i++) {
            FilterRepresentation representation = mFilters.elementAt(i);
            if (representation.getFilterType() == filterRepresentation.getFilterType()) {
                return representation;
            }
        }
        return null;
