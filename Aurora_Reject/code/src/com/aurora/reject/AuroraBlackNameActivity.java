	...
	private Handler handler=new Handler(){
		public void handleMessage(android.os.Message msg) {
			if(msg.arg1==0){
				isShowing=true;
				showDialog();
				System.out.println("isShowing=true");
			}else{
				System.out.println("isShowing=false");
				touch=false;
				blackBatch=false;
				startQuery();
	...
	private OnAuroraActionBarItemClickListener auroActionBarItemClickListener = new OnAuroraActionBarItemClickListener() {
		public void onAuroraActionBarItemClicked(int itemId) {
			...
			case ACTION_BTN_ADD:
				...
				AuroraBlackNameActivity.this.showAuroraMenu();
				break;
			default:
				break;
			}
			...
			if(cursor!=null){
				if(!cursor.moveToFirst()){
					...
					do{
						...
						System.out.println("numberE164="+numberE164);
						list.add(number);
