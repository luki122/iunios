...
//                + " END) AS " + DialerSearch.SEARCH_PHONE_NUMBER + ","
    ...
    private static void createDialerSearchTempTable(SQLiteDatabase db, String contactsSelect, String rawContactsSelect, String calllogSelect, boolean isByName) {
        if (ContactsProviderUtils.isSearchDbSupport()) {
            ...
            String dsViewSelect = " SELECT "
                ...
                + "," + dsDataViewName + ".is_privacy as is_privacy"
                + ", " + dsDataViewName + ".auto_record as auto_record"
                 + ", " + dsDataViewName + ".in_visible_group as in_visible_group"
                  + ", " + dsDataViewName + ".mimetype_id as mimetype_id"
                + ", " + dsDataViewName + "." + Contacts.INDEX_IN_SIM + " as " + Contacts.INDEX_IN_SIM

                + " FROM (SELECT * FROM " + Tables.DIALER_SEARCH
                //aurora modify by liguangyu for 16825 
                        + " WHERE " + DialerSearchLookupColumns.NAME_TYPE + " = " + (isByName ? DialerSearchLookupType.NAME_EXACT : DialerSearchLookupType.PHONE_EXACT)
    ...
    */
    ...
    public Cursor handleDialerSearchQueryEx(SQLiteDatabase db, Uri uri, String selection, boolean isByName) {
        ...
        LogUtils.d(TAG, "handleDialerSearchQueryEx, selection:" + selection);
        ...
        try {
            ...
            createDialerSearchTempTable(db, contactsSelect, rawContactsSelect, calllogSelect, isByName);
            ...
            cursor = db.rawQuery("SELECT " 
                  ...
                  + offsetsSelectedTable + " WHERE name_type=" + DialerSearchLookupType.PHONE_EXACT + ") )"  + " AND " + selection
        ...
        if (cursor == null) {
        	...
        	LogUtils.d(TAG, "DialerSearch Cusor is not null, count: " + cursor.getCount());
        }
