...
public class CallLogProviderEx {
    ...
    public static final HashMap<String, String> sCallsJoinDataViewProjectionMap;
    static {
        ...
        sCallsJoinDataViewProjectionMap.put("simid", "simid");
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            ...
            Cursor allCallLogCursorOfSameNum = db.query(Tables.CALLS,
                    ...
                    + " OR PHONE_NUMBERS_EQUAL(" + Calls.NUMBER + ", '" + strInsNumber + "')",
            ...
            */
            ...
            if (ContactsProvidersApplication.sIsGnSyncSupport) {
            	ContactsDatabaseHelper.writeGnVersion(mContext, values);            	
            }
