...
public class CallLogProvider extends ContentProvider {
    ...
    static {
        ...
        sURIMatcher.addURI(CallLog.AUTHORITY, "gncallsjoindataview", GN_CALLS_JION_DATA_VIEW);
        sURIMatcher.addURI(CallLog.AUTHORITY, "calls/aurora_search_filter/*", AURORA_DIALER_CALLLOG_SEARCH);
    }
...
//        sCallsProjectionMap.put("call_notification_type", "call_notification_type");
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        final SelectionBuilder selectionBuilder = new SelectionBuilder(auroraSelection);
        checkVoicemailPermissionAndAddRestriction(uri, selectionBuilder, true /*isQuery*/);
        
        /// M: @{
        final SQLiteDatabase db = mDbHelper.getReadableDatabase();
        LogUtils.d(TAG,"uri == " + uri + "    match == " +match);
        /// @}
        switch (match) {
            case CALLS:
                break;
...
//                qb.setProjectionMap(sCallsJoinDataViewProjectionMap);
        ...
        final SQLiteDatabase db = mDbHelper.getReadableDatabase();
         */
        Cursor c = qb.query(db, projection, selectionBuilder.build(), selectionArgs, groupBy,
  ...
  //Gionee:huangzy 20120906 add for CR00688166 start
	...
	public static final String GN_CALLS_COUNT_BY_NUMBER_IDS = "calls_count_ids";
  	...
  	private Cursor combineCalllogMatchNumber(Cursor src) {
  		...
  		int numberIndex = src.getColumnIndex(CallLogProviderEx.sCallsJoinDataViewProjectionMap.get(Calls.NUMBER));
