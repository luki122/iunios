...
public class NextDayPreViewAdapter extends PagerAdapter{
	...
	public NextDayPreViewAdapter(Context context, ArrayList<NextDayPictureInfo> list, ProgressBar progressBar) {
		...
		mContext = context;
		mImageLoaderHelper = ((AuroraChangeApp) mContext.getApplicationContext()).getImageLoaderHelper();
...
//				pictureInfo.setPictureOriginalUrl(pictureInfoDb.getPictureOriginalUrl());
    	...
    	boolean isMobileData = ((AuroraChangeApp) mContext.getApplicationContext()).getIsMobileData();
    	if (CommonUtil.NetWorkType.MOBILE_ONLY == CommonUtil.getNetWorkType(mContext) && !isMobileData) {
			...
			String width = String.valueOf(((AuroraChangeApp) mContext.getApplicationContext()).getDisplayWidth());
	    	String height = String.valueOf(((AuroraChangeApp) mContext.getApplicationContext()).getDisplayHeight());
