...
//    private int mBaseSystemUiVisibility = SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | SYSTEM_UI_FLAG_LAYOUT_STABLE;
    ...
    private void init(Context context) {
        ...
        mFloatDrawable = context.getResources().getDrawable(R.drawable.preview_lockpaper);

        /*mDefaultCropWidth = context.getResources().getDisplayMetrics().widthPixels;
        mDefaultCropHeight = context.getResources().getDisplayMetrics().heightPixels;
        Log.d(TAG, "mDefaultCropWidth=" + mDefaultCropWidth + ",mDefaultCropHeight=" + mDefaultCropHeight);*/
    }
...
//            mDrawableFloat.set(floatLeft, floatTop, floatLeft + floatWidth, floatTop + floatHeight);
    ...
    private void checkBounds() {
        ...
        if (mDrawableDst.left > mDrawableFloat.left) {
            newLeft = getRight() - mDrawableDst.width();
            isChange = true;
        }

        if (mDrawableDst.top > getBottom()) {
            newTop = getBottom() - mDrawableDst.height();
            isChange = true;
        }
