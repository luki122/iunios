...
public class TelephonyUtilsEx {
    ...
    public static boolean isCDMAPhone(Phone phone) {
        ...
        Log.d(TAG, "isCDMAPhone = " + (phoneType == PhoneConstants.PHONE_TYPE_CDMA));
        CardType cardType = UiccController.getInstance().getCardType();
        boolean isCTCard = cardType.isOPO9Card();
        Log.d(TAG, "isCDMAPhone cardType = " + cardType.toString() + " isCTCard = " + isCTCard);
        ...
        if (phoneType == PhoneConstants.PHONE_TYPE_CDMA) {
            ...
            return (isCTCard && SvlteModeController.getActiveSvlteModeSlotId() == slotId)
                    ? !isSvlteRoaming(phone) : false;
        }
    }
