...
//	            phone.setDataRoamingEnabled(false);
        	...
        	PhoneAccountHandle accountHandle = AuroraPhoneUtils.getPhoneAccountById(this, String.valueOf(SubscriptionManager.from(this).getSubIdUsingPhoneId(0)));
            telecomManager.setUserSelectedOutgoingPhoneAccount(accountHandle);
   	    }
