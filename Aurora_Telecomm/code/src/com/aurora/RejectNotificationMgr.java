...
public class RejectNotificationMgr {
    ...
    /** The singleton RejectNotificationMgr instance. */
     ...
     * @see init()
     */
    protected RejectNotificationMgr(Context context) {
        mContext = context;
        mNotificationManager = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        sp = mContext.getSharedPreferences("AddBlackTimeList", Context.MODE_PRIVATE); 
    }

    static RejectNotificationMgr init(Context context) {
        synchronized (RejectNotificationMgr.class) {
            if (sInstance == null) {
                sInstance = new RejectNotificationMgr(context);
            } else {
    ...
    static final int BLACK_NOTIFICATION_BASE = 17000;
    static final int BLACK_LIST_NOTIFICATION_BASE = 3;
...
//         PendingIntent inCallPendingIntent =  PendingIntent.getActivity(mContext, 0, AuroraGlobals.createAddBlackIntent(number, name), 0);
...
//         Notification notification = builder.getNotification();
    ...
    static final int HANGUP_BLACK_CALL_NOTIFICATION = BLACK_NOTIFICATION_BASE + BLACK_LIST_NOTIFICATION_BASE + 100;
