    ...
    static ContentResolver getCurrentProfileContentResolver(Context context) {
        ...
        if (myUser != currentUser) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "Can't find self package", e);
                ...
                if (cw == null) {
                    ...
                    switch (cw.event) {
                    	...
                    	case EVENT_AURORA_UPDATE:
                    		mCallerInfo.auroraUpdate(mContext);
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            if(cw.event == EVENT_AURORA_UPDATE) {
                ...
                if (cw.event == EVENT_EMERGENCY_NUMBER) {
                    ...
                    mCallerInfo = new AuroraCallerInfo().markAsEmergency(mContext);
                    /// M: CC006: CallerInfo for CDMA ECC number @{
                    ...
                    mCallerInfo = new AuroraCallerInfo().markAsVoiceMail(cw.subId);
                } else {
                    ...
                    mCallerInfo = AuroraCallerInfo.getCallerInfo(mContext, mQueryUri, cursor, cw.subId);
                    /// @}
...
//                                AuroraCallerInfo.getCurrentCountryIso(mContext));
                        mCallerInfo.phoneNumber = cw.number;
                    }
