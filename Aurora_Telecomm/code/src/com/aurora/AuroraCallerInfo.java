...
public class AuroraCallerInfo {
    ...
    /// M: CC001: CallerInfo OP Plugin @{
    public static AuroraCallerInfo getCallerInfo(Context context, Uri contactRef, Cursor cursor, int subId) {
    //// @}
                ...
                if(AuroraPrivacyUtils.isSupportPrivate()) {
	        		...
	        		if(info.mPrivateId > 0) {
	        			...
	        			if (info.mPrivateId != currentPrivateId) {
	        	        	...
	        	        	info.name = AuroraGlobals.getInstance().getString(R.string.private_unknown_contact);
	        			} 
	        		} 
                } else {
    ...
    public static AuroraCallerInfo getCallerInfo(Context context, Uri contactRef) {
        ...
        return getCallerInfo(context, contactRef,
                AuroraCallerInfoAsyncQuery.getCurrentProfileContentResolver(context)
                        .query(contactRef, null, null, null, PRIVATE_SQL_ORDER));
    }
     ...
     * with all relevant fields empty or null.
     */
    public static AuroraCallerInfo getCallerInfo(Context context, String number, int subId) {
        ...
        if (PhoneNumberUtils.isEmergencyNumberExt(number, phoneType)) {
        	AuroraCallerInfo info = new AuroraCallerInfo().markAsEmergency(context);
        ...
        /// @}
            ...
            return new AuroraCallerInfo().markAsVoiceMail(subId);
            /// @}
        }
    ...
    // should be displayed.
    /* package */ AuroraCallerInfo markAsEmergency(Context context) {
    ...
    /* package */ AuroraCallerInfo markAsVoiceMail() {
    ...
    /* package */ AuroraCallerInfo markAsVoiceMail(int subId) {
        mIsVoiceMail = true;
