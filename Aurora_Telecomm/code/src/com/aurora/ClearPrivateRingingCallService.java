...
public class ClearPrivateRingingCallService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        mApp = AuroraGlobals.getInstance();
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        if (ACTION_CLEAR_HANGUP_PRIVATE_RINGING_CALLS.equals(intent.getAction())) {
        	Log.i(this, "ACTION_CLEAR_HANGUP_PRIVATE_RINGING_CALLS");
        	...
        	Log.i(this, "ACTION_CLEAR_MISSED_CALLS");
            // Clear the list of new missed calls.
        	Log.i(this, "ACTION_CLEAR_MISSED_CALLS update database");
