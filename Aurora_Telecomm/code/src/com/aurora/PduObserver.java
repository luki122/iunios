...
public class PduObserver extends ContentObserver {
    ...
    {
       super(new Handler()); 
       mSharedPreferences = AuroraGlobals.getInstance().getSharedPreferences("mms_observer", Context.MODE_PRIVATE);
    }
    ...
    public void onChange(boolean selfChange){
       ...
       if(!RejectUtils.isSupportBlack()) {
        ...
        Cursor cursor = AuroraGlobals.getInstance().getContentResolver().query(Mms.CONTENT_URI, PROJECTION, " reject in ('0', '1')", null, Mms.DEFAULT_SORT_ORDER + " limit 0,1");
        try {
