...
//	}
    ...
    public static void getNoteInternal(String number) {  	
		if(RejectUtils.isSupportBlack()) {
	    	String result = getUserMarkInternal(AuroraGlobals.getInstance(), number);
	    	if(TextUtils.isEmpty(result)) {
	    		result = getInstance().getMarkContentInternal(AuroraGlobals.getInstance(), number);	  
	    	}
	    	if(TextUtils.isEmpty(result)) {
	    		getMarkContentFromCalllogInternal(AuroraGlobals.getInstance(), number);
	    	}
		}		
    }
