...
class MissedCallNotifier extends CallsManagerListenerBase {
    ...
    void clearMissedCalls() {
        ...
        clearPrivateMissedCallNotification();
    }
    ...
    void showMissedCallNotification(Call call) {
	    ...
	    if(AuroraPrivacyUtils.auroranotifyPrivateMissedCall(call)) {	    	
	    	return;
	    }
    ...
    private void cancelMissedCallNotification() {
        ...
        if(AuroraPrivacyUtils.isSupportPrivate()) {
        	AuroraGlobals.getInstance().mManagePrivate.notificationMgr.cancelPrivateMissedCallNotification();
        }
    }
    ...
    private void clearPrivateMissedCallNotification() {
      	Intent clearIntent = new Intent(mContext, ClearPrivateRingingCallService.class);
