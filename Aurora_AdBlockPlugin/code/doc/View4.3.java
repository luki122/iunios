...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    public View(Context context) {
        ...
        // Aurora <huangbin> <2014-06-23> added for adblock begin
        AuroraAdBlockHost.getInstance(getContext()).auroraHideAdView(getContext(),this);
        // Aurora <huangbin> <2014-06-23> added for adblock end
    }
    ...
    */
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
		...
		Log.e("liuwei","View  dispatchTouchEvent");
    ...
    public boolean onTouchEvent(MotionEvent event) {
		...
		Log.e("liuwei","View  onTouchEvent");
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		Log.e("View" , "AccessibilityManager.getInstance(mContext).isEnabled() = " + AccessibilityManager.getInstance(mContext).isEnabled());
        if (AccessibilityManager.getInstance(mContext).isEnabled()) {
   ...
   /**
    ...
    protected boolean overScrollBy(int deltaX, int deltaY,
		...
		Log.e("View" , "left = " + left);
		Log.e("View" , "right = " + right);
		Log.e("View" , "top = " + top);
		Log.e("View" , "bottom = " + bottom);
		Log.e("View" , "maxOverScrollY = " + maxOverScrollY);
		Log.e("View" , "scrollRangeY = " + scrollRangeY);
		...
		Log.e("View" , "clampedX = " + clampedX);
		Log.e("View" , "clampedY = " + clampedY);
