	...
	public boolean onPreferenceChange(AuroraPreference pref, Object value) {
		...
		if (pref.getKey().equals(WIFI_AUTO_UPGRADE_KEY)) {
			if (!mWifiAutoUpgradePref.isChecked() && changed) {
				...
				builder.setTitle(R.string.wifi_auto_upgrade_dialog_title);
				builder.setMessage(getString(R.string.wifi_auto_upgrade_dialog_message));
				builder.setPositiveButton(getString(R.string.wifi_auto_open),
