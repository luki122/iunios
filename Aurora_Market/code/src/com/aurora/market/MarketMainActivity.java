	...
	private void initActionBar() {
		...
		if (mCustomActionBar != null) {
			...
			mCustomActionBar.findViewById(com.aurora.R.id.aurora_custom_action_bar_search_view_icon)
				.setBackgroundResource(R.drawable.actionbar_main_right_ripple);
			...
			searchBtn.setPadding(DensityUtil.dip2px(this, 16), searchBtn.getPaddingTop(), DensityUtil.dip2px(this, 16), searchBtn.getPaddingBottom());
			searchBtn.setImageResource(com.aurora.R.drawable.aurora_action_bar_search_svg);
