...
public class AlarmClockFragment extends Fragment implements
	...
	private class AlarmTimeAdapter extends CursorAdapter {
		...
		public View newView(Context context, Cursor cursor, ViewGroup parent) {
	        ...
	        //view.setBackgroundColor(R.drawable.aurora_item_choose);
...
//					//android.util.Log.d("cjslog", "onclick");
//					
//					Intent intent = new Intent(mActivity, AuroraSetAlarm.class);
//					intent.putExtra(Alarms.ALARM_INTENT_EXTRA, alarm);
//					intent.putExtra("position", c1.getPosition());
...
//			});
            ...
            if (null != mSelectionManager) { // In selection mode!
                ...
                indicator.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                    	...
                    	if ( !mAlarmsList.auroraIsRubbishOut() ) {
                    		alarmEnabled[alarm.id] = !alarm.enabled;
                    		clockOnOff.setSoundEffectsEnabled(false);  //cjs add 
	...
	private void auroraJudgeIfDeleteAlarm( final int position ) {
        ...
        new AuroraAlertDialog.Builder(mActivity, AuroraAlertDialog.THEME_AMIGO_FULLSCREEN)
                ...
                .setTitle(getString(R.string.suretodeletealarm))
...
//        }
	...
	private void updateLayout() {
		...
		//android.util.Log.d("cjslog", "mAlarmsList.setOnItemClickListener");
		mAlarmsList.auroraEnableSelector(false);      //cjs add  
		mAlarmsList.setSelector(R.drawable.aurora_listview_selector);
		//mAlarmsList.auroraSetUseNewSelectorLogical(false);
...
//				mAlarmsList.setVisibility(View.INVISIBLE);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		//android.util.Log.d("cjslog" , "onItemClick " + position);
		// TODO Auto-generated method stub
        final Cursor c = (Cursor) mAlarmsList.getAdapter().getItem(position);
        final Alarm alarm = new Alarm(c);
        Intent intent = new Intent(mActivity, AuroraSetAlarm.class);
