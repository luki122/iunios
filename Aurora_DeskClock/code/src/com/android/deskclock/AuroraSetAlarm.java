...
public class AuroraSetAlarm extends AuroraActivity{
	...
	private void initViews( ) {
		...
		Bitmap background = Blur.getBackgroundPic(this, "Default-Wallpaper.png");
		aurorasetalarmback.setBackgroundDrawable(new BitmapDrawable(background));
...
//		}
        ...
        if ( Alarms.get24HourMode(this) ) {
        	...
        	auroraTimePicker.setWidgetGapWidth(45f);
        	//auroraTimePicker.setWidgetWidth(250f);
		}
...
//		        finish();
    ...
    private void judgeIfGiveUpSaveTheAlarm( ) {
        ...
        if (!isModify()) {
            ...
            .setTitle(getString(R.string.ifgiveupchange))
    ...
    private void deleteAlarm() {
        ...
        new AuroraAlertDialog.Builder(this, AuroraAlertDialog.THEME_AMIGO_FULLSCREEN)
                  /*.setTitle(getString(R.string.android_delete_alarm))*/
                   .setTitle(getString(R.string.isDelete_the_alarm))
                   //android jiating 20120608 change dialog info begin
                  .setPositiveButton(R.string.delete_alarm_title,
