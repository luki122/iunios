...
//        if(SystemProperties.get("ro.gn.mtk.poweroff.alarm.prop","no").equals("yes")){
//        	am.set(POWER_OFF_WAKE_UP, atTimeInMillis, sender);
//        }else{
//        	android.util.Log.e("333333", "--enableAlert--am.set---");
//        	am.set(AlarmManager.RTC_WAKEUP, atTimeInMillis, sender);
//        }
        //msm8974
//       String platform =SystemProperties.get("ro.board.platform","msm");
       android.util.Log.e("jadon", "型号："+android.os.Build.MODEL);
       int type=AlarmManager.RTC_WAKEUP;
       if(android.os.Build.MODEL.equals("U3")) //只有U3支持关机闹铃
       {
    	   type=RTC_POWEROFF_WAKEUP;
       }else{
    	   type=AlarmManager.RTC_WAKEUP;
       }
       am.set(type, atTimeInMillis, sender); 
//		if (VERSION.SDK_INT > 18 && platform.startsWith("msm89")&&isSupport()) {
//			android.util.Log.e("xxj", "--enableAlert--am.set---");
//			try {
//				am.set(RTC_POWEROFF_WAKEUP, atTimeInMillis, sender);
//			} catch (Exception e) {
//				
//			}
//		}
