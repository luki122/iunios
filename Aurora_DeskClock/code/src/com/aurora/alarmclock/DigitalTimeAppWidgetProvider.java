...
public class DigitalTimeAppWidgetProvider extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		...
		//Log.d("cjslog", "DigitalTimeAppWidgetProvider onReceive " + intent.getAction());
		...
		if (action.equals(AppWidgetManager.ACTION_APPWIDGET_UPDATE)) {
			...
			boolean timewidgetexsist = sharedPreferences.getBoolean("timewidgetexsist", false);
			if (timewidgetexsist) {
				context.startService(new Intent(context, DigitalTimeService.class));
			}
			//Log.d("cjslog", "timewidgetexsist " + timewidgetexsist);
		}
	...
	public void onEnabled(Context context) {
		context.sendBroadcast(new Intent("com.android.deskclock.TIMEWIDGETENABLE"));
		Intent intent = new Intent(context, DigitalTimeService.class);
	...
	public void onDisabled(Context context) {
		context.sendBroadcast(new Intent("com.android.deskclock.TIMEWIDGETDISABLED"));
		...
		//Log.d("cjslog", "onDisable111111");
		//Log.d("cjslog", intent.getAction());
