...
public static abstract class Stub extends android.os.Binder implements com.aurora.mediascanner.IAuroraMediaScannerListener
{
private static final java.lang.String DESCRIPTOR = "com.aurora.mediascanner.IAuroraMediaScannerListener";
...
/**
 * Cast an IBinder object into an com.aurora.mediascanner.IAuroraMediaScannerListener interface,
 * generating a proxy if needed.
 */
public static com.aurora.mediascanner.IAuroraMediaScannerListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.aurora.mediascanner.IAuroraMediaScannerListener))) {
return ((com.aurora.mediascanner.IAuroraMediaScannerListener)iin);
}
return new com.aurora.mediascanner.IAuroraMediaScannerListener.Stub.Proxy(obj);
}
...
private static class Proxy implements com.aurora.mediascanner.IAuroraMediaScannerListener
{
