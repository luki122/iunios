...
public class HttpRequstData {
	...
	public static String getURLStr(String http_url, String http_name, String http_action) {
			...
			if (stutas == 200) {
				...
				if (length == leng) {
					for (int i = 0; i < builder.length(); i++) {
						Log.i(TAG, "the return str = " + builder.charAt(i));
					}
	...
	public static String getFromHttp(String url) throws ClientProtocolException, IOException {
		StringBuilder builder = new StringBuilder();
