...
public class SystemUtils {
	...
	public static boolean isOpenGLVersionSupport(Context context)
	{
		ActivityManager am =(ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
		
		ConfigurationInfo info = am.getDeviceConfigurationInfo();
		
		return !(info.reqGlEsVersion<=OPEN_GL_VERSION_2);
	}
	...
	*/ 
    ...
    public static boolean copyAssetsToFilesystem(Context context, String assetsSrc, String desPath) {
        final String des = desPath + "/" + assetsSrc;
    ...
    public static String getLikeStr(String src) {
        String des = "%";
    ...
    public static String getLikeStrF(String src) {
        String des = "";
