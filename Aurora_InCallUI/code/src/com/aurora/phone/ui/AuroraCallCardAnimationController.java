...
public class AuroraCallCardAnimationController {
    ...
    AuroraCallCardAnimationController(InCallActivity a) {
    	mInCallActivity = a;
    }
    
	
	void setView(View v) {
		Log.v(LOG_TAG, "setView v = " + v);
		mIsInit = false;
		mCallCard = v;
		if(mCallCard != null && mInCallActivity != null) {
			GetSomeViewAndAnim();
		}
	...
	private void GetSomeViewAndAnim() {
        ...
        mPrimaryCallCardContainer = mCallCard.findViewById(R.id.primary_call_info_container);
		createSomeDimenForAnim(mInCallActivity);

		mPrimaryCallInfo = (ViewGroup) mCallCard
				.findViewById(R.id.primary_call_info);

		mCallStateLabel = (TextView) mCallCard
				.findViewById(R.id.callStateLabel);
	    ...
	    guang1_anim=android.view.animation.AnimationUtils.loadAnimation(mInCallActivity, R.anim.scale1);
	    guang11_anim=android.view.animation.AnimationUtils.loadAnimation(mInCallActivity, R.anim.scale11);
	    guang2_anim=android.view.animation.AnimationUtils.loadAnimation(mInCallActivity, R.anim.scale2);
	    guang3_anim=android.view.animation.AnimationUtils.loadAnimation(mInCallActivity, R.anim.scale3);
	    guang4_anim=android.view.animation.AnimationUtils.loadAnimation(mInCallActivity, R.anim.scale4);
	...
	private void ringToSmsFinal() {
		...
		ta.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_510);
...
//				guangquan.layout(mElapsedTime.getLeft(), top - photo_move_distance, mElapsedTime.getRight(), top - photo_move_distance + mElapsedTime.getHeight());
				...
				aa.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
				...
				aa.setAnimationListener(new AuroraAnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						ra.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_3000);
				...
				mInCallActivity.getCallCardFragment().setPrimaryImage(null);
...
//				namenote.setVisibility(View.VISIBLE);
	...
	private void hangupRingingCallAlmostFinal() {
		...
		ta.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
		ta.setInterpolator(new DecelerateInterpolator());
		AlphaAnimation aa = new AlphaAnimation(1, 0);
		aa.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
		aa.setInterpolator(new DecelerateInterpolator());
		...
		as.setAnimationListener(new AuroraAnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				mCallStateLabel.setText(mInCallActivity.getString(R.string.card_title_hanging_up));
	...
	private void hangupRingingCallFinal() {
		...
		ta.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		ta.setInterpolator(new DecelerateInterpolator());
		AlphaAnimation aa = new AlphaAnimation(0, 1);
		aa.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		aa.setInterpolator(new DecelerateInterpolator());
		AnimationSet as = new AnimationSet(false);
		...
		as.setAnimationListener(new AuroraAnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				mInCallActivity.getAnswerFragment().getPresenter().onDecline();
			}
		});
	...
	private void showCallCardBecauseHideDialpad() {
		...
		ta.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_410);
		ta.setInterpolator(new DecelerateInterpolator());
		ta.setAnimationListener(new AuroraAnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				if (fgCall != null && fgCall.getState() == Call.State.ACTIVE
					...
					// rota.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_3000);
	...
	private void startGuangQuanAnimation() {
		...
		if(!GlowPadView.mIsUseNewUI && state == InCallState.INCOMING) {
	    	 return;
	    }
		...
		}, AuroraAnimationConstant.ANIMATION_DURATION_400);
		animHandler.postDelayed(new Runnable() {
		...
		}, AuroraAnimationConstant.ANIMATION_DURATION_800);
	...
	void OnShoworHideCallCard(boolean is_show) {
		...
		if (mPrimaryCallInfo.getVisibility() == View.VISIBLE) {
			if (is_show) {
				...
				ta_hide.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_400);
				ta_hide.setInterpolator(new DecelerateInterpolator());
				AlphaAnimation aa_hide = new AlphaAnimation(1, 0);
				aa_hide.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_400);
			...
			mPrimaryCallCardContainer.setVisibility(is_show ? View.VISIBLE : View.GONE);
		}
	...
	void RingToSms() {
		...
		ta.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_400);
		sa.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_400);
		ta.setFillAfter(true);
		...
		ta3.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_510);
		...
		oa.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_400);
		oa.start();

		// aurora add zhouxiaobing 20140208 start
		mInCallActivity.getBackgroundView().startDisplayAnim();
	...
	private void ManDongzuoToStartAnimation() {
		...
		if (mSloganNote.getVisibility() == View.VISIBLE) {
			...
			mSloganRejectToTopAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_540);
	...
	private void createIncallCardViewAnimation() {
		Log.v(LOG_TAG, "createIncallCardViewAnimation, mIsInit = " + mIsInit);
		if(mIsInit) {
			return;
		}
...
//				|| numbery_incoming < 100) {
		...
		mPhotoRotationYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoRotationXAnimator = ObjectAnimator.ofFloat(mPhoto, "rotationX", 0f, rotateAngleX);
		mPhotoRotationXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);		
		mPhotoScaleXAnimator = ObjectAnimator.ofFloat(mPhoto, "scaleX", 1f, photeScale);
		mPhotoScaleXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoScaleYAnimator = ObjectAnimator.ofFloat(mPhoto, "scaleY", 1f, photeScale);
		mPhotoScaleYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoToTopAnimator = ObjectAnimator.ofFloat(mPhoto, "Y", top, top - photo_move_distance / 2);
		mPhotoToTopAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		
		mPhotoVRotationYAnimator = ObjectAnimator.ofFloat(mPhotoV, "rotationY", 0f, rotateAngle);
		mPhotoVRotationYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoVRotationXAnimator = ObjectAnimator.ofFloat(mPhotoV, "rotationX", 0f, rotateAngleX);
		mPhotoVRotationXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoVScaleXAnimator = ObjectAnimator.ofFloat(mPhotoV, "scaleX", 1f, photeScale);
		mPhotoVScaleXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoVScaleYAnimator = ObjectAnimator.ofFloat(mPhotoV, "scaleY", 1f, photeScale);
		mPhotoVScaleYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		...
		mPhotoVToTopAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);		


		mPhotoCircleRotationYAnimator = ObjectAnimator.ofFloat(guangquan, "rotationY", 0f, rotateAngle);
		mPhotoCircleRotationYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoCircleRotationXAnimator = ObjectAnimator.ofFloat(guangquan, "rotationX", 0f, rotateAngleX);
		mPhotoCircleRotationXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);		
		mPhotoCircleScaleXAnimator = ObjectAnimator.ofFloat(guangquan, "scaleX", 1f, photeScale);
		mPhotoCircleScaleXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoCircleScaleYAnimator = ObjectAnimator.ofFloat(guangquan, "scaleY", 1f, photeScale);
		mPhotoCircleScaleYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mPhotoCircleToTopAnimator = ObjectAnimator.ofFloat(guangquan, "Y", top, top - photo_move_distance / 2);
		mPhotoCircleToTopAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);

		mElapsedTimeRotationYAnimator = ObjectAnimator.ofFloat(mElapsedTime, "rotationY", 270f, 360f);
		mElapsedTimeRotationYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_220);
		mElapsedTimeRotationXAnimator = ObjectAnimator.ofFloat(mElapsedTime, "rotationX", 30f, 0f);
		mElapsedTimeRotationXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_220);
		mElapsedTimeScaleXAnimator = ObjectAnimator.ofFloat(mElapsedTime, "scaleX", 0.79f, 1f);
		mElapsedTimeScaleXAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mElapsedTimeScaleYAnimator = ObjectAnimator.ofFloat(mElapsedTime, "scaleY", 0.79f, 1f);
		mElapsedTimeScaleYAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_300);
		mElapsedTimeToTopAnimator = ObjectAnimator.ofFloat(mElapsedTime, "Y", top - photo_move_distance / 2, top - photo_move_distance);
		mElapsedTimeToTopAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_220);
		...
		int TextToTopDuration = GlowPadView.mIsUseNewUI ? AuroraAnimationConstant.ANIMATION_DURATION_540 : AuroraAnimationConstant.ANIMATION_DURATION_300;
		...
		float sogouTop = mInCallActivity.getResources().getDimension(R.dimen.aurora_sogou_top);
		...
		mNameTextSizeToSmallAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);

		mEclipstimeBgAlphaToShowAnimator = ObjectAnimator.ofFloat(meclipstimebg, "Alpha", 0, 1);
		mEclipstimeBgAlphaToShowAnimator.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
...
//		mRingingAnimsV22 = new HashSet<ObjectAnimator>(mRingingAnims);
	...
	void startRejectRingingCallAnimation() {
		...
		va1.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
		va1.setInterpolator(new DecelerateInterpolator());
		AlphaAnimation va2 = new AlphaAnimation(1, 0);
		va2.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
		...
		va3.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
		va3.setInterpolator(new DecelerateInterpolator());
		AlphaAnimation va4 = new AlphaAnimation(1, 0);
		va4.setDuration(AuroraAnimationConstant.ANIMATION_DURATION_500);
	...
	void ResetCallCardAnimation() {
		...
		animHandler.postDelayed(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				if (mPrimaryCallCardContainer.getVisibility() != View.VISIBLE)
					mPrimaryCallCardContainer.setVisibility(View.VISIBLE);
			}
		...
		mInCallActivity.getBackgroundView().is_anim_start = false;
...
//		fllp2.gravity = Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL;
		...
		int nameColor = mInCallActivity.getResources().getColor(R.color.aurora_name_text_color);
...
//		mCallCard.setDefaultPhoto(R.drawable.photo_default);
	...
	void updateForegroundCall(Call fgCall, Call bgCall) {
		...
		if ((Call.State.isDialing(fgCall.getState())) && (bgCall == null)) {
			photo_container.setVisibility(View.VISIBLE);
			namenote.setVisibility(View.VISIBLE);
			labelAndNumber.setVisibility(View.VISIBLE);
			mCallStateLabel.setTextSize(12);
	...
	void updateRingingCall(Call ringingCall) {
		Log.v(LOG_TAG, "updateRingingCall"); 
		// aurora add zhouxiaobing 20140102 start
		// if(ringingCall.getState()==Call.State.INCOMING||ringingCall.getState()==Call.State.WAITING)
		if (ringingCall.getState() == Call.State.INCOMING || ringingCall.getState() == Call.State.CALL_WAITING) {
			setDisconnectCannotAnim(false);
			mInCallActivity.getCallButtonFragment().setVisible(false);
	...
	boolean isAnimationingInRinging() {
		return isRingingToInCallStart() || isRejectToEndStart()
				|| isRejectToSmsStart() || mInCallActivity.getBackgroundView().is_anim_start;
	}
