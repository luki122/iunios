 ...
 */
public class AuroraCallButtonPresenter extends Presenter<AuroraCallButtonPresenter.CallButtonUi>
    ...
    public AuroraCallButtonPresenter() {
    }
    ...
    public void onStateChange(InCallState oldState, InCallState newState, CallList callList) {
        ...
        AuroraCallMonitor.getInstance().mManageRecord.handleRecordProc();
    }
    ...
    public void onDetailsChanged(Call call, android.telecom.Call.Details details) {
        ...
        getUi().setVisible(call.getState() != Call.State.CALL_WAITING 
        		&& call.getState() != Call.State.INCOMING 
        		&& !getUi().isManageConferenceVisible());
    }
...
//        TelecomAdapter.getInstance().swap(mCall.getId());
        Call mSecondary = CallList.getInstance().getBackgroundCall();
        if(mSecondary != null) {
    ...
    private void updateUi(InCallState state, Call call) {
        ...
        Log.d(this, "Updating call UI for call state: ", state);
        ...
        ui.setVisible(call.getState() != Call.State.CALL_WAITING 
        		&& call.getState() != Call.State.INCOMING 
        		&& call.getState() != Call.State.DISCONNECTED
        		&& !ui.isManageConferenceVisible());
    }
    ...
    private void updateVoiceCallButtons(Call call) {
        ...
        Log.v(this, "Show add call ", call.can(android.telecom.Call.Details.CAPABILITY_ADD_CALL));
        ...
        final boolean showMergeOption = call.can(android.telecom.Call.Details.CAPABILITY_MERGE_CONFERENCE);
        final boolean showAddCallOption = canAdd;

        // Show either HOLD or SWAP, but not both. If neither HOLD or SWAP is available:
        //     (1) If the device normally can hold, show HOLD in a disabled state.
        //     (2) If the device doesn't have the concept of hold/swap, remove the button.
//        final boolean showSwapOption = call.can(android.telecom.Call.Details.CAPABILITY_SWAP_CONFERENCE);
        final boolean showSwapOption = !canAdd && call.getState() == Call.State.ACTIVE ;
        ...
        ui.enableHold(enableHoldOption || call.getState() == Call.State.ONHOLD);
        ui.showSwapButton(showSwapOption);
        
        ui.updateRecordBtnState();
