...
//        if (PhoneApp.ISGNPHONE) {
            mContacts = intent.getStringExtra("contacts");
...
//            if (PhoneApp.ISGNPHONE) {
                mPhoneRecorder.stopRecord(mMount, mContacts);
//            } else {
...
//            }
    ...
    public void onStart(Intent intent, int startId) {
        ...
        if (null != mPhoneRecorder) {
            // Gionee fangbin 20121114 added for CR00728364 start
//            if (PhoneApp.ISGNPHONE) {
                mPhoneRecorder.startRecord(mName, mNumber);
//                return;
//            }
//            // Gionee fangbin 20121114 added for CR00728364 end
...
//                mPhoneRecorder.startRecord();
        ...
        public void stopRecord(boolean isMounted) {
            ...
            if (null != mPhoneRecorder) {
                // Gionee fangbin 20121114 modified for CR00728364 start
//                if (PhoneApp.ISGNPHONE) {
                    mPhoneRecorder.stopRecord(isMounted, mContacts);
//                } else {
