...
public final class Call {
    ...
    /**
     * This function used to translate mState to String to show for VoLTE conference.
     * @return
     */
    public String getTranslatedStatus() {
        //TODO:use string to show and translate it.
        String statusToShow = "";
        switch (mState) {
            case State.ACTIVE:
                statusToShow = "Online";
            ...
            case State.REDIALING:
                statusToShow = "Dialing";
                break;

            case State.DISCONNECTING:
                statusToShow = "DISCONNECTING";
                break;

            case State.DISCONNECTED:
                statusToShow = "DISCONNECTED";
                break;

            default:
                Log.d(this, "getTranslatedStatus()... un-expected state : " + mState);
                statusToShow = "Online";
                break;
        }
        return statusToShow;
