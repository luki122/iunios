...
public class ContactInfoCache implements ContactsAsyncHelper.OnImageLoadCompleteListener {
    ...
    public static void populateCacheEntry(Context context, CallerInfo info, ContactCacheEntry cce,
        ...
        cce.mRawContactId = info.mRawContactId;
        cce.mPrivateId = info.mPrivateId;
        cce.mPrivateNotiType = info.mPrivateNotiType;
        cce.mArea = info.mArea;
        cce.mNote = info.mNote;
        cce.mMark = info.mMark;
        cce.mMarkNumber = info.mMarkNumber;
        
        if(info.isCachedPhotoCurrent) {
    ...
    public Drawable getDefaultContactPhotoDrawable() {
        if (mDefaultContactPhotoDrawable == null) {
            mDefaultContactPhotoDrawable =
                    mContext.getResources().getDrawable(R.drawable.photo_default_outgoing);
        }
