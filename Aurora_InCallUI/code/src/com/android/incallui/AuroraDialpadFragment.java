 ...
 */
public class AuroraDialpadFragment extends BaseFragment<AuroraDialpadPresenter, AuroraDialpadPresenter.DialpadUi>
        implements AuroraDialpadPresenter.DialpadUi, View.OnTouchListener, View.OnKeyListener,
    ...
    @Override
    AuroraDialpadPresenter createPresenter() {
        return new AuroraDialpadPresenter();
    }

    @Override
    AuroraDialpadPresenter.DialpadUi getUi() {
        return this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	mDialerView = inflater.inflate(
                com.android.incallui.R.layout.aurora_dtmf_twelve_key_dialer_view, container, false);
    	mContainer = container;
        mDtmfDialerField = (EditText) mDialerView.findViewById(R.id.digits);
        if (mDtmfDialerField != null) {
            ...
            configureKeypadListeners(mDialerView);
        }
    ...
    private void animateShow() {
		...
		if (activity != null && !activity.mCallCardAnimationController.getCanStartAnim()) {
			is_open_dial = false;
...
//				mDialerView.setVisibility(View.VISIBLE);
	...
	public void ResetAnimator() {
		if (is_dialer_anim_start) {
			is_dialer_anim_start = false;
			Animation anim = mDialerView.getAnimation();
			if (anim != null)
				anim.cancel();
			mDialerView.clearAnimation();
		}
