    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case OP_BOOT_COMPLETED:
    			...
    			try {
    				Class<?> sPolicy = null;
    				sPolicy = Class.forName("com.android.internal.telephony.cat.AppInterface");
    				Method method = sPolicy.getMethod("onStkAppReady");
                    if (mStkService[mCurrentSlotId] != null) {
                    	method.invoke(mStkService[mCurrentSlotId]);
