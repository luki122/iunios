...
//        setContentView(R.layout.stk_menu_list);
    ...
    private void startTimeOut() {
        if (mState == STATE_SECONDARY) {
            // Reset timeout.
            cancelTimeOut();
            //aurora delete liguangyu 20140331 for bug 3727 start
//            mTimeoutHandler.sendMessageDelayed(mTimeoutHandler
//                    .obtainMessage(MSG_ID_TIMEOUT), StkApp.UI_TIMEOUT);
            //aurora delete liguangyu 20140331 for bug 3727 end
        }
    }
...
//    	finish();
//    	overridePendingTransition(R.anim.left_to_right2, R.anim.left_to_right);
//    }
}
