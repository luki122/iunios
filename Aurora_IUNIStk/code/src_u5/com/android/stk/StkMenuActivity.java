 ...
 *
 */
public class StkMenuActivity extends AuroraListActivity {
    ...
    private final BroadcastReceiver mIRStateChangeReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if ((SvlteRatController.INTENT_ACTION_START_SWITCH_SVLTE_RAT_MODE.
                    equals(intent.getAction())) ||
                (SvlteRatController.INTENT_ACTION_FINISH_SWITCH_SVLTE_RAT_MODE.
                        equals(intent.getAction()))) {
    ...
    setAuroraContentView(R.layout.stk_menu_list, AuroraActionBar.Type.Empty);
        ...
        if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()) {
            ...
            if (PhoneConstants.SIM_ID_1 == mSlotId) { //CSIM can only be inserted in SLOT 1.
                mIRStateChangeFilter.addAction(SvlteRatController.
                        INTENT_ACTION_START_SWITCH_SVLTE_RAT_MODE);
                mIRStateChangeFilter.addAction(SvlteRatController.
                        INTENT_ACTION_FINISH_SWITCH_SVLTE_RAT_MODE);
    ...
    private void displayMenu(ImageView iconView, TextView textView, AuroraListActivity list) {
