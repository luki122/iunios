...
//                    mToast.setGravity(Gravity.BOTTOM, 0, 0);
                ...
                if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()) {
                    ...
                    if ((cardType.contains("RUIM") || cardType.contains("CSIM"))
                            && getRoamingState() != RoamingMode.ROAMING_MODE_NORMAL_ROAMING) {
...
//        toast.setGravity(Gravity.TOP, 0, 0);
    ...
    */
    ...
    private RoamingMode getRoamingState() {
        SvlteRatController sInstance = null;
        try {
            sInstance = SvlteRatController.getInstance();
        } catch (RuntimeException rex) {
            CatLog.d(this, "fail to get SvlteRatController instance: RuntimeException");
            sInstance = null;
        } catch (Exception ex) {
            CatLog.d(this, "fail to get SvlteRatController instance: Exception");
            sInstance = null;
        }
        if (null != sInstance) {
