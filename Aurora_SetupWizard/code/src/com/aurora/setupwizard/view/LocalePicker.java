...
package com.aurora.setupwizard.view;
...
public class LocalePicker extends LinearLayout {
    ...
    private static final int DEFAULT_LAYOUT_RESOURCE_ID =
    		com.aurora.setupwizard.R.layout.locale_picker;
    ...
    public LocalePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        SELECTOR_WHEEL_ITEM_COUNT = context.getResources().getInteger(com.aurora.setupwizard.R.integer.local_picker_items);
        SELECTOR_MIDDLE_ITEM_INDEX = context.getResources().getInteger(com.aurora.setupwizard.R.integer.local_picker_items)/2;
        ...
        mSelectionDivider = context.getDrawable(com.aurora.setupwizard.R.drawable.divider);
...
//                R.styleable.NumberPicker_virtualButtonPressedDrawable);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSelectionDivider != null) {
            ...
            mSelectionDivider.setBounds(150, topOfTopDivider, mRight-150, bottomOfTopDivider);
            mSelectionDivider.draw(canvas);

            // draw the bottom divider
            int bottomOfBottomDivider = mBottomSelectionDividerBottom;
            int topOfBottomDivider = bottomOfBottomDivider - mSelectionDividerHeight;
            mSelectionDivider.setBounds(150, topOfBottomDivider, mRight-150, bottomOfBottomDivider);
            mSelectionDivider.draw(canvas);
        }
    }
