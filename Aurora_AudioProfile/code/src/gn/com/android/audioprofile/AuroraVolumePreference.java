    ...
    // penggangding add end
	    ...
	    public class SeekBarVolumizerEx implements OnSeekBarChangeListener, Runnable {
	        ...
	        private void initSeekBar(SeekBar seekBar, Uri defaultUri) {
	        	...
	        	Log.i(TAG, "initSeekBar  RingMode  =  "  + mAudioManager.getRingerMode());
	       ...
	       /* public void revertVolume() {
	        ...
	        public void onStopTrackingTouch(SeekBar seekBar) {
	        	...
	        	/*if(mLastProgress == mLastProgress &&mLastProgress == 0){
	        		return;
	        	}*/
        ...
        // penggangding add end
	        public void run() {
	        	...
	        	Log.i(TAG, "run   original mode ="+mAudioManager.getRingerMode());
	        	//解决设置音量为零的时候，设置成震动的bug
	        	/*if((mAudioManager.getRingerMode() == AudioManager.RINGER_MODE_SILENT || mAudioManager.getRingerMode() == AudioManager.RINGER_MODE_NORMAL) && mLastProgress == 0){
	        		return;
	        	}*/
	            mAudioManager.setStreamVolume(mStreamType, mLastProgress, 0);	   
	            Log.i(TAG, "run   after set streamRingVolume  mode ="+mAudioManager.getRingerMode());
