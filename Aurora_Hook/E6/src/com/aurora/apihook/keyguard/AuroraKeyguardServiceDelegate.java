...
public class AuroraKeyguardServiceDelegate {
    ...
    public static final String KEYGUARD_PACKAGE = "com.aurora.lockscreen";
    public static final String KEYGUARD_CLASS = "com.aurora.apihook.keyguard.AuroraKeyguardService";

    private static final String TAG = "KeyguardServiceDelegate";
    private static final boolean DEBUG = true;
    protected AuroraKeyguardServiceWrapper mKeyguardService;
    ...
    public AuroraKeyguardServiceDelegate(Context context, LockPatternUtils lockPatternUtils) {
        Intent intent = new Intent();
        intent.setClassName(KEYGUARD_PACKAGE, KEYGUARD_CLASS);
        //mScrim = createScrim(context);
        boolean res = false;
        if (Build.VERSION.SDK_INT >= 18) {
			res = context.bindServiceAsUser(intent, mKeyguardConnection,
	                Context.BIND_AUTO_CREATE, UserHandle.OWNER);
		} else {
			res = context.bindService(intent, mKeyguardConnection, Context.BIND_AUTO_CREATE);
		}
        if (!res) {
        ...
        Log.d("KeyguardHook", TAG+"---KeyguardServiceDelegate..."+System.currentTimeMillis());
    }
    ...
    private final ServiceConnection mKeyguardConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mKeyguardService = new AuroraKeyguardServiceWrapper(
            ...
            Log.d("KeyguardHook", TAG+"---mKeyguardConnection..."+System.currentTimeMillis());
        }
    ...
    public void onScreenTurnedOn(final ShowListener showListener) {
        if (mKeyguardService != null) {
            ...
            Log.w(TAG, "onScreenTurnedOn(): no keyguard service!");
	...
	public void auroraWakeWhenReady(int keyCode) {
		if (mKeyguardService != null) {
			mKeyguardService.auroraWakeWhenReady(keyCode);
		}
		mKeyguardState.wakeWhenReady = true;
	}
