 ...
 */
/**
 * Hook full Screen drop-down feature
 * @author: tongyh
 * @date:   2014-10-30
 */
public class AuroraSystemGesturesPointerEventListener extends InputEventReceiver {
    ...
    public AuroraSystemGesturesPointerEventListener(Context context, InputChannel inputChannel,  Looper looper) {
    ...
    @Override
    public void onInputEvent(InputEvent mInputEvent) {
        try {
            if (mInputEvent instanceof MotionEvent
                    && (mInputEvent.getSource() & InputDevice.SOURCE_CLASS_POINTER) != 0) {
                final MotionEvent event = (MotionEvent)mInputEvent;
            ...
            finishInputEvent(mInputEvent, false);
        }
    ...
    private void auroraRequestTransientBars() {
        boolean sb = mStatusBar.isDisplayedLw();
        if(!sb){
            Intent intent = new Intent("com.aurora.systemui.visiable.statusbar");
            mContext.sendBroadcast(intent);
        }
    }

    public void setWindow(WindowState statusBar){
