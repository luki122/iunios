...
public class AuroraPointerInterceptor {
	...
	private AuroraThreeFingerScreenShotPolicy mScreenShot;
        ...
        //Begin add by gary.gou for Screen and button both on
        private static final boolean SCREEN_BUTTON_BOTH_ON = SystemProperties.getBoolean("ro.aurora.screenbuttonbothon", false);
        private AuroraButtonKeyLight  mButtonKeyLight;
        //End add by gary.gou for Screen and button both on    
    ...
    public void enable() {
       ...
       /* mAuroraInputChannel=
        ...
        //Begin add by gary.gou for Screen and button both on
       if(mButtonKeyLight == null){
           mButtonKeyLight = new AuroraButtonKeyLight(mContext);
       }
        //End add by gary.gou for Screen and button both on
    ...
    private void onMotionEvent(MotionEvent event) {
        ...
        //Begin add by gary.gou for Screen and button both on
       if(SCREEN_BUTTON_BOTH_ON){
          mButtonKeyLight.handleEvent(event);
       }
       //End add by gary.gou for Screen and button both on
...
// Aurora <Felix.Duan> <2014-5-28> <END> Add debug code
    ...
    private boolean hasNavBar() {
        return isIUNI_U3() || isHonor6() || isSony() || isNexus();
    }

    private boolean isHonor6() {
    ...
    private boolean isSony() {
        boolean isSony = ("Xperia Z".equals(SystemProperties.get("ro.product.model")));
