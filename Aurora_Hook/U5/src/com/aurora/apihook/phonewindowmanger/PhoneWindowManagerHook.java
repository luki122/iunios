...
public class PhoneWindowManagerHook implements Hook {
	...
	private AuroraShutDownDialog dialog;
	
	private boolean mShow = false;

	private FrameAnimation mShutDownAnim,mAirmodeAnim,mRebootAnim;
...
/*		if(SHOW_AIRMODE_PANLE){
	 ...
	 * @param param
	 */
	public void before_showGlobalActionsInternal(final MethodHookParam param) {
		...
		if(dialog != null && dialog.isShowing()){
			...
			dialog = new AuroraShutDownDialog(mContext, wmf);
//			dialog.setFrameAnimation(mShutDownAnim,mAirmodeAnim,mRebootAnim);
