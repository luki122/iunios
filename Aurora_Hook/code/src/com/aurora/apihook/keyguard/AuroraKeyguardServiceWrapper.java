 ...
 *
 */
public class AuroraKeyguardServiceWrapper implements IKeyguardService {
    private IKeyguardService mService;
    private String TAG = "KeyguardServiceWrapper";

    public AuroraKeyguardServiceWrapper(IKeyguardService service) {
        mService = service;
    }
    ...
    public void auroraWakeWhenReady(int keyCode) {
        try {
            mService.auroraWakeWhenReady(keyCode);
        } catch (RemoteException e) {
            Log.w(TAG , "Remote Exception", e);
        }
    }
