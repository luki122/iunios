...
public class OpenDataSqlite extends SQLiteOpenHelper {	
     ...
     * 表名：隐私应用
     */
    public static final String TABLE_NAME_OF_privacyApp = "privacyApp";
    ...
    public void onCreate(SQLiteDatabase db) {     	   	    	   	
    	...
    	db.execSQL("CREATE TABLE " + TABLE_NAME_OF_privacyApp + 
          		" ("+FIELD_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+ 
          		ACCOUNT_ID +" INT4," +
          		PACKAGE_NAME +" TEXT);"
          		); 
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_OF_privacyApp);
		onCreate(db);
    }
