...
public class BatteryController extends BroadcastReceiver {
	...
	private AnimationDrawable mAnimationDrawable;//Aurora <Tymy.Tao> 2015-04-27 mod_battery_animation
...
//            final boolean plugged = intent.getIntExtra(BatteryManager.EXTRA_PLUGGED, 0) != 0;
            ...
            int icon=0;//tymy_20150507_bug13453
            /// @}
            ...
            for (int i=0; i<N; i++) {
                ...
                //tymy_20150507_bug13453_begin
                if(plugged && !fulled && !mBatteryProtection){
                	if(level>=0&&level<15){
                	...
                	mAnimationDrawable = (AnimationDrawable) v.getDrawable();
...
//			ImageView normalView = mIconViews.get(1);
            ...
            mChargingNow = (R.drawable.stat_sys_battery == icon ? false : true);//tymy_20150507_bug13453
...
//				bgView.setVisibility(View.GONE);
				...
				if(!mShouldShowBatteryPercentage&&!mChargingNow){//tymy_20150507_bug13453
