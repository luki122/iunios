...
public class MSimSignalClusterView
    ...
    private int mNumPhones = GnTelephonyManager.getPhoneCount();
    ...
    protected void onAttachedToWindow() {
        ...
        applySubscription(GnTelephonyManager.getDefaultSubscription(mContext));
    }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
		...
		//if (mMobileVisible && mMobileGroup[GnPhone.GEMINI_SIM_1].getContentDescription() != null)
        if (mMobileVisible && mMobileGroup[GnPhone.GEMINI_SIM_1]!= null && mMobileGroup[GnPhone.GEMINI_SIM_1].getContentDescription() != null)
		//steve.tang 2014-07-16 fix null pointer exception. start
            event.getText().add(mMobileGroup[GnPhone.GEMINI_SIM_1].
    ...
    private void applySubscription(int subscription) {
		...
		boolean isDataConnected = GnTelephonyManager.getDataState() ==2;
