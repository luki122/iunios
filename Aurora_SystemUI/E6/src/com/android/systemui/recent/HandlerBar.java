        ...
        mContext.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (DISABLE_HANDLER.equals(intent.getAction())) {
                    ...
                    mEnable = true;
                    showView(true);
                    // ONLY debug code, delete after done!
                    bindServiceView();
                    InvokerService.getInstance().updatePanelStatus(mEnable);
...
//	        snapChild(true);
 ...
 // Aurora <tongyh> <2013-12-06> set the statusbar background to black end
    ...
    private void loadRecentBg() {
		...
		try{
			Bitmap ScreenBitmap = Surface.screenshot((mDisplayMetrics.widthPixels>>2), (mDisplayMetrics.heightPixels>>2));
