...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public PhoneStatusBarTransitions(PhoneStatusBarView view) {
     ...
     // Aurora <tongyh> <2014-06-16> Non-desktop or lock screen lock screen, gray icon on the status bar displays the wrong begin
//      mIconAlphaWhenOpaque = res.getFraction(R.dimen.status_bar_icon_drawing_alpha, 1, 1);
      mIconAlphaWhenOpaque = 1;
   // Aurora <tongyh> <2014-06-16> Non-desktop or lock screen lock screen, gray icon on the status bar displays the wrong end
    }

    public void init() {
        mLeftSide = mView.findViewById(R.id.notification_icon_area);
        mStatusIcons = mView.findViewById(R.id.statusIcons);
        // felix changed for dual-sim
        //mSignalCluster = mView.findViewById(R.id.signal_cluster);
        mSignalCluster = mView.findViewById(R.id.msim_signal_cluster); //Bug #7435, null point if (mSignalCluster != null)
        ...
        if (animate) {
            ...
            /*mLeftSide.setAlpha(newAlpha);
                ...
                if (mSignalCluster != null) {
                    SignalCluster.setAlpha(newAlpha);
                }
