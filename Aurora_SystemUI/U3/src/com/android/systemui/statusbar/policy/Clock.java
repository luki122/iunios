...
// Aurora <zhanggp> <2013-10-17> modified for systemui end
    ...
    private int topPadding_huawei = 0;
    private int leftPaddingTF = 0;
...
//		auroraSetDefaultBaseLinePadding();
	    ...
	    topPadding_huawei = mContext.getResources()
	            .getDimensionPixelOffset(com.android.systemui.R.dimen.status_bar_clock_padding_hua_wei_top);
	    leftPaddingTF = mContext.getResources()
	            .getDimensionPixelOffset(com.android.systemui.R.dimen.status_bar_clock_padding_u3_left);
...
//        }
    ...
    final void updateClock() {
        ...
        if(DateFormat.is24HourFormat(getContext())){
        	if(Build.MODEL.contains("H60")){
        		setPadding(leftPadding,topPadding_huawei,0,0);
        	}else{
        		setPadding(leftPadding,0,0,0);
        	}
        	
        }else{
        	setPadding(leftPaddingTF,topPadding,0,0);
        }
     // Aurora <tongyh> <2015-03-18> clock bold begin
       getPaint().setStyle(Paint.Style.FILL_AND_STROKE);
		getPaint().setStrokeWidth(0.7f);
     // Aurora <tongyh> <2015-03-18> clock bold end
