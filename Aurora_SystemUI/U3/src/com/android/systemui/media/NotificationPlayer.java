...
// Aurora <zhanggp> <2013-11-13> added for systemui begin
import android.os.IBinder;
import android.os.Binder;
import android.app.INotificationPlayerOnCompletionListener;
import java.util.Vector;
import java.util.Iterator;
// Aurora <zhanggp> <2013-11-13> added for systemui end
...
public class NotificationPlayer implements OnCompletionListener {
	...
	private Vector<INotificationPlayerOnCompletionListener> mOnCompletionListener;
	// Aurora <zhanggp> <2013-11-13> added for systemui end
...
// Aurora <zhanggp> <2013-11-13> added for systemui begin	
	public IBinder setOnCompletionListener(INotificationPlayerOnCompletionListener l){
		mOnCompletionListener.addElement(l);
		return mBinder;
	}
// Aurora <zhanggp> <2013-11-13> added for systemui end
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        synchronized (mCmdQueue) {
			...
			// Aurora <zhanggp> <2013-11-13> added for systemui begin
			try {
				Iterator iterator = mOnCompletionListener.iterator();
				while(iterator.hasNext()){
					((INotificationPlayerOnCompletionListener)iterator.next()).onCompletion();
				}
			}catch (Exception e) {
    ...
    public NotificationPlayer(String tag) {
		...
		// Aurora <zhanggp> <2013-11-13> added for systemui begin
		mBinder = new Binder();
		mOnCompletionListener = new Vector<INotificationPlayerOnCompletionListener>();
		// Aurora <zhanggp> <2013-11-13> added for systemui end
    }
