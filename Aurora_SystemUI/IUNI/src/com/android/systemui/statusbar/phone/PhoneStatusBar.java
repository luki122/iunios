...
//Aurora <tongyh> <2015-01-13> add account end
 ...
 // Aurora <tongyh> <2014-03-08> add phone call state idle  can quick lock screen begin
    ...
    @Override
    public void start() {
    	Utils.ICON_REAL_SIZE = mContext.getResources().getDimensionPixelSize(R.dimen.statusbar_notificatin_icon_real_size);
...
// Aurora <zhanggp> <2013-10-08> added for systemui begin
		mPolicyCallback = new PhoneStatusBarPolicy.Callback(){
            ...
            public void setStausbarTransparentFlag(boolean isTransparent) {
                //Log.v("baisha", "setStausbarTransparentFlag isTransparent = " + isTransparent);
...
//        updateSearchPanel();
    ...
    public void addNotification(IBinder key, StatusBarNotification notification) {
    	Log.d("PhoneStatusBar", "notification.PackageName = " + notification.getPackageName());
    	Log.d("PhoneStatusBar", "notification.getId = " + notification.getId());
    	// Aurora <tongyh> <2013-10-19> delete the sansung msic notification begin
        if("com.sec.android.pagebuddynotisvc".equals(notification.getPackageName()) || "com.qualcomm.logkit".equals(notification.getPackageName()) || notification.getId() == 999){
        	return;
        }
...
//            String key = ent.notification.getPackageName() + String.valueOf(ent.notification.getNotification().icon);
            ...
            if("com.tencent.mobileqq".equals(ent.notification.getPackageName()) || "com.tencent.qqlite".equals(ent.notification.getPackageName())){
        		final StatusBarIconView iconView = new StatusBarIconView(mContext,
        				...
        				ent.notification.getNotification());
...
//                if(isSystemNotification(ent.notification)){
                	...
                	if(tv == null){
            			tv = (TextView)ent.row.findViewById(getOppoSystemTemplatesLineThreeId());
                	}
                	if(tv != null){	
...
//                    }
			...
			// Steve.Tang 2014-07-23 change carrier label as air mode change. start
				...
				boolean isAirModeOn = intent.getBooleanExtra("state", false);
				if(isAirModeOn) ((CarrierLabel)mCarrierLabel).updateNetworkName(false, null, false, null, isAirModeOn);
            }
			// Steve.Tang 2014-07-23 change carrier label as air mode change. end
...
//		if("com.tudou.android".equals(notification.getPackageName())){
	...
	private boolean canShowIcon(StatusBarNotification notification){
		...
		if(notification.getPackageName().equals("com.android.phone") || notification.getPackageName().equals("com.android.music")){
			return false;
		}
...
//		if(notification.isClearable()) return true;
        ...
        ||"com.oppo.usbselection".equals(notification.getPackageName()) 
		//Aurora <tongyh> <2014-11-05> add aurora privacymanage icon begin  
...
/*private View.OnTouchListener mQuickLockScreenTouchListenerSecond = new View.OnTouchListener() {
    ...
    private void AuroraCreatQcNvItems() {
        ...
        if (!Build.MODEL.contains("U810")) return;
