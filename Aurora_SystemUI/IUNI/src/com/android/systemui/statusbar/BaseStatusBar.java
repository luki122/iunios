...
// Aurora <zhanggp> <2013-10-08> added for systemui begin
	...
	public void updateViewStatus(NotificationData.Entry entry){
		...
		*/
		if(("com.android.phone".equals(sbn.getPackageName()) && sbn.getId() < 17000) || "com.tencent.mobileqq".equals(sbn.getPackageName()) || "com.tencent.mm".equals(sbn.getPackageName()) || "com.android.mms".equals(sbn.getPackageName()) || "com.android.music".equals(sbn.getPackageName())){
			return;//except pkg
		}
...
// Aurora <tongyh> <2014-10-28> hooking resources end
    		...
    		if(sbn.getId() == notification_wifi_id || sbn.getId() == -2000010 || sbn.getId() == 201852005){
        		...
        		setAuroraNotificationIconBitmap(baseIv,expendIv,R.drawable.aurora_systemui_stat_notify_wifi_in_range);
        	}else if(sbn.getId() == notification_adb_active_id || sbn.getId() == 17040516){
        		setAuroraNotificationIconBitmap(baseIv,expendIv,R.drawable.aurora_systemui_stat_sys_adb);
        	}else if(sbn.getId() == notification_stat_sys_data_usb_id || sbn.getId() == 17040508){
