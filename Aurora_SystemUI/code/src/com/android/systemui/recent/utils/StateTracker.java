...
public abstract class StateTracker {
    ...
    protected Boolean mActualState = null;
//    private Boolean mActualState = null; // initially not set
    ...
    public void setImageViewResources(Context context) {
        ...
        case STATE_DISABLED:
            ...
            getNameTextView().setTextColor(Color.WHITE);

            // Aurora <Felix.Duan> <2014-6-16> <BEGIN> Pixel perfect U3 recents panel view to IUNI design
            // Set to 50% transparent when disabled
            getNameTextView().setAlpha(0.5f);
            // Aurora <Felix.Duan> <2014-6-16> <END> Pixel perfect U3 recents panel view to IUNI design
        ...
        case STATE_ENABLED:
            ...
            getNameTextView().setTextColor(context.getResources().getColor(
                    R.color.quick_setting_font));
            // Aurora <Felix.Duan> <2014-6-16> <BEGIN> Pixel perfect U3 recents panel view to IUNI design
            // Set to 100% transparent when enabled
            getNameTextView().setAlpha(1);
            // Aurora <Felix.Duan> <2014-6-16> <END> Pixel perfect U3 recents panel view to IUNI design
            mtkImageView = getSwitchingGifView();
            if (mtkImageView != null) {
            	mtkImageView.setVisibility(View.GONE);
