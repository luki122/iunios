...
public class StatusBarIconView extends AnimatedImageView {
    ...
    public StatusBarIconView(Context context, String slot, Notification notification, BaseStatusBar bar) {
        super(context);
...
//            final float alpha = res.getFraction(R.dimen.status_bar_icon_drawing_alpha, 1, 1);
        ...
        mBar = bar;
        setColorFilter(mBar.mColorFilter);
    }
    ...
    protected void onDraw(Canvas canvas) {
		...
		// Aurora <zhanggp> <2013-10-08> added for systemui begin
            ...
            mAuroraNumberPain.setColorFilter(filter);
