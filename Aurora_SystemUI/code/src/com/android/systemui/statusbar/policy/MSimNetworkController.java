...
//                updateSimIcon(i);
    ...
    private void setCarrierText() {
        ...
        if((carrierNameSUB1 != null && carrierNameSUB1.equals(mContext.getString(com.android.internal.R.string.lockscreen_airplane_mode_on)))
        		&& (carrierNameSUB1 != null && carrierNameSUB2.equals(mContext.getString(com.android.internal.R.string.lockscreen_airplane_mode_on)))){
        	carrierName = mContext.getString(com.android.internal.R.string.lockscreen_airplane_mode_on);
			isAirmodeOn = true;
        }
	...
	private void updateCtaNetworkLabel(SIMInfoForCta ctaInfo01, SIMInfoForCta ctaInfo02, boolean isAirmodeOn, boolean isEmergencyMode){
		...
		if(isAirmodeOn){
			ctainfo = mContext.getString(com.android.internal.R.string.lockscreen_airplane_mode_on);
