    ...
    public void onCheckedChanged(CompoundButton toggle, boolean checked) {
        ...
        if (checked) {
            thumb = res.getDrawable(
                    com.aurora.R.drawable.scrubber_control_disabled_holo);
            slider = res.getDrawable(
                    R.drawable.status_bar_settings_slider_disabled);
        } else {
            thumb = res.getDrawable(
                    com.aurora.R.drawable.scrubber_control_selector_holo);
            slider = res.getDrawable(
                    com.aurora.R.drawable.scrubber_progress_horizontal_holo_dark);
        }
