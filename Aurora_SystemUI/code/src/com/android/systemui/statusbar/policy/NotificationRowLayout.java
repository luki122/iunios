...
import com.android.systemui.AuroraSwipeHelper;
...
public class NotificationRowLayout 
        ...
        implements AuroraSwipeHelper.Callback, ExpandHelper.Callback
		// Aurora <zhanggp> <2013-10-08> modified for systemui begin
		...
		// Aurora <zhanggp> <2013-10-08> modified for systemui end
{
	...
	// Aurora <zhanggp> <2013-10-08> modified for systemui begin
    private AuroraSwipeHelper mSwipeHelper;
    ...
    public NotificationRowLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		// Aurora <zhanggp> <2013-10-08> modified for systemui begin
		float buttonWidth = getResources().getDimension(R.dimen.aurora_notification_row_add_size);
        mSwipeHelper = new AuroraSwipeHelper(AuroraSwipeHelper.X, this, densityScale, pagingTouchSlop,buttonWidth);
    ...
    public boolean canChildBeDismissed(View v) {
        ...
        return (veto != null && veto.getVisibility() == View.VISIBLE);
	...
	// Aurora <zhanggp> <2013-10-08> modified for systemui begin
    public boolean canChildShowButton(View v) {
        return NotificationData.getCanShowButton(v);
    }
	// Aurora <zhanggp> <2013-10-08> modified for systemui end
...
// Aurora <zhanggp> <2013-10-17> added for systemui begin
	...
	public void releaseClearAllItem() {
		mSwipeHelper.snapShowButtonView();
    }
// Aurora <zhanggp> <2013-10-17> added for systemui end
	
	// Aurora <tongyh> <2014-01-02> Modify the height of the Samsung notice begin 
	public boolean getSanSungSpecialNotificationTag(View v){
		return NotificationData.getIsSanSungSpecialNotification(v);
	}
