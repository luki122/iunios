...
public class TelephonyIcons {
    ...
    static final int[][] AURORA_TELEPHONY_SIGNAL_STRENGTH = {
    	{ R.drawable.stat_sys_gemini_one_signal_0_blue,
            R.drawable.stat_sys_gemini_one_signal_1_blue,
            R.drawable.stat_sys_gemini_one_signal_2_blue,
            R.drawable.stat_sys_gemini_one_signal_3_blue,
            R.drawable.stat_sys_gemini_one_signal_4_blue },

		{ R.drawable.stat_sys_gemini_two_signal_0_blue,
            R.drawable.stat_sys_gemini_two_signal_1_blue,
            R.drawable.stat_sys_gemini_two_signal_2_blue,
            R.drawable.stat_sys_gemini_two_signal_3_blue,
            R.drawable.stat_sys_gemini_two_signal_4_blue }
    };
