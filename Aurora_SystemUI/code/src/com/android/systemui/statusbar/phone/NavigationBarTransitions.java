...
public final class NavigationBarTransitions extends BarTransitions {
    ...
    public void transitionTo(int mode, boolean animate) {
        //Log.v("Baisha", "mode = " + mode + " isKeyguard() = " + isKeyguard());
        mRequestedMode = mode;
    ...
    private void applyMode(int mode, boolean animate, boolean force) {
        ...
        setKeyButtonViewQuiescentAlpha(mView.getAuroraMenuButton(), alpha, animate);
    ...
    public void applyBackButtonQuiescentAlpha(int mode, boolean animate) {
        ...
        backAlpha = maxVisibleQuiescentAlpha(backAlpha, mView.getAuroraMenuButton());
    ...
    protected boolean isKeyguard(){
        ...
        if (mView.mContext != null) {
            KeyguardManager keyguardManager = (KeyguardManager)mView.mContext.getSystemService(Context.KEYGUARD_SERVICE);
            enable = keyguardManager.isKeyguardLocked();
		}
