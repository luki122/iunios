...
public class UsbDebuggingActivity extends AuroraAlertActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        final AuroraAlertController.AlertParams ap = mAlertParams;
        ap.mTitle = getString(R.string.usb_debugging_title);
        ap.mIconId = com.aurora.R.drawable.ic_dialog_usb;
        ...
        View checkbox = inflater.inflate(com.aurora.R.layout.always_use_checkbox, null);
        mAlwaysAllow = (CheckBox)checkbox.findViewById(com.aurora.R.id.alwaysUse);
