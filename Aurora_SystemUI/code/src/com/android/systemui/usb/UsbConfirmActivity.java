...
public class UsbConfirmActivity extends AlertActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        ap.mView = inflater.inflate(com.aurora.R.layout.always_use_checkbox, null);
        mAlwaysUse = (CheckBox)ap.mView.findViewById(com.aurora.R.id.alwaysUse);
        if (mDevice == null) {
        ...
        mClearDefaultHint = (TextView)ap.mView.findViewById(
                                                    com.aurora.R.id.clearDefaultHint);
