...
package com.aurora.wallpapercropper;

import com.aurora.photos.views.TiledImageRenderer.TileSource;
...
public class CropView extends TiledImageView implements OnScaleGestureListener {
    ...
    public boolean onScale(ScaleGestureDetector detector) {
        ...
        // Aurora liugj 2014-05-29 modified for 回弹动画 start
        ...
        // Aurora liugj 2014-05-29 modified for 回弹动画 end
        invalidate();
        return true;
    }
    ...
    public void onScaleEnd(ScaleGestureDetector detector) {
    	// Aurora liugj 2014-05-29 added for 回弹动画 start
    	if (mRenderer.scale < mMinScale) {
			mRenderer.scale = mMinScale;
		}else {
    	...
    	invalidate();
    	// Aurora liugj 2014-05-29 added for 回弹动画 end
    }
        ...
        synchronized (mLock) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                		upEvent();
                	break;
                	// Aurora liugj 2014-05-13 added for 回弹动画 end
            }
        }
