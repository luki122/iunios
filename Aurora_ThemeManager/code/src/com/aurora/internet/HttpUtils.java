...
public class HttpUtils {
	...
	public static Map<String,Object> createPostMap(String key,Object value,Context context){
		Map<String, Object> map = new HashMap<String, Object>();  
		map.put(key, value);
		map.put("phoneModel", SystemUtils.getModel());  
		map.put("imei",SystemUtils.getImei(context));  
		map.put("width", SystemUtils.getDisplayWidth(context));  
		map.put("height", SystemUtils.getDisplayHeight(context));  
		map.put("osVersion", SystemUtils.OS_VERSION+"");  
	...
	public static JSONObject createDownloadedPostData(Context context,int type,int typeId){
		Map<String, Object> map = new HashMap<String, Object>();  
		map.put("phoneModel", SystemUtils.getModel());  
		map.put("imei",SystemUtils.getImei(context));  
		map.put("width", SystemUtils.getDisplayWidth(context));  
		map.put("height", SystemUtils.getDisplayHeight(context));  
		map.put("osVersion", SystemUtils.OS_VERSION+"");  
		map.put("network", SystemUtils.getNetworkType(context));
		map.put("type", type);
		map.put("typeId", typeId);
		return new JSONObject(map);
	}
	
	public static JSONObject createCheckThemeNewVersion(Context context,int id,float version){
		Map<String, Object> map = new HashMap<String, Object>();  
		map.put("phoneModel", SystemUtils.getModel());  
		map.put("imei",SystemUtils.getImei(context));  
		map.put("width", SystemUtils.getDisplayWidth(context));  
