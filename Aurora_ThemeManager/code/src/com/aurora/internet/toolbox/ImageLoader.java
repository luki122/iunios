...
public abstract class ImageLoader {
	 ...
	 * will be used as an L1 cache before dispatch to internet. Implementations
     ...
     * @param cacheKey The cache key that is associated with the image request.
     */
    private void onGetImageError(String cacheKey, InternetError error) {
    ...
    private class BatchedImageRequest {
         ...
         */
        public void setError(InternetError error) {
            mError = error;
        }
