...
import com.aurora.internet.InternetLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public void finish(final String tag) {
        ...
        if (MarkerLog.ENABLED) {
            ...
            if (requestTime >= SLOW_REQUEST_THRESHOLD_MS) {
                InternetLog.d("%d ms: %s", requestTime, this.toString());
            }
        }
    }
	...
	/**
	 * Set how long the cache is expired, {@link com.aurora.internet.cache.DiskCache}
	...
	/**
	 * Prepare to execute, invoke before {@link com.aurora.internet.stack.HttpStack#performRequest}.
	 ...
	 * However the {@link com.aurora.internet.request.FileDownloadRequest}
     ...
     *
     * @param internetError the error retrieved from the network
     * @return an NetworkError augmented with additional information
     */
    protected InternetError parseNetworkError(InternetError internetError) {
     ...
     */
    public void deliverError(InternetError error) {
        if (mListener != null) {
