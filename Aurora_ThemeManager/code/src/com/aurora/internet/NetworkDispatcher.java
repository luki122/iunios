 ...
 * eligible, using a specified {@link com.aurora.internet.cache.DiskCache} interface.
...
public class NetworkDispatcher extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            } catch (InternetError internetError) {
				mDelivery.postError(request, request.parseNetworkError(internetError));
            } catch (Exception e) {
				InternetLog.e(e, "Unhandled exception %s", e.toString());
				mDelivery.postError(request, new InternetError(e));
			}
        }
    }
