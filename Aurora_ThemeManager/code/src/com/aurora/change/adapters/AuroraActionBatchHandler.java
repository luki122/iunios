...
//        updateTitle();
	...
	private void initActionBarListener() {
		...
		mCancelBtn.setTextColor(mActivity.getResources().getColor(R.color.action_bar_selecte_text_color));
		...
		mSelectAllBtn.setTextColor(mActivity.getResources().getColor(R.color.action_bar_selecte_text_color));
