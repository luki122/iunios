...
public class NextDayClockImageView extends ImageView {
	...
	public static final int[] TIME_KEY_WHITE = { R.drawable.time_key0, R.drawable.time_key1, R.drawable.time_key2,
		 ...
		 R.drawable.time_key7, R.drawable.time_key8, R.drawable.time_key9, R.drawable.time_key_devider};
	...
	public static final int[] TIME_KEY_BLACK = { R.drawable.time_key0_black, R.drawable.time_key1_black, R.drawable.time_key2_black,
		 ...
		 R.drawable.time_key7_black, R.drawable.time_key8_black, R.drawable.time_key9_black, R.drawable.time_key_devider_black};
    ...
    public NextDayClockImageView(Context context) {
        super(context);
		mContext = context;
        initView();
    }

    public NextDayClockImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
		mContext = context;
        initView();
    }

    public NextDayClockImageView(Context context, AttributeSet attrs, int defStyle) {
...
//        setTimeImage(0);
	...
	public void updateTime(NextDayPictureInfo pictureInfo) {
		
	    setTimeImage(pictureInfo);
	}
	
	public void setTimeImage(NextDayPictureInfo pictureInfo) {
		String date = pictureInfo.getPictureTime();
		
		boolean value = "white".equals(pictureInfo.getPictureTimeColor());
		setBlackStyle(!value);
		
		if (getId() == R.id.clock_image_1) {
        	int image1Id = timeToResource(Integer.valueOf(date.substring(4, 5)));
            setImageResource(image1Id);
            
        } else if (getId() == R.id.clock_image_2) {
        	int image2Id = timeToResource(Integer.valueOf(date.substring(5, 6)));
        	...
        	int image4Id = timeToResource(Integer.valueOf(date.substring(6, 7)));
            setImageResource(image4Id);
            
        } else if (getId() == R.id.clock_image_5) {
        	int image5Id = timeToResource(Integer.valueOf(date.substring(7, 8)));
