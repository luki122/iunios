...
public class WallpaperManagerActivity extends AuroraActivity implements OnClickListener {
    ...
    //shigq add start
    private View mManagerWallpaperBase;
	...
	private Runnable mLoadIconRunnable = new Runnable() {
		...
		public void run() {
			...
			mIconUtils
					.setupWallPaperPreviewBottomIcons(mPreViewIconBottomParent);
...
//        setContentView(R.layout.activity_wallpaper_manager);
        mIconUtils = new IconUtils(this,true);
        ...
        actionBar.setTitle(R.string.wallpapersetting);
    ...
    private void setupViews() {
        ...
        //shigq add start
        mManagerWallpaperBase =findViewById(R.id.manager_wallpaper_base);
