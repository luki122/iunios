...
//                                    Integer.MAX_VALUE, this);
                	...
                	Log.e(TAG, "liugj OutOfMemoryError - " + e);
				} finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
    ...
    public Bitmap getBitmapFromResources(Resources resources, String data) {
		...
		try {
			...
			Log.e("liugj", "====getBitmapFromResources====Exception:"+e.toString());
		}
...
//        ||        !isExternalStorageRemovable() 
		  // Aurora liugj 2015-04-07 modified for android-5.0 start
        final String cachePath = Environment.MEDIA_MOUNTED.equals( Environment.getExternalStorageState()
        		/*gionee.os.storage.GnStorageManager.getInstance(context).getInternalStoragePath()*/
        ) ? context.getCacheDir().getPath() : getExternalCacheDir(
                context).getPath();
        Log.d(TAG, "---getDiskCacheDir---"+cachePath);
		  // Aurora liugj 2015-04-07 modified for android-5.0 end
