...
public class DbInfoModel {
    ...
    public static class GroupColumns implements BaseColumns {
        ...
        public static final String DOWNLOADED_PKG_PATH="downloaded_pkg_path";
        
        public static final String FROM_THEME_PKG="from_theme_pkg";
        ...
        public static final int DOWNLOAD_ID_INDEX = 9;
        public static final int FROM_THEME_PKG_INDEX = 10;
        public static final int DOWNLOADED_PKG_PATH_INDEX = 11;
