...
public class ThemeConfig {
	 ...
	 * 已经应用的主题的锁屏存放路劲
	 */
	public static final String THEME_LOCKSCREEN_PATH = THEME_PATH + "time_wallpaper/";
	...
	public static final String THEME_DEFAULT_PATH = THEME_BASE_PATH+"default/";
	
	public static final String THEME_DEFAULT_WALLPAPER_PATH="wallpaper/";
	...
	public static final String KEY_FOR_APPLY_FROM_DEFAULT = "defaultTheme";
	...
	public static class  HttpConfig{
		...
		public static final String HOST_PATH = "http://theme.iunios.com/";
		
		public static final String DOWNLOADED_POST_URL = "http://theme.iunios.com/log";
		 ...
		 * 主题版本更新
		 */
		public static final String THEME_NEW_VERSION_CHECK_URL = HOST_PATH+"theme/checkUpdate";
		...
		public static final int DOWNLOADED_POST_TYPE_THEME = 0;
		
		public static final int DOWNLOADED_POST_TYPE_WALLPAPER = 1;
		
		public static final int DOWNLOADED_POST_TYPE_TIME_WALLPAPER = 2;
		
		public static final int DOWNLOADED_POST_TYPE_RINGTONG = 3;
	...
	public static final String[] WALLPAPER_PREVIEW_TOP_ICONS={
		...
		"com.aurora.weatherforecast",//天气
		"com.android.deskclock",//闹钟
		"com.aurora.market"//应用市场
	};
