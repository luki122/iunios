...
public class TimeWallpaperDatabaseController extends DatabaseController {

	public TimeWallpaperDatabaseController(Context context) {
		super(context,DbHelper.DOWNLOAD_TIME_WALLPAPER_TABLE);
