...
public class DownloadService extends Service {
	...
	public void onCreate() {
		...
		if (isNeedInitData()) {
			...
			mDownloadDaseController = DatabaseController.getController(this, DatabaseController.TYPE_DOWNLOAD);
...
//			cancleNotify(currentDownloadData.downloadId);
	...
	public static Map<Integer, FileDownloader> getDownloaders(Context context) {
		if (null == sDownloaders) {
			...
			if (context.getApplicationContext() != null) {
				Intent i = new Intent(context.getApplicationContext(), DownloadService.class);
	...
	public static void startDownload(Context context, DownloadData downloadData) {
		...
		startDownloadBundle.putParcelable(DownloadService.DOWNLOAD_DATA, downloadData);
		startDownloadBundle.putInt(DownloadService.DOWNLOAD_OPERATION, 
				DownloadService.OPERATION_START_DOWNLOAD);
	...
	public static void pauseOrContinueDownload(Context context, DownloadData downloadData) {
		...
		startDownloadBundle.putParcelable(DownloadService.DOWNLOAD_DATA, downloadData);
		startDownloadBundle.putInt(DownloadService.DOWNLOAD_OPERATION, 
				DownloadService.OPERATION_PAUSE_CONTINUE_DOWNLOAD);
		startDownload.putExtras(startDownloadBundle);
		context.startService(startDownload);
	}
	...
	public static void cancelDownload(Context context, DownloadData downloadData) {
		...
		Bundle startDownloadBundle = new Bundle();
		startDownloadBundle.putParcelable(DownloadService.DOWNLOAD_DATA, downloadData);
		startDownloadBundle.putInt(DownloadService.DOWNLOAD_OPERATION, DownloadService.OPERATION_CANCLE_DOWNLOAD);
		startDownload.putExtras(startDownloadBundle);
		context.startService(startDownload);
	}
