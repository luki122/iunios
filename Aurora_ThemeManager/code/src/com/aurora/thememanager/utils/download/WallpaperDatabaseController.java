...
public class WallpaperDatabaseController extends DatabaseController {

	public WallpaperDatabaseController(Context context) {
		super(context,DbHelper.DOWNLOAD_WALLPAPER_TABLE);
