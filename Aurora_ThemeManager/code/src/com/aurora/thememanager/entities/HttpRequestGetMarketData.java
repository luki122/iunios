...
//		}
		...
		if (Globals.isTestData) {
			// 先使用模拟数据
			returnData = SystemUtils.getFromAssets(ThemeManagerApplication.getInstance(), "market" + page + ".json");
	...
	public static String getCategoryListObject(String type,String style) throws Exception {
		...
		if (Globals.isTestData) {
			// 先使用模拟数据
			returnData = SystemUtils.getFromAssets(ThemeManagerApplication.getInstance(), "category1.json");
	...
	public static String getSpeciaListObject(String type, int page, int count) throws Exception {
		...
		if (Globals.isTestData) {
			// 先使用模拟数据
			returnData = SystemUtils.getFromAssets(ThemeManagerApplication.getInstance(), "special.json");
	...
	public static String getDetailsObject(String packagename) throws Exception {
		...
		if (Globals.isTestData) {
			// 先使用模拟数据
			returnData = SystemUtils.getFromAssets(ThemeManagerApplication.getInstance(), "appdetail.json");
	...
	*/
	...
	public static String getUpAppListObject(Context context) {
		...
		if (Globals.isTestData) {
			// 先使用模拟数据
			returnData = SystemUtils.getFromAssets(ThemeManagerApplication.getInstance(), "updateApp.json");
	...
	public static String getUpdateCountObject(Context context) {
		...
		if (Globals.isTestData) {
			// 先使用模拟数据
			returnData = SystemUtils.getFromAssets(ThemeManagerApplication.getInstance(), "updateCount.json");
