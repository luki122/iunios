...
import com.aurora.thememanager.activity.ThemeDetailActivity;
...
public class ThemeListAdapter extends AbsThemeAdapter{
	...
	private Handler mHandler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			if(msg.what == MSG_UPDATE_APPLIED_THEME_ITEM){
				...
				ThemeManager.restartApplications(mContext, themeId);
				ThemeManager.restartLauncher(mContext);
	...
	public View getView(final int position, View coverview, ViewGroup parent) {
		...
		if(theme != null){
			...
			holder.preview.setDefaultImageResId(R.drawable.item_default_bg_normal);
			...
			mDownloadManager.setCallBack(new DownloadStatusCallback() {
				...
				public void showOperationUpdate(final DownloadData data,
					...
					holder.downloadIcon.setStatus(ProgressBtn.STATUS_UPDATE);
...
//				Log.d("app", "themeId:"+theme.themeId);
//				holder.downloadIcon.setStatus(ProgressBtn.STATUS_INSTALLED);
//			}
