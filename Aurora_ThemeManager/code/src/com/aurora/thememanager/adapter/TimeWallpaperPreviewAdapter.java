...
public class TimeWallpaperPreviewAdapter extends PagerAdapter {

	private static final String TAG = "TimeWallpaperPreviewAdapter";
	private ViewPager mViewPager;
	private Context mContext;
	private String[] mPictureInfos;
	...
	public TimeWallpaperPreviewAdapter(Context context, String[] pictureInfos) {
		mContext = context;
	...
	public TimeWallpaperPreviewAdapter(Context context, String type,
	...
	public List<View> initLayout(String[] infos) {
	...
	public void refreshData(int position) {
		...
		NetworkImageView iv = (NetworkImageView) view
				.findViewById(R.id.wallpaper_preview_item_background);
		iv.setImageUrl(mPictureInfos[position], getImageLoader());
	}
