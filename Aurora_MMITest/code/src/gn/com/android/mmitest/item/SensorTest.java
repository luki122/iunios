...
public class SensorTest {
  ...
  static public synchronized int runSensorTest(SensorID sensorID, DataType
      ...
      Log.d("zhangxiaowei", "ID"+sensorID.getSensorID()+"dataType"+dataType+"testType"+testType+"saveToRegistry"+saveToRegistry+"applyCalNow"+applyCalNow+"nativeTestResult"+nativeTestResult);
   ...
   */
  static  native int runNativeSensorTest(int sensorID, int dataType, int testType,
