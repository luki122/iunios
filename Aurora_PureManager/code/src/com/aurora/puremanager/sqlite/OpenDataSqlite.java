...
public class OpenDataSqlite extends SQLiteOpenHelper {	
     ...
     * 表名：自动休眠的应用
     */
    public static final String TABLE_NAME_OF_AutoSleepApp = "AutoSleepApp";

    /**
     * 表名：禁止唤醒的应用
     */
    public static final String TABLE_NAME_OF_StopWakeApp = "StopWakeApp";
    ...
    public void onCreate(SQLiteDatabase db) {     	   	    	   	
        ...
        db.execSQL("CREATE TABLE " + TABLE_NAME_OF_AutoSleepApp +
                        " ("+FIELD_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+
                        PACKAGE_NAME +" TEXT);"
        );

        db.execSQL("CREATE TABLE " + TABLE_NAME_OF_StopWakeApp +
                        " ("+FIELD_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+
                        PACKAGE_NAME +" TEXT);"
        );
//    	resetPrivacyNumOfAllAccount();  
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_OF_AutoSleepApp);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_OF_StopWakeApp);
		onCreate(db);
    }
