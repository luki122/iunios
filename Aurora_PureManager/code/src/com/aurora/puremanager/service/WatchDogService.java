...
//import com.aurora.puremanager.activity.NetForbidHintActivity;
...
//import com.aurora.puremanager.data.NetForbidHintData;
//import com.aurora.puremanager.data.PermissionInfo;
//import com.aurora.puremanager.data.PrivacyAppData;
...
//import com.aurora.puremanager.model.GetRecomPermsModel;
//import com.aurora.puremanager.model.NetForbidHintModel;
...
//import com.aurora.puremanager.utils.NetworkUtils;
import com.aurora.puremanager.utils.StringUtils;
import com.aurora.puremanager.utils.mConfig;
import com.aurora.puremanager.view.OptimizeNotification;

import java.util.HashMap;
import java.util.List;

public class WatchDogService extends Service implements Observer{
...
//		}
		...
		if(StopWakeUpModel.getInstance() != null) {
			StopWakeUpModel.getInstance(this).inStallApp(appInfo);
		}

		if(AutoSleepModel.getInstance() != null) {
			AutoSleepModel.getInstance(this).inStallApp(appInfo);
		}
...
//		}
		...
		if(AutoSleepModel.getInstance() != null) {
			AutoSleepModel.getInstance(this).unInStallApp(pkgName);
		}

		if(StopWakeUpModel.getInstance() != null) {
			StopWakeUpModel.getInstance(this).unInStallApp(pkgName);
		}
