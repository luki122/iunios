...
public class StopWakeAppProvider extends BaseOpenContentProvider{
    private static final String TAG = StopWakeAppProvider.class.getName();

    private static final String URL_STR = "content://com.aurora.puremanager.provider.open.AuroraStopWakeAppProvider";
    public static final Uri CONTENT_URI = Uri.parse(URL_STR);

    private final static HashSet<String> mStopWakeAppList = new HashSet<String>();
     ...
     * @return
     */
    public static HashSet<String> loadStopWakeAppListInDB(Context context) {
        MyArrayList<String> stopWakeAppList = queryAllAppsInfo(context);
        mStopWakeAppList.clear();
        for (String app : stopWakeAppList.getDataList()) {
            mStopWakeAppList.add(app);
        }
        return mStopWakeAppList;
    }
    ...
    public String getTableName() {
        return OpenDataSqlite.TABLE_NAME_OF_StopWakeApp;
    }
