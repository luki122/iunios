...
//	private TextView mAppNum;
	...
	private void initView() {
		...
		header = (LinearLayout) getLayoutInflater().inflate(R.layout.list_header_ly, null);
...
//			findViewById(R.id.empty_view).setVisibility(View.VISIBLE);
			((TextView) header.findViewById(R.id.list_head_text)).setText(String.valueOf(AppList.size())
...
//					+ getResources().getString(R.string.app_num));
	...
	public void updateOfUnInstall(Subject subject, String pkgName) {
		...
		adapter.clear();
		updateViewHandler.sendEmptyMessage(0);
		FreezedAppProvider.freezeApp(UninstallAppActivity.this, pkgName);
	}
