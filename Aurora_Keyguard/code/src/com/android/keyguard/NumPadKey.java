...
public class NumPadKey extends AuroraAnimationImageView {
    ...
    private View.OnClickListener mListener = new View.OnClickListener() {
        ...
        public void onClick(View thisView) {
            ...
            //Aurora <zhang_xin> <2014-3-3> modify for bug1406 begin
            //if (mTextView != null && mTextView.isEnabled()) {
            if (mTextView != null && mTextView.isEnabled() && mTextView.getText().length() < 8) {
            //Aurora <zhang_xin> <2014-3-3> modify for bug1406 end
