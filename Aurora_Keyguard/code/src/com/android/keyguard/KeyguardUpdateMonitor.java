...
public class KeyguardUpdateMonitor {
    ...
    public static final boolean
            sIsMultiSimEnabled = GnTelephonyManager.isMultiSimEnabled();
...
*/            
    ...
    private void sendUpdates(KeyguardUpdateMonitorCallback callback) {
        ...
        int subscription = GnTelephonyManager.getDefaultSubscription(mContext);
        if (sIsMultiSimEnabled) {
    ...
    public IccCardConstants.State getSimState() {
        return getSimState(GnTelephonyManager.getDefaultSubscription(mContext));
    }
    ...
    public void reportSimUnlocked() {
        reportSimUnlocked(GnTelephonyManager.getDefaultSubscription(mContext));
    }
    ...
    public CharSequence getTelephonyPlmn() {
        return getTelephonyPlmn(GnTelephonyManager.getDefaultSubscription(mContext));
    }
    ...
    public CharSequence getTelephonySpn() {
        return getTelephonySpn(GnTelephonyManager.getDefaultSubscription(mContext));
    }
