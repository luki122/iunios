...
class KeyguardMessageArea extends TextView {
    ...
    Runnable mClearMessageRunnable = new Runnable() {
        @Override
        public void run() {
            //Aurora <zhang_xin> <2013-12-13> modify for msg show begin
//            mMessage = null;
//            mShowingMessage = false;
            //Aurora <zhang_xin> <2013-12-13> modify for msg show end
            if (mShowingBouncer) {
...
//            mShowingBatteryInfo = status.isPluggedIn() || status.isBatteryLow();
    ...
    String getOwnerInfo() {
        // Aurora <zhang_xin> <2013-8-27> modify for policy begin
        ...
        final boolean ownerInfoEnabled = Settings.Secure.getInt(cr,
                Settings.Secure.LOCK_SCREEN_OWNER_INFO_ENABLED, 1) != 0;
        return ownerInfoEnabled && !mShowingMessage ?
                Settings.Secure.getString(cr, Settings.Secure.LOCK_SCREEN_OWNER_INFO) : null;
        // Aurora <zhang_xin> <2013-8-27> modify for policy end
    }
