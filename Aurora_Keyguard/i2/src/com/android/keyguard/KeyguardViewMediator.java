...
public class KeyguardViewMediator {
    ...
    KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onSimStateChanged(IccCardConstants.State simState) {
            onSimStateChanged(simState, 0/*GnTelephonyManager.getDefaultSubscription(mContext)*/);
        }
    ...
    public void onScreenTurnedOn(IKeyguardShowCallback callback) {
    	if (DEBUG) Log.d(TAG, "onScreenTurnedOn, callback = " + callback);
        synchronized (this) {
            mScreenOn = true;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
				...
				case WAKE_WHEN_READY:
                    auroraHandleWakeWhenReady(msg.arg1);
                    break;
				// Aurora <liugj> <2014-06-27> added for screenoff gesture end
    ...
    private void sendUserPresentBroadcast() {
        ...
        if (Build.VERSION.SDK_INT > 18) {
            try {
                ...
                String currentGroup = sp.getString("current_lockpaper_group", "Dream");
                Log.d("liugj3", TAG+"-----sendUserPresentBroadcast---currentGroup = "+currentGroup);
                if (currentGroup.equals(AuroraKeyguardHostView.BLACKSTAYLE_LOCKPAPER_GROUP)) {
		...
		// Aurora liugj 2014-08-26 modified for MusicLockScreen require start
        StatusView.isMusicShow = false;
		// Aurora liugj 2014-08-26 modified for MusicLockScreen require end
    }
    ...
    private void handleHide() {
        synchronized (KeyguardViewMediator.this) {
            ...
            if (TelephonyManager.EXTRA_STATE_IDLE.equals(mPhoneState) && mShowing == true) {
                playSounds(false);
            }
	...
	private void handleOnActivityDrawn() {
        if (mKeyguardDonePending) {
            mKeyguardViewManager.onActivityDrawn();
        }
    }
        ...
        if (mStatusBarManager == null) {
            ...
            if (!(mContext instanceof Activity)) {
            	try {
					...
					Log.d(TAG, "adjustStatusBarLocked Exception: " + e.toString());
				}
            }
        }
    }

	 private void auroraHandleWakeWhenReady(int keyCode) {
        synchronized (KeyguardViewMediator.this) {
    ...
    private void handleReset(Bundle options) {
        ...
        synchronized (KeyguardViewMediator.this) {
            ...
            //Aurora <zhang_xin> <2014-3-13> modify for iuni bug3166 start
            adjustStatusBarLocked();
            //Aurora <zhang_xin> <2014-3-13> modify for iuni bug3166 end
        }
    }
