...
LOCAL_SRC_FILES := $(call all-java-files-under,$(src_dirs)) \
					src/com/android/deskclock/guardian/IGuardService.aidl
...
LOCAL_PACKAGE_NAME := Aurora_DeskClockDaemon
...
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := libyouju:libs/deskclock_pinyin.jar \
