...
//    void addDisconnectButton(AlertDialog dialog, boolean edit, DetailedState state, int networkId);
     ...
     */
    void initConnectView(Activity activity, AuroraPreferenceScreen screen);
    /**
     * Initiatlize gatway & netmask info in wifi advanced settings
     * @param screen The screen of wifi advanced settings
     */
    void initNetworkInfoView(AuroraPreferenceScreen screen);
    /**
     ...
     */
    void setSleepPolicyPreference(AuroraListPreference sleepPolicyPref, String[] sleepPolicyEntries, String[] sleepPolicyValues);
    /**
     * hide edit ap info
