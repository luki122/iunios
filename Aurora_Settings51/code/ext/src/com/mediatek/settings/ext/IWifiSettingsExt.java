...
public interface IWifiSettingsExt {
     ...
     */
    void setCategory(AuroraPreferenceCategory trustPref, AuroraPreferenceCategory configedPref,
    		AuroraPreferenceCategory newPref);
    /**
     * Remove all prefereces in every catogory
     * @param screen The parent screen
     */
    void emptyCategory(AuroraPreferenceCategory screen);
    /**
     * Remove all prefereces in the screen
     * @param screen The parent screen
     */
    void emptyScreen(AuroraPreferenceCategory screen);
    /**
     ...
     * @param screen The parent screen
     */
    void refreshCategory(AuroraPreferenceCategory screen);
    /**
     * get count of access points in the screen
     * @param screen The parent screen
     */
    int getAccessPointsCount(AuroraPreferenceCategory screen);
    /**
     ...
     */
    void addPreference(AuroraPreferenceCategory screen, AuroraPreference preference, boolean isConfiged);
     ...
     */
    AuroraPreference getPreference(AuroraPreferenceScreen preferenceScreen, int index);

    /**
     * add all Category to screen
     * @param screen The current screen
     */
    void addCategories(AuroraPreferenceCategory screen);

    /**
     * get all category
     * @return all category
     */
    List<AuroraPreferenceGroup> getPreferenceCategory(AuroraPreferenceCategory screen);
}
