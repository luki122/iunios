...
public interface IApnSettingsExt {
     ...
     */
    void customizeTetherApnSettings(AuroraPreferenceScreen root);
     ...
     * @param activity
     */
    void initTetherField(AuroraPreferenceFragment pref);
     ...
     */
    void setApnTypePreferenceState(AuroraPreference preference);
    /**
     * get Uri from intent
     ...
     */
    void updateFieldsStatus(int subId, AuroraPreferenceScreen root);
     ...
     */
     void customizePreference(int subId, AuroraPreferenceScreen root);
      ...
      * @param preference The preference to set state
      */
     void setMVNOPreferenceState(AuroraPreference preference);
