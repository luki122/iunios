...
public class DefaultApnSettingsExt implements IApnSettingsExt {
    ...
    public void customizeTetherApnSettings(AuroraPreferenceScreen root) {
    }
   ...
   public void updateMenu(Menu menu, int newMenuId, int restoreMenuId, String numeric) {
    ...
    public void initTetherField(AuroraPreferenceFragment pref) {
    }
    ...
    public void setApnTypePreferenceState(AuroraPreference preference) {
    }
    ...
    @Override
    public void updateFieldsStatus(int subId, AuroraPreferenceScreen root) {
    }
    ...
    @Override
    public void customizePreference(int subId, AuroraPreferenceScreen root) {
    }
    ...
    public void setMVNOPreferenceState(AuroraPreference preference) {
    ...
    @Override
    public void customizeUnselectableApn(ArrayList<AuroraPreference> prefList, int subId) {
    }
}
