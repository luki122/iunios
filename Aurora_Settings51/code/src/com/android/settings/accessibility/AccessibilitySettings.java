...
import static android.provider.Settings.System.APP_AUTHORITY_CONTROL;
import static android.provider.Settings.System.AUTHORITY_CONTROL_DEFAULT;
import static android.provider.Settings.System.AUTHORITY_CONTROL_DEFAULT_ENABLE;

/**
 * Activity with the accessibility settings.
 */
public class AccessibilitySettings extends AuroraSettingsPreferenceFragment implements DialogCreatable,
    ...
    private static final String APP_AUTHORITY_CONTROL_PREFERENCE_SCREEN =
            "toggle_app_authoriy_control_preference";
	...
	private AuroraSwitchPreference mToggleAppAuthorityControl;
	...
	private void initializeAllPreferences() {
     ...
     //--------------------end ---------------------------
		...
		//Aurora hujianwei  20160216 modify for accessbility settings start
		mSystemsCategory.removePreference(mToggleThreeFingersScreenshots);
		//Aurora hujianwei  20160216 modify for accessbility settings end
		...
		//Aurora hujianwei  20160216 modify for accessbility settings start
		mSystemsCategory.removePreference(mGlovePreference);
		//Aurora hujianwei  20160216 modify for accessbility settings end
		...
		//Aurora hujianwei  20160216 modify for accessbility settings start
		mSystemsCategory.removePreference(mMusicPreference);
		//Aurora hujianwei  20160216 modify for accessbility settings end
		...
		mToggleAppAuthorityControl = (AuroraSwitchPreference) findPreference(APP_AUTHORITY_CONTROL_PREFERENCE_SCREEN);
		if (mToggleAppAuthorityControl != null) {
			
			mToggleAppAuthorityControl.setChecked(Settings.System.getInt(getContentResolver(), APP_AUTHORITY_CONTROL, AUTHORITY_CONTROL_DEFAULT_ENABLE) == AUTHORITY_CONTROL_DEFAULT_ENABLE ? true : false);
			mToggleAppAuthorityControl.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
				
				@Override
				public boolean onPreferenceChange(AuroraPreference preference, Object object) {
			
					final boolean value = (Boolean) object;
					int mTmpValue = value ? AUTHORITY_CONTROL_DEFAULT : 0;
					if(  mTmpValue ==  Settings.System.getInt(getContentResolver(), APP_AUTHORITY_CONTROL, AUTHORITY_CONTROL_DEFAULT_ENABLE))  return false;
					Settings.System.putInt(getContentResolver(), APP_AUTHORITY_CONTROL, mTmpValue);
					return true;
				}
			});
		}
		//Aurora hujianwei  20160321 modify for accessbility settings start
		mSystemsCategory.removePreference(mToggleAppAuthorityControl);
		//Aurora hujianwei  20160321 modify for accessbility settings start
            ...
            if (mNoServicesMessagePreference == null) {
                ...
                mNoServicesMessagePreference = new AuroraPreference(getActivity()) {
                    ...
                    protected void onBindView(View view) {
                        ...
                        containerView.setGravity(Gravity.LEFT);

                        TextView summaryView = (TextView) view.findViewById(R.id.summary);
                        String title = getString(R.string.accessibility_no_services_installed);
                        //Aurora hujianwei 20160303 modify style start
                        summaryView.setTextColor(Color.parseColor("#b3b3b3"));
                        summaryView.setTextSize(14);
                        //Aurora hujianwei 20160303 modify style 
