...
class SettingsInjector {
     ...
     */
    public List<AuroraPreference> getInjectedSettings(final int profileId) {
        final UserManager um = (UserManager) mContext.getSystemService(Context.USER_SERVICE);
        final List<UserHandle> profiles = um.getUserProfiles();
        ArrayList<AuroraPreference> prefs = new ArrayList<AuroraPreference>();
        ...
        for (int i = 0; i < profileCount; ++i) {
            ...
            if (profileId == UserHandle.USER_CURRENT || profileId == userHandle.getIdentifier()) {
                ...
                for (InjectedSetting setting : settings) {
                    AuroraPreference pref = addServiceSetting(prefs, setting);
     ...
     */
    private AuroraPreference addServiceSetting(List<AuroraPreference> prefs, InjectedSetting info) {
        PackageManager pm = mContext.getPackageManager();
        ...
        AuroraPreference pref = new DimmableIconPreference(mContext, badgedAppLabel);
        pref.setTitle(info.title);
        pref.setSummary(null);
        pref.setIconSize(dip2px(mContext,50),dip2px(mContext,50));
        pref.setIcon(icon);
    ...
    private final class Setting {
        ...
        public final AuroraPreference preference;
        public long startMillis;

        private Setting(InjectedSetting setting, AuroraPreference preference) {
