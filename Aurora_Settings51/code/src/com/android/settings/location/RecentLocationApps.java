...
public class RecentLocationApps {
    ...
    private class PackageEntryClickedListener
        ...
        public boolean onPreferenceClick(AuroraPreference preference) {
        	...
        	Intent intent = new Intent("android.settings.APPLICATION_DETAILS_SETTINGS");
			   intent.putExtra("actionBarStyle", 0);  
    ...
    private DimmableIconPreference createRecentLocationEntry(
            ...
            AuroraPreference.OnPreferenceClickListener listener) {
        DimmableIconPreference pref = new DimmableIconPreference(mActivity, contentDescription);
 		pref.setIconSize(dip2px(mActivity,50),dip2px(mActivity,50));
        pref.setIcon(icon);
        pref.setTitle(label);
        if (isHighBattery) {
     ...
     */
    public List<AuroraPreference> getAppList() {
        ...
        for (int i = 0; i < appOpsN; ++i) {
            ...
            AuroraPreference preference = getPreferenceFromOps(um, now, ops);
            if (preference != null) {
     ...
     */
    private AuroraPreference getPreferenceFromOps(final UserManager um, long now,
