...
public class SpellCheckersSettings extends AuroraSettingsPreferenceFragment
        implements OnSwitchChangeListener, AuroraPreference.OnPreferenceClickListener,
    ...
    private AuroraPreference mSpellCheckerLanaguagePref;
    ...
    @Override
    public void onSwitchChanged(final aurora.widget.AuroraSwitch switchView, final boolean isChecked) {
    ...
    private void updatePreferenceScreen() {
        ...
        for (int index = 0; index < count; index++) {
            final AuroraPreference preference = screen.getPreference(index);
    ...
    @Override
    public boolean onPreferenceClick(final AuroraPreference pref) {
