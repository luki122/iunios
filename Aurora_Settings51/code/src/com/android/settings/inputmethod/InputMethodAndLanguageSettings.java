...
public class InputMethodAndLanguageSettings extends AuroraSettingsPreferenceFragment
    ...
    private final ArrayList<AuroraPreferenceScreen> mHardKeyboardPreferenceList = new ArrayList<>();
    ...
    public void onCreate(Bundle icicle) {
        ...
        // Spell Checker
        final AuroraPreference spellChecker = findPreference(KEY_SPELL_CHECKERS);
        ...
        /// {@ M: Input method extends features
        AuroraPreferenceCategory voiceCategory = (AuroraPreferenceCategory) findPreference("voice_category");
        AuroraPreferenceCategory pointerSettingsCategory = (AuroraPreferenceCategory) findPreference("pointer_settings_category");
        ...
        //add by aurora jiyouguang 
		if(null != voiceCategory){
		...
		if(null != pointerSettingsCategory){
    ...
    public void onResume() {
        ...
        if (!mShowsOnlyFullImeAndKeyboardList) {
            if (mLanguagePref != null) {
                ...
                //add by jiguang
                mLanguagePref.auroraSetArrowText(localeName);
                //end
            }
        ...
        if (preference instanceof AuroraPreferenceScreen) {
            if (preference.getFragment() != null) {
              ...
              /*  final InputMethodManager imm = (InputMethodManager)
                ...
                Intent intent = new Intent(getActivity(), AuroraInputMethodPickerActivity.class);
...
/*            final List<InputMethodInfo> imis = mShowsOnlyFullImeAndKeyboardList
    ...
    private void updateCurrentImeName() {
        ...
        if (curPref != null) {
            final CharSequence curIme =
                    mInputMethodSettingValues.getCurrentInputMethodName(context,getPackageManager());
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
            ...
            // Current IME.
            String currImeName = immValues.getCurrentInputMethodName(context,context.getPackageManager()).toString();
            indexable = new SearchIndexableRaw(context);
