 ...
 */
class InputMethodPreference extends AuroraCheckBoxPreference implements AuroraPreference.OnPreferenceClickListener,
AuroraPreference.OnPreferenceChangeListener{
    ...
    private LinearLayout mInputMethodSettingsButton;
    ...
    InputMethodPreference(final Context context, final InputMethodInfo imi,
       ...
       // super(context);
    	 super(context, null, R.style.InputMethodPreferenceStyle);
       ...
       // if (!isImeEnabler) { //不做判断是否是第三方应用调用
            // Hide switch widget.
...
//end
        ...
        //----modify by jiyouguang  this is not necessary ---------
...
//        setOnPreferenceChangeListener(this);
    ...
    private final OnClickListener mPrefOnclickListener = new OnClickListener() {
        ...
        public void onClick(View arg0) {
            if (!isEnabled() || mIsSystemIme) { //系统的输入法不允许勾掉
                return;
            }
            if (isChecked()) {
    ...
    protected void onBindView(View view){
         ...
         mInputMethodSettingsButton = (LinearLayout)view.findViewById(R.id.inputmethod_pref);
//         mInputMethodSettingsButton=view.findViewById(R.id.);
    ...
    @Override
    public boolean onPreferenceChange(final AuroraPreference preference, final Object newValue) {
    ...
    @Override
    public boolean onPreferenceClick(final AuroraPreference preference) {
