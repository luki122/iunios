...
import aurora.preference.AuroraPreferenceGroupAdapter;
 ...
 */
public class AuroraSettingsPreferenceFragment extends AuroraPreferenceFragment implements DialogCreatable {

    private static final String TAG = "AuroraSettingsPreferenceFragment";
...
*/
        ...
        if (adapter != null && adapter instanceof AuroraPreferenceGroupAdapter) {
...
//            ((AuroraPreferenceGroupAdapter) adapter).setHighlightedDrawable(highlight);
//            ((AuroraPreferenceGroupAdapter) adapter).setHighlighted(position);
    ...
    private int findListPositionFromKey(ListAdapter adapter, String key) {
        ...
        for (int n = 0; n < count; n++) {
            ...
            if (item instanceof AuroraPreference) {
                AuroraPreference preference = (AuroraPreference) item;
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public void onStart() {
            ...
            if (mParentFragment != null && mParentFragment instanceof AuroraSettingsPreferenceFragment) {
                ((AuroraSettingsPreferenceFragment) mParentFragment).onDialogShowing();
            }
        }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                // This dialog fragment could be created from non-AuroraSettingsPreferenceFragment
                if (mParentFragment instanceof AuroraSettingsPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((AuroraSettingsPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof AuroraSettingsPreferenceFragment) {
                ...
                if (((AuroraSettingsPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((AuroraSettingsPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
    ...
    public boolean startFragment(Fragment caller, String fragmentClass, int titleRes,
        ...
        if (activity instanceof SettingsActivity) {
            ...
            return true;
        } else if (activity instanceof AuroraPreferenceActivity) {
            AuroraPreferenceActivity sa = (AuroraPreferenceActivity) activity;
            sa.startPreferencePanel(fragmentClass, extras, titleRes, null, caller, requestCode);
            return true;
        } else {
            Log.w(TAG,
                    "Parent isn't SettingsActivity nor AuroraPreferenceActivity, thus there's no way to "
