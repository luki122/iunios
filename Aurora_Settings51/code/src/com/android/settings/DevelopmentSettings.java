 ...
 */
public class DevelopmentSettings extends AuroraSettingsPreferenceFragment
...
//    private AuroraCheckBoxPreference mEnableAdb;
    private AuroraPreference mClearAdbKeys;
    private AuroraCheckBoxPreference mEnableTerminal;
...
//    private AuroraCheckBoxPreference mBugreportInPower;
    ...
    private AuroraCheckBoxPreference mBtHciSnoopLog;
    private AuroraCheckBoxPreference mEnableOemUnlock;
    private AuroraCheckBoxPreference mAllowMockLocation;
    private AuroraCheckBoxPreference mDebugViewAttributes;
    ...
    private AuroraCheckBoxPreference mWifiDisplayCertification;
    private AuroraCheckBoxPreference mWifiVerboseLogging;
    private AuroraCheckBoxPreference mWifiAggressiveHandover;

    private AuroraCheckBoxPreference mWifiAllowScansWithTraffic;
    ...
    private AuroraCheckBoxPreference mForceRtlLayout;
    private AuroraListPreference mDebugHwOverdraw;
    private AuroraListPreference mLogdSize;
    private AuroraListPreference mTrackFrameTime;
    private AuroraListPreference mShowNonRectClip;
    ...
    private AuroraListPreference mSimulateColorSpace;

    private AuroraCheckBoxPreference mUseAwesomePlayer;
    private AuroraCheckBoxPreference mUSBAudio;
...
//    private AuroraPreferenceScreen mProcessStats;
    private final ArrayList<AuroraPreference> mAllPrefs = new ArrayList<AuroraPreference>();

    private final ArrayList<AuroraCheckBoxPreference> mResetSwitchPrefs
  ...
  //gionee wangyy 20120710 modify for CR00643075 begin
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (android.os.Process.myUserHandle().getIdentifier() != UserHandle.USER_OWNER
            ...
            mUnavailable = true;
            setPreferenceScreen(new AuroraPreferenceScreen(getActivity(), null));
            return;
        }

        addPreferencesFromResource(R.xml.aurora_development_prefs);

        final AuroraPreferenceGroup debugDebuggingCategory = (AuroraPreferenceGroup)
...
//        mEnableOemUnlock = findAndInitSwitchPref(ENABLE_OEM_UNLOCK);
        ...
        findPreference(KEY_DEV_AURORA_BUILD_NUMBER).setSummary(iuniBuildNumber);
        	...
        	//---------hide "PROCESS_STATS"  by  JM begin-------//
//        mProcessStats = (AuroraPreferenceScreen) findPreference(PROCESS_STATS);
//        mAllPrefs.add(mProcessStats);
    ...
    private AuroraListPreference addListPreference(String prefKey) {	
    	AuroraListPreference pref = (AuroraListPreference) findPreference(prefKey);
        mAllPrefs.add(pref);
        pref.setOnPreferenceChangeListener(this);
        return pref;
    }

    private void disableForUser(AuroraPreference pref) {
        if (pref != null) {
...
//    	mDebugDrawPref = (AuroraPreferenceCategory) findPreference(DEBUG_DRAWING_KEY);
    ...
    private AuroraCheckBoxPreference findAndInitSwitchPref(String key) {
    ...
    private boolean removePreferenceForProduction(AuroraPreference preference) {
    ...
    private void removePreference(AuroraPreference preference) {
...
//        setPrefsEnabledState(mLastEnabledState);
        ...
        Log.d(TAG,"mEnableAdb:1111111111111111111111111111111111111111111111111");
        Log.i(TAG, "mEnableAdb:1111111111111111111111111111111111111111111111111 " + mEnableAdb);
    ...
    void updateSwitchPreference(AuroraTwoStatePreference switchPreference, boolean value) {
...
//                Settings.Secure.BUGREPORT_IN_POWER_MENU, 0) != 0);
    ...
    private void resetDangerousOptions() {
        ...
        for (int i=0; i< mResetSwitchPrefs.size(); i++) {
        	AuroraCheckBoxPreference cb = mResetSwitchPrefs.get(i);
            if (cb.isChecked()) {
                cb.setChecked(false);
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(
                    ...
                    sir.xmlResId = R.xml.aurora_development_prefs;
