 ...
 */
public class AuroraChooseLockPattern extends AuroraPreferenceActivity {
    /**
    ...
    public Intent getIntent() {
        ...
        modIntent.putExtra(EXTRA_SHOW_FRAGMENT, AuroraChooseLockPatternFragment.class.getName());
        return modIntent;
    }

    public static Intent createIntent(Context context, final boolean isFallback,
            boolean requirePassword, boolean confirmCredentials) {
        Intent intent = new Intent(context, AuroraChooseLockPattern.class);
        intent.putExtra("key_lock_method", "pattern");
        intent.putExtra(SecurityUtils.CONFIRM_CREDENTIALS, confirmCredentials);
    ...
    public static class AuroraChooseLockPatternFragment extends Fragment
        ...
        protected AuroraTextView mHeaderText;
        protected LockPatternView mLockPatternView;
        protected TextView mFooterText;
        private AuroraButton mFooterLeftButton;
        private AuroraButton mFooterRightButton;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (!(getActivity() instanceof AuroraChooseLockPattern)) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            // setupViews()
            View view = inflater.inflate(R.layout.aurora_choose_lock_pattern, null);
            ...
            mFooterLeftButton = (AuroraButton) view.findViewById(R.id.footerLeftButton);
            mFooterRightButton = (AuroraButton) view.findViewById(R.id.footerRightButton);
        ...
        private void saveChosenPatternAndFinish() {
            ...
            //getActivity().setResult(RESULT_FINISHED);
            //Gionee <chenml> <2015-01-07> modify for CR01434175 begin
            ...
            //Gionee <chenml> <2015-01-07> modify for CR01434175 end
			/*Intent intent = new Intent().setClass(getActivity(), AuroraPasswordSuccessActivity.class);
			intent.putExtra(AuroraPasswordSuccessActivity.EXTRA_PASSWORD_VALUE, 
			    LockPatternUtils.patternToString(mChosenPattern));
			intent.putExtra(AuroraPasswordSuccessActivity.EXTRA_PASSWORD_QUALITY, DevicePolicyManager.PASSWORD_QUALITY_SOMETHING);
            ...
            if(SecurityUtils.isSecurityPasswordEnable(mLockPatternUtils)){
                ...
                remindUserBind(LockPatternUtils.patternToString(mChosenPattern));
            }
            savePattern(mChosenPattern);
            
            getActivity().finish();
            mDone = true;
        }

        private void savePattern(List<Cell> pattern) {
            ...
            if(mLockPatternUtils.isSecure()){
                ...
                mLockPatternUtils.gnSetLockPattern(strPattern);
            }
            final boolean lockVirgin = !mLockPatternUtils.isPatternEverChosen();
            if (lockVirgin) {
                mLockPatternUtils.setVisiblePatternEnabled(true);
            }			
            mLockPatternUtils.gnSetString(SecurityUtils.BACKUP_PATTERN, strPattern);
