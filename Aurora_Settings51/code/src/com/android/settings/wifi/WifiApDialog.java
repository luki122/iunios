...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*aurora linchunhui 调整界面布局,去掉无用控件*/
        //mView = getLayoutInflater().inflate(R.layout.wifi_ap_dialog, null);
        mView = getLayoutInflater().inflate(R.layout.aurora_wifi_ap_dialog, null);
        mSecurity = (AuroraSpinner) mView.findViewById(R.id.security);
        mSecurity.setTextAppearance(R.style.aurora_wifi_spinner_textsize);
        /// M: get plug in and set adapter for mSecurity @{
        mExt = UtilsExt.getAuroraWifiApDialogPlugin(context);
        ...
        setButton(BUTTON_SUBMIT, context.getString(R.string.dlg_ok), mListener);
