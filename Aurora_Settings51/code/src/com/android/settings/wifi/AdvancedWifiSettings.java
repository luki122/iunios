...
public class AdvancedWifiSettings extends AuroraSettingsPreferenceFragment
    ...
    private AuroraSwitchPreference mWifiAssistantPreference;
    private AuroraPreferenceScreen sleepPolicyPref;
    ...
    public void onResume() {
        ...
        /*aurora linchunhui 20150813 when the policy change, the summay shoule be change too. begin*/
        sleepPolicyPref = (AuroraPreferenceScreen) findPreference(KEY_SLEEP_POLICY);
        ...
        /*aurora linchunhui 20150813 when the policy change, the summay shoule be change too. end*/
    }
...
//        notifyOpenNetworks.setEnabled(mWifiManager.isWifiEnabled());
        ...
        AuroraSwitchPreference scanAlwaysAvailable =
            (AuroraSwitchPreference) findPreference(KEY_SCAN_ALWAYS_AVAILABLE);
        ...
        AuroraPreference pref = findPreference(KEY_INSTALL_CREDENTIALS);
        //pref.setIntent(intent);
        getPreferenceScreen().removePreference(pref);

        final Context context = getActivity();
        mWifiAssistantPreference = (AuroraSwitchPreference) findPreference(KEY_WIFI_ASSISTANT);
        ...
        if (UserHandle.myUserId() == UserHandle.USER_OWNER && !scorers.isEmpty()) {
		   ...
		   mWifiAssistantPreference.setChecked(checked);
        ...
        AuroraPreference wifiDirectPref = findPreference(KEY_WIFI_DIRECT);
        wifiDirectPref.setIntent(wifiDirectIntent);

        // WpsDialog: Create the dialog like WifiSettings does.
        AuroraPreference wpsPushPref = findPreference(KEY_WPS_PUSH);
        ...
        // WpsDialog: Create the dialog like WifiSettings does.
        AuroraPreference wpsPinPref = findPreference(KEY_WPS_PIN);
      ...
      /*  AuroraListPreference sleepPolicyPref = (AuroraListPreference) findPreference(KEY_SLEEP_POLICY);
        ...
        Log.d(TAG, "  immediately remove preference !!!!!!!");
        getPreferenceScreen().removePreference(frequencyPref);
        getPreferenceScreen().removePreference(scanAlwaysAvailable);
        getPreferenceScreen().removePreference(pref);
        getPreferenceScreen().removePreference(mWifiAssistantPreference);
        getPreferenceScreen().removePreference(wifiDirectPref);
        getPreferenceScreen().removePreference(wpsPushPref);
        getPreferenceScreen().removePreference(wpsPinPref);
    ...
    private void updateFrequencyBandSummary(AuroraPreference frequencyBandPref, int index) {
    ...
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen screen, AuroraPreference preference) {
        ...
        if (KEY_NOTIFY_OPEN_NETWORKS.equals(key)) {
            Global.putInt(getContentResolver(),
                    ...
                    ((AuroraSwitchPreference) preference).isChecked() ? 1 : 0);
