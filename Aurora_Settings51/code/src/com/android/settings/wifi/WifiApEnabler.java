...
public class WifiApEnabler extends Fragment
    ...
    private static final int DELAY_DISABLE_TO_ENABLE_SWITCH = 0;
    private static final int DELAY_ENABLE_TO_DISENABLE_SWITCH = 1;
    private Handler mHander = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			switch(msg.what){
			case DELAY_DISABLE_TO_ENABLE_SWITCH:
				setSwitchEnabled(true);
				break;
			case DELAY_ENABLE_TO_DISENABLE_SWITCH:
	           setSwitchEnabled(true);
	           if (mSwitchBar == null) {
    ...
    public WifiApEnabler(Context context, AuroraSwitchPreference switchPreference) {
        mContext = context;
    ...
    private void handleWifiApStateChanged(int state) {
        switch (state) {
            ...
            case WifiManager.WIFI_AP_STATE_ENABLED:
                ...
                mHander.removeMessages(DELAY_DISABLE_TO_ENABLE_SWITCH);
                mHander.sendEmptyMessageDelayed(DELAY_DISABLE_TO_ENABLE_SWITCH,2000);//Aurora linchunhui modify for BUG-19221
                setStartTime(true);
                break;
            ...
            case WifiManager.WIFI_AP_STATE_DISABLED:
                ...
                setSwitchChecked(false);
                mHander.removeMessages(DELAY_ENABLE_TO_DISENABLE_SWITCH);
                mHander.sendEmptyMessageDelayed(DELAY_ENABLE_TO_DISENABLE_SWITCH,2500); //Aurora linchunhui modify for BUG-19221
                break;
            default:
                enableWifiSwitch();
                break;
    ...
    public boolean onPreferenceChange(AuroraPreference preference, Object value) {
        if (preference.getKey().equals(WIFI_SWITCH_SETTINGS)) {
            setSwitchEnabled(false); //Aurora linchunhui modify for BUG-19221
            sendBroadcast(); // M: ALPS01831234
