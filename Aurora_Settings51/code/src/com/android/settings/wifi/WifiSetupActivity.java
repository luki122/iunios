...
public class WifiSetupActivity extends WifiPickerActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsFirstRun = intent.getBooleanExtra("firstRun", false);
    ...
    public void onAttachedToWindow () {
        ...
        com.aurora.utils.SystemUtils.switchStatusBarColorMode(
                   com.aurora.utils.SystemUtils.STATUS_BAR_MODE_BLACK, WifiSetupActivity.this);
    }
    ...
    @Override
    /* package */ Class<? extends AuroraPreferenceFragment> getWifiSettingsClass() {
    ...
    public void onNavigateNext() {
        if (mWifiConnected) {
            ...
            // if there is none.
            /*Aurora linchunhui 20160324 start*/
            ...
            /*Aurora linchunhui 20160324 end*/
        }
    }
