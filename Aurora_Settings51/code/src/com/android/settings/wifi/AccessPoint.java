...
class AccessPoint extends AuroraPreference{
    ...
    public LruCache<String, ScanResult> mScanResultCache;
     ...
     static final String KEY_DETAILEDSTATE = "key_detailedstate";
     ...
     public static final int AP_VIEW_ON_CLICK = 0;
     public static final int AP_VIEW_ON_LONG_CLICK = 1;
     /*BUG-15846 aurora linchunhui 不能刷新主界面导致无法通过设置按钮开启wifi begin*/
     //private Handler mHandler = new Handler(){
     private Handler mHandler = new Handler(getContext().getMainLooper()){
     /*BUG-15846 aurora linchunhui 不能刷新主界面导致无法通过设置按钮开启wifi end*/
		@Override
		public void handleMessage(Message msg) {
			// TODO Auto-generated method stub
		         switch(msg.what){
		         case AP_VIEW_ON_CLICK:
		        	 if (mFragment != null) {
		        		 Log.v(TAG, "handleMessage");
					      mFragment.doPreferenceTreeClick(mAccessPoint, false);
					}
		        	 break;
                         /*Aurora linchunhui 20160406 add */
		         case AP_VIEW_ON_LONG_CLICK:
		        	 if (mFragment != null) {
		        		 Log.v(TAG, "handleMessage long click ... ");
					      mFragment.doPreferenceTreeLongClick(mAccessPoint);
					}
		        	 break;
		         }
		}
    ...
    public int mRssi = Integer.MAX_VALUE; //Aurora linchunhui 20160226 modify to public
...
//        /// @}
        if(android.text.TextUtils.isEmpty(getSummary()))
        {
        	 ...
        	 if(accesspoint_layout!=null)
        	 {
        		 ...
        		 params.height = com.aurora.utils.DensityUtil.dip2px(getContext(), 52);
        		 accesspoint_layout.setLayoutParams(params);
        	 }
        }

        /*Aurora <linchunhui> remove the detail view begin*/
        signalView = (ImageView) view.findViewById(R.id.wifi_signal);
        ...
        if (mRssi == Integer.MAX_VALUE) {
        	...
        	signalView.setImageLevel(getLevel(5));
        ...
        /*Aurora <linchunhui> remove the detail view end*/
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               /* if (mFragment != null) {
            	...
            	mHandler.removeMessages(AP_VIEW_ON_CLICK);
				mHandler.sendEmptyMessage(AP_VIEW_ON_CLICK);
            }
        });
        ...
        view.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View arg0) {
            	mHandler.removeMessages(AP_VIEW_ON_LONG_CLICK);
				mHandler.sendEmptyMessage(AP_VIEW_ON_LONG_CLICK);
                return true;
            }
        });
    ...
    boolean update(ScanResult result) {
        ...
        if (ssid.equals(result.SSID) && security == getSecurity(result)) {
            if (WifiManager.compareSignalLevel(result.level, mRssi) > 0) {
                int oldLevel = getLevel(5);
                mRssi = result.level;
                if (getLevel(5) != oldLevel) {
                    notifyChanged();
                }
            }
...
//            mRssi = info.getRssi();
    ...
    /*
     * num 将信号分为num个级别，aurora linchunhui 20150821
     */
    int getLevel(int num) {
        if (mRssi == Integer.MAX_VALUE) {
            return -1;
        }
        return WifiManager.calculateSignalLevel(mRssi, num);
    }
