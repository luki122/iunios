...
public class VoiceInputOutputSettings {
    ...
    private AuroraPreference mVoiceInputSettingsPref;
    private AuroraPreference mTtsSettingsPref;
    private final AuroraSettingsPreferenceFragment mFragment;
    private final TtsEngines mTtsEngines;

    public VoiceInputOutputSettings(AuroraSettingsPreferenceFragment fragment) {
        mFragment = fragment;
