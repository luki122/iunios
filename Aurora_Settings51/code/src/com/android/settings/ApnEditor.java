...
public class ApnEditor extends AuroraPreferenceActivity
        implements SharedPreferences.OnSharedPreferenceChangeListener,
                    ...
                    MsimRadioValueObserver.Listener,View.OnClickListener {
    ...
    private AuroraListPreference mMvnoType;
    private AuroraEditTextPreference mMvnoMatchData;
    ...
    private AuroraApnEditTextPreference mApnTypeList; //aurora linchunhui 20150910 BUG-16347 
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //aurora linchunhui 20150910 BUG-16347 begin
        /// M: change the type preference to list preference {@
        mApnTypeList = (AuroraApnEditTextPreference) findPreference("apn_type_list");
        mApnTypeList.setOnPreferenceChangeListener(this);
        /// @}
        //aurora linchunhui 20150910 BUG-16347 end
        ...
        mMvnoType = (AuroraListPreference) findPreference(KEY_MVNO_TYPE);
        mMvnoType.setOnPreferenceChangeListener(this);
        mMvnoMatchData = (AuroraEditTextPreference) findPreference("mvno_match_data");
    ...
    public void onResume() {
       ...
       /* if (ApnUtils.TETHER_TYPE.equals(mApnTypeList.getText())) {
            mExt.setApnTypePreferenceState(mApnTypeList);
        } */
        mExt.setMVNOPreferenceState(mMvnoType);
        mExt.setMVNOPreferenceState(mMvnoMatchData);
    ...
    private void fillUi() {
        ...
        if (mFirstTime) {
            ...
            mApnTypeList.setText(strType); //aurora linchunhui 20150910 BUG-16347 
            ...
            if (mNewApn) {
                ...
                if (ApnUtils.TETHER_TYPE.equals(apnType)) {
                    mApnTypeList.setSummary("tethering");//aurora linchunhui 20150910 BUG-16347 
                  //  mApnTypeList.intCheckState("tethering");
                } else {
                    mApnTypeList.setSummary("default");//aurora linchunhui 20150910 BUG-16347 
        ...
        mApnTypeList.setSummary(checkNull(mApnTypeList.getText()));//aurora linchunhui 20150910 BUG-16347 
 ...
 /*  private String mvnoDescription(String newValue) {
    ...
    public boolean onPreferenceChange(AuroraPreference preference, Object newValue) {
        ...
        if (KEY_AUTH_TYPE.equals(key)) {
            ...
            mApnTypeList.setSummary(checkNull((String) newValue));//aurora linchunhui 20150910 BUG-16347 
        }
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK: {
			/*
			 * if (validateAndSave(false)) { finish(); }
			 */
			String name = checkNotSet(mName.getText());
			String apn = checkNotSet(mApn.getText());
			if (mNewApn) {
				if (name.length() > 0 || apn.length() > 0) {
					new AlertDialog.Builder(this) //Aurora linchunhui 20160309 modify
							.setTitle(R.string.aurora_apn_add_message)
							//.setMessage(R.string.apn_add_message)
							.setPositiveButton(R.string.aurora_apn_ok,
									new OnClickListener() {
										@Override
										public void onClick(
							...
							.setNegativeButton(R.string.apn_cancel,
									new OnClickListener() {
				...
				new AlertDialog.Builder(this)
						.setTitle(R.string.aurora_apn_add_message)//Aurora linchunhui 20160321 modify
						//.setMessage(R.string.apn_edit_message)
						.setPositiveButton(R.string.aurora_apn_ok,
								new OnClickListener() {
									@Override
    ...
    private boolean validateAndSave(boolean force) {
        ...
        values.put(Telephony.Carriers.TYPE, checkNotSet(mApnTypeList.getText()));//aurora linchunhui 20150910 BUG-16347 
    ...
    private String getErrorMsg() {
        ...
        String apnType = mApnTypeList.getText();//aurora linchunhui 20150910 BUG-16347 
                ...
                if (!portStr.equals("")) {
                    try {
                        ...
                        if (portNum > 65535 || portNum <= 0) {
                            ...
                            ((AuroraEditTextPreference) pref).setText("");
                        }
                    } catch (NumberFormatException e) {
                        Toast.makeText(this, getString(R.string.apn_port_warning),
                                Toast.LENGTH_LONG).show();
    ...
    private String updateMccMncForSvlte(int subId, String iccNumeric) {
        ...
        int c2kSlot = FeatureOption.getExternalModemSlot();
