 ...
 */
public class PowerGaugePreference extends AuroraPreference {
...
//        setIcon(icon != null ? icon : new ColorDrawable(0));
    ...
    public void setPercent(double percentOfMax, double percentOfTotal) {
        /*aurora linchunhui 20150817 fix the wrong progress begin*/
        //mProgress = (int) Math.ceil(percentOfMax);
        mProgress = (int) (percentOfTotal + 0.5);
        /*aurora linchunhui 20150817 fix the wrong progress end*/
