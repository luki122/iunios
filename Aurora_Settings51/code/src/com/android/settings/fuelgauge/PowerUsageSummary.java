 ...
 */
public class PowerUsageSummary extends AuroraPreferenceFragment implements AuroraPreference.OnPreferenceChangeListener {
    ...
    private BroadcastReceiver mBatteryInfoReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
				...
				String batteryStatus = com.android.settings.Utils
						.getBatteryStatus(getResources(), intent);
    ...
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen preferenceScreen, AuroraPreference preference) {
    	...
    	/**
    	 * Percentage of Charge Details intent
    	 */
    ...
    private void refreshStats() {
        ...
        mHistPref.setOrder(-1);
         ...
         //---------------Shielded power usage details Figure  from by JM begin-----------
        
        //Percentage of Charge Details
//        mAppListGroup.addPreference(mHistPref);
        //---------------Shielded power usage details Figure  from by JM end-----------
        ...
        if (averagePower >= MIN_AVERAGE_POWER_THRESHOLD_MILLI_AMP) {
            ...
            for (int i = 0; i < numSippers; i++) {
                ...
                addedSome = true;
                /*aurora linchunhui 20150817 begin*/
                pref.setSelectable(false);
                /*aurora linchunhui 20150817 end*/
