...
public class ZonePicker extends ListFragment {
    ...
    public static SimpleAdapter constructTimezoneAdapter(Context context,
        ...
        return constructTimezoneAdapter(context, sortedByName,
        		R.layout.gn_simple_list_item_2   /* R.layout.date_time_setup_custom_list_item_2*/);
    }

    static class SimpleAdapterSelf extends SimpleAdapter{
	
		public SimpleAdapterSelf(Context context,
...
//			android.R.id.text1, android.R.id.text2
    ...
    public static SimpleAdapter constructTimezoneAdapter(Context context,
        ...
        final SimpleAdapter adapter = new SimpleAdapterSelf(context,
                sortedList,
                layoutId,
                from,
                to);
