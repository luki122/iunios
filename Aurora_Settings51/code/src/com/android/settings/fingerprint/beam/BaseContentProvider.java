...
import com.aurora.utils.StringUtil;

public abstract class BaseContentProvider extends ContentProvider {

    private AuroraFingerprintSqlite dbHelper;
    ...
    public static boolean isHave(Context context, String selection,
        ...
        boolean flag = false;
        if (context == null || StringUtil.isEmpty(selection) || selectionArgs == null) {
            return flag;
        }
    ...
    public boolean onCreate() {
        dbHelper = new AuroraFingerprintSqlite(getContext());
