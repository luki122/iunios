...
public class VpnSettings extends AuroraSettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedState) {
        ...
        if (!SystemProperties.getBoolean("persist.radio.imsregrequired", false)) {
        	//按照产品要求，去除这项功能
        	 //mActionBar.addItem(AuroraActionBarItem.Type.More, MENU_ID_VPN_LOCKDOWN);
        }
    ...
    public void onResume() {
        ...
        getListView().registerFragmentForContextMenu(this);
    }
