...
class VpnDialog extends AuroraAlertDialog implements TextWatcher,
    ...
    private AuroraCheckBox mMppe;
    private TextView mL2tpSecret;
    private TextView mIpsecIdentifier;
    private TextView mIpsecSecret;
	private AuroraSpinner mIpsecUserCert;
	private AuroraSpinner mIpsecCaCert;
	private AuroraSpinner mIpsecServerCert;
    //private Spinner mIpsecUserCert;
    //private Spinner mIpsecCaCert;
    //private Spinner mIpsecServerCert;
    private AuroraCheckBox mSaveLogin;
    ...
    protected void onCreate(Bundle savedState) {
        ...
        mType = (AuroraSpinner) mView.findViewById(R.id.type);
        ...
        mMppe = (AuroraCheckBox) mView.findViewById(R.id.mppe);
        ...
        mIpsecUserCert = (AuroraSpinner) mView.findViewById(R.id.ipsec_user_cert);
        mIpsecCaCert = (AuroraSpinner) mView.findViewById(R.id.ipsec_ca_cert);
        mIpsecServerCert = (AuroraSpinner) mView.findViewById(R.id.ipsec_server_cert);
        mSaveLogin = (AuroraCheckBox) mView.findViewById(R.id.save_login);
        ...
        // Let AuroraAlertDialog create everything.
        super.onCreate(null);
        ...
        // Aurora penggangding 2013-09-17 begin
				...
				timer.schedule(new TimerTask() {
					...
					public void run() {
						((InputMethodManager) getContext().getSystemService(
								"input_method")).toggleSoftInput(0,
		...
		// Aurora penggangding 2013-09-17 end
    }
    ...
    private void loadCertificates(AuroraSpinner spinner, String prefix, int firstId, String selected) {
        Context context = getContext();
