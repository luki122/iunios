 ...
 */
public class AccountSettings extends AuroraSettingsPreferenceFragment
    ...
    private AuroraPreference mProfileNotAvailablePreference;
    ...
    private static class ProfileData {
         ...
         */
        public AuroraPreferenceGroup preferenceGroup;
        /**
         * The preference that displays the add account button.
         */
        public AuroraPreference addAccountPreference;
        /**
         * The preference that displays the button to remove the managed profile
         */
        public AuroraPreference removeWorkProfilePreference;
        /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mProfileNotAvailablePreference = new AuroraPreference(getActivity());
    ...
    void updateUi() {
        ...
        final AuroraPreferenceScreen preferenceScreen = (AuroraPreferenceScreen) findPreference(KEY_ACCOUNT);
        if(mUm.isLinkedUser()) {
    ...
    private void updateProfileUi(final UserInfo userInfo, boolean addCategory,
        ...
        if (addCategory) {
            profileData.preferenceGroup = new AuroraPreferenceCategory(context);
    ...
    private AuroraPreference newAddAccountPreference(Context context) {
        AuroraPreference preference = new AuroraPreference(context);
    ...
    private AuroraPreference newRemoveWorkProfilePreference(Context context) {
        AuroraPreference preference = new AuroraPreference(context);
    ...
    private void cleanUpPreferences() {
        AuroraPreferenceScreen preferenceScreen = getPreferenceScreen();
    ...
    private class AccountPreference extends AuroraPreference implements AuroraPreference.OnPreferenceClickListener {
        /**
