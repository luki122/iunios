...
public final class CredentialStorage extends Activity {
            ...
            DialogInterface.OnClickListener, DialogInterface.OnDismissListener
    {
        ...
        private UnlockDialog() {
            ...
            mOldPassword.setInputType(EditorInfo.TYPE_CLASS_PHONE);
            view.findViewById(R.id.old_password_line).setVisibility(View.VISIBLE);
            view.findViewById(R.id.hint_message).setVisibility(View.VISIBLE);
            ...
            /* Aurora linchunhui 20160412 modify start */
            sUnlockDialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
            InputMethodManager imm = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
            imm.showSoftInput(mOldPassword, 0);
            imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
            /* Aurora linchunhui 20160412 modify end */
        }
