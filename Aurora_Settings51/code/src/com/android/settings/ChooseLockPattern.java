...
import com.android.settings.Settings.AuroraLockScreenNotifyActivity;
import com.android.settings.notification.RedactionInterstitial;
import com.android.settings.securitypasswd.AuroraLockPatternUtils;
import com.android.settings.securitypasswd.SecurityUtils;
import com.aurora.utils.LockPatternView;
 ...
 */
public class ChooseLockPattern extends AuroraPreferenceActivity {
    /**
   ...
   /* @Override
    ...
    public static class ChooseLockPatternFragment extends Fragment
        ...
        protected List<com.android.internal.widget.LockPatternView.Cell> mChosenPattern = null;
        ...
        protected LockPatternView.OnPatternListener mChooseNewLockPatternListener =
                new LockPatternView.OnPatternListener() {
                    ...
                    public void onPatternCellAdded(List<com.android.internal.widget.LockPatternView.Cell> pattern) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return inflater.inflate(R.layout.choose_lock_pattern_u, container, false);
        }
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            mLockPatternView.setOnPatternListener((LockPatternView.OnPatternListener) mChooseNewLockPatternListener);
            ...
            //<Aurora> <hujianwei> 20150727 modify for fix bug BUG #14842 with confirm_credentials true -> false
            ...
            if (savedInstanceState == null) {
                ...
                if (patternString != null) {
                    ...
                    //Aurora <jiyouguang> <2015-05-08> modify for pattern begin
                    mChosenPattern = LockPatternUtils.stringToPattern(patternString);
                    //mChosenPattern = mLockPatternView.stringToPattern(patternString);
                    //Aurora <jiyouguang> <2015-05-08> modify for pattern end
                }
        ...
        public void handleRightButton() {
            if (mUiStage.rightMode == RightButtonMode.Continue) {
                ...
                mLockPatternView.clearPattern();
                //Aurora <jiyouguang> <2015-07-01> modify for pattern begin
                // mLockPatternView.setDisplayMode(DisplayMode.Correct);
                mLockPatternView.setDisplayMode(LockPatternView.DisplayMode.Correct);
                //Aurora <jiyouguang> <2015-07-01> modify for pattern end
                updateStage(Stage.Introduction);
            }
        }
        ...
        public void onSaveInstanceState(Bundle outState) {
            ...
            if (mChosenPattern != null) {
                ...
                /*outState.putString(KEY_PATTERN_CHOICE,
                        mLockPatternView.patternToString(mChosenPattern));*/
                //Aurora <jiyouguang> <2015-05-08> modify for pattern end
...
//            mLockPatternView.saveLockPattern(mChosenPattern, isFallback);
            AuroraLockPatternUtils mLockPatternUtils = new AuroraLockPatternUtils(getActivity());

            mLockPatternUtils.gnSetLong(SecurityUtils.SECURITYPASSWORD_TYPE, SecurityUtils.SECURITYPWD_PATTERN_TYPE);
            ...
            Intent intent = new Intent(getActivity(), AuroraLockScreenNotifyActivity.class);
            intent.putExtra(Utils.ACTIVITY_FINISH_AFTER_ON_PREFERENCE_CLICK, true);
