 ...
 */
public final class AuroraBluetoothDevicePreference extends AuroraPreference implements
        CachedBluetoothDevice.Callback, OnClickListener {
    private static final String TAG = "AuroraBluetoothDevicePreference";
    ...
    public AuroraBluetoothDevicePreference(Context context, CachedBluetoothDevice cachedDevice) {
        super(context);
        ...
        if (cachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
            ...
            if (! um.hasUserRestriction(DISALLOW_CONFIG_BLUETOOTH)) {
                setWidgetLayoutResource(R.layout.aurora_preference_bluetooth);
            }
        }
    ...
    public boolean equals(Object o) {
        if ((o == null) || !(o instanceof AuroraBluetoothDevicePreference)) {
            return false;
        }
        return mCachedDevice.equals(
                ((AuroraBluetoothDevicePreference) o).mCachedDevice);
    }
    ...
    public int compareTo(AuroraPreference another) {
        if (!(another instanceof AuroraBluetoothDevicePreference)) {
            // Rely on default sort
            return super.compareTo(another);
        }

        return mCachedDevice
                .compareTo(((AuroraBluetoothDevicePreference) another).mCachedDevice);
    }
    ...
    void onClicked() {
        ...
        if (mCachedDevice.isConnected()) {
            Log.d(TAG, "Profile is connected, ask disconnect ");
            askDisconnect();
        } else if (bondState == BluetoothDevice.BOND_BONDED) {
            Log.d(TAG, "Device is bonded, request to connect : " + mCachedDevice.getName());
            mCachedDevice.connect(true);
        } else if (bondState == BluetoothDevice.BOND_NONE) {
            Log.d(TAG, "Device is unbonded, request to pair : " + mCachedDevice.getName());
            pair();
        }
    }
    ...
    private void pair() {
        if (!mCachedDevice.startPairing()) {
            ...
            data.className = AuroraBluetoothSettings.class.getName();
