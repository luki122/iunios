 ...
 */
public abstract class AuroraDeviceListPreferenceFragment extends
        AuroraRestrictedSettingsFragment implements BluetoothCallback {

    private static final String TAG = "AuroraDeviceListPreferenceFragment";
    ...
    private AuroraPreferenceGroup mDeviceListGroup;

    final WeakHashMap<CachedBluetoothDevice, AuroraBluetoothDevicePreference> mDevicePreferenceMap =
            new WeakHashMap<CachedBluetoothDevice, AuroraBluetoothDevicePreference>();

    AuroraDeviceListPreferenceFragment(String restrictedKey) {
        super(restrictedKey);
    ...
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen preferenceScreen,
        ...
        if (preference instanceof AuroraBluetoothDevicePreference) {
            AuroraBluetoothDevicePreference btPreference = (AuroraBluetoothDevicePreference) preference;
    ...
    void createDevicePreference(CachedBluetoothDevice cachedDevice) {
        ...
        AuroraBluetoothDevicePreference preference = new AuroraBluetoothDevicePreference(
    ...
    public void onDeviceDeleted(CachedBluetoothDevice cachedDevice) {
        AuroraBluetoothDevicePreference preference = mDevicePreferenceMap.remove(cachedDevice);
        if (preference != null) {
