 ...
 */
public final class AuroraDevicePickerFragment extends AuroraDeviceListPreferenceFragment {
    private static final int MENU_ID_REFRESH = Menu.FIRST;

    private static final String TAG = "AuroraDevicePickerFragment";

    public AuroraDevicePickerFragment() {
    ...
    void addPreferencesForActivity() {
        addPreferencesFromResource(R.xml.aurora_device_picker);
    ...
    public void onResume() {
        ...
        com.aurora.utils.SystemUtils.switchStatusBarColorMode(
                   com.aurora.utils.SystemUtils.STATUS_BAR_MODE_BLACK, getActivity());
    }
