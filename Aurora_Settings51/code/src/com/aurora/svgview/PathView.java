...
public class PathView extends View {
     ...
     */
    public AnimatorBuilder getPathAnimator(AnimatorBuilder.ListenerEnd listenerEnd) {
        if (animatorBuilder == null) {
            animatorBuilder = new AnimatorBuilder(this, listenerEnd);
        }
        return animatorBuilder;
    }

    public void setPathAnimator(boolean first) {
        animatorBuilder.setAnimDirect(this, first);
    }
    ...
    public static class AnimatorBuilder {
         ...
         */
        public AnimatorBuilder(final PathView pathView, ListenerEnd listenerEnd) {
            anim = ObjectAnimator.ofFloat(pathView, "percentage", 1.0f, 0.0f);
            listenerEnd(listenerEnd);
        }
        ...
        public AnimatorBuilder setAnimDirect(final PathView pathView, boolean first) {
            if (first) {
                anim = ObjectAnimator.ofFloat(pathView, "percentage", 1.0f, 0.0f);
