...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.LockPatternView);
        ...
        mRegularColor = getResources().getColor(R.color.lock_pattern_normal_color);
        mErrorColor = getResources().getColor(R.color.lock_pattern_failed_color);
        mSuccessColor = getResources().getColor(R.color.lock_pattern_cuccess_color);
        mRegularColor = a.getColor(com.android.internal.R.styleable.LockPatternView_regularColor, mRegularColor);
        mErrorColor = a.getColor(com.android.internal.R.styleable.LockPatternView_errorColor, mErrorColor);
        mSuccessColor = a.getColor(com.android.internal.R.styleable.LockPatternView_successColor, mSuccessColor);

        int pathColor = a.getColor(com.android.internal.R.styleable.LockPatternView_pathColor, mRegularColor);
        ...
        mPathWidth = getResources().getDimensionPixelSize(com.android.internal.R.dimen.lock_pattern_dot_line_width);
        mPathPaint.setStrokeWidth(mPathWidth);

        mDotSize = getResources().getDimensionPixelSize(com.android.internal.R.dimen.lock_pattern_dot_size);
        ...
        mFastOutSlowInInterpolator =
                AnimationUtils.loadInterpolator(context, com.android.internal.R.interpolator.fast_out_slow_in);
        mLinearOutSlowInInterpolator =
                AnimationUtils.loadInterpolator(context, com.android.internal.R.interpolator.linear_out_slow_in);
    }
    ...
    private void notifyCellAdded() {
        sendAccessEvent(com.android.internal.R.string.lockscreen_access_pattern_cell_added);
    ...
    private void startCellActivatedAnimation(Cell cell) {
        ...
        startLineEndAnimation(cellState, mInProgressX, mInProgressY,
                getCenterXForColumn(cell.getColumn()), getCenterYForRow(cell.getRow()));
    }
        ...
        for (int i = 0; i < historySize + 1; i++) {
            ...
            if (mPatternInProgress && patternSize > 0) {
                ...
                if (hitCell != null) {
                    ...
                    final float hitCellCenterX = getCenterXForColumn(hitCell.getColumn());
                    final float hitCellCenterY = getCenterYForRow(hitCell.getRow());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawPath) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (i != 0) {
                    CellState state = mCellStates[cell.getRow()][cell.getColumn()];
                    currentPath.rewind();
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR =
                new Creator<LockPatternView.SavedState>() {
