...
public class AuroraAnimationImageView extends ImageView{
    private static final String TAG = "AnimationImageButton";
    ...
    public AuroraAnimationImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAnimationBG = context.getResources().getDrawable(R.drawable.keyinput_btn_bg_pressed);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mAnimationBG = getResources().getDrawable(R.drawable.keyinput_btn_bg_pressed);
