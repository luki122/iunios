...
public class DisplaySettingsExt implements AuroraPreference.OnPreferenceClickListener {
    ...
    private AuroraPreference mHDMISettings;
    private ISettingsMiscExt mExt;

    private AuroraPreferenceCategory mDisplayPerCategory;
    private AuroraPreferenceCategory mDisplayDefCategory;
    ...
    private AuroraPreference mLockScreenStylePref;
    private IStatusBarPlmnDisplayExt mPlmnName;
    private boolean mIsUpdateFont;
    private Context mContext;

    private AuroraPreference mScreenTimeoutPreference;
    private AuroraListPreference mFontSizePref;
    ...
    private AuroraPreference mClearMotion;

    // add for MiraVision
    private static final String KEY_MIRA_VISION = "mira_vision";
    private AuroraPreference mMiraVision;
     ...
     * @return
     */
    private AuroraPreference createPreference(int type, int titleRes, String key, AuroraPreferenceGroup screen) {
    ...
    private void initPreference(AuroraPreferenceScreen screen) {
        mDisplayPerCategory = (AuroraPreferenceCategory) createPreference(TYPE_CATEGORY,
                R.string.display_personalize, DISPLAY_PERSONALIZE, screen);

        mDisplayDefCategory = (AuroraPreferenceCategory) createPreference(TYPE_CATEGORY,
        ...
        mFontSizePref = (AuroraListPreference) mDisplayDefCategory.findPreference(KEY_FONT_SIZE);
       ...
       // mPlmnName.createCheckBox(mDisplayDefCategory, j);
        ...
        if (status.getFeatureState() == WifiDisplayStatus.FEATURE_STATE_UNAVAILABLE) {
            ...
            AuroraPreferenceScreen wfdPreferenceScreen = (AuroraPreferenceScreen) screen
    ...
    public void removePreference(AuroraPreference preference) {
     ...
     */
    private void updateFontSize(AuroraListPreference fontSizePreference) {
    ...
    public int floatToIndex(AuroraListPreference fontSizePreference, float val) {
