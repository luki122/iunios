...
public class PowerUsageExts {
    ...
    private AuroraSwitchPreference mBgPowerSavingPrf;

    // Power saving mode feature plug in
    private IBatteryExt mBatteryExt;

    public PowerUsageExts(Context context, AuroraPreferenceGroup appListGroup) {
        mContext = context;
    ...
    public void initPowerUsageExtItems() {
        ...
        if (FeatureOption.MTK_BG_POWER_SAVING_SUPPORT
            ...
            mBgPowerSavingPrf = new AuroraSwitchPreference(mContext);
    ...
    // on click
    public boolean onPowerUsageExtItemsClick(AuroraPreferenceScreen preferenceScreen,
        ...
        if (KEY_BACKGROUND_POWER_SAVING.equals(preference.getKey())) {
            if (preference instanceof AuroraSwitchPreference) {
                AuroraSwitchPreference pref = (AuroraSwitchPreference) preference;
