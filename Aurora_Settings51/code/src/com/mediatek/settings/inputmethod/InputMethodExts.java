...
public class InputMethodExts {
    ...
    private AuroraPreference mVoiceUiPref;
    private Intent mVoiceControlIntent;

    // { @ Smart book mouse/touch pad settings
    private AuroraListPreference mPointerPrimayKeyPrefe;
    private AuroraPreferenceCategory mPointerSettingsCategory;
    ...
    public InputMethodExts(Context context, boolean isOnlyImeSettings,
            AuroraPreferenceCategory voiceCategory, AuroraPreferenceCategory pointCategory) {
        mContext = context;
    ...
    public void initExtendsItems() {
        // For voice control
        mVoiceUiPref = new AuroraPreference(mContext);
        ...
        // { @ : Smart book mouse/touch pad settings
        mPointerPrimayKeyPrefe = new AuroraListPreference(mContext);
            ...
            if (mPointerSettingsCategory != null) {
                if (mPointerPrimayKeyPrefe != null) {
                    ...
                    mPointerPrimayKeyPrefe
                            .setOnPreferenceChangeListener(new AuroraPreference.OnPreferenceChangeListener() {
