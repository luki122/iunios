...
public class StorageVolumePreferenceCategoryExts {
    ...
    public void setVolumeTitle(AuroraPreference preference) {
        String title = null;
        if (mVolume == null) {
            int resId  = (FeatureOption.MTK_SHARED_SDCARD && !FeatureOption.MTK_2SDCARD_SWAP) ?
            		R.string.aurora_internal_storage : R.string.internal_storage;
    ...
    public void updateUserOwnerState(UserManager userManager, AuroraPreference preference) {
    ...
    public void initPhoneStorageMountTogglePreference(AuroraPreferenceCategory root,
           AuroraPreference mountToggle, StorageManager storageManager) {
