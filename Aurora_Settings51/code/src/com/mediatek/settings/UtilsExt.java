...
public class UtilsExt {
    ...
    public static AuroraIWifiApDialogExt getAuroraWifiApDialogPlugin(Context context) {
    	AuroraIWifiApDialogExt ext;
        ext = (AuroraIWifiApDialogExt) MPlugin.createInstance(
        		AuroraIWifiApDialogExt.class.getName(), context);
        if (ext == null) {
            ext = new AuroraDefaultWifiApDialogExt();
        }
        return ext;
    }
