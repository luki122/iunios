...
public class WifiGprsSelector extends WifiSettings implements OnPreferenceChangeListener {
    ...
    private AuroraPreferenceCategory mApnList;
    private AuroraPreference mAddWifiNetwork;
    private AuroraCheckBoxPreference mDataEnabler;
    private AuroraPreference mDataEnablerGemini;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mApnList = (AuroraPreferenceCategory)findPreference(KEY_APN_LIST);
        mAddWifiNetwork = findPreference(KEY_ADD_WIFI_NETWORK);
  
        AuroraPreferenceCategory dataEnableCategory =
            (AuroraPreferenceCategory)findPreference(KEY_DATA_ENABLER_CATEGORY);
        if (FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            mDataEnabler = (AuroraCheckBoxPreference)findPreference(KEY_DATA_ENABLER);
