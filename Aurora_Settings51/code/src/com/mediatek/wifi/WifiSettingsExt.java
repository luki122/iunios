...
public class WifiSettingsExt {
    ...
    public void onActivityCreated(AuroraSettingsPreferenceFragment fragment, WifiManager wifiManager) {
...
//        mExt.addCategories(fragment.getPreferenceScreen());
        mExt.addCategories(((WifiSettings)fragment).getPreferenceCategory());
    ...
    public void submit(WifiConfiguration config, AuroraPreference accessPoint, int networkId, DetailedState state) {
