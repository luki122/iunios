...
import com.android.settings.wifi.AuroraWifiApFregment;
 ...
 */
public class TetherWifiSettings extends AuroraSettingsPreferenceFragment
    ...
    private AuroraListPreference mWifiAutoDisable;
    private AuroraPreference mCreateNetwork;
    private AuroraPreference mWpsConnect;
    private AuroraPreference mBandwidth;
    ...
    private AuroraPreferenceCategory mConnectedCategory;
    private AuroraPreferenceCategory mBlockedCategory;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mWifiAutoDisable = (AuroraListPreference) findPreference(WIFI_AUTO_DISABLE);
        ...
        getPreferenceScreen().removePreference(mWpsConnect); //Aurora linchunhui 20160226 modify for BUG-19836
        ...
        mConnectedCategory = (AuroraPreferenceCategory)findPreference(CONNECTED_CATEGORY);
        mBlockedCategory = (AuroraPreferenceCategory)findPreference(BLOCKED_CATEGORY);
...
//                    mSecurityType[index]));
    ...
    AuroraWifiApFregment auroraWifiApFregment=null;
    @Override
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen screen, AuroraPreference preference) {
        ConnectivityManager cm =
                (ConnectivityManager)getSystemService(Context.CONNECTIVITY_SERVICE);
        Log.d(TAG, "  preferenceName ='"+preference+"'  Taskid= "+getActivity().getTaskId());
        if (preference == mCreateNetwork) {

             showDialog(DIALOG_AP_SETTINGS); //Aurora linchunhui modify 20160226

             /*Modify by penggangding begin
             Intent nIntent= new Intent(getActivity(),AuroraWifiApFregment.class );
             Bundle bundle=new Bundle();
             bundle.putParcelable("wifi_config", mWifiConfig);
             nIntent.putExtra("bundle", bundle);
