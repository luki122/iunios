...
public abstract class CursorAdapter extends BaseAdapter implements Filterable,
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 100:
//				AuroraLog.elog(TAG, "mCursor.requery()");
...
//			AuroraLog.elog(TAG, "ChangeObserver.onChange");
			onSelfContentChanged();
		}
	}
...
//			AuroraLog.elog(TAG, "MyDataSetObserver.onChange");
			mDataValid = true;
			notifyDataSetChanged();
		}
