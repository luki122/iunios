 ...
 */
public class AuroraDownloadManager {

	private static final String TAG = "DownloadManager/Framework";
	...
	/**
	 * Value of {@link #COLUMN_STATUS} when the download has failed because of
	 * insufficient memory This is only used to OMA download
	 * 
	 * @hide
	 */
	...
	/**
	 * Value of {@link #COLUMN_STATUS} when the download has failed because of
	 * invalid descriptor This is only used to OMA Download
	 * 
	 * @hide
	 */
	...
	/**
	 * Value of {@link #COLUMN_REASON} when the download is paused for paused by
	 * app. This flag is used to Resume download
	 * 
	 * @hide
	 */
	...
	public static final String GN_ACTION_DOWNLOAD_COMPLETE = "gn.android.intent.action.DOWNLOAD_COMPLETE";
	...
	public static class Request {
		 ...
		 * usuable only with
		 * {@link AuroraDownloadManager#addCompletedDownload(String, String, boolean, String, String, long, boolean)}
		 * .
		 */
		...
		public Request setDestinationUri(Uri uri) {
			mDestinationUri = uri;
			Log.v(TAG, "setDestinationUri: mDestinationUri " + mDestinationUri);
			return this;
		}
		...
		public Request setDestinationInExternalPublicDir(String dirType,
			...
			Log.v(TAG, "setExternalPublicDir: dirType " + dirType + " subPath "
					+ subPath + "file" + file);
		...
		private void setDestinationFromBase(File base, String subPath) {
			...
			Log.v(TAG, "setDestinationFromBase: mDestinationUri "
					+ mDestinationUri);
		}
		 ...
		 * {@link AuroraDownloadManager#enqueue(Request)} is called.
		 */
		...
		public Request setUserAgent(String userAgent) {
			...
			Log.v(TAG, "setUserAgent: userAgent is: " + userAgent);
			return this;
		}
	...
	public static class Query {
		...
		Cursor runQuery(ContentResolver resolver, String[] projection,
			...
			// add by aven for aurora 下载列表排序
			String orderBy = "status" + " ASC , " + "lastmod" + " DESC ";
	...
	public AuroraDownloadManager(ContentResolver resolver, String packageName) {
		mResolver = resolver;
	...
	public Uri getUriForDownloadedFile(long id) {
		...
		try {
			...
			if (cursor.moveToFirst()) {
				...
				if (AuroraDownloadManager.STATUS_SUCCESSFUL == status) {
					int indx = cursor
