...
public class PhoneInterfaceManager extends ITelephony.Stub {
    ...
    private void publish() {
        ...
        } else if (DeviceUtils.isHMNOTE1LTETD()|| DeviceUtils.isMI4()) {
           	ServiceManager.addService("phone.0", this);
   ...
   public void call(String number) {
    ...
    public boolean supplyPin(String pin) {
        return (supplyPinReportResult(pin)[0] == PhoneConstants.PIN_RESULT_SUCCESS) ? true : false;
    }
...
/*    public int supplyPukReportResult(String puk, String pin) {
    ...
    public int[]  supplyPukReportResult(String puk, String pin) {
		...
		result[1]=mRetryCount;
		Log.v("PhoneInterface","mRetryCount2="+mRetryCount);
		return result;
    }//aurora change zhouxiaobing 20140512 for 4.4 build and the 4.4 phone is not have this
                        ...
                        switch (msg.what) {
                            case SUPPLY_PIN_COMPLETE:
                                ...
                                synchronized (UnlockSim.this) {
									...
									Log.v("PhoneInterface","mRetryCount1="+mRetryCount);
...
////aurora add zhouxiaobing 20131226 end
    ...
    public void cancelMissedCallsNotification() {
        enforceModifyPermission();
        log("cancelMissedCallsNotification");
