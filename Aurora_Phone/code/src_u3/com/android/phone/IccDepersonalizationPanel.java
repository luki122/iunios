...
public class IccDepersonalizationPanel extends IccPanel {
    ...
    View.OnClickListener mUnlockListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            mPhone.getIccCard().supplyDepersonalization(pin, Integer.toString(mPersoSubtype),//aurora change zhouxiaobing 20140512 for 4.4 build and the 4.4 phone is not have this
