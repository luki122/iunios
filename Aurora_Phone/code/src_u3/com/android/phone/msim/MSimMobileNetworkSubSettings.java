...
public class MSimMobileNetworkSubSettings extends AuroraPreferenceActivity
    ...
    private AuroraCheckBoxPreference mButtonDataRoam;
    private AuroraCheckBoxPreference mButtonDataEnabled;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButtonDataEnabled = (AuroraCheckBoxPreference) prefSet.findPreference(BUTTON_DATA_ENABLED_KEY);
        mButtonDataRoam = (AuroraCheckBoxPreference) prefSet.findPreference(BUTTON_ROAMING_KEY);
    ...
    protected void onResume() {
        ...
        } else if (getPreferenceScreen().findPreference(BUTTON_PREFERED_NETWORK_MODE2) != null)  {
            mPhone.getPreferredNetworkType(mHandler.obtainMessage(
                    MyHandler.MESSAGE_GET_PREFERRED_NETWORK_TYPE));
        }
    ...
    private int getPreferredNetworkStringId() {
      	 int NetworkMode = getPreferredNetworkMode();
           switch(NetworkMode) {
           		case 0:
