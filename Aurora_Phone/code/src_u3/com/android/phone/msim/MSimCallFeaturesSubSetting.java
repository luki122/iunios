 ...
 */
public class MSimCallFeaturesSubSetting extends AuroraPreferenceFragment
    ...
    // Extra put in the return from VM provider config containing voicemail number to set
     static final String VM_NUMBER_EXTRA = "com.android.phone.VoicemailNumber";
    // Extra put in the return from VM provider config containing call forwarding number to set
     static final String FWD_NUMBER_EXTRA = "com.android.phone.ForwardingNumber";
    // Extra put in the return from VM provider config containing call forwarding number to set
     static final String FWD_NUMBER_TIME_EXTRA = "com.android.phone.ForwardingNumberTime";
    // If the VM provider returns non null value in this extra we will force the user to
    // choose another VM provider
     static final String SIGNOUT_EXTRA = "com.android.phone.Signout";

    //Information about logical "up" Activity
     static final String UP_ACTIVITY_PACKAGE = "com.android.contacts";
     static final String UP_ACTIVITY_CLASS =
            "com.android.contacts.activities.DialtactsActivity";

    // Used to tell the saving logic to leave forwarding number as is
     static final CallForwardInfo[] FWD_SETTINGS_DONT_TOUCH = null;

    // Suffix appended to provider key for storing vm number
     static final String VM_NUMBER_TAG = "#VMNumber";
    // Suffix appended to provider key for storing forwarding settings
     static final String FWD_SETTINGS_TAG = "#FWDSettings";
    // Suffix appended to forward settings key for storing length of settings array
     static final String FWD_SETTINGS_LENGTH_TAG = "#Length";
    // Suffix appended to forward settings key for storing an individual setting
     static final String FWD_SETTING_TAG = "#Setting";
    // Suffixes appended to forward setting key for storing an individual setting properties
     static final String FWD_SETTING_STATUS = "#Status";
     static final String FWD_SETTING_REASON = "#Reason";
     static final String FWD_SETTING_NUMBER = "#Number";
     static final String FWD_SETTING_TIME = "#Time";

    // Key identifying the default vocie mail provider
     static final String DEFAULT_VM_PROVIDER_KEY = "";
     ...
     */
     static final String IGNORE_PROVIDER_EXTRA = "com.android.phone.ProviderToIgnore";

    // string constants
     static final String NUM_PROJECTION[] = {CommonDataKinds.Phone.NUMBER};

    // String keys for preference lookup
    // TODO: Naming these "BUTTON_*" is confusing since they're not actually buttons(!)
     static final String BUTTON_VOICEMAIL_KEY = "button_voicemail_key";
     static final String BUTTON_VOICEMAIL_PROVIDER_KEY = "button_voicemail_provider_key";
     static final String BUTTON_VOICEMAIL_SETTING_KEY = "button_voicemail_setting_key";
    ...
    public static final String BUTTON_FDN_KEY   = "button_fdn_key";
    public static final String BUTTON_RESPOND_VIA_SMS_KEY   = "button_respond_via_sms_key";

    public static final String BUTTON_RINGTONE_KEY    = "button_ringtone_key";
    public static final String BUTTON_VIBRATE_ON_RING = "button_vibrate_on_ring";

    public static final String BUTTON_GSM_UMTS_OPTIONS = "button_gsm_more_expand_key";
    public static final String BUTTON_CDMA_OPTIONS = "button_cdma_more_expand_key";

    public static final String BUTTON_CF_EXPAND_KEY = "button_cf_expand_key";
    public static final String BUTTON_MORE_EXPAND_KEY = "button_more_expand_key";


    public static final String VM_NUMBERS_SHARED_PREFERENCES_NAME = "vm_numbers";

     Intent mContactListIntent;

    /** Event for Async voicemail change call */
    public static final int EVENT_VOICEMAIL_CHANGED        = 500;
    public static final int EVENT_FORWARDING_CHANGED       = 501;
    public static final int EVENT_FORWARDING_GET_COMPLETED = 502;

    public static final int MSG_UPDATE_RINGTONE_SUMMARY = 1;
    public static final int MSG_UPDATE_VOICEMAIL_RINGTONE_SUMMARY = 2;

    /** Handle to voicemail pref */
    public static final int VOICEMAIL_PREF_ID = 1;
    public static final int VOICEMAIL_PROVIDER_CFG_ID = 2;

    private Phone mPhone;

    private AudioManager mAudioManager;

    public static final int VM_NOCHANGE_ERROR = 400;
    public static final int VM_RESPONSE_ERROR = 500;
    public static final int FW_SET_RESPONSE_ERROR = 501;
    public static final int FW_GET_RESPONSE_ERROR = 502;


    // dialog identifiers for voicemail
    public static final int VOICEMAIL_DIALOG_CONFIRM = 600;
    public static final int VOICEMAIL_FWD_SAVING_DIALOG = 601;
    public static final int VOICEMAIL_FWD_READING_DIALOG = 602;
    public static final int VOICEMAIL_REVERTING_DIALOG = 603;

    // status message sent back from handlers
     static final int MSG_OK = 100;

    // special statuses for voicemail controls.
    public static final int MSG_VM_EXCEPTION = 400;
    public static final int MSG_FW_SET_EXCEPTION = 401;
    public static final int MSG_FW_GET_EXCEPTION = 402;
    public static final int MSG_VM_OK = 600;
    public static final int MSG_VM_NOCHANGE = 700;

    // voicemail notification vibration string constants
    public static final String VOICEMAIL_VIBRATION_ALWAYS = "always";
    public static final String VOICEMAIL_VIBRATION_NEVER = "never";

    private AuroraPreferenceScreen mSubscriptionPrefFDN;
    private AuroraPreferenceScreen mSubscriptionPrefGSM;
    private AuroraPreferenceScreen mSubscriptionPrefCDMA;
    private AuroraPreferenceScreen mSubscriptionPrefEXPAND;
    private AuroraPreferenceScreen mSubscriptionPrefMOREEXPAND;

     EditPhoneNumberPreference mSubMenuVoicemailSettings;
    ...
    private AuroraPreference mRingtonePreference;
    private AuroraCheckBoxPreference mVibrateWhenRinging;
    private AuroraListPreference mVoicemailProviders;
    private AuroraPreferenceScreen mVoicemailSettings;
    private AuroraPreference mVoicemailNotificationRingtone;
    private AuroraCheckBoxPreference mVoicemailNotificationVibrate;
    ...
    void switchToPreviousVoicemailProvider() {
...
//    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (getActivity().getIntent().getAction().equals(ACTION_ADD_VOICEMAIL)) {
            getActivity().finish();
        }
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (DBG) log("onCreate(). Intent: " + getActivity().getIntent());
...
//        mSubscription = getIntent().getIntExtra(SUBSCRIPTION_KEY, 0);
        ...
        mSubscriptionPrefFDN  = (AuroraPreferenceScreen) findPreference(BUTTON_FDN_KEY);
        mSubscriptionPrefGSM  = (AuroraPreferenceScreen) findPreference(BUTTON_GSM_UMTS_OPTIONS);
        mSubscriptionPrefCDMA = (AuroraPreferenceScreen) findPreference(BUTTON_CDMA_OPTIONS);
        ...
        if (mSubMenuVoicemailSettings != null) {
            mSubMenuVoicemailSettings.setParentActivity(getActivity(), VOICEMAIL_PREF_ID, this);
            mSubMenuVoicemailSettings.setDialogOnClosedListener(this);
            mSubMenuVoicemailSettings.setDialogTitle(R.string.voicemail_settings_number_label);
        }
        
        mRingtonePreference = findPreference(BUTTON_RINGTONE_KEY);
        mVibrateWhenRinging = (AuroraCheckBoxPreference) findPreference(BUTTON_VIBRATE_ON_RING);
        mVoicemailProviders = (AuroraListPreference) findPreference(BUTTON_VOICEMAIL_PROVIDER_KEY);
        if (mVoicemailProviders != null) {
            mVoicemailProviders.setOnPreferenceChangeListener(this);
            mVoicemailSettings = (AuroraPreferenceScreen)findPreference(BUTTON_VOICEMAIL_SETTING_KEY);
            mVoicemailNotificationRingtone =
                    findPreference(BUTTON_VOICEMAIL_NOTIFICATION_RINGTONE_KEY);
            mVoicemailNotificationVibrate =
                    (AuroraCheckBoxPreference) findPreference(BUTTON_VOICEMAIL_NOTIFICATION_VIBRATE_KEY);
        ...
        if (!getResources().getBoolean(R.bool.world_phone)) {
        	AuroraPreference options = prefSet.findPreference(BUTTON_CDMA_OPTIONS);
            if (options != null)
            ...
            if (phoneType == PhoneConstants.PHONE_TYPE_CDMA) {
            	AuroraPreference fdnButton = prefSet.findPreference(BUTTON_FDN_KEY);
                if (fdnButton != null)
                ...
                mSubscriptionPrefEXPAND = (AuroraPreferenceScreen) findPreference(BUTTON_CF_EXPAND_KEY);
...
//        }
        ...
        AuroraPreference mSmsPreferenceCategory = findPreference(BUTTON_RESPOND_VIA_SMS_KEY);
        if(mSmsPreferenceCategory != null) {
            prefSet.removePreference(mSmsPreferenceCategory);
        }
        AuroraPreference mRingtonePreferenceCategory = findPreference("button_ringtone_category_key");
        if(mRingtonePreferenceCategory != null) {
            prefSet.removePreference(mRingtonePreferenceCategory);
        }
        AuroraPreference mVoicemailPreferenceCategory = findPreference("button_voicemail_category_key");
        if(mVoicemailPreferenceCategory != null) {
            prefSet.removePreference(mVoicemailPreferenceCategory);
        }
     ...
     */
    private void updateRingtoneName(int type, AuroraPreference preference, int msg) {
        ...
        if (type == RingtoneManager.TYPE_NOTIFICATION) {
            ...
            if (TextUtils.isEmpty(uriString)) {
                ...
                if (uriString.equals(Settings.System.DEFAULT_NOTIFICATION_URI.toString())) {
                    ...
                    ringtoneUri = RingtoneManager.getActualDefaultRingtoneUri(getActivity(), type);
                } else {
        ...
        if (ringtoneUri == null) {
            ...
            try {
                Cursor cursor = getActivity().getContentResolver().query(ringtoneUri,
    ...
    public void onResume() {
        ...
        if (mVibrateWhenRinging != null) {
            mVibrateWhenRinging.setChecked(getVibrateWhenRinging(getActivity()));
        }
    ...
    private void initVoiceMailProviders() {
        ...
        mPerProviderSavedVMNumbers =
        		getActivity().getApplicationContext().getSharedPreferences(
                        VM_NUMBERS_SHARED_PREFERENCES_NAME, Activity.MODE_PRIVATE);

        String providerToIgnore = null;
        if (getActivity().getIntent().getAction().equals(ACTION_ADD_VOICEMAIL)) {
            if (getActivity().getIntent().hasExtra(IGNORE_PROVIDER_EXTRA)) {
                providerToIgnore = getActivity().getIntent().getStringExtra(IGNORE_PROVIDER_EXTRA);
            }
     ...
     */
    private void simulatePreferenceClick(AuroraPreference preference) {
    ...
    String getCurrentVoicemailProviderKey() {
    ...
    public MSimCallFeaturesSubSetting() {
    }
    
    public MSimCallFeaturesSubSetting(int slot) {
    	mSubscription = slot;
    }
  ...
  protected Dialog onCreateDialog(int id) {
      if ((id == VM_RESPONSE_ERROR) || (id == VM_NOCHANGE_ERROR) ||
          ...
          return dialog;
              ...
              id == VOICEMAIL_REVERTING_DIALOG) {
          AuroraProgressDialog dialog = new AuroraProgressDialog(getActivity());
          dialog.setTitle(getText(R.string.updating_title));
          dialog.setIndeterminate(true);
          dialog.setCancelable(false);
          dialog.setMessage(getText(
