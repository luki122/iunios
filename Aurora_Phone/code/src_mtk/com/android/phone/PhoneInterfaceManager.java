...
//JB TEMP   intent.setClassName(mApp, PhoneGlobals.getCallScreenClassName());
    ...
    public boolean isOffhookGemini(int simId) {
        ...
        if (DBG) log("isOffhookGemini simId: " + simId);
            ...
            if (simId == Phone.GEMINI_SIM_1)
            {
                return (((GeminiPhone)mPhone).getStateGemini(Phone.GEMINI_SIM_1) == PhoneConstants.State.OFFHOOK);
            }
            else
            {
                return (((GeminiPhone)mPhone).getStateGemini(Phone.GEMINI_SIM_2) == PhoneConstants.State.OFFHOOK);
            }
        }
        else
        {
    ...
    public boolean isRingingGemini(int simId) {
        ...
        if (DBG) log("isRingingGemini simId: " + simId);
            ...
            if (simId == Phone.GEMINI_SIM_1)
            {
                return (((GeminiPhone)mPhone).getStateGemini(Phone.GEMINI_SIM_1) == PhoneConstants.State.RINGING);
            }
            else
            {
                return (((GeminiPhone)mPhone).getStateGemini(Phone.GEMINI_SIM_2) == PhoneConstants.State.RINGING);
            }
        }
        else
        {
    ...
    public boolean isIdleGemini(int simId) {
        ...
        if (DBG) log("isIdleGemini simId: " + simId);
            ...
            if (simId == Phone.GEMINI_SIM_1)
            {
                return (((GeminiPhone)mPhone).getStateGemini(Phone.GEMINI_SIM_1) == PhoneConstants.State.IDLE);
            }
            else
            {
                return (((GeminiPhone)mPhone).getStateGemini(Phone.GEMINI_SIM_2) == PhoneConstants.State.IDLE);
            }
        }
        else
        {
...
/* Fion add end */
   ...
   public String getIccCardTypeGemini(int simId) {
    ...
    public String getSimOperatorName(int simId) {
        Log.d( LOG_TAG,"getSimOperatorName");
    ...
    public String getSimCountryIso(int simId) {
        Log.d( LOG_TAG,"getSimCountryIso");
        return (simId == Phone.GEMINI_SIM_1)
    ...
    public IPhoneSubInfo getSubscriberInfo(int simId) {
        Log.d( LOG_TAG,"getSubscriberInfo");
