...
public class BluetoothHeadsetService extends Service {
    ...
    public void onCreate() {
        ...
        mBtHandsfree = ((MtkPhoneGlobals)PhoneGlobals.getInstance()).getBluetoothHandsfree();
        /* MTK Modified : Begin */
    ...
    */
    ...
    private final IBluetoothHeadset.Stub mBinder = new IBluetoothHeadset.Stub() {
        ...
        public int getPriority(BluetoothDevice device) {
            ...
            synchronized (BluetoothHeadsetService.this) {
                int priority = Settings.Secure.getInt(getContentResolver(),
                        getBluetoothHeadsetPriorityKey(device.getAddress()),
        ...
        public final String BLUETOOTH_HEADSET_PRIORITY_PREFIX = "bluetooth_headset_priority_";
        
        public final String getBluetoothHeadsetPriorityKey(String address) {
