...
public class UssdAlertActivity extends AlertActivity implements 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playUSSDTone(PhoneGlobals.getInstance());
    ...
    private View createView() {
        View dialogView = getLayoutInflater().inflate(R.layout.mtk_dialog_ussd_response, null);
    ...
    protected void onDestroy() {
        ...
        if (!isClick && mType == USSD_DIALOG_REQUEST) {
            PhoneUtils.cancelUssdDialog();
