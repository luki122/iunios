...
public class CallPickerAdapter extends BaseAdapter {
    ...
    public CallPickerAdapter(Context context, List<Call> items) {
        mContext = context;
        mItems = items;
        mSimIndicatorPaddingLeft = mContext.getResources().getDimensionPixelSize(R.dimen.call_banner_sim_indicator_padding_left);
        mSimIndicatorPaddingRight = mContext.getResources().getDimensionPixelSize(R.dimen.call_banner_sim_indicator_padding_right);
    }
