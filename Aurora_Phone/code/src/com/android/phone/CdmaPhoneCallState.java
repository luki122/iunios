 ...
 */
   public class CdmaPhoneCallState {
        ...
        public void resetCdmaPhoneCallState() {
            ...
            mIsSingleDialing = false;
            //aurora add liguangyu 20140730 for BUG #7013 end
            if(PhoneGlobals.getInCallScreen() != null) {
            	PhoneGlobals.getInCallScreen().mInCallControlState.resetHoldState();
            }
        }        
        
        //aurora add liguangyu 20140730 for BUG #7013 start
        private boolean mIsSingleDialing = false;
        
        public void setSiggleDialingState(boolean newState) {
        	mIsSingleDialing = newState;
        }
        
        public boolean getSiggleDialingState() {
            return mIsSingleDialing;
        }
        //aurora add liguangyu 20140730 for BUG #7013 end
   }
