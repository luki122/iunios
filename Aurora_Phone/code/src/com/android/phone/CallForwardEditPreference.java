...
//        setLayoutResource(R.layout.aurora_cf_update_icon);
        ...
        slotId = a.getInt(R.styleable.CallForwardEditPreference_phoneslot,
                -1);
        if(slotId != -1) {
        	 phone = PhoneGlobals.getInstance().getPhone(slotId);
        } else {
...
//        	});
//        }        
//        main =  view.findViewById(R.id.aurora_main_frame);
//        if (main != null) {
//        	main.setOnClickListener(new View.OnClickListener() {
//		            @Override        				
//		            public void onClick(View v) {        
//		                if (DBG) Log.d(LOG_TAG, "onClick main");
//		                	showMyDialog();
//		            }        				
//        	});
//        }        
