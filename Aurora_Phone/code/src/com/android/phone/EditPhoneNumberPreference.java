...
public class EditPhoneNumberPreference extends AuroraEditTextPreference {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (hasFocus) {
               ...
               String number = textView.getText().toString();
            	...
            	AuroraAlertDialog dialog= (AuroraAlertDialog)(EditPhoneNumberPreference.this.getDialog());
            	if(dialog != null) {
            		Log.i("onBindDialogView", "dialog not null");
                    Button pButton = dialog.getButton(DialogInterface.BUTTON_POSITIVE);
                    Button nButton = dialog.getButton(DialogInterface.BUTTON_NEUTRAL);   
                    if(pButton != null) pButton.setEnabled(length > 3 ? true : false);
                    if(nButton != null) nButton.setEnabled(length > 3 ? true : false);
            	}
            }
        }
    };
    ...
    public EditPhoneNumberPreference(Context context, AttributeSet attrs) {
        ...
        mContactListIntent.addCategory("android.intent.category.GIONEE");
    ...
    protected void onBindDialogView(View view) {
        ...
        if (editText != null) {
            ...
            editText.setBackgroundResource(R.drawable.input_edit_text);
        }
