...
public class ContactsAsyncHelper {
    ...
    public static class ImageTracker {
        ...
        private AuroraCallerInfo mCurrentCallerInfo;
         ...
         */
        public boolean isDifferentImageRequest(AuroraCallerInfo ci) {
        ...
        public boolean isDifferentImageRequest(Connection connection) {
            ...
            if (o instanceof AuroraCallerInfo) {
                runQuery = isDifferentImageRequest((AuroraCallerInfo) o);
            }
            return runQuery;
        }
         ...
         */
        public void setPhotoRequest(AuroraCallerInfo ci) {
...
//        sThreadHandler = new WorkerHandler(thread.getLooper());
    	  sThreadHandler = new WorkerHandler();
          //aurora change liguangyu 20131206 end
    }
    ...
    public static final void startObtainPhotoAsync(int token, Context context, Uri personUri,
        ...
        int privateData[] = AuroraPrivacyUtils.getPrivateData(personUri);
...
//        sThreadHandler.sendMessage(msg);
            ...
            args.photoIcon = null;
        	  ...
        	  try {
	              ...
	              if (inputStream != null) {
	                  ...
	                  args.photoIcon = getAuroraPhotoIconWhenAppropriate(args.context, args.photo);
	                  if (DBG) Log.d(LOG_TAG, "Loading image success");
	              } else {
	                  args.photo = null;
	                  args.photoIcon = null;
	                  if (DBG) Log.d(LOG_TAG, "Problem with image");
	              }
        	   } finally {
                   if (inputStream != null) {
                       try {
        ...
        if (args.listener != null) {
            ...
            args.listener.onImageLoadComplete(token, args.photo, args.photoIcon,
                    args.cookie);
        }
    
    }
    
    private static Bitmap getAuroraPhotoIconWhenAppropriate(Context context, Drawable photo) {
        if (!(photo instanceof BitmapDrawable)) {
            return null;
        }
        Bitmap orgBitmap = ((BitmapDrawable) photo).getBitmap();
        return getAuroraPhotoIconWhenAppropriate(context, orgBitmap);
    }
