 ...
 */
public class Enhanced4GLteSwitchPreference extends AuroraSwitchPreference {
    ...
    public Enhanced4GLteSwitchPreference(Context context, AttributeSet attrs) {
    	this(context, attrs, com.android.internal.R.attr.switchPreferenceStyle);
    }

    public Enhanced4GLteSwitchPreference(Context context, AttributeSet attrs, int defStyle) {
