...
//                }
//                
//                GnCbSmsMessage[] msgs = new GnCbSmsMessage[messages.length];
...
//aurora add zhouxiaobing 20131115 start
	...
	{
		return gionee.provider.GnTelephony.Sms.addMessageToUri(resolver,uri,address,body,subject,date,read,deliveryReport,threadId,simId);
