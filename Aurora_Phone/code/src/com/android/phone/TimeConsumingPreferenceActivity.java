...
interface  TimeConsumingPreferenceListener {
    public void onStarted(AuroraPreference preference, boolean reading);
    public void onFinished(AuroraPreference preference, boolean reading);
    public void onError(AuroraPreference preference, int error);
    public void onException(AuroraPreference preference, CommandException exception);
}

public class TimeConsumingPreferenceActivity extends AuroraPreferenceActivity
    ...
    protected Dialog onCreateDialog(int id) {
        if (id == BUSY_READING_DIALOG || id == BUSY_SAVING_DIALOG) {
        	...
        	//aurora add liguangyu 20140822 for 7810 start
        	dialog.setPlayAnimationFlag(false);
        	//aurora add liguangyu 20140822 for 7810 end
