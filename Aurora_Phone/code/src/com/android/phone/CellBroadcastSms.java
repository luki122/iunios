 ...
 */
public class CellBroadcastSms extends AuroraPreferenceActivity
    ...
    //UI objects
    private AuroraCheckBoxPreference mButtonBcSms;

    private AuroraListPreference mListLanguage;

    private AuroraCheckBoxPreference mButtonEmergencyBroadcast;
    private AuroraCheckBoxPreference mButtonAdministrative;
    private AuroraCheckBoxPreference mButtonMaintenance;
    private AuroraCheckBoxPreference mButtonLocalWeather;
    private AuroraCheckBoxPreference mButtonAtr;
    private AuroraCheckBoxPreference mButtonLafs;
    private AuroraCheckBoxPreference mButtonRestaurants;
    private AuroraCheckBoxPreference mButtonLodgings;
    private AuroraCheckBoxPreference mButtonRetailDirectory;
    private AuroraCheckBoxPreference mButtonAdvertisements;
    private AuroraCheckBoxPreference mButtonStockQuotes;
    private AuroraCheckBoxPreference mButtonEo;
    private AuroraCheckBoxPreference mButtonMhh;
    private AuroraCheckBoxPreference mButtonTechnologyNews;
    private AuroraCheckBoxPreference mButtonMultiCategory;

    private AuroraCheckBoxPreference mButtonLocal1;
    private AuroraCheckBoxPreference mButtonRegional1;
    private AuroraCheckBoxPreference mButtonNational1;
    private AuroraCheckBoxPreference mButtonInternational1;

    private AuroraCheckBoxPreference mButtonLocal2;
    private AuroraCheckBoxPreference mButtonRegional2;
    private AuroraCheckBoxPreference mButtonNational2;
    private AuroraCheckBoxPreference mButtonInternational2;

    private AuroraCheckBoxPreference mButtonLocal3;
    private AuroraCheckBoxPreference mButtonRegional3;
    private AuroraCheckBoxPreference mButtonNational3;
    private AuroraCheckBoxPreference mButtonInternational3;

    private AuroraCheckBoxPreference mButtonLocal4;
    private AuroraCheckBoxPreference mButtonRegional4;
    private AuroraCheckBoxPreference mButtonNational4;
    private AuroraCheckBoxPreference mButtonInternational4;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mButtonBcSms = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_ENABLE_DISABLE_BC_SMS_KEY);
        mListLanguage = (AuroraListPreference) prefSet.findPreference(
                LIST_LANGUAGE_KEY);
        // set the listener for the language list preference
        mListLanguage.setOnPreferenceChangeListener(this);
        mButtonEmergencyBroadcast = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_EMERGENCY_BROADCAST_KEY);
        mButtonAdministrative = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_ADMINISTRATIVE_KEY);
        mButtonMaintenance = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_MAINTENANCE_KEY);
        mButtonLocalWeather = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LOCAL_WEATHER_KEY);
        mButtonAtr = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_ATR_KEY);
        mButtonLafs = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LAFS_KEY);
        mButtonRestaurants = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_RESTAURANTS_KEY);
        mButtonLodgings = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LODGINGS_KEY);
        mButtonRetailDirectory = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_RETAIL_DIRECTORY_KEY);
        mButtonAdvertisements = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_ADVERTISEMENTS_KEY);
        mButtonStockQuotes = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_STOCK_QUOTES_KEY);
        mButtonEo = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_EO_KEY);
        mButtonMhh = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_MHH_KEY);
        mButtonTechnologyNews = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_TECHNOLOGY_NEWS_KEY);
        mButtonMultiCategory = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_MULTI_CATEGORY_KEY);

        mButtonLocal1 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LOCAL_GENERAL_NEWS_KEY);
        mButtonRegional1 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_REGIONAL_GENERAL_NEWS_KEY);
        mButtonNational1 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_NATIONAL_GENERAL_NEWS_KEY);
        mButtonInternational1 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_INTERNATIONAL_GENERAL_NEWS_KEY);

        mButtonLocal2 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LOCAL_BF_NEWS_KEY);
        mButtonRegional2 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_REGIONAL_BF_NEWS_KEY);
        mButtonNational2 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_NATIONAL_BF_NEWS_KEY);
        mButtonInternational2 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_INTERNATIONAL_BF_NEWS_KEY);

        mButtonLocal3 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LOCAL_SPORTS_NEWS_KEY);
        mButtonRegional3 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_REGIONAL_SPORTS_NEWS_KEY);
        mButtonNational3 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_NATIONAL_SPORTS_NEWS_KEY);
        mButtonInternational3 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_INTERNATIONAL_SPORTS_NEWS_KEY);

        mButtonLocal4 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_LOCAL_ENTERTAINMENT_NEWS_KEY);
        mButtonRegional4 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_REGIONAL_ENTERTAINMENT_NEWS_KEY);
        mButtonNational4 = (AuroraCheckBoxPreference) prefSet.findPreference(
                BUTTON_NATIONAL_ENTERTAINMENT_NEWS_KEY);
        mButtonInternational4 = (AuroraCheckBoxPreference) prefSet.findPreference(
