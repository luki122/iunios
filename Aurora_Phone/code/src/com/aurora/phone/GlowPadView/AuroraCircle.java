...
public class AuroraCircle {
    protected static final float MIN_POINT_SIZE = 2.0f;
    protected static final float MAX_POINT_SIZE = 4.0f;
    protected static final int INNER_POINTS = 8;
    protected static final String TAG = "AuroraCircle";
    ...
    protected static float hypot(float x, float y) {
    ...
    protected float interp(float min, float max, float f) {
