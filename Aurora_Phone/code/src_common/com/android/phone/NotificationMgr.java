...
//                .setContentIntent(PendingIntent.getActivity(mContext, 0, callLogIntent, 0))
        ...
        if (mNumberMissedCalls == 1
            ...
            //aurora change liguangyu 20131108 for missing call notification start
//            builder.addAction(R.drawable.aurora_stat_sys_phone_call,
//                    mContext.getString(R.string.notification_missedCall_call_back),
//                    PhoneGlobals.getCallBackPendingIntent(mContext, number));
//
//            builder.addAction(R.drawable.aurora_ic_text_holo_dark,
...
//        if (photoIcon != null) {
//        	photoIcon = RoundBitmapUtils.toRoundBitmap(photoIcon);
//            contentView.setImageViewBitmap(R.id.image, photoIcon);
//        } else if (photo instanceof BitmapDrawable) {
//        	Bitmap bitmap = ((BitmapDrawable)photo).getBitmap();
//        	bitmap = RoundBitmapUtils.toRoundBitmap(bitmap);
...
//            builder.setTicker(expandedViewLine2);
        ...
        log("Notifying IN_CALL_NOTIFICATION ID = " + (InCallScreen.mIsOnPuaseWhenRinging ? RINGING_AND_HOME_NOTIFICATION : IN_CALL_NOTIFICATION));
        if(InCallScreen.mIsOnPuaseWhenRinging) {
        	mHasSendRingInCall = true;
        }
        mNotificationManager.notify(InCallScreen.mIsOnPuaseWhenRinging ? RINGING_AND_HOME_NOTIFICATION : IN_CALL_NOTIFICATION, notification);
