...
public class CdmaOptions {
    ...
    public CdmaOptions(AuroraPreferenceActivity prefActivity, AuroraPreferenceScreen prefScreen, Phone phone) {
    ...
    public void showDialog(AuroraPreference preference) {
        if (preference.getKey().equals(BUTTON_CDMA_SYSTEM_SELECT_KEY)) {
