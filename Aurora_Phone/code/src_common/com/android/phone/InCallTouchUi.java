...
//        animator.alpha(0f);
    ...
    void updateRecordBtnState() {
        ...
        if (!sManager.getVolumeState(GnPhoneRecordHelper.SDCARD_DEFAULT_PATH).equals(Environment.MEDIA_MOUNTED) && 
            ...
            if(fgCall.getState() != Call.State.ACTIVE || fgCall.getState() == Call.State.ACTIVE && mCM.getFgPhone().getPhoneType() == PhoneConstants.PHONE_TYPE_SIP) {
