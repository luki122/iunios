...
//        }
        ...
        if(DeviceUtils.hasKey() || DeviceUtils.is8910()) {
        	...
        	setContentView(R.layout.incall_screen_no_key);
        }
...
//            Settings.System.putInt(getContentResolver(),Settings.System.SOUND_EFFECTS_ENABLED, mTouchSoundSettings);
    ...
    protected void registerForPhoneStates() {
        if (!mRegisteredForPhoneStates) {
            ...
            //aurora add liguangyu 20140730 for BUG #7013 start
            if(PhoneGlobals.getPhone().getPhoneType() == PhoneConstants.PHONE_TYPE_CDMA) {
            	PhoneGlobals.getPhone().registerForLineControlInfo(mHandler, CDMA_ACCEPT, null);
            }
            //aurora add liguangyu 20140730 for BUG #7013 end
    ...
    protected void unregisterForPhoneStates() {
        ...
        //aurora add liguangyu 20140730 for BUG #7013 start
        if(PhoneGlobals.getPhone().getPhoneType() == PhoneConstants.PHONE_TYPE_CDMA) {
        	PhoneGlobals.getPhone().unregisterForLineControlInfo(mHandler);
        }
        //aurora add liguangyu 20140730 for BUG #7013 end
...
//                                            + intent);
    ...
    protected void initInCallScreen() {
        ...
        mCallCardAnimController = new AuroraCallCardAnimationController(this);
        mCallCardAnimController.setCallCard(mCallCard); 
...
//				if(isDisconnectAnimaRunning) {
    ...
    //aurora liguangyu add for BUG #9849 手机通话结束后来短信无提示音 20141215
    ...
    AuroraCallCardAnimationController mCallCardAnimController;
    AuroraInCallTouchUiAnimationController mInCallTouchUiAnimController;
}
