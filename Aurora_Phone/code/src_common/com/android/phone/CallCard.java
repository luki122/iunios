...
public class CallCard extends LinearLayout
    ...
    protected void onFinishInflate() {
	    ...
	    mSogouLine = findViewById(R.id.sogou_line);
 	    mSogouNote = (TextView)findViewById(R.id.sogou_note);
...
//            mPrimaryCallInfo.setVisibility(View.GONE);
    ...
    private void updateElapsedTimeWidget(long timeElapsed) {
		...
		// aurora add liguangyu 20140730 for BUG #7013 end
		mElapsedTime.setText(getTimeString(timeElapsed));
		// aurora add zhouxiaobing 20131010 start
		if (isNeedUpdateFirstInfoTime() && mfirstcalltime != null) {
			mfirstcalltime.setText(getTimeString(timeElapsed));
		}
		// aurora add zhouxiaobing 20131010 end
    }
    
    private String getTimeString(long timeElapsed) {
               ...
               showImage(mFirstCallPhoto, R.drawable.picture_conference);
	            ...
	            if (infoToken2.isFinal) {
	             ...
	             // if(mSecondaryCallPhoto.getDrawable()==null)	
	                ...
	                showImage(mFirstCallPhoto, R.drawable.photoicon_unknown);//aurora change zhouxiaobing 20131002
	            }
            ...
            case HOLDING:
                ...
                //aurora add zhouxiaobing 20140411 end        
                    ...
                    if (infoToken.isFinal) {
                    	...
                    	if (DBG) log(" displaySecondaryCallStatus 2");
                        showImage(mSecondaryCallPhoto, R.drawable.photoicon_unknown);//aurora change zhouxiaobing 20131002
                    }
            ...
            case ACTIVE:
                ...
                if (phone.getPhoneType() == PhoneConstants.PHONE_TYPE_CDMA) {
                    ...
                    if (connections.size() > 2) {
                        ...
                        showImage(mSecondaryCallPhoto, /*R.drawable.picture_unknown*/R.drawable.photoicon_unknown);//aurora change zhouxiaobing 20131002
                    } else {
...
//               if(state.isRinging() && DeviceUtils.is7503()) {
	...
	private final void showImage(ImageView view, Drawable drawable) {
		if ((mVideoCallPanel != null)
				&& (mVideoCallPanel.getVisibility() == View.VISIBLE)) {
...
//aurora add zhouxiaobing 20131231 start
	...
	private static int mdefault_photo_id = R.drawable.photo_default_outgoing;
	...
	private ImageView mSogouIcon;
	 ...
	 private AuroraCallCardAnimationController mAnimController;
          	   ...
          	   if (PhoneUtils.isConferenceCall(otherFgCall)) {
	               ...
	               if (infoToken2.isFinal) {
	                ...
	                // if(mSecondaryCallPhoto.getDrawable()==null)	
	                   ...
	                   showImage(mThirdCallPhoto, R.drawable.photoicon_unknown);//aurora change zhouxiaobing 20131002
	               }
	              //aurora add zhouxiaobing 20140411 end
               }
...
//                      if(mFourthCallPhoto.getDrawable()==null)	
                        ...
                        showImage(mFourthCallPhoto, R.drawable.photoicon_unknown);//aurora change zhouxiaobing 20131002
                    }
            ...
            case ACTIVE:
                ...
                if (phone.getPhoneType() == PhoneConstants.PHONE_TYPE_CDMA) {
                    ...
                    if (connections.size() > 2) {
                        ...
                        mFourthCallName.setText(
                                getContext().getString(R.string.card_title_in_call));
                        showImage(mFourthCallPhoto, /*R.drawable.picture_unknown*/R.drawable.photoicon_unknown);//aurora change zhouxiaobing 20131002
                    } else {
                        // This means that the current Mobile Originated call IS the first 3-Way
                        // and hence we display the first callers/party's info here.
                        Connection conn = call.getEarliestConnection();
...
//        mThirdCallPhoto.setImageDrawable(mPhoto.getDrawable());
    ...
    void updateAuroraDefaultPhotoId(int is_sim) {
		if (is_sim > -1) {
			if (mdefault_photo_id == R.drawable.photo_default) {
				mdefault_photo_id = SimIconUtils.getSimIconDefaultPhotoIncoming(is_sim);// R.drawable.photo_default_sim;
			} else if (mdefault_photo_id == R.drawable.photo_default_outgoing) {
				mdefault_photo_id = SimIconUtils.getSimIconDefaultPhotoOutgoing(is_sim);// R.drawable.photo_default_outgoing_sim;
			}
		} else {
			if (isDefaultPhotoSimId(mdefault_photo_id)) {
				mdefault_photo_id = R.drawable.photo_default;
			} else if (isDefaultPhotoSimIdOutgoing(mdefault_photo_id)) {
				mdefault_photo_id = R.drawable.photo_default_outgoing;
		    }
		}
    }         
	...
	private void auroraUpdateFirstInfo() {
       //aurora add zhouxiaobing 20131008 start
        ...
        mfirstcalltime.setText(callStateLabel);
        if (mFirstCallPhoto == null) {
            mFirstCallPhoto = (ImageView) findViewById(R.id.firstCallPhoto);
        }
        mFirstCallPhoto.setImageDrawable(mPhoto.getDrawable());  
	}
	...
	private static boolean isDefaultPhotoSimId(int resid) {
		return (resid == R.drawable.photo_default_sim1)
				|| (resid == R.drawable.photo_default_sim2)
				|| (resid == R.drawable.photo_default_sime)
				|| (resid == R.drawable.photo_default_simh)
				|| (resid == R.drawable.photo_default_simo)
				|| (resid == R.drawable.photo_default_simp);
	}

	private static boolean isDefaultPhotoSimIdOutgoing(int resid) {
		return (resid == R.drawable.photo_default_outgoing_sim1)
				|| (resid == R.drawable.photo_default_outgoing_sim2)
				|| (resid == R.drawable.photo_default_outgoing_sime)
				|| (resid == R.drawable.photo_default_outgoing_simh)
				|| (resid == R.drawable.photo_default_outgoing_simo)
				|| (resid == R.drawable.photo_default_outgoing_simp);
	}
