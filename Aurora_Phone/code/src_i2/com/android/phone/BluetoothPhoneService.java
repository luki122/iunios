...
//                mBluetoothHeadset.roamChanged(roam);
    ...
    private final IBluetoothHeadsetPhone.Stub mBinder = new IBluetoothHeadsetPhone.Stub() {
        public boolean answerCall() {
            ...
            return AuroraPhoneUtils.answerCallAndSleepSoon(mCM.getFirstActiveRingingCall());
        }
        ...
        public boolean processChld(int chld) {
            ...
            if (chld == CHLD_TYPE_RELEASEHELD) {
                ...
                if (phoneType == PhoneConstants.PHONE_TYPE_CDMA) {
                	...
                	//aurora modify liguangyu 20140410 for bluetooth start
//                    return PhoneUtils.answerAndEndActive(PhoneGlobals.getInstance().mCM, ringingCall);
                  ...
                  //aurora modify liguangyu 20140410 for bluetooth end
                } else {
                ...
                if (phoneType == PhoneConstants.PHONE_TYPE_CDMA) {
                    ...
                    if (ringingCall.isRinging()) {
                        ...
                        AuroraPhoneUtils.answerCallAndSleepSoon(ringingCall);
...
//aurora add zhouxiaobing 20140520 start        
        public String getSubscriberId() {
            return mCM.getDefaultPhone().getSubscriberId();
        }
        
        public String getDeviceId() {
            return mCM.getDefaultPhone().getDeviceId();
        }
//aurora add zhouxiaobing 20140520 end   
        
        /// M: DSDA @{
        @Override
        public boolean restrictDualTalk() {
        	return false;
        }
        /// @}
    };
