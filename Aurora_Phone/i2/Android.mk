...
LOCAL_STATIC_JAVA_LIBRARIES := hmtsdk yulore_helper guava
...
LOCAL_SRC_FILES += $(call all-java-files-under, src_i2)
LOCAL_SRC_FILES += $(call all-java-files-under, src_common_5)
