...
public class ContactAggregator {
    ...
    private boolean mEnabled = false;//true;
    ...
    public ContactAggregator(ContactsProvider2 contactsProvider,
        ...
        */
        ...
        // Gionee:wangth 20121212 modify for CR00739289 end
        ...
        // aurora wangth 20140924 add begin
        mContactPrivacyUpdate = db.compileStatement("UPDATE " + Tables.CONTACTS + " SET "
                + CONTACTS_PRIVACY_COLUM + "=?" + " WHERE " + Contacts.NAME_RAW_CONTACT_ID + "=?");
        
        mCallsPrivacyUpdate = db.compileStatement("UPDATE " + Tables.CALLS + " SET "
                + CALLS_PRIVACY_COLUM + "=?" + " WHERE raw_contact_id=?");
