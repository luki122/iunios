...
public class AuroraPrivacyUtils {
    ...
    private static final String TAG = "ContactsProvider_AuroraPrivacyUtils";
	...
	public static void bindService(Context context) {
		if (!mIsServiceConnected && ContactsProvidersApplication.sIsAuroraPrivacySupport) {
		    try {
    ...
    public static void sendBroadToMms(String number, int type, boolean isMan) {
        ...
        long currentAccountId = AuroraPrivacyUtils.mCurrentAccountId;
    ...
    public static void updateCallRecordings(String number, int type) {
        ...
        String privacyCallRecodingEncodePath = AuroraPrivacyUtils.mCurrentAccountHomePath
    ...
    private static void auroraMoveToPrivacy(String privacyCallRecodingEncodePath, String number) {
        String path = GnStorageManager.getInstance(ContactsProvidersApplication.getInstance().getApplicationContext()).getInternalStoragePath();
        if (path == null) {
            return;
        }
        
        String historyPath = path + "/" + ContactsProvidersApplication.getInstance().getApplicationContext().getString(R.string.aurora_call_record_history_path);
        int found = 0;
        try {
