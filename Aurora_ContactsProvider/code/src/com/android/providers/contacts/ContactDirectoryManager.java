...
public class ContactDirectoryManager {
    ...
    private void insertDefaultDirectory(SQLiteDatabase db) {
        ...
        values.put(Directory.DIRECTORY_AUTHORITY, GnContactsContract.AUTHORITY);
    ...
    private List<DirectoryInfo> updateDirectoriesForPackage(
        ...
        SQLiteDatabase db = getDbHelper().getWritableDatabase();
        // Gionee:wangth 20121130 add for CR00736303 begin
        try {
        // Gionee:wangth 20121130 add for CR00736303 end
        db.beginTransaction();
        try {
