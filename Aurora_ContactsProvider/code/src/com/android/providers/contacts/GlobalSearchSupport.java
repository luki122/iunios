...
public class GlobalSearchSupport {
    ...
    private static boolean mIsGnShowSlotSupport = SystemProperties.get("ro.gn.operator.showslot").equals("yes");
    private static boolean mIsGnShowDigitalSlotSupport = SystemProperties.get("ro.gn.operator.showdigitalslot").equals("yes");
    // Gionee lihuafang 20120422 add for CR00573564 end
    ...
    private Cursor buildCursorForSearchSuggestionsBasedOnPhoneNumber(String searchClause) {
        ...
        if (isVoiceCapable()) {
            ...
            dialNumber.add(GnContactsContract.Intents.SEARCH_SUGGESTION_DIAL_NUMBER_CLICKED);
            dialNumber.add(null);
        ...
        createContact.add(GnContactsContract.Intents.SEARCH_SUGGESTION_CREATE_CONTACT_CLICKED);
    ...
    private Cursor buildCursorForSearchSuggestionsBasedOnFilter(SQLiteDatabase db,
        ...
        try {
            while (c.moveToNext()) {
                ...
                if (haveFilter) {
                    suggestion.text2 = shortenSnippet(c.getString(7));
                }
                /*
                 * Feature Fix by Mediatek End
                 */
    ...
    private static String processIcon(int slotId) {
        String icon = null;
        ...
        if (slotId >= 0) {
             ...
             */
            // Gionee lihuafang 20120422 add for CR00573564 begin
            else if (mIsGnContactsSupport && (mIsGnShowDigitalSlotSupport || mIsGnShowDigitalSlotSupport)) {
                ...
                try {
                    if (FeatureOption.MTK_GEMINI_SUPPORT) {
                        ...
                        if (iTel != null && GnITelephony.getIccCardTypeGemini(iTel, slotId).equals("USIM")) {
                            icon = String.valueOf(R.drawable.contact_icon_usim);
            ...
            icon = String.valueOf(R.drawable.ic_contact_picture);
        }
        return icon;
    }
    /*
