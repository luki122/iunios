...
public class DataRowHandlerForPhoto extends DataRowHandler {
    ...
    private boolean processPhoto(ContentValues values) {
        ...
        if (originalPhoto != null) {
            ...
            int maxDisplayPhotoDim = mContext.getResources().getInteger(maxDisplayPhotoDimResId);
            //Gionee:huangzy 20120615 modify for CR00624875 end

            final int maxThumbnailPhotoDim;
            if(ContactsProvidersApplication.isCts()){
            	maxThumbnailPhotoDim = mContext.getResources().getInteger(
