...
//        */
//        String[][] pinyinArrays = ChineseToPinyinHelper.translateMulti(name);
//        if (pinyinArrays.length > 1) {
//            for (String[] pinyinArray : pinyinArrays) {
//                boolean isAllJianPin = true;
//                String jianPinStr = "";
//                String pinyinStr = "";
//                for (String str : pinyinArray) {
//                    jianPinStr += String.valueOf(str.charAt(0));
//                    if (str.length() > 1) {
//                        isAllJianPin = false;
//                    }
//                    pinyinStr += str;
//                    continue;
//                }
//                Iterator<String> it = ContactLocaleUtils.getIntance().getNameLookupKeys(pinyinStr, fullNameStyle);
//                if (it != null) {
//                    while (it.hasNext()) {
//                        builder.appendName(it.next());
//                    }
...
//                
//                if (!isAllJianPin) {
//                    Iterator<String> jpit = ContactLocaleUtils.getIntance().getNameLookupKeys(jianPinStr, fullNameStyle);
//                    if (jpit != null) {
//                        while (jpit.hasNext()) {
//                            builder.appendName(jpit.next());
//                        }
//                    }
//                }
//            }
