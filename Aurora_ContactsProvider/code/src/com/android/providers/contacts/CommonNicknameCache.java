...
public class CommonNicknameCache  {
    ...
    private void preloadNicknameBloomFilter() {
        ...
        // Gionee:wangth 20121225 modify for CR00751311 begin
        SQLiteDatabase nDb = mDb;
        if (!mDb.isOpen()) {
            nDb = ContactsProvider2.mGnContactsHelper.getWritableDatabase();
        }
        
        Cursor cursor = nDb.query(NicknameLookupPreloadQuery.TABLE,
                NicknameLookupPreloadQuery.COLUMNS,
                null, null, null, null, null);
        // Gionee:wangth 20121225 modify for CR00751311 end
        try {
