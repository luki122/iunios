...
public class ChineseToPinyinHelper {
	...
	public static String[][] translateMulti(String input, boolean flag) {
        ...
        for (int i = 0; i < inputLength; i++) {
            ...
            if (character < 256) {
                // aurora <wangth> <2014-2-19> modify for aurora begin
                if (flag) {
