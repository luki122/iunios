...
//            Log.d("JXH", "--------mFileName:"+mFileName+" mStatus:"+mStatus+" mCurrentBytes:"+mCurrentBytes+" mTotalBytes:"+mTotalBytes);
            return values;
        }
    ...
    public void run() {
        ...
        try {
            ...
            Log.i("JXH", "Download " + mInfo.mId + " starting ,currentThread id: " +
                    Thread.currentThread().getId()+" mInfo.mStatus:"+mInfo.mStatus);
            ...
            try {
                ...
                switch (responseCode) {
                    ...
                    case HTTP_PARTIAL:
                        ...
                        Log.d(Constants.TAG, "HTTP_PARTIAL");
                        transferData(conn);
                        return;
    ...
    private void transferData(InputStream in, OutputStream out, FileDescriptor outFd)
        ...
        Log.d(Constants.TAG, "transferData");
        while (true) {
