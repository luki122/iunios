...
public class OpenHelper {
	...
	//paul add for BUG #15339 <2015-08-06> start
	private static String trimMimeType(String mimeType){
		if(null != mimeType && mimeType.startsWith("\"") && mimeType.endsWith("\"") ){
			return mimeType.substring(1, mimeType.length() - 1);
		}
		return mimeType;
	}
	//paul add for BUG #15339 <2015-08-06> end
    ...
    private static Intent buildViewIntent(Context context, long id) {
        ...
        try {
			...
			//paul modify for BUG #15339 <2015-08-06>
            String mimeType = trimMimeType(getCursorString(cursor, COLUMN_MEDIA_TYPE));//getCursorString(cursor, COLUMN_MEDIA_TYPE)
