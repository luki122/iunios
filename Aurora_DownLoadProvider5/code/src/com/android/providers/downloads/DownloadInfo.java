...
public class DownloadInfo {
     ...
     * {@link Executor}.
     *
     * @return If actively downloading.ThreadPoolExecutor
     */
        ...
        synchronized (this) {
            ...
            if (isReady && !isActive) {
                if (mStatus != Impl.STATUS_RUNNING) {
                    ...
                    //modify by JXH begin STATUS_PENDING
                    ContentValues values = new ContentValues();
                    if (((ThreadPoolExecutor)executor).getActiveCount() < DownloadService.maxConcurrent) {
                    ...
                    //modify by JXH end STATUS_PENDING
                }
