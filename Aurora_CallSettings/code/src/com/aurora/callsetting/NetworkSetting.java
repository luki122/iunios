...
public class NetworkSetting extends AuroraPreferenceActivity
//aurora change liguangyu 20131102 for Settings Theme end
    ...
    private HashMap<AuroraPreference, OperatorInfo> mNetworkMap;
    ...
    //preference objects
    private AuroraPreferenceScreen mNetworkList;
    private AuroraPreference mSearchButton;
    private AuroraPreference mAutoSelect;
...
//            loadNetworksList();
    ...
    public boolean onPreferenceTreeClick(AuroraPreferenceScreen preferenceScreen, AuroraPreference preference) {
        ...
        if (preference == mSearchButton) {
        	...
        	AuroraPreference selectedCarrier = preference;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //aurora change liguangyu 20131102 for Settings Theme start
        getAuroraActionBar().setTitle(R.string.label_available);
        //aurora change liguangyu 20131102 for Settings Theme end
        ...
        mNetworkList = (AuroraPreferenceScreen) getPreferenceScreen().findPreference(LIST_NETWORKS_KEY);
        mNetworkMap = new HashMap<AuroraPreference, OperatorInfo>();
        ...
        if (status != NetworkQueryService.QUERY_OK) {
            ...
            if (result != null){
                ...
                for (OperatorInfo ni : result) {
                	AuroraPreference carrier = new AuroraPreference(this, null);
                    carrier.setTitle(PhoneUtils.getNetworkTitle(ni));
...
//        //aurora modify liguangyu 20140925 for cta start
...
//			}
//    	}    	 
//    	return title + convertNetTypeToName(Integer.valueOf(ni.getRadioTech()));
//        //aurora modify liguangyu 20140925 for cta end
//    }

    private void clearList() {
        for (AuroraPreference p : mNetworkMap.keySet()) {
    ...
    private void postTransientNotification(int notifyId, CharSequence msg) {
        if (mToast != null) {
            mToast.cancel();
        }
