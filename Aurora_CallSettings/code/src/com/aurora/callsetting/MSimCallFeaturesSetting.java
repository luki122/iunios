 ...
 *
 * @see com.aurora.callsetting.MSimMobileNetworkSettings
 */
public class MSimCallFeaturesSetting extends AuroraPreferenceActivity
    ...
    private AuroraSwitchPreference mOverTurn, mRinger, mTouch;
    private SharedPreferences mOutSp;
    ...
    public boolean onPreferenceChange(AuroraPreference preference, Object objValue) {
        ...
        if (preference == mButtonDTMF) {
        	...
        	final SharedPreferences.Editor editor = mOutSp.edit();
            editor.putBoolean("overturn", (Boolean) objValue);
            editor.commit();
        } else if (preference == mRinger) {
        	final SharedPreferences.Editor editor = mOutSp.edit();
            editor.putBoolean("ringermode", (Boolean) objValue);
            editor.commit();
        } else if(preference == mTouch) {
           	final SharedPreferences.Editor editor = mOutSp.edit();
            editor.putBoolean("touch", (Boolean) objValue);
            editor.commit();
        }
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mOverTurn = (AuroraSwitchPreference) findPreference("aurora_incoming_touch_switch");
        mRinger = (AuroraSwitchPreference) findPreference("aurora_ringer_switch");
        mTouch = (AuroraSwitchPreference) findPreference("aurora_incoming_touch_switch");
...
/*        if(mDialpadAutocomplete != null) {
        ...
        mOutSp = getSharedPreferences("com.android.phone.settings",Context.MODE_WORLD_READABLE);
    }
