...
import com.aurora.callsetting.sip.SipSharedPreferences;
 ...
 *
 * Note that this activity is part of the package com.aurora.callsetting, even
 ...
 *
 * @see com.aurora.callsetting.MobileNetworkSettings
 */
public class CallFeaturesSetting extends AuroraPreferenceActivity
    ...
    public static final String ACTION_ADD_VOICEMAIL =
            "com.aurora.callsetting.CallFeaturesSetting.ADD_VOICEMAIL";
    // intent action sent by this activity to a voice mail provider
    // to trigger its configuration UI
    public static final String ACTION_CONFIGURE_VOICEMAIL =
            "com.aurora.callsetting.CallFeaturesSetting.CONFIGURE_VOICEMAIL";
    // Extra put in the return from VM provider config containing voicemail number to set
    public static final String VM_NUMBER_EXTRA = "com.aurora.callsetting.VoicemailNumber";
    // Extra put in the return from VM provider config containing call forwarding number to set
    public static final String FWD_NUMBER_EXTRA = "com.aurora.callsetting.ForwardingNumber";
    // Extra put in the return from VM provider config containing call forwarding number to set
    public static final String FWD_NUMBER_TIME_EXTRA = "com.aurora.callsetting.ForwardingNumberTime";
    // If the VM provider returns non null value in this extra we will force the user to
    // choose another VM provider
    public static final String SIGNOUT_EXTRA = "com.aurora.callsetting.Signout";
     ...
     */
    public static final String IGNORE_PROVIDER_EXTRA = "com.aurora.callsetting.ProviderToIgnore";
    ...
    private AuroraListPreference mButtonTTY;
    ...
    protected Dialog onCreateDialog(int id) {
        if ((id == VM_RESPONSE_ERROR) || (id == VM_NOCHANGE_ERROR) ||
            ...
            AuroraAlertDialog dialog = b.create();
    ...
    protected void onCreate(Bundle icicle) {
        ...
        getAuroraActionBar().setTitle(R.string.call_settings);
        ...
        mButtonTTY = (AuroraListPreference) findPreference(BUTTON_TTY_KEY);
        ...
        if (!getResources().getBoolean(R.bool.world_phone)) {
            AuroraPreference options = (AuroraPreference)prefSet.findPreference(BUTTON_CDMA_OPTIONS);
            if (options != null)
            ...
            if (phoneType == PhoneConstants.PHONE_TYPE_CDMA) {
            	AuroraPreference fdnButton = (AuroraPreference)prefSet.findPreference(BUTTON_FDN_KEY);
                if (fdnButton != null)
...
//        }
        ...
        AuroraPreferenceCategory ring = (AuroraPreferenceCategory) findPreference("button_ringtone_category_key");
   		 if(ring != null) {
   			 prefSet.removePreference(ring);
   		 }
   		 AuroraPreferenceScreen voicemail = (AuroraPreferenceScreen) findPreference("button_voicemail_category_key");
   		 if(voicemail != null) {
		 ...
		 AuroraPreferenceScreen sms = (AuroraPreferenceScreen) findPreference("button_respond_via_sms_key");
  		 if(sms != null) {
  			 prefSet.removePreference(sms);
  		 } 
  		 AuroraPreferenceScreen fdn = (AuroraPreferenceScreen) findPreference("button_fdn_key");
 		 if(fdn != null) {
 			 prefSet.removePreference(fdn);
 		 } 
    ...
    private AuroraListPreference getSipCallOptionPreference() {
        AuroraListPreference wifiAnd3G = (AuroraListPreference)
                findPreference(BUTTON_SIP_CALL_OPTIONS);
        AuroraListPreference wifiOnly = (AuroraListPreference)
                findPreference(BUTTON_SIP_CALL_OPTIONS_WIFI_ONLY);
        AuroraPreferenceGroup sipSettings = (AuroraPreferenceGroup)
    ...
    protected void onResume() {
        ...
        if (isAirplaneModeOn()) {
        	AuroraPreference sipSettings = (AuroraPreference)findPreference(SIP_SETTINGS_CATEGORY_KEY);
        	AuroraPreferenceScreen screen = (AuroraPreferenceScreen)getPreferenceScreen();
            int count = screen.getPreferenceCount();
            for (int i = 0 ; i < count ; ++i) {
                AuroraPreference pref = (AuroraPreference)screen.getPreference(i);
    ...
    private void handleTTYChange(AuroraPreference preference, Object objValue) {
//        int buttonTtyMode;
