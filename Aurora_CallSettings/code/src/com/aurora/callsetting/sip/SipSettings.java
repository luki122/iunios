...
import com.aurora.callsetting.CallFeaturesSetting;
 ...
 */
public class SipSettings extends AuroraPreferenceActivity {
    ...
    private AuroraCheckBoxPreference mButtonSipReceiveCalls;
    private AuroraPreferenceCategory mSipListContainer;
    private Map<String, SipPreference> mSipPreferenceMap;
    private List<SipProfile> mSipProfileList;
    private SipSharedPreferences mSipSharedPreferences;
    private int mUid = Process.myUid();

    private class SipPreference extends AuroraPreference {
        SipProfile mProfile;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSipListContainer = (AuroraPreferenceCategory) findPreference(PREF_SIP_LIST);
...
//        }
    ...
    private void registerForReceiveCallsCheckBox() {
        mButtonSipReceiveCalls = (AuroraCheckBoxPreference) findPreference
                ...
                new AuroraPreference.OnPreferenceClickListener() {
                    public boolean onPreferenceClick(AuroraPreference preference) {
                        final boolean enabled =
                                ((AuroraCheckBoxPreference) preference).isChecked();
